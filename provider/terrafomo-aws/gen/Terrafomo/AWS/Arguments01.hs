...
instance HasAbortIncompleteMultipartUploadDays a b => HasAbortIncompleteMultipartUploadDays (TF.Resource l p a) b where
...
instance HasAccelerationStatus a b => HasAccelerationStatus (TF.Resource l p a) b where
...
instance HasAcceptanceRequired a b => HasAcceptanceRequired (TF.Resource l p a) b where
...
instance HasAcceptedRouteCount a b => HasAcceptedRouteCount (TF.Resource l p a) b where
    acceptedRouteCount = TF.configuration . acceptedRouteCount

class HasAccepter a b | a -> b where
    accepter :: P.Lens' a b

instance HasAccepter a b => HasAccepter (TF.Resource l p a) b where
...
instance HasAccessLogSettings a b => HasAccessLogSettings (TF.Resource l p a) b where
    accessLogSettings = TF.configuration . accessLogSettings

class HasAccessLogs a b | a -> b where
    accessLogs :: P.Lens' a b

instance HasAccessLogs a b => HasAccessLogs (TF.Resource l p a) b where
    accessLogs = TF.configuration . accessLogs

class HasAccessPolicies a b | a -> b where
    accessPolicies :: P.Lens' a b

instance HasAccessPolicies a b => HasAccessPolicies (TF.Resource l p a) b where
...
instance HasAccountAggregationSource a b => HasAccountAggregationSource (TF.Resource l p a) b where
...
instance HasAccountIds a b => HasAccountIds (TF.Resource l p a) b where
...
instance HasAcmCertificateArn a b => HasAcmCertificateArn (TF.Resource l p a) b where
...
instance HasActionOnFailure a b => HasActionOnFailure (TF.Resource l p a) b where
    actionOnFailure = TF.configuration . actionOnFailure

class HasActionOnTimeout a b | a -> b where
    actionOnTimeout :: P.Lens' a b

instance HasActionOnTimeout a b => HasActionOnTimeout (TF.Resource l p a) b where
...
instance HasActionsEnabled a b => HasActionsEnabled (TF.Resource l p a) b where
    actionsEnabled = TF.configuration . actionsEnabled

class HasActivate a b | a -> b where
    activate :: P.Lens' a b

instance HasActivate a b => HasActivate (TF.Resource l p a) b where
    activate = TF.configuration . activate

class HasActivatedRule a b | a -> b where
    activatedRule :: P.Lens' a b

instance HasActivatedRule a b => HasActivatedRule (TF.Resource l p a) b where
    activatedRule = TF.configuration . activatedRule

class HasActivationKey a b | a -> b where
    activationKey :: P.Lens' a b

instance HasActivationKey a b => HasActivationKey (TF.Resource l p a) b where
...
instance HasAdDomainJoinPassword a b => HasAdDomainJoinPassword (TF.Resource l p a) b where
...
instance HasAdDomainJoinUser a b => HasAdDomainJoinUser (TF.Resource l p a) b where
    adDomainJoinUser = TF.configuration . adDomainJoinUser

class HasAddHeaderAction a b | a -> b where
    addHeaderAction :: P.Lens' a b

instance HasAddHeaderAction a b => HasAddHeaderAction (TF.Resource l p a) b where
    addHeaderAction = TF.configuration . addHeaderAction

class HasAdditionalInfo a b | a -> b where
    additionalInfo :: P.Lens' a b

instance HasAdditionalInfo a b => HasAdditionalInfo (TF.Resource l p a) b where
...
instance HasAdditionalMasterSecurityGroups a b => HasAdditionalMasterSecurityGroups (TF.Resource l p a) b where
...
instance HasAdditionalSlaveSecurityGroups a b => HasAdditionalSlaveSecurityGroups (TF.Resource l p a) b where
...
instance HasAdditionalVersionWeights a b => HasAdditionalVersionWeights (TF.Resource l p a) b where
...
instance HasAdminCreateUserConfig a b => HasAdminCreateUserConfig (TF.Resource l p a) b where
...
instance HasAdvancedOptions a b => HasAdvancedOptions (TF.Resource l p a) b where
...
instance HasAllocationStrategy a b => HasAllocationStrategy (TF.Resource l p a) b where
...
instance HasAllowAdminCreateUserOnly a b => HasAllowAdminCreateUserOnly (TF.Resource l p a) b where
...
instance HasAllowClassicLinkToRemoteVpc a b => HasAllowClassicLinkToRemoteVpc (TF.Resource l p a) b where
...
instance HasAllowMajorVersionUpgrade a b => HasAllowMajorVersionUpgrade (TF.Resource l p a) b where
...
instance HasAllowOverwrite a b => HasAllowOverwrite (TF.Resource l p a) b where
    allowOverwrite = TF.configuration . allowOverwrite

class HasAllowReassociation a b | a -> b where
    allowReassociation :: P.Lens' a b

instance HasAllowReassociation a b => HasAllowReassociation (TF.Resource l p a) b where
...
instance HasAllowRemoteVpcDnsResolution a b => HasAllowRemoteVpcDnsResolution (TF.Resource l p a) b where
...
instance HasAllowSelfManagement a b => HasAllowSelfManagement (TF.Resource l p a) b where
    allowSelfManagement = TF.configuration . allowSelfManagement

class HasAllowSsh a b | a -> b where
    allowSsh :: P.Lens' a b

instance HasAllowSsh a b => HasAllowSsh (TF.Resource l p a) b where
    allowSsh = TF.configuration . allowSsh

class HasAllowSudo a b | a -> b where
    allowSudo :: P.Lens' a b

instance HasAllowSudo a b => HasAllowSudo (TF.Resource l p a) b where
    allowSudo = TF.configuration . allowSudo

class HasAllowUnassociatedTargets a b | a -> b where
    allowUnassociatedTargets :: P.Lens' a b

instance HasAllowUnassociatedTargets a b => HasAllowUnassociatedTargets (TF.Resource l p a) b where
...
instance HasAllowUnauthenticatedIdentities a b => HasAllowUnauthenticatedIdentities (TF.Resource l p a) b where
...
instance HasAllowUsersToChangePassword a b => HasAllowUsersToChangePassword (TF.Resource l p a) b where
...
instance HasAllowVersionUpgrade a b => HasAllowVersionUpgrade (TF.Resource l p a) b where
...
instance HasAllowVpcToRemoteClassicLink a b => HasAllowVpcToRemoteClassicLink (TF.Resource l p a) b where
...
instance HasAllowedAccountIds a b => HasAllowedAccountIds (TF.Resource l p a) b where
...
instance HasAllowedOauthFlows a b => HasAllowedOauthFlows (TF.Resource l p a) b where
...
instance HasAllowedOauthFlowsUserPoolClient a b => HasAllowedOauthFlowsUserPoolClient (TF.Resource l p a) b where
...
instance HasAllowedOauthScopes a b => HasAllowedOauthScopes (TF.Resource l p a) b where
...
instance HasApplicationFailureFeedbackRoleArn a b => HasApplicationFailureFeedbackRoleArn (TF.Resource l p a) b where
...
instance HasApplicationSuccessFeedbackRoleArn a b => HasApplicationSuccessFeedbackRoleArn (TF.Resource l p a) b where
...
instance HasApplicationSuccessFeedbackSampleRate a b => HasApplicationSuccessFeedbackSampleRate (TF.Resource l p a) b where
...
instance HasApplications a b => HasApplications (TF.Resource l p a) b where
    applications = TF.configuration . applications

class HasApplyImmediately a b | a -> b where
    applyImmediately :: P.Lens' a b

instance HasApplyImmediately a b => HasApplyImmediately (TF.Resource l p a) b where
    applyImmediately = TF.configuration . applyImmediately

class HasApplyMethod a b | a -> b where
    applyMethod :: P.Lens' a b

instance HasApplyMethod a b => HasApplyMethod (TF.Resource l p a) b where
...
instance HasApplyServerSideEncryptionByDefault a b => HasApplyServerSideEncryptionByDefault (TF.Resource l p a) b where
...
instance HasApprovalRule a b => HasApprovalRule (TF.Resource l p a) b where
    approvalRule = TF.configuration . approvalRule

class HasApproveAfterDays a b | a -> b where
    approveAfterDays :: P.Lens' a b

instance HasApproveAfterDays a b => HasApproveAfterDays (TF.Resource l p a) b where
    approveAfterDays = TF.configuration . approveAfterDays

class HasApprovedPatches a b | a -> b where
    approvedPatches :: P.Lens' a b

instance HasApprovedPatches a b => HasApprovedPatches (TF.Resource l p a) b where
...
instance HasApprovedPatchesComplianceLevel a b => HasApprovedPatchesComplianceLevel (TF.Resource l p a) b where
...
instance HasAppversionLifecycle a b => HasAppversionLifecycle (TF.Resource l p a) b where
    appversionLifecycle = TF.configuration . appversionLifecycle

class HasArchitecture a b | a -> b where
    architecture :: P.Lens' a b

instance HasArchitecture a b => HasArchitecture (TF.Resource l p a) b where
...
instance HasAssignGeneratedIpv6CidrBlock a b => HasAssignGeneratedIpv6CidrBlock (TF.Resource l p a) b where
...
instance HasAssignIpv6AddressOnCreation a b => HasAssignIpv6AddressOnCreation (TF.Resource l p a) b where
...
instance HasAssignPublicIp a b => HasAssignPublicIp (TF.Resource l p a) b where
...
instance HasAssociatePublicIpAddress a b => HasAssociatePublicIpAddress (TF.Resource l p a) b where
...
instance HasAssociateWithPrivateIp a b => HasAssociateWithPrivateIp (TF.Resource l p a) b where
...
instance HasAssociationName a b => HasAssociationName (TF.Resource l p a) b where
    associationName = TF.configuration . associationName

class HasAssumeRole a b | a -> b where
    assumeRole :: P.Lens' a b

instance HasAssumeRole a b => HasAssumeRole (TF.Resource l p a) b where
    assumeRole = TF.configuration . assumeRole

class HasAssumeRolePolicy a b | a -> b where
    assumeRolePolicy :: P.Lens' a b

instance HasAssumeRolePolicy a b => HasAssumeRolePolicy (TF.Resource l p a) b where
...
instance HasAtRestEncryptionEnabled a b => HasAtRestEncryptionEnabled (TF.Resource l p a) b where
...
instance HasAttachedVpcId a b => HasAttachedVpcId (TF.Resource l p a) b where
    attachedVpcId = TF.configuration . attachedVpcId

class HasAttachment a b | a -> b where
    attachment :: P.Lens' a b

instance HasAttachment a b => HasAttachment (TF.Resource l p a) b where
    attachment = TF.configuration . attachment

class HasAttemptDurationSeconds a b | a -> b where
    attemptDurationSeconds :: P.Lens' a b

instance HasAttemptDurationSeconds a b => HasAttemptDurationSeconds (TF.Resource l p a) b where
...
instance HasAuthenticated a b => HasAuthenticated (TF.Resource l p a) b where
    authenticated = TF.configuration . authenticated

class HasAuthentication a b | a -> b where
    authentication :: P.Lens' a b

instance HasAuthentication a b => HasAuthentication (TF.Resource l p a) b where
...
instance HasAuthorization a b => HasAuthorization (TF.Resource l p a) b where
    authorization = TF.configuration . authorization

class HasAuthorizationScopes a b | a -> b where
    authorizationScopes :: P.Lens' a b

instance HasAuthorizationScopes a b => HasAuthorizationScopes (TF.Resource l p a) b where
...
instance HasAuthorizerCredentials a b => HasAuthorizerCredentials (TF.Resource l p a) b where
    authorizerCredentials = TF.configuration . authorizerCredentials

class HasAuthorizerId a b | a -> b where
    authorizerId :: P.Lens' a b

instance HasAuthorizerId a b => HasAuthorizerId (TF.Resource l p a) b where
...
instance HasAuthorizerResultTtlInSeconds a b => HasAuthorizerResultTtlInSeconds (TF.Resource l p a) b where
...
instance HasAuthorizerUri a b => HasAuthorizerUri (TF.Resource l p a) b where
    authorizerUri = TF.configuration . authorizerUri

class HasAutoAccept a b | a -> b where
    autoAccept :: P.Lens' a b

instance HasAutoAccept a b => HasAutoAccept (TF.Resource l p a) b where
    autoAccept = TF.configuration . autoAccept

class HasAutoAssignElasticIps a b | a -> b where
    autoAssignElasticIps :: P.Lens' a b

instance HasAutoAssignElasticIps a b => HasAutoAssignElasticIps (TF.Resource l p a) b where
...
instance HasAutoAssignPublicIps a b => HasAutoAssignPublicIps (TF.Resource l p a) b where
...
instance HasAutoBundleOnDeploy a b => HasAutoBundleOnDeploy (TF.Resource l p a) b where
    autoBundleOnDeploy = TF.configuration . autoBundleOnDeploy

class HasAutoHealing a b | a -> b where
    autoHealing :: P.Lens' a b

instance HasAutoHealing a b => HasAutoHealing (TF.Resource l p a) b where
    autoHealing = TF.configuration . autoHealing

class HasAutoMinorVersionUpgrade a b | a -> b where
    autoMinorVersionUpgrade :: P.Lens' a b

instance HasAutoMinorVersionUpgrade a b => HasAutoMinorVersionUpgrade (TF.Resource l p a) b where
...
instance HasAutoRollbackConfiguration a b => HasAutoRollbackConfiguration (TF.Resource l p a) b where
...
instance HasAutoScalingType a b => HasAutoScalingType (TF.Resource l p a) b where
...
instance HasAutoVerifiedAttributes a b => HasAutoVerifiedAttributes (TF.Resource l p a) b where
...
instance HasAutomatedSnapshotRetentionPeriod a b => HasAutomatedSnapshotRetentionPeriod (TF.Resource l p a) b where
...
instance HasAutomatedSnapshotStartHour a b => HasAutomatedSnapshotStartHour (TF.Resource l p a) b where
...
instance HasAutomaticFailoverEnabled a b => HasAutomaticFailoverEnabled (TF.Resource l p a) b where
...
instance HasAutomaticStopTimeMinutes a b => HasAutomaticStopTimeMinutes (TF.Resource l p a) b where
...
instance HasAutomaticallyAfterDays a b => HasAutomaticallyAfterDays (TF.Resource l p a) b where
...
instance HasAutoscalingGroupName a b => HasAutoscalingGroupName (TF.Resource l p a) b where
...
instance HasAutoscalingGroups a b => HasAutoscalingGroups (TF.Resource l p a) b where
...
instance HasAutoscalingRole a b => HasAutoscalingRole (TF.Resource l p a) b where
...
instance HasAvailabilityZones a b => HasAvailabilityZones (TF.Resource l p a) b where
...
instance HasBackupRetentionPeriod a b => HasBackupRetentionPeriod (TF.Resource l p a) b where
    backupRetentionPeriod = TF.configuration . backupRetentionPeriod

class HasBackupWindow a b | a -> b where
    backupWindow :: P.Lens' a b

instance HasBackupWindow a b => HasBackupWindow (TF.Resource l p a) b where
    backupWindow = TF.configuration . backupWindow

class HasBadgeEnabled a b | a -> b where
    badgeEnabled :: P.Lens' a b

instance HasBadgeEnabled a b => HasBadgeEnabled (TF.Resource l p a) b where
...
instance HasBlockDeviceMappings a b => HasBlockDeviceMappings (TF.Resource l p a) b where
...
instance HasBlockDurationMinutes a b => HasBlockDurationMinutes (TF.Resource l p a) b where
    blockDurationMinutes = TF.configuration . blockDurationMinutes

class HasBlockSizeBytes a b | a -> b where
    blockSizeBytes :: P.Lens' a b

instance HasBlockSizeBytes a b => HasBlockSizeBytes (TF.Resource l p a) b where
    blockSizeBytes = TF.configuration . blockSizeBytes

class HasBloomFilterColumns a b | a -> b where
    bloomFilterColumns :: P.Lens' a b

instance HasBloomFilterColumns a b => HasBloomFilterColumns (TF.Resource l p a) b where
...
instance HasBloomFilterFalsePositiveProbability a b => HasBloomFilterFalsePositiveProbability (TF.Resource l p a) b where
...
instance HasBlueGreenDeploymentConfig a b => HasBlueGreenDeploymentConfig (TF.Resource l p a) b where
...
instance HasBlueprintId a b => HasBlueprintId (TF.Resource l p a) b where
...
instance HasBucketArn a b => HasBucketArn (TF.Resource l p a) b where
    bucketArn = TF.configuration . bucketArn

class HasBucketColumns a b | a -> b where
    bucketColumns :: P.Lens' a b

instance HasBucketColumns a b => HasBucketColumns (TF.Resource l p a) b where
    bucketColumns = TF.configuration . bucketColumns

class HasBucketFolder a b | a -> b where
    bucketFolder :: P.Lens' a b

instance HasBucketFolder a b => HasBucketFolder (TF.Resource l p a) b where
...
instance HasCacheClusterSize a b => HasCacheClusterSize (TF.Resource l p a) b where
...
instance HasCacheDataEncrypted a b => HasCacheDataEncrypted (TF.Resource l p a) b where
...
instance HasCaseInsensitive a b => HasCaseInsensitive (TF.Resource l p a) b where
    caseInsensitive = TF.configuration . caseInsensitive

class HasCatalogId a b | a -> b where
    catalogId :: P.Lens' a b

instance HasCatalogId a b => HasCatalogId (TF.Resource l p a) b where
...
instance HasCdcStartTime a b => HasCdcStartTime (TF.Resource l p a) b where
...
instance HasCertificateArn a b => HasCertificateArn (TF.Resource l p a) b where
...
instance HasCertificateAuthorityConfiguration a b => HasCertificateAuthorityConfiguration (TF.Resource l p a) b where
...
instance HasCertificateId a b => HasCertificateId (TF.Resource l p a) b where
    certificateId = TF.configuration . certificateId

class HasCertificateName a b | a -> b where
    certificateName :: P.Lens' a b

instance HasCertificateName a b => HasCertificateName (TF.Resource l p a) b where
    certificateName = TF.configuration . certificateName

class HasCertificatePem a b | a -> b where
    certificatePem :: P.Lens' a b

instance HasCertificatePem a b => HasCertificatePem (TF.Resource l p a) b where
...
instance HasCertificatePrivateKey a b => HasCertificatePrivateKey (TF.Resource l p a) b where
...
instance HasChildHealthThreshold a b => HasChildHealthThreshold (TF.Resource l p a) b where
...
instance HasChildHealthchecks a b => HasChildHealthchecks (TF.Resource l p a) b where
...
instance HasClientIdList a b => HasClientIdList (TF.Resource l p a) b where
    clientIdList = TF.configuration . clientIdList

class HasClientList a b | a -> b where
    clientList :: P.Lens' a b

instance HasClientList a b => HasClientList (TF.Resource l p a) b where
    clientList = TF.configuration . clientList

class HasCloudWatchLogsGroupArn a b | a -> b where
    cloudWatchLogsGroupArn :: P.Lens' a b

instance HasCloudWatchLogsGroupArn a b => HasCloudWatchLogsGroupArn (TF.Resource l p a) b where
...
instance HasCloudWatchLogsRoleArn a b => HasCloudWatchLogsRoleArn (TF.Resource l p a) b where
...
instance HasCloudformation a b => HasCloudformation (TF.Resource l p a) b where
...
instance HasCloudfrontDefaultCertificate a b => HasCloudfrontDefaultCertificate (TF.Resource l p a) b where
...
instance HasCloudwatchAlarm a b => HasCloudwatchAlarm (TF.Resource l p a) b where
    cloudwatchAlarm = TF.configuration . cloudwatchAlarm

class HasCloudwatchAlarmName a b | a -> b where
    cloudwatchAlarmName :: P.Lens' a b

instance HasCloudwatchAlarmName a b => HasCloudwatchAlarmName (TF.Resource l p a) b where
...
instance HasCloudwatchAlarmRegion a b => HasCloudwatchAlarmRegion (TF.Resource l p a) b where
...
instance HasCloudwatchDestination a b => HasCloudwatchDestination (TF.Resource l p a) b where
...
instance HasCloudwatchLogGroupArn a b => HasCloudwatchLogGroupArn (TF.Resource l p a) b where
...
instance HasCloudwatchLoggingOptions a b => HasCloudwatchLoggingOptions (TF.Resource l p a) b where
...
instance HasClusterArn a b => HasClusterArn (TF.Resource l p a) b where
...
instance HasClusterIdentifier a b => HasClusterIdentifier (TF.Resource l p a) b where
...
instance HasClusterIdentifierPrefix a b => HasClusterIdentifierPrefix (TF.Resource l p a) b where
...
instance HasClusterJdbcurl a b => HasClusterJdbcurl (TF.Resource l p a) b where
    clusterJdbcurl = TF.configuration . clusterJdbcurl

class HasClusterMembers a b | a -> b where
    clusterMembers :: P.Lens' a b

instance HasClusterMembers a b => HasClusterMembers (TF.Resource l p a) b where
    clusterMembers = TF.configuration . clusterMembers

class HasClusterMode a b | a -> b where
    clusterMode :: P.Lens' a b

instance HasClusterMode a b => HasClusterMode (TF.Resource l p a) b where
...
instance HasClusterParameterGroupName a b => HasClusterParameterGroupName (TF.Resource l p a) b where
...
instance HasClusterPublicKey a b => HasClusterPublicKey (TF.Resource l p a) b where
...
instance HasClusterRevisionNumber a b => HasClusterRevisionNumber (TF.Resource l p a) b where
...
instance HasClusterSecurityGroups a b => HasClusterSecurityGroups (TF.Resource l p a) b where
...
instance HasCognitoOptions a b => HasCognitoOptions (TF.Resource l p a) b where
...
instance HasColumnToJsonKeyMappings a b => HasColumnToJsonKeyMappings (TF.Resource l p a) b where
    columnToJsonKeyMappings = TF.configuration . columnToJsonKeyMappings

class HasColumns a b | a -> b where
    columns :: P.Lens' a b

instance HasColumns a b => HasColumns (TF.Resource l p a) b where
...
instance HasComplianceResourceId a b => HasComplianceResourceId (TF.Resource l p a) b where
...
instance HasComplianceResourceTypes a b => HasComplianceResourceTypes (TF.Resource l p a) b where
    complianceResourceTypes = TF.configuration . complianceResourceTypes

class HasCompress a b | a -> b where
    compress :: P.Lens' a b

instance HasCompress a b => HasCompress (TF.Resource l p a) b where
    compress = TF.configuration . compress

class HasCompressed a b | a -> b where
    compressed :: P.Lens' a b

instance HasCompressed a b => HasCompressed (TF.Resource l p a) b where
...
instance HasCompressionFormat a b => HasCompressionFormat (TF.Resource l p a) b where
    compressionFormat = TF.configuration . compressionFormat

class HasCompressionType a b | a -> b where
    compressionType :: P.Lens' a b

instance HasCompressionType a b => HasCompressionType (TF.Resource l p a) b where
...
instance HasComputeEnvironmentName a b => HasComputeEnvironmentName (TF.Resource l p a) b where
...
instance HasConditions a b => HasConditions (TF.Resource l p a) b where
...
instance HasConfigurationManagerName a b => HasConfigurationManagerName (TF.Resource l p a) b where
...
instance HasConfigurationManagerVersion a b => HasConfigurationManagerVersion (TF.Resource l p a) b where
...
instance HasConfigurationSetName a b => HasConfigurationSetName (TF.Resource l p a) b where
    configurationSetName = TF.configuration . configurationSetName

class HasConfigurations a b | a -> b where
    configurations :: P.Lens' a b

instance HasConfigurations a b => HasConfigurations (TF.Resource l p a) b where
    configurations = TF.configuration . configurations

class HasConfigurationsJson a b | a -> b where
    configurationsJson :: P.Lens' a b

instance HasConfigurationsJson a b => HasConfigurationsJson (TF.Resource l p a) b where
...
instance HasConfirmationTimeoutInMinutes a b => HasConfirmationTimeoutInMinutes (TF.Resource l p a) b where
...
instance HasConnectSettings a b => HasConnectSettings (TF.Resource l p a) b where
    connectSettings = TF.configuration . connectSettings

class HasConnectionDraining a b | a -> b where
    connectionDraining :: P.Lens' a b

instance HasConnectionDraining a b => HasConnectionDraining (TF.Resource l p a) b where
...
instance HasConnectionDrainingTimeout a b => HasConnectionDrainingTimeout (TF.Resource l p a) b where
...
instance HasConnectionEvents a b => HasConnectionEvents (TF.Resource l p a) b where
    connectionEvents = TF.configuration . connectionEvents

class HasConnectionId a b | a -> b where
    connectionId :: P.Lens' a b

instance HasConnectionId a b => HasConnectionId (TF.Resource l p a) b where
    connectionId = TF.configuration . connectionId

class HasConnectionName a b | a -> b where
    connectionName :: P.Lens' a b

instance HasConnectionName a b => HasConnectionName (TF.Resource l p a) b where
...
instance HasConnectionNotificationArn a b => HasConnectionNotificationArn (TF.Resource l p a) b where
...
instance HasContainerDefinitions a b => HasContainerDefinitions (TF.Resource l p a) b where
...
instance HasContainerPort a b => HasContainerPort (TF.Resource l p a) b where
    containerPort = TF.configuration . containerPort

class HasContainerProperties a b | a -> b where
    containerProperties :: P.Lens' a b

instance HasContainerProperties a b => HasContainerProperties (TF.Resource l p a) b where
...
instance HasContentBase64 a b => HasContentBase64 (TF.Resource l p a) b where
...
instance HasContentBasedDeduplication a b => HasContentBasedDeduplication (TF.Resource l p a) b where
...
instance HasContentConfig a b => HasContentConfig (TF.Resource l p a) b where
...
instance HasContentConfigPermissions a b => HasContentConfigPermissions (TF.Resource l p a) b where
