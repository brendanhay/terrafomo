...
instance P.HasBucket (AthenaDatabaseResource s) (TF.Attr s Text) where
    bucket =
        lens (_bucket :: AthenaDatabaseResource s -> TF.Attr s Text)
             (\s a -> s { _bucket = a } :: AthenaDatabaseResource s)

instance P.HasForceDestroy (AthenaDatabaseResource s) (TF.Attr s Text) where
    forceDestroy =
        lens (_force_destroy :: AthenaDatabaseResource s -> TF.Attr s Text)
...
instance P.HasComputedBucket (AthenaDatabaseResource s) s (TF.Attr s Text) where
    computedBucket =
        (_bucket :: AthenaDatabaseResource s -> TF.Attr s Text)
            . TF.refValue

instance P.HasComputedForceDestroy (AthenaDatabaseResource s) s (TF.Attr s Text) where
    computedForceDestroy =
        (_force_destroy :: AthenaDatabaseResource s -> TF.Attr s Text)
            . TF.refValue

instance P.HasComputedId (AthenaDatabaseResource s) s (TF.Attr s Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
data EmrClusterResource s = EmrClusterResource {
    ...
    , _scale_down_behavior               :: !(TF.Attr s Text)
...
instance P.HasScaleDownBehavior (EmrClusterResource s) (TF.Attr s Text) where
    scaleDownBehavior =
        lens (_scale_down_behavior :: EmrClusterResource s -> TF.Attr s Text)
...
instance P.HasComputedScaleDownBehavior (EmrClusterResource s) s (TF.Attr s Text) where
    computedScaleDownBehavior =
        (_scale_down_behavior :: EmrClusterResource s -> TF.Attr s Text)
            . TF.refValue
