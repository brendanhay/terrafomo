...
wafregionalWebAclAssociationResource
    ...
    -> TF.Resource AWS (WafregionalWebAclAssociationResource s)
...
instance P.HasResourceArn (WafregionalWebAclAssociationResource s) (TF.Attr s P.Text) where
    resourceArn =
        lens (_resourceArn :: (WafregionalWebAclAssociationResource s) -> (TF.Attr s P.Text))
...
instance P.HasWebAclId (WafregionalWebAclAssociationResource s) (TF.Attr s P.Text) where
    webAclId =
        lens (_webAclId :: (WafregionalWebAclAssociationResource s) -> (TF.Attr s P.Text))
...
data (WafregionalXssMatchSetResource s) = WafregionalXssMatchSetResource'
    ...
    , _xssMatchTuple :: (TF.Attr s (XssMatchTuple s))
    } deriving (Show, Eq, Generic)
...
wafregionalXssMatchSetResource
    ...
    -> TF.Resource AWS (WafregionalXssMatchSetResource s)
...
instance P.HasXssMatchTuple (WafregionalXssMatchSetResource s) (TF.Attr s (XssMatchTuple s)) where
    xssMatchTuple =
        lens (_xssMatchTuple :: (WafregionalXssMatchSetResource s) -> (TF.Attr s (XssMatchTuple s)))
