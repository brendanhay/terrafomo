...
data CognitoUserPoolResource s = CognitoUserPoolResource'
    { _adminCreateUserConfig :: TF.Attr s (CognitoUserPoolAdminCreateUserConfig s)
    ...
    --
    , _lambdaConfig :: TF.Attr s (CognitoUserPoolLambdaConfig s)
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _passwordPolicy :: TF.Attr s (CognitoUserPoolPasswordPolicy s)
    ...
    --
    -- * 'aliasAttributes'
    , _verificationMessageTemplate :: TF.Attr s (CognitoUserPoolVerificationMessageTemplate s)
        ...
        , if (_usernameAttributes P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_adminCreateUserConfig"
                  (_adminCreateUserConfig
                      :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolAdminCreateUserConfig s))
                  TF.validator
           ...
           P.<> TF.settingsValidator "_lambdaConfig"
                  (_lambdaConfig
                      :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolLambdaConfig s))
                  TF.validator
           P.<> TF.settingsValidator "_passwordPolicy"
                  (_passwordPolicy
                      :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolPasswordPolicy s))
                  TF.validator
           ...
           P.<> TF.settingsValidator "_verificationMessageTemplate"
                  (_verificationMessageTemplate
                      :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolVerificationMessageTemplate s))
                  TF.validator

instance P.HasAdminCreateUserConfig (CognitoUserPoolResource s) (TF.Attr s (CognitoUserPoolAdminCreateUserConfig s)) where
    adminCreateUserConfig =
        P.lens (_adminCreateUserConfig :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolAdminCreateUserConfig s))
...
instance P.HasLambdaConfig (CognitoUserPoolResource s) (TF.Attr s (CognitoUserPoolLambdaConfig s)) where
    lambdaConfig =
        P.lens (_lambdaConfig :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolLambdaConfig s))
...
instance P.HasPasswordPolicy (CognitoUserPoolResource s) (TF.Attr s (CognitoUserPoolPasswordPolicy s)) where
    passwordPolicy =
        P.lens (_passwordPolicy :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolPasswordPolicy s))
...
instance P.HasVerificationMessageTemplate (CognitoUserPoolResource s) (TF.Attr s (CognitoUserPoolVerificationMessageTemplate s)) where
    verificationMessageTemplate =
        P.lens (_verificationMessageTemplate :: CognitoUserPoolResource s -> TF.Attr s (CognitoUserPoolVerificationMessageTemplate s))
...
configConfigRuleResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s (ConfigConfigRuleSource s) -- ^ @source@ ('P._source', 'P.source')
...
data ConfigConfigurationRecorderResource s = ConfigConfigurationRecorderResource'
    ...
    --
    , _recordingGroup :: TF.Attr s (ConfigConfigurationRecorderRecordingGroup s)
...
instance TF.IsValid (ConfigConfigurationRecorderResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_recordingGroup"
                  (_recordingGroup
                      :: ConfigConfigurationRecorderResource s -> TF.Attr s (ConfigConfigurationRecorderRecordingGroup s))
                  TF.validator
...
instance P.HasRecordingGroup (ConfigConfigurationRecorderResource s) (TF.Attr s (ConfigConfigurationRecorderRecordingGroup s)) where
    recordingGroup =
        P.lens (_recordingGroup :: ConfigConfigurationRecorderResource s -> TF.Attr s (ConfigConfigurationRecorderRecordingGroup s))
...
data DaxParameterGroupResource s = DaxParameterGroupResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _parameters  :: TF.Attr s [TF.Attr s (DaxParameterGroupParameters s)]
    -- ^ @parameters@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasParameters (DaxParameterGroupResource s) (TF.Attr s [TF.Attr s (DaxParameterGroupParameters s)]) where
    parameters =
        P.lens (_parameters :: DaxParameterGroupResource s -> TF.Attr s [TF.Attr s (DaxParameterGroupParameters s)])
...
dbSecurityGroupResource
    :: TF.Attr s [TF.Attr s (DbSecurityGroupIngress s)] -- ^ @ingress@ ('P._ingress', 'P.ingress')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
data DefaultRouteTableResource s = DefaultRouteTableResource'
    ...
    --
    , _route               :: TF.Attr s [TF.Attr s (DefaultRouteTableRoute s)]
    -- ^ @route@ - (Optional)
    --
    , _tags                :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance P.HasRoute (DefaultRouteTableResource s) (TF.Attr s [TF.Attr s (DefaultRouteTableRoute s)]) where
    route =
        P.lens (_route :: DefaultRouteTableResource s -> TF.Attr s [TF.Attr s (DefaultRouteTableRoute s)])
...
dynamodbGlobalTableResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s [TF.Attr s (DynamodbGlobalTableReplica s)] -- ^ @replica@ ('P._replica', 'P.replica')
...
data DynamodbTableResource s = DynamodbTableResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _pointInTimeRecovery :: TF.Attr s (DynamodbTablePointInTimeRecovery s)
...
dynamodbTableResource
    :: TF.Attr s [TF.Attr s (DynamodbTableAttribute s)] -- ^ @attribute@ ('P._attribute', 'P.attribute')
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_pointInTimeRecovery"
                  (_pointInTimeRecovery
                      :: DynamodbTableResource s -> TF.Attr s (DynamodbTablePointInTimeRecovery s))
                  TF.validator
           P.<> TF.settingsValidator "_serverSideEncryption"
                  (_serverSideEncryption
                      :: DynamodbTableResource s -> TF.Attr s (DynamodbTableServerSideEncryption s))
                  TF.validator
...
instance P.HasPointInTimeRecovery (DynamodbTableResource s) (TF.Attr s (DynamodbTablePointInTimeRecovery s)) where
    pointInTimeRecovery =
        P.lens (_pointInTimeRecovery :: DynamodbTableResource s -> TF.Attr s (DynamodbTablePointInTimeRecovery s))
...
instance P.HasServerSideEncryption (DynamodbTableResource s) (TF.Attr s (DynamodbTableServerSideEncryption s)) where
    serverSideEncryption =
        P.lens (_serverSideEncryption :: DynamodbTableResource s -> TF.Attr s (DynamodbTableServerSideEncryption s))
...
eksClusterResource
    :: TF.Attr s P.Text -- ^ @role_arn@ ('P._roleArn', 'P.roleArn')
    -> TF.Attr s (EksClusterVpcConfig s) -- ^ @vpc_config@ ('P._vpcConfig', 'P.vpcConfig')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
data ElasticBeanstalkConfigurationTemplateResource s = ElasticBeanstalkConfigurationTemplateResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _setting :: TF.Attr s [TF.Attr s (ElasticBeanstalkConfigurationTemplateSetting s)]
    -- ^ @setting@ - (Optional)
    --
...
instance P.HasSetting (ElasticBeanstalkConfigurationTemplateResource s) (TF.Attr s [TF.Attr s (ElasticBeanstalkConfigurationTemplateSetting s)]) where
    setting =
        P.lens (_setting :: ElasticBeanstalkConfigurationTemplateResource s -> TF.Attr s [TF.Attr s (ElasticBeanstalkConfigurationTemplateSetting s)])
...
data ElasticacheReplicationGroupResource s = ElasticacheReplicationGroupResource'
    ...
    -- ^ @availability_zones@ - (Optional, Forces New)
    --
    , _clusterMode :: TF.Attr s (ElasticacheReplicationGroupClusterMode s)
...
instance TF.IsValid (ElasticacheReplicationGroupResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_clusterMode"
                  (_clusterMode
                      :: ElasticacheReplicationGroupResource s -> TF.Attr s (ElasticacheReplicationGroupClusterMode s))
                  TF.validator
...
instance P.HasClusterMode (ElasticacheReplicationGroupResource s) (TF.Attr s (ElasticacheReplicationGroupClusterMode s)) where
    clusterMode =
        P.lens (_clusterMode :: ElasticacheReplicationGroupResource s -> TF.Attr s (ElasticacheReplicationGroupClusterMode s))
...
data ElasticsearchDomainResource s = ElasticsearchDomainResource'
    ...
    --
    , _clusterConfig :: TF.Attr s [TF.Attr s (ElasticsearchDomainClusterConfig s)]
    ...
    --
    , _ebsOptions :: TF.Attr s [TF.Attr s (ElasticsearchDomainEbsOptions s)]
    -- ^ @ebs_options@ - (Optional)
    --
    , _elasticsearchVersion :: TF.Attr s P.Text
    -- ^ @elasticsearch_version@ - (Optional, Forces New)
    --
    , _encryptAtRest :: TF.Attr s (ElasticsearchDomainEncryptAtRest s)
...
instance TF.IsValid (ElasticsearchDomainResource s) where
    validator = P.mempty
           ...
           P.<> TF.settingsValidator "_encryptAtRest"
                  (_encryptAtRest
                      :: ElasticsearchDomainResource s -> TF.Attr s (ElasticsearchDomainEncryptAtRest s))
                  TF.validator
...
instance P.HasClusterConfig (ElasticsearchDomainResource s) (TF.Attr s [TF.Attr s (ElasticsearchDomainClusterConfig s)]) where
    clusterConfig =
        P.lens (_clusterConfig :: ElasticsearchDomainResource s -> TF.Attr s [TF.Attr s (ElasticsearchDomainClusterConfig s)])
...
instance P.HasEbsOptions (ElasticsearchDomainResource s) (TF.Attr s [TF.Attr s (ElasticsearchDomainEbsOptions s)]) where
    ebsOptions =
        P.lens (_ebsOptions :: ElasticsearchDomainResource s -> TF.Attr s [TF.Attr s (ElasticsearchDomainEbsOptions s)])
...
instance P.HasEncryptAtRest (ElasticsearchDomainResource s) (TF.Attr s (ElasticsearchDomainEncryptAtRest s)) where
    encryptAtRest =
        P.lens (_encryptAtRest :: ElasticsearchDomainResource s -> TF.Attr s (ElasticsearchDomainEncryptAtRest s))
...
data ElastictranscoderPipelineResource s = ElastictranscoderPipelineResource'
    ...
    --
    , _contentConfig :: TF.Attr s (ElastictranscoderPipelineContentConfig s)
    ...
    -- ^ @role@ - (Required)
    --
    , _thumbnailConfig :: TF.Attr s (ElastictranscoderPipelineThumbnailConfig s)
...
instance TF.IsValid (ElastictranscoderPipelineResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_contentConfig"
                  (_contentConfig
                      :: ElastictranscoderPipelineResource s -> TF.Attr s (ElastictranscoderPipelineContentConfig s))
                  TF.validator
           ...
           P.<> TF.settingsValidator "_thumbnailConfig"
                  (_thumbnailConfig
                      :: ElastictranscoderPipelineResource s -> TF.Attr s (ElastictranscoderPipelineThumbnailConfig s))
                  TF.validator
...
instance P.HasContentConfig (ElastictranscoderPipelineResource s) (TF.Attr s (ElastictranscoderPipelineContentConfig s)) where
    contentConfig =
        P.lens (_contentConfig :: ElastictranscoderPipelineResource s -> TF.Attr s (ElastictranscoderPipelineContentConfig s))
...
instance P.HasThumbnailConfig (ElastictranscoderPipelineResource s) (TF.Attr s (ElastictranscoderPipelineThumbnailConfig s)) where
    thumbnailConfig =
        P.lens (_thumbnailConfig :: ElastictranscoderPipelineResource s -> TF.Attr s (ElastictranscoderPipelineThumbnailConfig s))
