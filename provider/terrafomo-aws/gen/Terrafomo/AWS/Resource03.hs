...
data DynamodbTableResource s = DynamodbTableResource'
    { _attribute :: TF.Attr s [TF.Attr s (P.DynamodbAttributeSetting s)]
    -- ^ @attribute@ - (Required)
    --
...
dynamodbTableResource
    :: TF.Attr s [TF.Attr s (P.DynamodbAttributeSetting s)] -- ^ @attribute@ ('P._attribute', 'P.attribute')
...
instance P.HasAttribute (DynamodbTableResource s) (TF.Attr s [TF.Attr s (P.DynamodbAttributeSetting s)]) where
    attribute =
        P.lens (_attribute :: DynamodbTableResource s -> TF.Attr s [TF.Attr s (P.DynamodbAttributeSetting s)])
