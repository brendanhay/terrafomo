...
data ApiGatewayMethodResource = ApiGatewayMethodResource
    ...
    , _request_validator_id :: !(Attr Text)
...
data AppautoscalingScheduledActionResource = AppautoscalingScheduledActionResource
    ...
    , _scalable_target_action :: !(Attr Text)
...
type instance Computed AthenaNamedQueryResource
    = '[ '("id", Text)
...
type instance Computed CloudwatchLogResourcePolicyResource
    = '[ '("id", Text)
...
data CognitoUserPoolResource = CognitoUserPoolResource
    ...
    , _verification_message_template :: !(Attr Text)
...
type instance Computed DxConnectionResource
    = '[ '("id", Text)
...
data DxLagResource = DxLagResource
    { _connections_bandwidth :: !(Attr Text)
...
type instance Computed EcrLifecyclePolicyResource
    = '[ '("registry_id", Text)
...
data EcsServiceResource = EcsServiceResource
    ...
    , _network_configuration              :: !(Attr Text)
...
data EcsTaskDefinitionResource = EcsTaskDefinitionResource
    ...
    , _requires_compatibilities :: !(Attr Text)
...
data ElasticacheReplicationGroupResource = ElasticacheReplicationGroupResource
    ...
    , _at_rest_encryption_enabled    :: !(Attr Text)
    {- ^ (Optional) Whether to enable encryption at rest. -}
    , _auth_token                    :: !(Attr Text)
    ...
    , _tags                          :: !(Attr Text)
    {- ^ (Optional) A mapping of tags to assign to the resource -}
    , _transit_encryption_enabled    :: !(Attr Text)
...
data ElasticsearchDomainResource = ElasticsearchDomainResource
    ...
    , _log_publishing_options :: !(Attr Text)
...
data LambdaFunctionResource = LambdaFunctionResource
    ...
    , _reserved_concurrent_executions :: !(Attr Text)
...
type instance Computed MediaStoreContainerResource
    = '[ '("arn", Text)
...
data MqBrokerResource = MqBrokerResource
    ...
    , _host_instance_type            :: !(Attr Text)
    {- ^ (Required) The broker's instance type. e.g. @mq.t2.micro@ or @mq.m4.large@ -}
    , _maintenance_window_start_time :: !(Attr Text)
...
type instance Computed MqConfigurationResource
    = '[ '("arn", Text)
...
data SecurityGroupResource = SecurityGroupResource
    ...
    , _name_prefix            :: !(Attr Text)
    {- ^ (Optional, Forces new resource) Creates a unique name beginning with the specified prefix. Conflicts with @name@ . -}
    , _revoke_rules_on_delete :: !(Attr Text)
...
type instance Computed ServiceDiscoveryPrivateDnsNamespaceResource
    = '[ '("arn", Text)
...
type instance Computed ServiceDiscoveryPublicDnsNamespaceResource
    = '[ '("arn", Text)
       {- - The ARN that Amazon Route 53 assigns to the namespace when you create it. -}
       , '("hosted_zone", Text)
       {- - The ID for the hosted zone that Amazon Route 53 creates when you create a namespace. -}
...
type instance Computed SesTemplateResource
    = '[ '("id", Text)
