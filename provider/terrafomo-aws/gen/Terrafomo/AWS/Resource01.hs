...
acmCertificateResource
    ...
    -> TF.Resource AWS (AcmCertificateResource s)
...
instance P.HasDomainName (AcmCertificateResource s) (TF.Attr s P.Text) where
    domainName =
        lens (_domainName :: (AcmCertificateResource s) -> (TF.Attr s P.Text))
...
instance P.HasSubjectAlternativeNames (AcmCertificateResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    subjectAlternativeNames =
        lens (_subjectAlternativeNames :: (AcmCertificateResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasTags (AcmCertificateResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (AcmCertificateResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
             (\s a -> s { _tags = a } :: (AcmCertificateResource s))

instance P.HasValidationMethod (AcmCertificateResource s) (TF.Attr s P.Text) where
    validationMethod =
        lens (_validationMethod :: (AcmCertificateResource s) -> (TF.Attr s P.Text))
...
acmCertificateValidationResource
    ...
    -> TF.Resource AWS (AcmCertificateValidationResource s)
...
instance P.HasCertificateArn (AcmCertificateValidationResource s) (TF.Attr s P.Text) where
    certificateArn =
        lens (_certificateArn :: (AcmCertificateValidationResource s) -> (TF.Attr s P.Text))
...
instance P.HasValidationRecordFqdns (AcmCertificateValidationResource s) (TF.Attr s (TF.Attr s P.Text)) where
    validationRecordFqdns =
        lens (_validationRecordFqdns :: (AcmCertificateValidationResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
acmpcaCertificateAuthorityResource
    ...
    -> TF.Resource AWS (AcmpcaCertificateAuthorityResource s)
...
instance P.HasCertificateAuthorityConfiguration (AcmpcaCertificateAuthorityResource s) (TF.Attr s [(CertificateAuthorityConfiguration s)]) where
    certificateAuthorityConfiguration =
        lens (_certificateAuthorityConfiguration :: (AcmpcaCertificateAuthorityResource s) -> (TF.Attr s [(CertificateAuthorityConfiguration s)]))
...
instance P.HasRevocationConfiguration (AcmpcaCertificateAuthorityResource s) (TF.Attr s [(RevocationConfiguration s)]) where
    revocationConfiguration =
        lens (_revocationConfiguration :: (AcmpcaCertificateAuthorityResource s) -> (TF.Attr s [(RevocationConfiguration s)]))
...
instance P.HasTags (AcmpcaCertificateAuthorityResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (AcmpcaCertificateAuthorityResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasEnableCrossZoneLoadBalancing (AlbResource s) (TF.Attr s P.Bool) where
    enableCrossZoneLoadBalancing =
        lens (_enableCrossZoneLoadBalancing :: (AlbResource s) -> (TF.Attr s P.Bool))
...
instance s ~ s' => P.HasComputedSubnetMapping (TF.Ref s' (AlbResource s)) (TF.Attr s (SubnetMapping s)) where
...
albListenerResource
    ...
    -> TF.Resource AWS (AlbListenerResource s)
...
instance P.HasCertificateArn (AlbListenerResource s) (TF.Attr s P.Text) where
    certificateArn =
        lens (_certificateArn :: (AlbListenerResource s) -> (TF.Attr s P.Text))
...
albListenerCertificateResource
    ...
    -> TF.Resource AWS (AlbListenerCertificateResource s)
...
instance P.HasCertificateArn (AlbListenerCertificateResource s) (TF.Attr s P.Text) where
    certificateArn =
        lens (_certificateArn :: (AlbListenerCertificateResource s) -> (TF.Attr s P.Text))
...
instance P.HasListenerArn (AlbListenerCertificateResource s) (TF.Attr s P.Text) where
    listenerArn =
        lens (_listenerArn :: (AlbListenerCertificateResource s) -> (TF.Attr s P.Text))
...
albListenerRuleResource
    ...
    -> (TF.Attr s P.Text) -- ^ @listener_arn@
    -> TF.Resource AWS (AlbListenerRuleResource s)
...
instance P.HasAction (AlbListenerRuleResource s) (TF.Attr s [(Action s)]) where
    action =
        lens (_action :: (AlbListenerRuleResource s) -> (TF.Attr s [(Action s)]))
             (\s a -> s { _action = a } :: (AlbListenerRuleResource s))

instance P.HasCondition (AlbListenerRuleResource s) (TF.Attr s (Condition s)) where
    condition =
        lens (_condition :: (AlbListenerRuleResource s) -> (TF.Attr s (Condition s)))
             (\s a -> s { _condition = a } :: (AlbListenerRuleResource s))

instance P.HasListenerArn (AlbListenerRuleResource s) (TF.Attr s P.Text) where
    listenerArn =
        lens (_listenerArn :: (AlbListenerRuleResource s) -> (TF.Attr s P.Text))
...
albTargetGroupResource
    ...
    -> TF.Resource AWS (AlbTargetGroupResource s)
...
instance P.HasDeregistrationDelay (AlbTargetGroupResource s) (TF.Attr s P.Integer) where
    deregistrationDelay =
        lens (_deregistrationDelay :: (AlbTargetGroupResource s) -> (TF.Attr s P.Integer))
...
instance P.HasSlowStart (AlbTargetGroupResource s) (TF.Attr s P.Integer) where
    slowStart =
        lens (_slowStart :: (AlbTargetGroupResource s) -> (TF.Attr s P.Integer))
...
albTargetGroupAttachmentResource
    ...
    -> TF.Resource AWS (AlbTargetGroupAttachmentResource s)
...
instance P.HasAvailabilityZone (AlbTargetGroupAttachmentResource s) (TF.Attr s P.Text) where
    availabilityZone =
        lens (_availabilityZone :: (AlbTargetGroupAttachmentResource s) -> (TF.Attr s P.Text))
...
instance P.HasPort (AlbTargetGroupAttachmentResource s) (TF.Attr s P.Integer) where
    port =
        lens (_port :: (AlbTargetGroupAttachmentResource s) -> (TF.Attr s P.Integer))
...
instance P.HasTargetGroupArn (AlbTargetGroupAttachmentResource s) (TF.Attr s P.Text) where
    targetGroupArn =
        lens (_targetGroupArn :: (AlbTargetGroupAttachmentResource s) -> (TF.Attr s P.Text))
...
instance P.HasTargetId (AlbTargetGroupAttachmentResource s) (TF.Attr s P.Text) where
    targetId =
        lens (_targetId :: (AlbTargetGroupAttachmentResource s) -> (TF.Attr s P.Text))
...
instance P.HasEnaSupport (AmiResource s) (TF.Attr s P.Bool) where
    enaSupport =
        lens (_enaSupport :: (AmiResource s) -> (TF.Attr s P.Bool))
             (\s a -> s { _enaSupport = a } :: (AmiResource s))

instance P.HasKernelId (AmiResource s) (TF.Attr s P.Text) where
    kernelId =
        lens (_kernelId :: (AmiResource s) -> (TF.Attr s P.Text))
...
amiCopyResource
    ...
    -> TF.Resource AWS (AmiCopyResource s)
...
instance P.HasDescription (AmiCopyResource s) (TF.Attr s P.Text) where
    description =
        lens (_description :: (AmiCopyResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _description = a } :: (AmiCopyResource s))

instance P.HasEncrypted (AmiCopyResource s) (TF.Attr s P.Bool) where
    encrypted =
        lens (_encrypted :: (AmiCopyResource s) -> (TF.Attr s P.Bool))
...
instance P.HasSourceAmiId (AmiCopyResource s) (TF.Attr s P.Text) where
    sourceAmiId =
        lens (_sourceAmiId :: (AmiCopyResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _sourceAmiId = a } :: (AmiCopyResource s))

instance P.HasSourceAmiRegion (AmiCopyResource s) (TF.Attr s P.Text) where
    sourceAmiRegion =
        lens (_sourceAmiRegion :: (AmiCopyResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (AmiCopyResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (AmiCopyResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (AmiCopyResource s)) (TF.Attr s (EbsBlockDevice s)) where
    computedEbsBlockDevice x = TF.compute (TF.refKey x) "ebs_block_device"
...
instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (AmiCopyResource s)) (TF.Attr s (EphemeralBlockDevice s)) where
    computedEphemeralBlockDevice x = TF.compute (TF.refKey x) "ephemeral_block_device"
...
amiFromInstanceResource
    ...
    -> TF.Resource AWS (AmiFromInstanceResource s)
...
instance P.HasDescription (AmiFromInstanceResource s) (TF.Attr s P.Text) where
    description =
        lens (_description :: (AmiFromInstanceResource s) -> (TF.Attr s P.Text))
...
instance P.HasSnapshotWithoutReboot (AmiFromInstanceResource s) (TF.Attr s P.Bool) where
    snapshotWithoutReboot =
        lens (_snapshotWithoutReboot :: (AmiFromInstanceResource s) -> (TF.Attr s P.Bool))
...
instance P.HasSourceInstanceId (AmiFromInstanceResource s) (TF.Attr s P.Text) where
    sourceInstanceId =
        lens (_sourceInstanceId :: (AmiFromInstanceResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (AmiFromInstanceResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (AmiFromInstanceResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance s ~ s' => P.HasComputedEbsBlockDevice (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s (EbsBlockDevice s)) where
    computedEbsBlockDevice x = TF.compute (TF.refKey x) "ebs_block_device"

instance s ~ s' => P.HasComputedEnaSupport (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s P.Bool) where
    computedEnaSupport x = TF.compute (TF.refKey x) "ena_support"

instance s ~ s' => P.HasComputedEphemeralBlockDevice (TF.Ref s' (AmiFromInstanceResource s)) (TF.Attr s (EphemeralBlockDevice s)) where
    computedEphemeralBlockDevice x = TF.compute (TF.refKey x) "ephemeral_block_device"
...
amiLaunchPermissionResource
    ...
    -> TF.Resource AWS (AmiLaunchPermissionResource s)
...
instance P.HasAccountId (AmiLaunchPermissionResource s) (TF.Attr s P.Text) where
    accountId =
        lens (_accountId :: (AmiLaunchPermissionResource s) -> (TF.Attr s P.Text))
...
instance P.HasImageId (AmiLaunchPermissionResource s) (TF.Attr s P.Text) where
    imageId =
        lens (_imageId :: (AmiLaunchPermissionResource s) -> (TF.Attr s P.Text))
...
apiGatewayAccountResource
    :: TF.Resource AWS (ApiGatewayAccountResource s)
apiGatewayAccountResource =
...
instance P.HasCloudwatchRoleArn (ApiGatewayAccountResource s) (TF.Attr s P.Text) where
    cloudwatchRoleArn =
        lens (_cloudwatchRoleArn :: (ApiGatewayAccountResource s) -> (TF.Attr s P.Text))
...
data (ApiGatewayApiKeyResource s) = ApiGatewayApiKeyResource'
    ...
    , _enabled :: (TF.Attr s P.Bool)
    , _name :: (TF.Attr s P.Text)
    , _stageKey :: (TF.Attr s (StageKey s))
    } deriving (Show, Eq, Generic)
...
apiGatewayApiKeyResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (ApiGatewayApiKeyResource s)
...
instance P.HasStageKey (ApiGatewayApiKeyResource s) (TF.Attr s (StageKey s)) where
    stageKey =
        lens (_stageKey :: (ApiGatewayApiKeyResource s) -> (TF.Attr s (StageKey s)))
...
apiGatewayAuthorizerResource
    ...
    -> TF.Resource AWS (ApiGatewayAuthorizerResource s)
...
instance P.HasAuthorizerCredentials (ApiGatewayAuthorizerResource s) (TF.Attr s P.Text) where
    authorizerCredentials =
        lens (_authorizerCredentials :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Text))
...
instance P.HasAuthorizerResultTtlInSeconds (ApiGatewayAuthorizerResource s) (TF.Attr s P.Integer) where
    authorizerResultTtlInSeconds =
        lens (_authorizerResultTtlInSeconds :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Integer))
...
instance P.HasAuthorizerUri (ApiGatewayAuthorizerResource s) (TF.Attr s P.Text) where
    authorizerUri =
        lens (_authorizerUri :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Text))
...
instance P.HasIdentitySource (ApiGatewayAuthorizerResource s) (TF.Attr s P.Text) where
    identitySource =
        lens (_identitySource :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Text))
...
instance P.HasIdentityValidationExpression (ApiGatewayAuthorizerResource s) (TF.Attr s P.Text) where
    identityValidationExpression =
        lens (_identityValidationExpression :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Text))
...
instance P.HasProviderArns (ApiGatewayAuthorizerResource s) (TF.Attr s (TF.Attr s P.Text)) where
    providerArns =
        lens (_providerArns :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasRestApiId (ApiGatewayAuthorizerResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayAuthorizerResource s) -> (TF.Attr s P.Text))
...
apiGatewayBasePathMappingResource
    ...
    -> (TF.Attr s P.Text) -- ^ @domain_name@
    -> TF.Resource AWS (ApiGatewayBasePathMappingResource s)
...
instance P.HasApiId (ApiGatewayBasePathMappingResource s) (TF.Attr s P.Text) where
    apiId =
        lens (_apiId :: (ApiGatewayBasePathMappingResource s) -> (TF.Attr s P.Text))
...
instance P.HasBasePath (ApiGatewayBasePathMappingResource s) (TF.Attr s P.Text) where
    basePath =
        lens (_basePath :: (ApiGatewayBasePathMappingResource s) -> (TF.Attr s P.Text))
...
instance P.HasDomainName (ApiGatewayBasePathMappingResource s) (TF.Attr s P.Text) where
    domainName =
        lens (_domainName :: (ApiGatewayBasePathMappingResource s) -> (TF.Attr s P.Text))
...
instance P.HasStageName (ApiGatewayBasePathMappingResource s) (TF.Attr s P.Text) where
    stageName =
        lens (_stageName :: (ApiGatewayBasePathMappingResource s) -> (TF.Attr s P.Text))
...
apiGatewayClientCertificateResource
    :: TF.Resource AWS (ApiGatewayClientCertificateResource s)
apiGatewayClientCertificateResource =
...
apiGatewayDeploymentResource
    ...
    -> TF.Resource AWS (ApiGatewayDeploymentResource s)
...
instance P.HasRestApiId (ApiGatewayDeploymentResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayDeploymentResource s) -> (TF.Attr s P.Text))
...
instance P.HasStageDescription (ApiGatewayDeploymentResource s) (TF.Attr s P.Text) where
    stageDescription =
        lens (_stageDescription :: (ApiGatewayDeploymentResource s) -> (TF.Attr s P.Text))
...
instance P.HasStageName (ApiGatewayDeploymentResource s) (TF.Attr s P.Text) where
    stageName =
        lens (_stageName :: (ApiGatewayDeploymentResource s) -> (TF.Attr s P.Text))
...
instance P.HasVariables (ApiGatewayDeploymentResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    variables =
        lens (_variables :: (ApiGatewayDeploymentResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
apiGatewayDocumentationPartResource
    ...
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayDocumentationPartResource s)
...
instance P.HasLocation (ApiGatewayDocumentationPartResource s) (TF.Attr s [(Location s)]) where
    location =
        lens (_location :: (ApiGatewayDocumentationPartResource s) -> (TF.Attr s [(Location s)]))
...
instance P.HasRestApiId (ApiGatewayDocumentationPartResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayDocumentationPartResource s) -> (TF.Attr s P.Text))
...
apiGatewayDocumentationVersionResource
    ...
    -> TF.Resource AWS (ApiGatewayDocumentationVersionResource s)
...
instance P.HasRestApiId (ApiGatewayDocumentationVersionResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayDocumentationVersionResource s) -> (TF.Attr s P.Text))
...
apiGatewayDomainNameResource
    :: (TF.Attr s P.Text) -- ^ @domain_name@
    -> TF.Resource AWS (ApiGatewayDomainNameResource s)
...
instance P.HasCertificateArn (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    certificateArn =
        lens (_certificateArn :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasCertificateBody (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    certificateBody =
        lens (_certificateBody :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasCertificateChain (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    certificateChain =
        lens (_certificateChain :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasCertificateName (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    certificateName =
        lens (_certificateName :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasCertificatePrivateKey (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    certificatePrivateKey =
        lens (_certificatePrivateKey :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasDomainName (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    domainName =
        lens (_domainName :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasRegionalCertificateArn (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    regionalCertificateArn =
        lens (_regionalCertificateArn :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
instance P.HasRegionalCertificateName (ApiGatewayDomainNameResource s) (TF.Attr s P.Text) where
    regionalCertificateName =
        lens (_regionalCertificateName :: (ApiGatewayDomainNameResource s) -> (TF.Attr s P.Text))
...
apiGatewayGatewayResponseResource
    ...
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayGatewayResponseResource s)
...
instance P.HasResponseParameters (ApiGatewayGatewayResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    responseParameters =
        lens (_responseParameters :: (ApiGatewayGatewayResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasResponseTemplates (ApiGatewayGatewayResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    responseTemplates =
        lens (_responseTemplates :: (ApiGatewayGatewayResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasResponseType (ApiGatewayGatewayResponseResource s) (TF.Attr s P.Text) where
    responseType =
        lens (_responseType :: (ApiGatewayGatewayResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayGatewayResponseResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayGatewayResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasStatusCode (ApiGatewayGatewayResponseResource s) (TF.Attr s P.Text) where
    statusCode =
        lens (_statusCode :: (ApiGatewayGatewayResponseResource s) -> (TF.Attr s P.Text))
...
apiGatewayIntegrationResource
    ...
    -> TF.Resource AWS (ApiGatewayIntegrationResource s)
...
instance P.HasCacheKeyParameters (ApiGatewayIntegrationResource s) (TF.Attr s (TF.Attr s P.Text)) where
    cacheKeyParameters =
        lens (_cacheKeyParameters :: (ApiGatewayIntegrationResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasConnectionId (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    connectionId =
        lens (_connectionId :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasConnectionType (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    connectionType =
        lens (_connectionType :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasContentHandling (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    contentHandling =
        lens (_contentHandling :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasHttpMethod (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    httpMethod =
        lens (_httpMethod :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasIntegrationHttpMethod (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    integrationHttpMethod =
        lens (_integrationHttpMethod :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasRequestParameters (ApiGatewayIntegrationResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    requestParameters =
        lens (_requestParameters :: (ApiGatewayIntegrationResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasRequestParametersInJson (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    requestParametersInJson =
        lens (_requestParametersInJson :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasRequestTemplates (ApiGatewayIntegrationResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    requestTemplates =
        lens (_requestTemplates :: (ApiGatewayIntegrationResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasResourceId (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayIntegrationResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Text))
...
instance P.HasTimeoutMilliseconds (ApiGatewayIntegrationResource s) (TF.Attr s P.Integer) where
    timeoutMilliseconds =
        lens (_timeoutMilliseconds :: (ApiGatewayIntegrationResource s) -> (TF.Attr s P.Integer))
...
apiGatewayIntegrationResponseResource
    ...
    -> TF.Resource AWS (ApiGatewayIntegrationResponseResource s)
...
instance P.HasContentHandling (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    contentHandling =
        lens (_contentHandling :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasHttpMethod (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    httpMethod =
        lens (_httpMethod :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasResourceId (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasResponseParameters (ApiGatewayIntegrationResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    responseParameters =
        lens (_responseParameters :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasResponseParametersInJson (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    responseParametersInJson =
        lens (_responseParametersInJson :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasResponseTemplates (ApiGatewayIntegrationResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    responseTemplates =
        lens (_responseTemplates :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasRestApiId (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasSelectionPattern (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    selectionPattern =
        lens (_selectionPattern :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasStatusCode (ApiGatewayIntegrationResponseResource s) (TF.Attr s P.Text) where
    statusCode =
        lens (_statusCode :: (ApiGatewayIntegrationResponseResource s) -> (TF.Attr s P.Text))
...
apiGatewayMethodResource
    ...
    -> (TF.Attr s P.Text) -- ^ @resource_id@
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayMethodResource s)
...
instance P.HasApiKeyRequired (ApiGatewayMethodResource s) (TF.Attr s P.Bool) where
    apiKeyRequired =
        lens (_apiKeyRequired :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Bool))
...
instance P.HasAuthorizationScopes (ApiGatewayMethodResource s) (TF.Attr s (TF.Attr s P.Text)) where
    authorizationScopes =
        lens (_authorizationScopes :: (ApiGatewayMethodResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasAuthorizerId (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    authorizerId =
        lens (_authorizerId :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
...
instance P.HasHttpMethod (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    httpMethod =
        lens (_httpMethod :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
...
instance P.HasRequestModels (ApiGatewayMethodResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    requestModels =
        lens (_requestModels :: (ApiGatewayMethodResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasRequestParameters (ApiGatewayMethodResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Bool))) where
    requestParameters =
        lens (_requestParameters :: (ApiGatewayMethodResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Bool))))
...
instance P.HasRequestParametersInJson (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    requestParametersInJson =
        lens (_requestParametersInJson :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
...
instance P.HasRequestValidatorId (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    requestValidatorId =
        lens (_requestValidatorId :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
...
instance P.HasResourceId (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _resourceId = a } :: (ApiGatewayMethodResource s))

instance P.HasRestApiId (ApiGatewayMethodResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayMethodResource s) -> (TF.Attr s P.Text))
...
apiGatewayMethodResponseResource
    ...
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> (TF.Attr s P.Text) -- ^ @status_code@
    -> TF.Resource AWS (ApiGatewayMethodResponseResource s)
...
instance P.HasHttpMethod (ApiGatewayMethodResponseResource s) (TF.Attr s P.Text) where
    httpMethod =
        lens (_httpMethod :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasResourceId (ApiGatewayMethodResponseResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasResponseModels (ApiGatewayMethodResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    responseModels =
        lens (_responseModels :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasResponseParameters (ApiGatewayMethodResponseResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Bool))) where
    responseParameters =
        lens (_responseParameters :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Bool))))
...
instance P.HasResponseParametersInJson (ApiGatewayMethodResponseResource s) (TF.Attr s P.Text) where
    responseParametersInJson =
        lens (_responseParametersInJson :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayMethodResponseResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s P.Text))
...
instance P.HasStatusCode (ApiGatewayMethodResponseResource s) (TF.Attr s P.Text) where
    statusCode =
        lens (_statusCode :: (ApiGatewayMethodResponseResource s) -> (TF.Attr s P.Text))
...
apiGatewayMethodSettingsResource
    ...
    -> (TF.Attr s P.Text) -- ^ @stage_name@
    -> TF.Resource AWS (ApiGatewayMethodSettingsResource s)
...
instance P.HasMethodPath (ApiGatewayMethodSettingsResource s) (TF.Attr s P.Text) where
    methodPath =
        lens (_methodPath :: (ApiGatewayMethodSettingsResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayMethodSettingsResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayMethodSettingsResource s) -> (TF.Attr s P.Text))
...
instance P.HasSettings (ApiGatewayMethodSettingsResource s) (TF.Attr s [(Settings s)]) where
    settings =
        lens (_settings :: (ApiGatewayMethodSettingsResource s) -> (TF.Attr s [(Settings s)]))
...
instance P.HasStageName (ApiGatewayMethodSettingsResource s) (TF.Attr s P.Text) where
    stageName =
        lens (_stageName :: (ApiGatewayMethodSettingsResource s) -> (TF.Attr s P.Text))
...
apiGatewayModelResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayModelResource s)
...
instance P.HasContentType (ApiGatewayModelResource s) (TF.Attr s P.Text) where
    contentType =
        lens (_contentType :: (ApiGatewayModelResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayModelResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayModelResource s) -> (TF.Attr s P.Text))
...
apiGatewayRequestValidatorResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayRequestValidatorResource s)
...
instance P.HasRestApiId (ApiGatewayRequestValidatorResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayRequestValidatorResource s) -> (TF.Attr s P.Text))
...
instance P.HasValidateRequestBody (ApiGatewayRequestValidatorResource s) (TF.Attr s P.Bool) where
    validateRequestBody =
        lens (_validateRequestBody :: (ApiGatewayRequestValidatorResource s) -> (TF.Attr s P.Bool))
...
instance P.HasValidateRequestParameters (ApiGatewayRequestValidatorResource s) (TF.Attr s P.Bool) where
    validateRequestParameters =
        lens (_validateRequestParameters :: (ApiGatewayRequestValidatorResource s) -> (TF.Attr s P.Bool))
...
apiGatewayResourceResource
    ...
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> TF.Resource AWS (ApiGatewayResourceResource s)
...
instance P.HasParentId (ApiGatewayResourceResource s) (TF.Attr s P.Text) where
    parentId =
        lens (_parentId :: (ApiGatewayResourceResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _parentId = a } :: (ApiGatewayResourceResource s))

instance P.HasPathPart (ApiGatewayResourceResource s) (TF.Attr s P.Text) where
    pathPart =
        lens (_pathPart :: (ApiGatewayResourceResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayResourceResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayResourceResource s) -> (TF.Attr s P.Text))
...
apiGatewayRestApiResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (ApiGatewayRestApiResource s)
...
instance P.HasApiKeySource (ApiGatewayRestApiResource s) (TF.Attr s P.Text) where
    apiKeySource =
        lens (_apiKeySource :: (ApiGatewayRestApiResource s) -> (TF.Attr s P.Text))
...
instance P.HasBinaryMediaTypes (ApiGatewayRestApiResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    binaryMediaTypes =
        lens (_binaryMediaTypes :: (ApiGatewayRestApiResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasMinimumCompressionSize (ApiGatewayRestApiResource s) (TF.Attr s P.Integer) where
    minimumCompressionSize =
        lens (_minimumCompressionSize :: (ApiGatewayRestApiResource s) -> (TF.Attr s P.Integer))
...
apiGatewayStageResource
    ...
    -> (TF.Attr s P.Text) -- ^ @rest_api_id@
    -> (TF.Attr s P.Text) -- ^ @stage_name@
    -> TF.Resource AWS (ApiGatewayStageResource s)
...
instance P.HasAccessLogSettings (ApiGatewayStageResource s) (TF.Attr s [(AccessLogSettings s)]) where
    accessLogSettings =
        lens (_accessLogSettings :: (ApiGatewayStageResource s) -> (TF.Attr s [(AccessLogSettings s)]))
...
instance P.HasCacheClusterEnabled (ApiGatewayStageResource s) (TF.Attr s P.Bool) where
    cacheClusterEnabled =
        lens (_cacheClusterEnabled :: (ApiGatewayStageResource s) -> (TF.Attr s P.Bool))
...
instance P.HasCacheClusterSize (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    cacheClusterSize =
        lens (_cacheClusterSize :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
...
instance P.HasClientCertificateId (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    clientCertificateId =
        lens (_clientCertificateId :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
...
instance P.HasDeploymentId (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    deploymentId =
        lens (_deploymentId :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
...
instance P.HasDocumentationVersion (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    documentationVersion =
        lens (_documentationVersion :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
...
instance P.HasRestApiId (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    restApiId =
        lens (_restApiId :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _restApiId = a } :: (ApiGatewayStageResource s))

instance P.HasStageName (ApiGatewayStageResource s) (TF.Attr s P.Text) where
    stageName =
        lens (_stageName :: (ApiGatewayStageResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (ApiGatewayStageResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (ApiGatewayStageResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasVariables (ApiGatewayStageResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    variables =
        lens (_variables :: (ApiGatewayStageResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
apiGatewayUsagePlanResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (ApiGatewayUsagePlanResource s)
...
instance P.HasApiStages (ApiGatewayUsagePlanResource s) (TF.Attr s [(ApiStages s)]) where
    apiStages =
        lens (_apiStages :: (ApiGatewayUsagePlanResource s) -> (TF.Attr s [(ApiStages s)]))
...
instance P.HasProductCode (ApiGatewayUsagePlanResource s) (TF.Attr s P.Text) where
    productCode =
        lens (_productCode :: (ApiGatewayUsagePlanResource s) -> (TF.Attr s P.Text))
...
instance P.HasQuotaSettings (ApiGatewayUsagePlanResource s) (TF.Attr s (QuotaSettings s)) where
    quotaSettings =
        lens (_quotaSettings :: (ApiGatewayUsagePlanResource s) -> (TF.Attr s (QuotaSettings s)))
...
instance P.HasThrottleSettings (ApiGatewayUsagePlanResource s) (TF.Attr s (ThrottleSettings s)) where
    throttleSettings =
        lens (_throttleSettings :: (ApiGatewayUsagePlanResource s) -> (TF.Attr s (ThrottleSettings s)))
...
apiGatewayUsagePlanKeyResource
    ...
    -> TF.Resource AWS (ApiGatewayUsagePlanKeyResource s)
...
instance P.HasKeyId (ApiGatewayUsagePlanKeyResource s) (TF.Attr s P.Text) where
    keyId =
        lens (_keyId :: (ApiGatewayUsagePlanKeyResource s) -> (TF.Attr s P.Text))
...
instance P.HasKeyType (ApiGatewayUsagePlanKeyResource s) (TF.Attr s P.Text) where
    keyType =
        lens (_keyType :: (ApiGatewayUsagePlanKeyResource s) -> (TF.Attr s P.Text))
...
instance P.HasUsagePlanId (ApiGatewayUsagePlanKeyResource s) (TF.Attr s P.Text) where
    usagePlanId =
        lens (_usagePlanId :: (ApiGatewayUsagePlanKeyResource s) -> (TF.Attr s P.Text))
...
data (ApiGatewayVpcLinkResource s) = ApiGatewayVpcLinkResource'
    { _description :: (TF.Attr s P.Text)
    , _name :: (TF.Attr s P.Text)
    , _targetArns :: (TF.Attr s (TF.Attr s P.Text))
    } deriving (Show, Eq, Generic)
...
apiGatewayVpcLinkResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s (TF.Attr s P.Text)) -- ^ @target_arns@
    -> TF.Resource AWS (ApiGatewayVpcLinkResource s)
...
instance P.HasTargetArns (ApiGatewayVpcLinkResource s) (TF.Attr s (TF.Attr s P.Text)) where
    targetArns =
        lens (_targetArns :: (ApiGatewayVpcLinkResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
appCookieStickinessPolicyResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (AppCookieStickinessPolicyResource s)
...
instance P.HasCookieName (AppCookieStickinessPolicyResource s) (TF.Attr s P.Text) where
    cookieName =
        lens (_cookieName :: (AppCookieStickinessPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasLbPort (AppCookieStickinessPolicyResource s) (TF.Attr s P.Integer) where
    lbPort =
        lens (_lbPort :: (AppCookieStickinessPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasLoadBalancer (AppCookieStickinessPolicyResource s) (TF.Attr s P.Text) where
    loadBalancer =
        lens (_loadBalancer :: (AppCookieStickinessPolicyResource s) -> (TF.Attr s P.Text))
...
appautoscalingPolicyResource
    ...
    -> TF.Resource AWS (AppautoscalingPolicyResource s)
...
instance P.HasAdjustmentType (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    adjustmentType =
        lens (_adjustmentType :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasAlarms (AppautoscalingPolicyResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    alarms =
        lens (_alarms :: (AppautoscalingPolicyResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasCooldown (AppautoscalingPolicyResource s) (TF.Attr s P.Integer) where
    cooldown =
        lens (_cooldown :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMetricAggregationType (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    metricAggregationType =
        lens (_metricAggregationType :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasMinAdjustmentMagnitude (AppautoscalingPolicyResource s) (TF.Attr s P.Integer) where
    minAdjustmentMagnitude =
        lens (_minAdjustmentMagnitude :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasPolicyType (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    policyType =
        lens (_policyType :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasResourceId (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasScalableDimension (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    scalableDimension =
        lens (_scalableDimension :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasServiceNamespace (AppautoscalingPolicyResource s) (TF.Attr s P.Text) where
    serviceNamespace =
        lens (_serviceNamespace :: (AppautoscalingPolicyResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _serviceNamespace = a } :: (AppautoscalingPolicyResource s))

instance P.HasStepAdjustment (AppautoscalingPolicyResource s) (TF.Attr s (StepAdjustment s)) where
    stepAdjustment =
        lens (_stepAdjustment :: (AppautoscalingPolicyResource s) -> (TF.Attr s (StepAdjustment s)))
...
instance P.HasStepScalingPolicyConfiguration (AppautoscalingPolicyResource s) (TF.Attr s [(StepScalingPolicyConfiguration s)]) where
    stepScalingPolicyConfiguration =
        lens (_stepScalingPolicyConfiguration :: (AppautoscalingPolicyResource s) -> (TF.Attr s [(StepScalingPolicyConfiguration s)]))
...
instance P.HasTargetTrackingScalingPolicyConfiguration (AppautoscalingPolicyResource s) (TF.Attr s [(TargetTrackingScalingPolicyConfiguration s)]) where
    targetTrackingScalingPolicyConfiguration =
        lens (_targetTrackingScalingPolicyConfiguration :: (AppautoscalingPolicyResource s) -> (TF.Attr s [(TargetTrackingScalingPolicyConfiguration s)]))
...
appautoscalingScheduledActionResource
    ...
    -> (TF.Attr s P.Text) -- ^ @resource_id@
    -> (TF.Attr s P.Text) -- ^ @service_namespace@
    -> TF.Resource AWS (AppautoscalingScheduledActionResource s)
...
instance P.HasEndTime (AppautoscalingScheduledActionResource s) (TF.Attr s P.Text) where
    endTime =
        lens (_endTime :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s P.Text))
...
instance P.HasResourceId (AppautoscalingScheduledActionResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s P.Text))
...
instance P.HasScalableDimension (AppautoscalingScheduledActionResource s) (TF.Attr s P.Text) where
    scalableDimension =
        lens (_scalableDimension :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s P.Text))
...
instance P.HasScalableTargetAction (AppautoscalingScheduledActionResource s) (TF.Attr s [(ScalableTargetAction s)]) where
    scalableTargetAction =
        lens (_scalableTargetAction :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s [(ScalableTargetAction s)]))
...
instance P.HasServiceNamespace (AppautoscalingScheduledActionResource s) (TF.Attr s P.Text) where
    serviceNamespace =
        lens (_serviceNamespace :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s P.Text))
...
instance P.HasStartTime (AppautoscalingScheduledActionResource s) (TF.Attr s P.Text) where
    startTime =
        lens (_startTime :: (AppautoscalingScheduledActionResource s) -> (TF.Attr s P.Text))
...
appautoscalingTargetResource
    ...
    -> (TF.Attr s P.Text) -- ^ @scalable_dimension@
    -> (TF.Attr s P.Text) -- ^ @service_namespace@
    -> TF.Resource AWS (AppautoscalingTargetResource s)
...
instance P.HasMaxCapacity (AppautoscalingTargetResource s) (TF.Attr s P.Integer) where
    maxCapacity =
        lens (_maxCapacity :: (AppautoscalingTargetResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMinCapacity (AppautoscalingTargetResource s) (TF.Attr s P.Integer) where
    minCapacity =
        lens (_minCapacity :: (AppautoscalingTargetResource s) -> (TF.Attr s P.Integer))
...
instance P.HasResourceId (AppautoscalingTargetResource s) (TF.Attr s P.Text) where
    resourceId =
        lens (_resourceId :: (AppautoscalingTargetResource s) -> (TF.Attr s P.Text))
...
instance P.HasScalableDimension (AppautoscalingTargetResource s) (TF.Attr s P.Text) where
    scalableDimension =
        lens (_scalableDimension :: (AppautoscalingTargetResource s) -> (TF.Attr s P.Text))
...
instance P.HasServiceNamespace (AppautoscalingTargetResource s) (TF.Attr s P.Text) where
    serviceNamespace =
        lens (_serviceNamespace :: (AppautoscalingTargetResource s) -> (TF.Attr s P.Text))
...
appsyncApiKeyResource
    :: (TF.Attr s P.Text) -- ^ @api_id@
    -> TF.Resource AWS (AppsyncApiKeyResource s)
...
instance P.HasApiId (AppsyncApiKeyResource s) (TF.Attr s P.Text) where
    apiId =
        lens (_apiId :: (AppsyncApiKeyResource s) -> (TF.Attr s P.Text))
...
appsyncDatasourceResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @type@
    -> TF.Resource AWS (AppsyncDatasourceResource s)
...
instance P.HasApiId (AppsyncDatasourceResource s) (TF.Attr s P.Text) where
    apiId =
        lens (_apiId :: (AppsyncDatasourceResource s) -> (TF.Attr s P.Text))
...
instance P.HasDynamodbConfig (AppsyncDatasourceResource s) (TF.Attr s [(DynamodbConfig s)]) where
    dynamodbConfig =
        lens (_dynamodbConfig :: (AppsyncDatasourceResource s) -> (TF.Attr s [(DynamodbConfig s)]))
...
instance P.HasElasticsearchConfig (AppsyncDatasourceResource s) (TF.Attr s [(ElasticsearchConfig s)]) where
    elasticsearchConfig =
        lens (_elasticsearchConfig :: (AppsyncDatasourceResource s) -> (TF.Attr s [(ElasticsearchConfig s)]))
...
instance P.HasLambdaConfig (AppsyncDatasourceResource s) (TF.Attr s [(LambdaConfig s)]) where
    lambdaConfig =
        lens (_lambdaConfig :: (AppsyncDatasourceResource s) -> (TF.Attr s [(LambdaConfig s)]))
...
instance P.HasServiceRoleArn (AppsyncDatasourceResource s) (TF.Attr s P.Text) where
    serviceRoleArn =
        lens (_serviceRoleArn :: (AppsyncDatasourceResource s) -> (TF.Attr s P.Text))
...
appsyncGraphqlApiResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (AppsyncGraphqlApiResource s)
...
instance P.HasAuthenticationType (AppsyncGraphqlApiResource s) (TF.Attr s P.Text) where
    authenticationType =
        lens (_authenticationType :: (AppsyncGraphqlApiResource s) -> (TF.Attr s P.Text))
...
instance P.HasUserPoolConfig (AppsyncGraphqlApiResource s) (TF.Attr s [(UserPoolConfig s)]) where
    userPoolConfig =
        lens (_userPoolConfig :: (AppsyncGraphqlApiResource s) -> (TF.Attr s [(UserPoolConfig s)]))
...
athenaDatabaseResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (AthenaDatabaseResource s)
...
instance P.HasForceDestroy (AthenaDatabaseResource s) (TF.Attr s P.Bool) where
    forceDestroy =
        lens (_forceDestroy :: (AthenaDatabaseResource s) -> (TF.Attr s P.Bool))
...
athenaNamedQueryResource
    ...
    -> TF.Resource AWS (AthenaNamedQueryResource s)
...
autoscalingAttachmentResource
    ...
    -> TF.Resource AWS (AutoscalingAttachmentResource s)
...
instance P.HasAlbTargetGroupArn (AutoscalingAttachmentResource s) (TF.Attr s P.Text) where
    albTargetGroupArn =
        lens (_albTargetGroupArn :: (AutoscalingAttachmentResource s) -> (TF.Attr s P.Text))
...
instance P.HasAutoscalingGroupName (AutoscalingAttachmentResource s) (TF.Attr s P.Text) where
    autoscalingGroupName =
        lens (_autoscalingGroupName :: (AutoscalingAttachmentResource s) -> (TF.Attr s P.Text))
...
data (AutoscalingGroupResource s) = AutoscalingGroupResource'
    ...
    , _initialLifecycleHook :: (TF.Attr s (InitialLifecycleHook s))
...
autoscalingGroupResource
    ...
    -> TF.Resource AWS (AutoscalingGroupResource s)
...
instance P.HasEnabledMetrics (AutoscalingGroupResource s) (TF.Attr s (TF.Attr s P.Text)) where
    enabledMetrics =
        lens (_enabledMetrics :: (AutoscalingGroupResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasForceDelete (AutoscalingGroupResource s) (TF.Attr s P.Bool) where
    forceDelete =
        lens (_forceDelete :: (AutoscalingGroupResource s) -> (TF.Attr s P.Bool))
...
instance P.HasHealthCheckGracePeriod (AutoscalingGroupResource s) (TF.Attr s P.Integer) where
    healthCheckGracePeriod =
        lens (_healthCheckGracePeriod :: (AutoscalingGroupResource s) -> (TF.Attr s P.Integer))
             (\s a -> s { _healthCheckGracePeriod = a } :: (AutoscalingGroupResource s))

instance P.HasInitialLifecycleHook (AutoscalingGroupResource s) (TF.Attr s (InitialLifecycleHook s)) where
    initialLifecycleHook =
        lens (_initialLifecycleHook :: (AutoscalingGroupResource s) -> (TF.Attr s (InitialLifecycleHook s)))
...
instance P.HasLaunchConfiguration (AutoscalingGroupResource s) (TF.Attr s P.Text) where
    launchConfiguration =
        lens (_launchConfiguration :: (AutoscalingGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasLaunchTemplate (AutoscalingGroupResource s) (TF.Attr s [(LaunchTemplate s)]) where
    launchTemplate =
        lens (_launchTemplate :: (AutoscalingGroupResource s) -> (TF.Attr s [(LaunchTemplate s)]))
...
instance P.HasMaxSize (AutoscalingGroupResource s) (TF.Attr s P.Integer) where
    maxSize =
        lens (_maxSize :: (AutoscalingGroupResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMetricsGranularity (AutoscalingGroupResource s) (TF.Attr s P.Text) where
    metricsGranularity =
        lens (_metricsGranularity :: (AutoscalingGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasMinElbCapacity (AutoscalingGroupResource s) (TF.Attr s P.Integer) where
    minElbCapacity =
        lens (_minElbCapacity :: (AutoscalingGroupResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMinSize (AutoscalingGroupResource s) (TF.Attr s P.Integer) where
    minSize =
        lens (_minSize :: (AutoscalingGroupResource s) -> (TF.Attr s P.Integer))
             (\s a -> s { _minSize = a } :: (AutoscalingGroupResource s))

instance P.HasNamePrefix (AutoscalingGroupResource s) (TF.Attr s P.Text) where
    namePrefix =
        lens (_namePrefix :: (AutoscalingGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasPlacementGroup (AutoscalingGroupResource s) (TF.Attr s P.Text) where
    placementGroup =
        lens (_placementGroup :: (AutoscalingGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasProtectFromScaleIn (AutoscalingGroupResource s) (TF.Attr s P.Bool) where
    protectFromScaleIn =
        lens (_protectFromScaleIn :: (AutoscalingGroupResource s) -> (TF.Attr s P.Bool))
...
instance P.HasSuspendedProcesses (AutoscalingGroupResource s) (TF.Attr s (TF.Attr s P.Text)) where
    suspendedProcesses =
        lens (_suspendedProcesses :: (AutoscalingGroupResource s) -> (TF.Attr s (TF.Attr s P.Text)))
             (\s a -> s { _suspendedProcesses = a } :: (AutoscalingGroupResource s))

instance P.HasTag (AutoscalingGroupResource s) (TF.Attr s (Tag s)) where
    tag =
        lens (_tag :: (AutoscalingGroupResource s) -> (TF.Attr s (Tag s)))
...
instance P.HasTags (AutoscalingGroupResource s) (TF.Attr s [(TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text)))]) where
    tags =
        lens (_tags :: (AutoscalingGroupResource s) -> (TF.Attr s [(TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text)))]))
...
instance P.HasTerminationPolicies (AutoscalingGroupResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    terminationPolicies =
        lens (_terminationPolicies :: (AutoscalingGroupResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasWaitForCapacityTimeout (AutoscalingGroupResource s) (TF.Attr s P.Text) where
    waitForCapacityTimeout =
        lens (_waitForCapacityTimeout :: (AutoscalingGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasWaitForElbCapacity (AutoscalingGroupResource s) (TF.Attr s P.Integer) where
    waitForElbCapacity =
        lens (_waitForElbCapacity :: (AutoscalingGroupResource s) -> (TF.Attr s P.Integer))
...
autoscalingLifecycleHookResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (AutoscalingLifecycleHookResource s)
...
instance P.HasAutoscalingGroupName (AutoscalingLifecycleHookResource s) (TF.Attr s P.Text) where
    autoscalingGroupName =
        lens (_autoscalingGroupName :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Text))
...
instance P.HasHeartbeatTimeout (AutoscalingLifecycleHookResource s) (TF.Attr s P.Integer) where
    heartbeatTimeout =
        lens (_heartbeatTimeout :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Integer))
...
instance P.HasLifecycleTransition (AutoscalingLifecycleHookResource s) (TF.Attr s P.Text) where
    lifecycleTransition =
        lens (_lifecycleTransition :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Text))
...
instance P.HasNotificationMetadata (AutoscalingLifecycleHookResource s) (TF.Attr s P.Text) where
    notificationMetadata =
        lens (_notificationMetadata :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Text))
...
instance P.HasNotificationTargetArn (AutoscalingLifecycleHookResource s) (TF.Attr s P.Text) where
    notificationTargetArn =
        lens (_notificationTargetArn :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Text))
...
instance P.HasRoleArn (AutoscalingLifecycleHookResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (AutoscalingLifecycleHookResource s) -> (TF.Attr s P.Text))
...
autoscalingNotificationResource
    :: (TF.Attr s (TF.Attr s P.Text)) -- ^ @group_names@
    -> (TF.Attr s (TF.Attr s P.Text)) -- ^ @notifications@
    -> (TF.Attr s P.Text) -- ^ @topic_arn@
    -> TF.Resource AWS (AutoscalingNotificationResource s)
...
instance P.HasGroupNames (AutoscalingNotificationResource s) (TF.Attr s (TF.Attr s P.Text)) where
    groupNames =
        lens (_groupNames :: (AutoscalingNotificationResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasNotifications (AutoscalingNotificationResource s) (TF.Attr s (TF.Attr s P.Text)) where
    notifications =
        lens (_notifications :: (AutoscalingNotificationResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasTopicArn (AutoscalingNotificationResource s) (TF.Attr s P.Text) where
    topicArn =
        lens (_topicArn :: (AutoscalingNotificationResource s) -> (TF.Attr s P.Text))
...
autoscalingPolicyResource
    :: (TF.Attr s P.Text) -- ^ @autoscaling_group_name@
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (AutoscalingPolicyResource s)
...
instance P.HasAdjustmentType (AutoscalingPolicyResource s) (TF.Attr s P.Text) where
    adjustmentType =
        lens (_adjustmentType :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasAutoscalingGroupName (AutoscalingPolicyResource s) (TF.Attr s P.Text) where
    autoscalingGroupName =
        lens (_autoscalingGroupName :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasCooldown (AutoscalingPolicyResource s) (TF.Attr s P.Integer) where
    cooldown =
        lens (_cooldown :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasEstimatedInstanceWarmup (AutoscalingPolicyResource s) (TF.Attr s P.Integer) where
    estimatedInstanceWarmup =
        lens (_estimatedInstanceWarmup :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMinAdjustmentMagnitude (AutoscalingPolicyResource s) (TF.Attr s P.Integer) where
    minAdjustmentMagnitude =
        lens (_minAdjustmentMagnitude :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasMinAdjustmentStep (AutoscalingPolicyResource s) (TF.Attr s P.Integer) where
    minAdjustmentStep =
        lens (_minAdjustmentStep :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Integer))
...
instance P.HasPolicyType (AutoscalingPolicyResource s) (TF.Attr s P.Text) where
    policyType =
        lens (_policyType :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasScalingAdjustment (AutoscalingPolicyResource s) (TF.Attr s P.Integer) where
    scalingAdjustment =
        lens (_scalingAdjustment :: (AutoscalingPolicyResource s) -> (TF.Attr s P.Integer))
             (\s a -> s { _scalingAdjustment = a } :: (AutoscalingPolicyResource s))

instance P.HasStepAdjustment (AutoscalingPolicyResource s) (TF.Attr s (StepAdjustment s)) where
    stepAdjustment =
        lens (_stepAdjustment :: (AutoscalingPolicyResource s) -> (TF.Attr s (StepAdjustment s)))
...
instance P.HasTargetTrackingConfiguration (AutoscalingPolicyResource s) (TF.Attr s [(TargetTrackingConfiguration s)]) where
    targetTrackingConfiguration =
        lens (_targetTrackingConfiguration :: (AutoscalingPolicyResource s) -> (TF.Attr s [(TargetTrackingConfiguration s)]))
...
autoscalingScheduleResource
    ...
    -> TF.Resource AWS (AutoscalingScheduleResource s)
...
instance P.HasAutoscalingGroupName (AutoscalingScheduleResource s) (TF.Attr s P.Text) where
    autoscalingGroupName =
        lens (_autoscalingGroupName :: (AutoscalingScheduleResource s) -> (TF.Attr s P.Text))
...
instance P.HasScheduledActionName (AutoscalingScheduleResource s) (TF.Attr s P.Text) where
    scheduledActionName =
        lens (_scheduledActionName :: (AutoscalingScheduleResource s) -> (TF.Attr s P.Text))
...
batchComputeEnvironmentResource
    ...
    -> (TF.Attr s P.Text) -- ^ @type@
    -> TF.Resource AWS (BatchComputeEnvironmentResource s)
...
instance P.HasComputeEnvironmentName (BatchComputeEnvironmentResource s) (TF.Attr s P.Text) where
    computeEnvironmentName =
        lens (_computeEnvironmentName :: (BatchComputeEnvironmentResource s) -> (TF.Attr s P.Text))
...
instance P.HasComputeResources (BatchComputeEnvironmentResource s) (TF.Attr s [(ComputeResources s)]) where
    computeResources =
        lens (_computeResources :: (BatchComputeEnvironmentResource s) -> (TF.Attr s [(ComputeResources s)]))
...
instance P.HasServiceRole (BatchComputeEnvironmentResource s) (TF.Attr s P.Text) where
    serviceRole =
        lens (_serviceRole :: (BatchComputeEnvironmentResource s) -> (TF.Attr s P.Text))
...
batchJobDefinitionResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @type@
    -> TF.Resource AWS (BatchJobDefinitionResource s)
...
instance P.HasContainerProperties (BatchJobDefinitionResource s) (TF.Attr s P.Text) where
    containerProperties =
        lens (_containerProperties :: (BatchJobDefinitionResource s) -> (TF.Attr s P.Text))
...
instance P.HasParameters (BatchJobDefinitionResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    parameters =
        lens (_parameters :: (BatchJobDefinitionResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasRetryStrategy (BatchJobDefinitionResource s) (TF.Attr s [(RetryStrategy s)]) where
    retryStrategy =
        lens (_retryStrategy :: (BatchJobDefinitionResource s) -> (TF.Attr s [(RetryStrategy s)]))
...
instance P.HasTimeout (BatchJobDefinitionResource s) (TF.Attr s [(Timeout s)]) where
    timeout =
        lens (_timeout :: (BatchJobDefinitionResource s) -> (TF.Attr s [(Timeout s)]))
...
batchJobQueueResource
    ...
    -> TF.Resource AWS (BatchJobQueueResource s)
...
instance P.HasComputeEnvironments (BatchJobQueueResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    computeEnvironments =
        lens (_computeEnvironments :: (BatchJobQueueResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasPriority (BatchJobQueueResource s) (TF.Attr s P.Integer) where
    priority =
        lens (_priority :: (BatchJobQueueResource s) -> (TF.Attr s P.Integer))
...
budgetsBudgetResource
    ...
    -> TF.Resource AWS (BudgetsBudgetResource s)
...
instance P.HasTimePeriodStart (BudgetsBudgetResource s) (TF.Attr s P.Text) where
    timePeriodStart =
        lens (_timePeriodStart :: (BudgetsBudgetResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _timePeriodStart = a } :: (BudgetsBudgetResource s))

instance P.HasTimeUnit (BudgetsBudgetResource s) (TF.Attr s P.Text) where
    timeUnit =
        lens (_timeUnit :: (BudgetsBudgetResource s) -> (TF.Attr s P.Text))
...
cloud9EnvironmentEc2Resource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (Cloud9EnvironmentEc2Resource s)
...
instance P.HasAutomaticStopTimeMinutes (Cloud9EnvironmentEc2Resource s) (TF.Attr s P.Integer) where
    automaticStopTimeMinutes =
        lens (_automaticStopTimeMinutes :: (Cloud9EnvironmentEc2Resource s) -> (TF.Attr s P.Integer))
...
instance P.HasInstanceType (Cloud9EnvironmentEc2Resource s) (TF.Attr s P.Text) where
    instanceType =
        lens (_instanceType :: (Cloud9EnvironmentEc2Resource s) -> (TF.Attr s P.Text))
...
instance P.HasSubnetId (Cloud9EnvironmentEc2Resource s) (TF.Attr s P.Text) where
    subnetId =
        lens (_subnetId :: (Cloud9EnvironmentEc2Resource s) -> (TF.Attr s P.Text))
...
cloudformationStackResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (CloudformationStackResource s)
...
instance P.HasCapabilities (CloudformationStackResource s) (TF.Attr s (TF.Attr s P.Text)) where
    capabilities =
        lens (_capabilities :: (CloudformationStackResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasDisableRollback (CloudformationStackResource s) (TF.Attr s P.Bool) where
    disableRollback =
        lens (_disableRollback :: (CloudformationStackResource s) -> (TF.Attr s P.Bool))
...
instance P.HasIamRoleArn (CloudformationStackResource s) (TF.Attr s P.Text) where
    iamRoleArn =
        lens (_iamRoleArn :: (CloudformationStackResource s) -> (TF.Attr s P.Text))
...
instance P.HasNotificationArns (CloudformationStackResource s) (TF.Attr s (TF.Attr s P.Text)) where
    notificationArns =
        lens (_notificationArns :: (CloudformationStackResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasOnFailure (CloudformationStackResource s) (TF.Attr s P.Text) where
    onFailure =
        lens (_onFailure :: (CloudformationStackResource s) -> (TF.Attr s P.Text))
...
instance P.HasPolicyUrl (CloudformationStackResource s) (TF.Attr s P.Text) where
    policyUrl =
        lens (_policyUrl :: (CloudformationStackResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (CloudformationStackResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CloudformationStackResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasTemplateUrl (CloudformationStackResource s) (TF.Attr s P.Text) where
    templateUrl =
        lens (_templateUrl :: (CloudformationStackResource s) -> (TF.Attr s P.Text))
...
instance P.HasTimeoutInMinutes (CloudformationStackResource s) (TF.Attr s P.Integer) where
    timeoutInMinutes =
        lens (_timeoutInMinutes :: (CloudformationStackResource s) -> (TF.Attr s P.Integer))
...
data (CloudfrontDistributionResource s) = CloudfrontDistributionResource'
    ...
    , _cacheBehavior :: (TF.Attr s (CacheBehavior s))
    , _comment :: (TF.Attr s P.Text)
    , _customErrorResponse :: (TF.Attr s (CustomErrorResponse s))
...
cloudfrontDistributionResource
    :: (TF.Attr s (DefaultCacheBehavior s)) -- ^ @default_cache_behavior@
    -> (TF.Attr s P.Bool) -- ^ @enabled@
    -> (TF.Attr s (Origin s)) -- ^ @origin@
    -> (TF.Attr s (Restrictions s)) -- ^ @restrictions@
    -> (TF.Attr s (ViewerCertificate s)) -- ^ @viewer_certificate@
    -> TF.Resource AWS (CloudfrontDistributionResource s)
...
instance P.HasAliases (CloudfrontDistributionResource s) (TF.Attr s (TF.Attr s P.Text)) where
    aliases =
        lens (_aliases :: (CloudfrontDistributionResource s) -> (TF.Attr s (TF.Attr s P.Text)))
             (\s a -> s { _aliases = a } :: (CloudfrontDistributionResource s))

instance P.HasCacheBehavior (CloudfrontDistributionResource s) (TF.Attr s (CacheBehavior s)) where
    cacheBehavior =
        lens (_cacheBehavior :: (CloudfrontDistributionResource s) -> (TF.Attr s (CacheBehavior s)))
...
instance P.HasCustomErrorResponse (CloudfrontDistributionResource s) (TF.Attr s (CustomErrorResponse s)) where
    customErrorResponse =
        lens (_customErrorResponse :: (CloudfrontDistributionResource s) -> (TF.Attr s (CustomErrorResponse s)))
             (\s a -> s { _customErrorResponse = a } :: (CloudfrontDistributionResource s))

instance P.HasDefaultCacheBehavior (CloudfrontDistributionResource s) (TF.Attr s (DefaultCacheBehavior s)) where
    defaultCacheBehavior =
        lens (_defaultCacheBehavior :: (CloudfrontDistributionResource s) -> (TF.Attr s (DefaultCacheBehavior s)))
...
instance P.HasDefaultRootObject (CloudfrontDistributionResource s) (TF.Attr s P.Text) where
    defaultRootObject =
        lens (_defaultRootObject :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Text))
...
instance P.HasHttpVersion (CloudfrontDistributionResource s) (TF.Attr s P.Text) where
    httpVersion =
        lens (_httpVersion :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Text))
...
instance P.HasIsIpv6Enabled (CloudfrontDistributionResource s) (TF.Attr s P.Bool) where
    isIpv6Enabled =
        lens (_isIpv6Enabled :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Bool))
             (\s a -> s { _isIpv6Enabled = a } :: (CloudfrontDistributionResource s))

instance P.HasLoggingConfig (CloudfrontDistributionResource s) (TF.Attr s (LoggingConfig s)) where
    loggingConfig =
        lens (_loggingConfig :: (CloudfrontDistributionResource s) -> (TF.Attr s (LoggingConfig s)))
...
instance P.HasOrderedCacheBehavior (CloudfrontDistributionResource s) (TF.Attr s [(OrderedCacheBehavior s)]) where
    orderedCacheBehavior =
        lens (_orderedCacheBehavior :: (CloudfrontDistributionResource s) -> (TF.Attr s [(OrderedCacheBehavior s)]))
             (\s a -> s { _orderedCacheBehavior = a } :: (CloudfrontDistributionResource s))

instance P.HasOrigin (CloudfrontDistributionResource s) (TF.Attr s (Origin s)) where
    origin =
        lens (_origin :: (CloudfrontDistributionResource s) -> (TF.Attr s (Origin s)))
...
instance P.HasPriceClass (CloudfrontDistributionResource s) (TF.Attr s P.Text) where
    priceClass =
        lens (_priceClass :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _priceClass = a } :: (CloudfrontDistributionResource s))

instance P.HasRestrictions (CloudfrontDistributionResource s) (TF.Attr s (Restrictions s)) where
    restrictions =
        lens (_restrictions :: (CloudfrontDistributionResource s) -> (TF.Attr s (Restrictions s)))
...
instance P.HasRetainOnDelete (CloudfrontDistributionResource s) (TF.Attr s P.Bool) where
    retainOnDelete =
        lens (_retainOnDelete :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Bool))
...
instance P.HasTags (CloudfrontDistributionResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CloudfrontDistributionResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
             (\s a -> s { _tags = a } :: (CloudfrontDistributionResource s))

instance P.HasViewerCertificate (CloudfrontDistributionResource s) (TF.Attr s (ViewerCertificate s)) where
    viewerCertificate =
        lens (_viewerCertificate :: (CloudfrontDistributionResource s) -> (TF.Attr s (ViewerCertificate s)))
...
instance P.HasWebAclId (CloudfrontDistributionResource s) (TF.Attr s P.Text) where
    webAclId =
        lens (_webAclId :: (CloudfrontDistributionResource s) -> (TF.Attr s P.Text))
...
cloudfrontOriginAccessIdentityResource
    :: TF.Resource AWS (CloudfrontOriginAccessIdentityResource s)
cloudfrontOriginAccessIdentityResource =
...
cloudtrailResource
    ...
    -> TF.Resource AWS (CloudtrailResource s)
...
instance P.HasCloudWatchLogsGroupArn (CloudtrailResource s) (TF.Attr s P.Text) where
    cloudWatchLogsGroupArn =
        lens (_cloudWatchLogsGroupArn :: (CloudtrailResource s) -> (TF.Attr s P.Text))
...
instance P.HasCloudWatchLogsRoleArn (CloudtrailResource s) (TF.Attr s P.Text) where
    cloudWatchLogsRoleArn =
        lens (_cloudWatchLogsRoleArn :: (CloudtrailResource s) -> (TF.Attr s P.Text))
...
instance P.HasEnableLogFileValidation (CloudtrailResource s) (TF.Attr s P.Bool) where
    enableLogFileValidation =
        lens (_enableLogFileValidation :: (CloudtrailResource s) -> (TF.Attr s P.Bool))
...
instance P.HasEnableLogging (CloudtrailResource s) (TF.Attr s P.Bool) where
    enableLogging =
        lens (_enableLogging :: (CloudtrailResource s) -> (TF.Attr s P.Bool))
...
instance P.HasEventSelector (CloudtrailResource s) (TF.Attr s [(EventSelector s)]) where
    eventSelector =
        lens (_eventSelector :: (CloudtrailResource s) -> (TF.Attr s [(EventSelector s)]))
...
instance P.HasIncludeGlobalServiceEvents (CloudtrailResource s) (TF.Attr s P.Bool) where
    includeGlobalServiceEvents =
        lens (_includeGlobalServiceEvents :: (CloudtrailResource s) -> (TF.Attr s P.Bool))
...
instance P.HasIsMultiRegionTrail (CloudtrailResource s) (TF.Attr s P.Bool) where
    isMultiRegionTrail =
        lens (_isMultiRegionTrail :: (CloudtrailResource s) -> (TF.Attr s P.Bool))
             (\s a -> s { _isMultiRegionTrail = a } :: (CloudtrailResource s))

instance P.HasKmsKeyId (CloudtrailResource s) (TF.Attr s P.Text) where
    kmsKeyId =
        lens (_kmsKeyId :: (CloudtrailResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (CloudtrailResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CloudtrailResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
cloudwatchDashboardResource
    ...
    -> TF.Resource AWS (CloudwatchDashboardResource s)
...
instance P.HasDashboardBody (CloudwatchDashboardResource s) (TF.Attr s P.Text) where
    dashboardBody =
        lens (_dashboardBody :: (CloudwatchDashboardResource s) -> (TF.Attr s P.Text))
...
instance P.HasDashboardName (CloudwatchDashboardResource s) (TF.Attr s P.Text) where
    dashboardName =
        lens (_dashboardName :: (CloudwatchDashboardResource s) -> (TF.Attr s P.Text))
...
cloudwatchEventPermissionResource
    ...
    -> TF.Resource AWS (CloudwatchEventPermissionResource s)
...
instance P.HasStatementId (CloudwatchEventPermissionResource s) (TF.Attr s P.Text) where
    statementId =
        lens (_statementId :: (CloudwatchEventPermissionResource s) -> (TF.Attr s P.Text))
...
cloudwatchEventRuleResource
    :: TF.Resource AWS (CloudwatchEventRuleResource s)
cloudwatchEventRuleResource =
...
instance P.HasEventPattern (CloudwatchEventRuleResource s) (TF.Attr s P.Text) where
    eventPattern =
        lens (_eventPattern :: (CloudwatchEventRuleResource s) -> (TF.Attr s P.Text))
...
instance P.HasIsEnabled (CloudwatchEventRuleResource s) (TF.Attr s P.Bool) where
    isEnabled =
        lens (_isEnabled :: (CloudwatchEventRuleResource s) -> (TF.Attr s P.Bool))
...
instance P.HasNamePrefix (CloudwatchEventRuleResource s) (TF.Attr s P.Text) where
    namePrefix =
        lens (_namePrefix :: (CloudwatchEventRuleResource s) -> (TF.Attr s P.Text))
...
instance P.HasRoleArn (CloudwatchEventRuleResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (CloudwatchEventRuleResource s) -> (TF.Attr s P.Text))
...
instance P.HasScheduleExpression (CloudwatchEventRuleResource s) (TF.Attr s P.Text) where
    scheduleExpression =
        lens (_scheduleExpression :: (CloudwatchEventRuleResource s) -> (TF.Attr s P.Text))
...
cloudwatchEventTargetResource
    ...
    -> TF.Resource AWS (CloudwatchEventTargetResource s)
...
instance P.HasBatchTarget (CloudwatchEventTargetResource s) (TF.Attr s [(BatchTarget s)]) where
    batchTarget =
        lens (_batchTarget :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(BatchTarget s)]))
...
instance P.HasEcsTarget (CloudwatchEventTargetResource s) (TF.Attr s [(EcsTarget s)]) where
    ecsTarget =
        lens (_ecsTarget :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(EcsTarget s)]))
...
instance P.HasInputPath (CloudwatchEventTargetResource s) (TF.Attr s P.Text) where
    inputPath =
        lens (_inputPath :: (CloudwatchEventTargetResource s) -> (TF.Attr s P.Text))
...
instance P.HasInputTransformer (CloudwatchEventTargetResource s) (TF.Attr s [(InputTransformer s)]) where
    inputTransformer =
        lens (_inputTransformer :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(InputTransformer s)]))
...
instance P.HasKinesisTarget (CloudwatchEventTargetResource s) (TF.Attr s [(KinesisTarget s)]) where
    kinesisTarget =
        lens (_kinesisTarget :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(KinesisTarget s)]))
...
instance P.HasRoleArn (CloudwatchEventTargetResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (CloudwatchEventTargetResource s) -> (TF.Attr s P.Text))
...
instance P.HasRunCommandTargets (CloudwatchEventTargetResource s) (TF.Attr s [(RunCommandTargets s)]) where
    runCommandTargets =
        lens (_runCommandTargets :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(RunCommandTargets s)]))
...
instance P.HasSqsTarget (CloudwatchEventTargetResource s) (TF.Attr s [(SqsTarget s)]) where
    sqsTarget =
        lens (_sqsTarget :: (CloudwatchEventTargetResource s) -> (TF.Attr s [(SqsTarget s)]))
...
cloudwatchLogDestinationResource
    ...
    -> TF.Resource AWS (CloudwatchLogDestinationResource s)
...
instance P.HasRoleArn (CloudwatchLogDestinationResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (CloudwatchLogDestinationResource s) -> (TF.Attr s P.Text))
...
instance P.HasTargetArn (CloudwatchLogDestinationResource s) (TF.Attr s P.Text) where
    targetArn =
        lens (_targetArn :: (CloudwatchLogDestinationResource s) -> (TF.Attr s P.Text))
...
cloudwatchLogDestinationPolicyResource
    ...
    -> TF.Resource AWS (CloudwatchLogDestinationPolicyResource s)
...
instance P.HasAccessPolicy (CloudwatchLogDestinationPolicyResource s) (TF.Attr s P.Text) where
    accessPolicy =
        lens (_accessPolicy :: (CloudwatchLogDestinationPolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasDestinationName (CloudwatchLogDestinationPolicyResource s) (TF.Attr s P.Text) where
    destinationName =
        lens (_destinationName :: (CloudwatchLogDestinationPolicyResource s) -> (TF.Attr s P.Text))
...
cloudwatchLogGroupResource
    :: TF.Resource AWS (CloudwatchLogGroupResource s)
cloudwatchLogGroupResource =
...
instance P.HasKmsKeyId (CloudwatchLogGroupResource s) (TF.Attr s P.Text) where
    kmsKeyId =
        lens (_kmsKeyId :: (CloudwatchLogGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasNamePrefix (CloudwatchLogGroupResource s) (TF.Attr s P.Text) where
    namePrefix =
        lens (_namePrefix :: (CloudwatchLogGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasRetentionInDays (CloudwatchLogGroupResource s) (TF.Attr s P.Integer) where
    retentionInDays =
        lens (_retentionInDays :: (CloudwatchLogGroupResource s) -> (TF.Attr s P.Integer))
...
instance P.HasTags (CloudwatchLogGroupResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CloudwatchLogGroupResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
cloudwatchLogMetricFilterResource
    ...
    -> TF.Resource AWS (CloudwatchLogMetricFilterResource s)
...
instance P.HasLogGroupName (CloudwatchLogMetricFilterResource s) (TF.Attr s P.Text) where
    logGroupName =
        lens (_logGroupName :: (CloudwatchLogMetricFilterResource s) -> (TF.Attr s P.Text))
...
instance P.HasMetricTransformation (CloudwatchLogMetricFilterResource s) (TF.Attr s [(MetricTransformation s)]) where
    metricTransformation =
        lens (_metricTransformation :: (CloudwatchLogMetricFilterResource s) -> (TF.Attr s [(MetricTransformation s)]))
...
cloudwatchLogResourcePolicyResource
    ...
    -> TF.Resource AWS (CloudwatchLogResourcePolicyResource s)
...
instance P.HasPolicyDocument (CloudwatchLogResourcePolicyResource s) (TF.Attr s P.Text) where
    policyDocument =
        lens (_policyDocument :: (CloudwatchLogResourcePolicyResource s) -> (TF.Attr s P.Text))
...
instance P.HasPolicyName (CloudwatchLogResourcePolicyResource s) (TF.Attr s P.Text) where
    policyName =
        lens (_policyName :: (CloudwatchLogResourcePolicyResource s) -> (TF.Attr s P.Text))
...
cloudwatchLogStreamResource
    :: (TF.Attr s P.Text) -- ^ @log_group_name@
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (CloudwatchLogStreamResource s)
...
instance P.HasLogGroupName (CloudwatchLogStreamResource s) (TF.Attr s P.Text) where
    logGroupName =
        lens (_logGroupName :: (CloudwatchLogStreamResource s) -> (TF.Attr s P.Text))
...
cloudwatchLogSubscriptionFilterResource
    ...
    -> (TF.Attr s P.Text) -- ^ @log_group_name@
    -> (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (CloudwatchLogSubscriptionFilterResource s)
...
instance P.HasDestinationArn (CloudwatchLogSubscriptionFilterResource s) (TF.Attr s P.Text) where
    destinationArn =
        lens (_destinationArn :: (CloudwatchLogSubscriptionFilterResource s) -> (TF.Attr s P.Text))
...
instance P.HasFilterPattern (CloudwatchLogSubscriptionFilterResource s) (TF.Attr s P.Text) where
    filterPattern =
        lens (_filterPattern :: (CloudwatchLogSubscriptionFilterResource s) -> (TF.Attr s P.Text))
...
instance P.HasLogGroupName (CloudwatchLogSubscriptionFilterResource s) (TF.Attr s P.Text) where
    logGroupName =
        lens (_logGroupName :: (CloudwatchLogSubscriptionFilterResource s) -> (TF.Attr s P.Text))
...
cloudwatchMetricAlarmResource
    ...
    -> TF.Resource AWS (CloudwatchMetricAlarmResource s)
...
instance P.HasActionsEnabled (CloudwatchMetricAlarmResource s) (TF.Attr s P.Bool) where
    actionsEnabled =
        lens (_actionsEnabled :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Bool))
...
instance P.HasAlarmActions (CloudwatchMetricAlarmResource s) (TF.Attr s (TF.Attr s P.Text)) where
    alarmActions =
        lens (_alarmActions :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasAlarmDescription (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    alarmDescription =
        lens (_alarmDescription :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
instance P.HasAlarmName (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    alarmName =
        lens (_alarmName :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
instance P.HasComparisonOperator (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    comparisonOperator =
        lens (_comparisonOperator :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
instance P.HasDatapointsToAlarm (CloudwatchMetricAlarmResource s) (TF.Attr s P.Integer) where
    datapointsToAlarm =
        lens (_datapointsToAlarm :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Integer))
...
instance P.HasDimensions (CloudwatchMetricAlarmResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    dimensions =
        lens (_dimensions :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasEvaluationPeriods (CloudwatchMetricAlarmResource s) (TF.Attr s P.Integer) where
    evaluationPeriods =
        lens (_evaluationPeriods :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Integer))
...
instance P.HasExtendedStatistic (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    extendedStatistic =
        lens (_extendedStatistic :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
instance P.HasInsufficientDataActions (CloudwatchMetricAlarmResource s) (TF.Attr s (TF.Attr s P.Text)) where
    insufficientDataActions =
        lens (_insufficientDataActions :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasMetricName (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    metricName =
        lens (_metricName :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
instance P.HasOkActions (CloudwatchMetricAlarmResource s) (TF.Attr s (TF.Attr s P.Text)) where
    okActions =
        lens (_okActions :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasPeriod (CloudwatchMetricAlarmResource s) (TF.Attr s P.Integer) where
    period =
        lens (_period :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Integer))
...
instance P.HasThreshold (CloudwatchMetricAlarmResource s) (TF.Attr s P.Double) where
    threshold =
        lens (_threshold :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Double))
...
instance P.HasTreatMissingData (CloudwatchMetricAlarmResource s) (TF.Attr s P.Text) where
    treatMissingData =
        lens (_treatMissingData :: (CloudwatchMetricAlarmResource s) -> (TF.Attr s P.Text))
...
codebuildProjectResource
    :: (TF.Attr s (Artifacts s)) -- ^ @artifacts@
    -> (TF.Attr s (Environment s)) -- ^ @environment@
    -> (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @service_role@
    -> (TF.Attr s (Source s)) -- ^ @source@
    -> TF.Resource AWS (CodebuildProjectResource s)
...
instance P.HasArtifacts (CodebuildProjectResource s) (TF.Attr s (Artifacts s)) where
    artifacts =
        lens (_artifacts :: (CodebuildProjectResource s) -> (TF.Attr s (Artifacts s)))
...
instance P.HasBadgeEnabled (CodebuildProjectResource s) (TF.Attr s P.Bool) where
    badgeEnabled =
        lens (_badgeEnabled :: (CodebuildProjectResource s) -> (TF.Attr s P.Bool))
...
instance P.HasBuildTimeout (CodebuildProjectResource s) (TF.Attr s P.Integer) where
    buildTimeout =
        lens (_buildTimeout :: (CodebuildProjectResource s) -> (TF.Attr s P.Integer))
             (\s a -> s { _buildTimeout = a } :: (CodebuildProjectResource s))

instance P.HasCache (CodebuildProjectResource s) (TF.Attr s [(Cache s)]) where
    cache =
        lens (_cache :: (CodebuildProjectResource s) -> (TF.Attr s [(Cache s)]))
             (\s a -> s { _cache = a } :: (CodebuildProjectResource s))

instance P.HasEnvironment (CodebuildProjectResource s) (TF.Attr s (Environment s)) where
    environment =
        lens (_environment :: (CodebuildProjectResource s) -> (TF.Attr s (Environment s)))
...
instance P.HasServiceRole (CodebuildProjectResource s) (TF.Attr s P.Text) where
    serviceRole =
        lens (_serviceRole :: (CodebuildProjectResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _serviceRole = a } :: (CodebuildProjectResource s))

instance P.HasSource (CodebuildProjectResource s) (TF.Attr s (Source s)) where
    source =
        lens (_source :: (CodebuildProjectResource s) -> (TF.Attr s (Source s)))
...
instance P.HasTags (CodebuildProjectResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CodebuildProjectResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
             (\s a -> s { _tags = a } :: (CodebuildProjectResource s))

instance P.HasTimeout (CodebuildProjectResource s) (TF.Attr s P.Integer) where
    timeout =
        lens (_timeout :: (CodebuildProjectResource s) -> (TF.Attr s P.Integer))
...
instance P.HasVpcConfig (CodebuildProjectResource s) (TF.Attr s [(VpcConfig s)]) where
    vpcConfig =
        lens (_vpcConfig :: (CodebuildProjectResource s) -> (TF.Attr s [(VpcConfig s)]))
...
codebuildWebhookResource
    ...
    -> TF.Resource AWS (CodebuildWebhookResource s)
...
instance P.HasBranchFilter (CodebuildWebhookResource s) (TF.Attr s P.Text) where
    branchFilter =
        lens (_branchFilter :: (CodebuildWebhookResource s) -> (TF.Attr s P.Text))
...
instance P.HasProjectName (CodebuildWebhookResource s) (TF.Attr s P.Text) where
    projectName =
        lens (_projectName :: (CodebuildWebhookResource s) -> (TF.Attr s P.Text))
...
codecommitRepositoryResource
    ...
    -> TF.Resource AWS (CodecommitRepositoryResource s)
...
instance P.HasDefaultBranch (CodecommitRepositoryResource s) (TF.Attr s P.Text) where
    defaultBranch =
        lens (_defaultBranch :: (CodecommitRepositoryResource s) -> (TF.Attr s P.Text))
...
instance P.HasRepositoryName (CodecommitRepositoryResource s) (TF.Attr s P.Text) where
    repositoryName =
        lens (_repositoryName :: (CodecommitRepositoryResource s) -> (TF.Attr s P.Text))
...
codecommitTriggerResource
    :: (TF.Attr s P.Text) -- ^ @repository_name@
    -> (TF.Attr s (Trigger s)) -- ^ @trigger@
    -> TF.Resource AWS (CodecommitTriggerResource s)
...
instance P.HasRepositoryName (CodecommitTriggerResource s) (TF.Attr s P.Text) where
    repositoryName =
        lens (_repositoryName :: (CodecommitTriggerResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _repositoryName = a } :: (CodecommitTriggerResource s))

instance P.HasTrigger (CodecommitTriggerResource s) (TF.Attr s (Trigger s)) where
    trigger =
        lens (_trigger :: (CodecommitTriggerResource s) -> (TF.Attr s (Trigger s)))
...
codedeployAppResource
    :: (TF.Attr s P.Text) -- ^ @name@
    -> TF.Resource AWS (CodedeployAppResource s)
...
instance P.HasComputePlatform (CodedeployAppResource s) (TF.Attr s P.Text) where
    computePlatform =
        lens (_computePlatform :: (CodedeployAppResource s) -> (TF.Attr s P.Text))
...
codedeployDeploymentConfigResource
    ...
    -> TF.Resource AWS (CodedeployDeploymentConfigResource s)
...
instance P.HasDeploymentConfigName (CodedeployDeploymentConfigResource s) (TF.Attr s P.Text) where
    deploymentConfigName =
        lens (_deploymentConfigName :: (CodedeployDeploymentConfigResource s) -> (TF.Attr s P.Text))
...
instance P.HasMinimumHealthyHosts (CodedeployDeploymentConfigResource s) (TF.Attr s [(MinimumHealthyHosts s)]) where
    minimumHealthyHosts =
        lens (_minimumHealthyHosts :: (CodedeployDeploymentConfigResource s) -> (TF.Attr s [(MinimumHealthyHosts s)]))
...
data (CodedeployDeploymentGroupResource s) = CodedeployDeploymentGroupResource'
    ...
    , _ec2TagSet :: (TF.Attr s (Ec2TagSet s))
    , _onPremisesInstanceTagFilter :: (TF.Attr s (OnPremisesInstanceTagFilter s))
    , _serviceRoleArn :: (TF.Attr s P.Text)
    , _triggerConfiguration :: (TF.Attr s (TriggerConfiguration s))
    } deriving (Show, Eq, Generic)
...
codedeployDeploymentGroupResource
    ...
    -> TF.Resource AWS (CodedeployDeploymentGroupResource s)
...
instance P.HasAlarmConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s [(AlarmConfiguration s)]) where
    alarmConfiguration =
        lens (_alarmConfiguration :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s [(AlarmConfiguration s)]))
...
instance P.HasAppName (CodedeployDeploymentGroupResource s) (TF.Attr s P.Text) where
    appName =
        lens (_appName :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasAutoRollbackConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s [(AutoRollbackConfiguration s)]) where
    autoRollbackConfiguration =
        lens (_autoRollbackConfiguration :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s [(AutoRollbackConfiguration s)]))
...
instance P.HasAutoscalingGroups (CodedeployDeploymentGroupResource s) (TF.Attr s (TF.Attr s P.Text)) where
    autoscalingGroups =
        lens (_autoscalingGroups :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasDeploymentConfigName (CodedeployDeploymentGroupResource s) (TF.Attr s P.Text) where
    deploymentConfigName =
        lens (_deploymentConfigName :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s P.Text))
...
instance P.HasDeploymentGroupName (CodedeployDeploymentGroupResource s) (TF.Attr s P.Text) where
    deploymentGroupName =
        lens (_deploymentGroupName :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _deploymentGroupName = a } :: (CodedeployDeploymentGroupResource s))

instance P.HasEc2TagFilter (CodedeployDeploymentGroupResource s) (TF.Attr s (Ec2TagFilter s)) where
    ec2TagFilter =
        lens (_ec2TagFilter :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s (Ec2TagFilter s)))
             (\s a -> s { _ec2TagFilter = a } :: (CodedeployDeploymentGroupResource s))

instance P.HasEc2TagSet (CodedeployDeploymentGroupResource s) (TF.Attr s (Ec2TagSet s)) where
    ec2TagSet =
        lens (_ec2TagSet :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s (Ec2TagSet s)))
             (\s a -> s { _ec2TagSet = a } :: (CodedeployDeploymentGroupResource s))

instance P.HasOnPremisesInstanceTagFilter (CodedeployDeploymentGroupResource s) (TF.Attr s (OnPremisesInstanceTagFilter s)) where
    onPremisesInstanceTagFilter =
        lens (_onPremisesInstanceTagFilter :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s (OnPremisesInstanceTagFilter s)))
...
instance P.HasServiceRoleArn (CodedeployDeploymentGroupResource s) (TF.Attr s P.Text) where
    serviceRoleArn =
        lens (_serviceRoleArn :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _serviceRoleArn = a } :: (CodedeployDeploymentGroupResource s))

instance P.HasTriggerConfiguration (CodedeployDeploymentGroupResource s) (TF.Attr s (TriggerConfiguration s)) where
    triggerConfiguration =
        lens (_triggerConfiguration :: (CodedeployDeploymentGroupResource s) -> (TF.Attr s (TriggerConfiguration s)))
...
codepipelineResource
    ...
    -> (TF.Attr s P.Text) -- ^ @name@
    -> (TF.Attr s P.Text) -- ^ @role_arn@
    -> (TF.Attr s [(Stage s)]) -- ^ @stage@
    -> TF.Resource AWS (CodepipelineResource s)
...
instance P.HasArtifactStore (CodepipelineResource s) (TF.Attr s [(ArtifactStore s)]) where
    artifactStore =
        lens (_artifactStore :: (CodepipelineResource s) -> (TF.Attr s [(ArtifactStore s)]))
...
instance P.HasRoleArn (CodepipelineResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (CodepipelineResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _roleArn = a } :: (CodepipelineResource s))

instance P.HasStage (CodepipelineResource s) (TF.Attr s [(Stage s)]) where
    stage =
        lens (_stage :: (CodepipelineResource s) -> (TF.Attr s [(Stage s)]))
...
data (CognitoIdentityPoolResource s) = CognitoIdentityPoolResource'
    ...
    , _cognitoIdentityProviders :: (TF.Attr s (CognitoIdentityProviders s))
...
instance P.HasAllowUnauthenticatedIdentities (CognitoIdentityPoolResource s) (TF.Attr s P.Bool) where
    allowUnauthenticatedIdentities =
        lens (_allowUnauthenticatedIdentities :: (CognitoIdentityPoolResource s) -> (TF.Attr s P.Bool))
             (\s a -> s { _allowUnauthenticatedIdentities = a } :: (CognitoIdentityPoolResource s))

instance P.HasCognitoIdentityProviders (CognitoIdentityPoolResource s) (TF.Attr s (CognitoIdentityProviders s)) where
    cognitoIdentityProviders =
        lens (_cognitoIdentityProviders :: (CognitoIdentityPoolResource s) -> (TF.Attr s (CognitoIdentityProviders s)))
...
instance P.HasDeveloperProviderName (CognitoIdentityPoolResource s) (TF.Attr s P.Text) where
    developerProviderName =
        lens (_developerProviderName :: (CognitoIdentityPoolResource s) -> (TF.Attr s P.Text))
...
instance P.HasIdentityPoolName (CognitoIdentityPoolResource s) (TF.Attr s P.Text) where
    identityPoolName =
        lens (_identityPoolName :: (CognitoIdentityPoolResource s) -> (TF.Attr s P.Text))
...
instance P.HasOpenidConnectProviderArns (CognitoIdentityPoolResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    openidConnectProviderArns =
        lens (_openidConnectProviderArns :: (CognitoIdentityPoolResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasSamlProviderArns (CognitoIdentityPoolResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    samlProviderArns =
        lens (_samlProviderArns :: (CognitoIdentityPoolResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasSupportedLoginProviders (CognitoIdentityPoolResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    supportedLoginProviders =
        lens (_supportedLoginProviders :: (CognitoIdentityPoolResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
data (CognitoIdentityPoolRolesAttachmentResource s) = CognitoIdentityPoolRolesAttachmentResource'
    ...
    , _roleMapping :: (TF.Attr s (RoleMapping s))
...
instance P.HasIdentityPoolId (CognitoIdentityPoolRolesAttachmentResource s) (TF.Attr s P.Text) where
    identityPoolId =
        lens (_identityPoolId :: (CognitoIdentityPoolRolesAttachmentResource s) -> (TF.Attr s P.Text))
             (\s a -> s { _identityPoolId = a } :: (CognitoIdentityPoolRolesAttachmentResource s))

instance P.HasRoleMapping (CognitoIdentityPoolRolesAttachmentResource s) (TF.Attr s (RoleMapping s)) where
    roleMapping =
        lens (_roleMapping :: (CognitoIdentityPoolRolesAttachmentResource s) -> (TF.Attr s (RoleMapping s)))
...
instance P.HasRoles (CognitoIdentityPoolRolesAttachmentResource s) (TF.Attr s (P.HashMap P.Text (Roles s))) where
    roles =
        lens (_roles :: (CognitoIdentityPoolRolesAttachmentResource s) -> (TF.Attr s (P.HashMap P.Text (Roles s))))
...
instance P.HasAttributeMapping (CognitoIdentityProviderResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    attributeMapping =
        lens (_attributeMapping :: (CognitoIdentityProviderResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasIdpIdentifiers (CognitoIdentityProviderResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    idpIdentifiers =
        lens (_idpIdentifiers :: (CognitoIdentityProviderResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasProviderDetails (CognitoIdentityProviderResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    providerDetails =
        lens (_providerDetails :: (CognitoIdentityProviderResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasProviderName (CognitoIdentityProviderResource s) (TF.Attr s P.Text) where
    providerName =
        lens (_providerName :: (CognitoIdentityProviderResource s) -> (TF.Attr s P.Text))
...
instance P.HasProviderType (CognitoIdentityProviderResource s) (TF.Attr s P.Text) where
    providerType =
        lens (_providerType :: (CognitoIdentityProviderResource s) -> (TF.Attr s P.Text))
...
instance P.HasUserPoolId (CognitoIdentityProviderResource s) (TF.Attr s P.Text) where
    userPoolId =
        lens (_userPoolId :: (CognitoIdentityProviderResource s) -> (TF.Attr s P.Text))
...
instance P.HasScope (CognitoResourceServerResource s) (TF.Attr s (Scope s)) where
    scope =
        lens (_scope :: (CognitoResourceServerResource s) -> (TF.Attr s (Scope s)))
...
instance P.HasUserPoolId (CognitoResourceServerResource s) (TF.Attr s P.Text) where
    userPoolId =
        lens (_userPoolId :: (CognitoResourceServerResource s) -> (TF.Attr s P.Text))
...
instance P.HasAliasAttributes (CognitoUserPoolResource s) (TF.Attr s (TF.Attr s P.Text)) where
    aliasAttributes =
        lens (_aliasAttributes :: (CognitoUserPoolResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasAutoVerifiedAttributes (CognitoUserPoolResource s) (TF.Attr s (TF.Attr s P.Text)) where
    autoVerifiedAttributes =
        lens (_autoVerifiedAttributes :: (CognitoUserPoolResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasDeviceConfiguration (CognitoUserPoolResource s) (TF.Attr s [(DeviceConfiguration s)]) where
    deviceConfiguration =
        lens (_deviceConfiguration :: (CognitoUserPoolResource s) -> (TF.Attr s [(DeviceConfiguration s)]))
...
instance P.HasEmailConfiguration (CognitoUserPoolResource s) (TF.Attr s [(EmailConfiguration s)]) where
    emailConfiguration =
        lens (_emailConfiguration :: (CognitoUserPoolResource s) -> (TF.Attr s [(EmailConfiguration s)]))
...
instance P.HasMfaConfiguration (CognitoUserPoolResource s) (TF.Attr s P.Text) where
    mfaConfiguration =
        lens (_mfaConfiguration :: (CognitoUserPoolResource s) -> (TF.Attr s P.Text))
...
instance P.HasSchema (CognitoUserPoolResource s) (TF.Attr s (Schema s)) where
    schema =
        lens (_schema :: (CognitoUserPoolResource s) -> (TF.Attr s (Schema s)))
...
instance P.HasSmsAuthenticationMessage (CognitoUserPoolResource s) (TF.Attr s P.Text) where
    smsAuthenticationMessage =
        lens (_smsAuthenticationMessage :: (CognitoUserPoolResource s) -> (TF.Attr s P.Text))
...
instance P.HasSmsConfiguration (CognitoUserPoolResource s) (TF.Attr s [(SmsConfiguration s)]) where
    smsConfiguration =
        lens (_smsConfiguration :: (CognitoUserPoolResource s) -> (TF.Attr s [(SmsConfiguration s)]))
...
instance P.HasSmsVerificationMessage (CognitoUserPoolResource s) (TF.Attr s P.Text) where
    smsVerificationMessage =
        lens (_smsVerificationMessage :: (CognitoUserPoolResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (CognitoUserPoolResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CognitoUserPoolResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasUsernameAttributes (CognitoUserPoolResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    usernameAttributes =
        lens (_usernameAttributes :: (CognitoUserPoolResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasAllowedOauthFlows (CognitoUserPoolClientResource s) (TF.Attr s (TF.Attr s P.Text)) where
    allowedOauthFlows =
        lens (_allowedOauthFlows :: (CognitoUserPoolClientResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasAllowedOauthFlowsUserPoolClient (CognitoUserPoolClientResource s) (TF.Attr s P.Bool) where
    allowedOauthFlowsUserPoolClient =
        lens (_allowedOauthFlowsUserPoolClient :: (CognitoUserPoolClientResource s) -> (TF.Attr s P.Bool))
...
instance P.HasAllowedOauthScopes (CognitoUserPoolClientResource s) (TF.Attr s (TF.Attr s P.Text)) where
    allowedOauthScopes =
        lens (_allowedOauthScopes :: (CognitoUserPoolClientResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasCallbackUrls (CognitoUserPoolClientResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    callbackUrls =
        lens (_callbackUrls :: (CognitoUserPoolClientResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasDefaultRedirectUri (CognitoUserPoolClientResource s) (TF.Attr s P.Text) where
    defaultRedirectUri =
        lens (_defaultRedirectUri :: (CognitoUserPoolClientResource s) -> (TF.Attr s P.Text))
...
instance P.HasExplicitAuthFlows (CognitoUserPoolClientResource s) (TF.Attr s (TF.Attr s P.Text)) where
    explicitAuthFlows =
        lens (_explicitAuthFlows :: (CognitoUserPoolClientResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasGenerateSecret (CognitoUserPoolClientResource s) (TF.Attr s P.Bool) where
    generateSecret =
        lens (_generateSecret :: (CognitoUserPoolClientResource s) -> (TF.Attr s P.Bool))
...
instance P.HasLogoutUrls (CognitoUserPoolClientResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    logoutUrls =
        lens (_logoutUrls :: (CognitoUserPoolClientResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasReadAttributes (CognitoUserPoolClientResource s) (TF.Attr s (TF.Attr s P.Text)) where
    readAttributes =
        lens (_readAttributes :: (CognitoUserPoolClientResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasRefreshTokenValidity (CognitoUserPoolClientResource s) (TF.Attr s P.Integer) where
    refreshTokenValidity =
        lens (_refreshTokenValidity :: (CognitoUserPoolClientResource s) -> (TF.Attr s P.Integer))
...
instance P.HasSupportedIdentityProviders (CognitoUserPoolClientResource s) (TF.Attr s [(TF.Attr s P.Text)]) where
    supportedIdentityProviders =
        lens (_supportedIdentityProviders :: (CognitoUserPoolClientResource s) -> (TF.Attr s [(TF.Attr s P.Text)]))
...
instance P.HasUserPoolId (CognitoUserPoolClientResource s) (TF.Attr s P.Text) where
    userPoolId =
        lens (_userPoolId :: (CognitoUserPoolClientResource s) -> (TF.Attr s P.Text))
...
instance P.HasWriteAttributes (CognitoUserPoolClientResource s) (TF.Attr s (TF.Attr s P.Text)) where
    writeAttributes =
        lens (_writeAttributes :: (CognitoUserPoolClientResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasUserPoolId (CognitoUserPoolDomainResource s) (TF.Attr s P.Text) where
    userPoolId =
        lens (_userPoolId :: (CognitoUserPoolDomainResource s) -> (TF.Attr s P.Text))
...
instance P.HasAccountId (ConfigAggregateAuthorizationResource s) (TF.Attr s P.Text) where
    accountId =
        lens (_accountId :: (ConfigAggregateAuthorizationResource s) -> (TF.Attr s P.Text))
...
instance P.HasRegion (ConfigAggregateAuthorizationResource s) (TF.Attr s P.Text) where
    region =
        lens (_region :: (ConfigAggregateAuthorizationResource s) -> (TF.Attr s P.Text))
...
instance P.HasInputParameters (ConfigConfigRuleResource s) (TF.Attr s P.Text) where
    inputParameters =
        lens (_inputParameters :: (ConfigConfigRuleResource s) -> (TF.Attr s P.Text))
...
instance P.HasMaximumExecutionFrequency (ConfigConfigRuleResource s) (TF.Attr s P.Text) where
    maximumExecutionFrequency =
        lens (_maximumExecutionFrequency :: (ConfigConfigRuleResource s) -> (TF.Attr s P.Text))
...
instance P.HasScope (ConfigConfigRuleResource s) (TF.Attr s [(Scope s)]) where
    scope =
        lens (_scope :: (ConfigConfigRuleResource s) -> (TF.Attr s [(Scope s)]))
             (\s a -> s { _scope = a } :: (ConfigConfigRuleResource s))

instance P.HasSource (ConfigConfigRuleResource s) (TF.Attr s [(Source s)]) where
    source =
        lens (_source :: (ConfigConfigRuleResource s) -> (TF.Attr s [(Source s)]))
...
instance P.HasAccountAggregationSource (ConfigConfigurationAggregatorResource s) (TF.Attr s [(AccountAggregationSource s)]) where
    accountAggregationSource =
        lens (_accountAggregationSource :: (ConfigConfigurationAggregatorResource s) -> (TF.Attr s [(AccountAggregationSource s)]))
...
instance P.HasOrganizationAggregationSource (ConfigConfigurationAggregatorResource s) (TF.Attr s [(OrganizationAggregationSource s)]) where
    organizationAggregationSource =
        lens (_organizationAggregationSource :: (ConfigConfigurationAggregatorResource s) -> (TF.Attr s [(OrganizationAggregationSource s)]))
...
instance P.HasRoleArn (ConfigConfigurationRecorderResource s) (TF.Attr s P.Text) where
    roleArn =
        lens (_roleArn :: (ConfigConfigurationRecorderResource s) -> (TF.Attr s P.Text))
...
instance P.HasIsEnabled (ConfigConfigurationRecorderStatusResource s) (TF.Attr s P.Bool) where
    isEnabled =
        lens (_isEnabled :: (ConfigConfigurationRecorderStatusResource s) -> (TF.Attr s P.Bool))
...
instance P.HasS3BucketName (ConfigDeliveryChannelResource s) (TF.Attr s P.Text) where
    s3BucketName =
        lens (_s3BucketName :: (ConfigDeliveryChannelResource s) -> (TF.Attr s P.Text))
...
instance P.HasS3KeyPrefix (ConfigDeliveryChannelResource s) (TF.Attr s P.Text) where
    s3KeyPrefix =
        lens (_s3KeyPrefix :: (ConfigDeliveryChannelResource s) -> (TF.Attr s P.Text))
...
instance P.HasSnapshotDeliveryProperties (ConfigDeliveryChannelResource s) (TF.Attr s [(SnapshotDeliveryProperties s)]) where
    snapshotDeliveryProperties =
        lens (_snapshotDeliveryProperties :: (ConfigDeliveryChannelResource s) -> (TF.Attr s [(SnapshotDeliveryProperties s)]))
...
instance P.HasSnsTopicArn (ConfigDeliveryChannelResource s) (TF.Attr s P.Text) where
    snsTopicArn =
        lens (_snsTopicArn :: (ConfigDeliveryChannelResource s) -> (TF.Attr s P.Text))
...
instance P.HasBgpAsn (CustomerGatewayResource s) (TF.Attr s P.Integer) where
    bgpAsn =
        lens (_bgpAsn :: (CustomerGatewayResource s) -> (TF.Attr s P.Integer))
             (\s a -> s { _bgpAsn = a } :: (CustomerGatewayResource s))

instance P.HasIpAddress (CustomerGatewayResource s) (TF.Attr s P.Text) where
    ipAddress =
        lens (_ipAddress :: (CustomerGatewayResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (CustomerGatewayResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (CustomerGatewayResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance P.HasAvailabilityZones (DaxClusterResource s) (TF.Attr s (TF.Attr s P.Text)) where
    availabilityZones =
        lens (_availabilityZones :: (DaxClusterResource s) -> (TF.Attr s (TF.Attr s P.Text)))
             (\s a -> s { _availabilityZones = a } :: (DaxClusterResource s))

instance P.HasClusterName (DaxClusterResource s) (TF.Attr s P.Text) where
    clusterName =
        lens (_clusterName :: (DaxClusterResource s) -> (TF.Attr s P.Text))
...
instance P.HasReplicationFactor (DaxClusterResource s) (TF.Attr s P.Integer) where
    replicationFactor =
        lens (_replicationFactor :: (DaxClusterResource s) -> (TF.Attr s P.Integer))
...
instance P.HasTags (DaxClusterResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (DaxClusterResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
...
instance s ~ s' => P.HasComputedParameters (TF.Ref s' (DaxParameterGroupResource s)) (TF.Attr s (Parameters s)) where
    computedParameters x = TF.compute (TF.refKey x) "parameters"
...
instance P.HasSubnetIds (DaxSubnetGroupResource s) (TF.Attr s (TF.Attr s P.Text)) where
    subnetIds =
        lens (_subnetIds :: (DaxSubnetGroupResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasDbClusterIdentifier (DbClusterSnapshotResource s) (TF.Attr s P.Text) where
    dbClusterIdentifier =
        lens (_dbClusterIdentifier :: (DbClusterSnapshotResource s) -> (TF.Attr s P.Text))
...
instance P.HasDbClusterSnapshotIdentifier (DbClusterSnapshotResource s) (TF.Attr s P.Text) where
    dbClusterSnapshotIdentifier =
        lens (_dbClusterSnapshotIdentifier :: (DbClusterSnapshotResource s) -> (TF.Attr s P.Text))
...
instance P.HasEventCategories (DbEventSubscriptionResource s) (TF.Attr s (TF.Attr s P.Text)) where
    eventCategories =
        lens (_eventCategories :: (DbEventSubscriptionResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasNamePrefix (DbEventSubscriptionResource s) (TF.Attr s P.Text) where
    namePrefix =
        lens (_namePrefix :: (DbEventSubscriptionResource s) -> (TF.Attr s P.Text))
...
instance P.HasSnsTopic (DbEventSubscriptionResource s) (TF.Attr s P.Text) where
    snsTopic =
        lens (_snsTopic :: (DbEventSubscriptionResource s) -> (TF.Attr s P.Text))
...
instance P.HasSourceIds (DbEventSubscriptionResource s) (TF.Attr s (TF.Attr s P.Text)) where
    sourceIds =
        lens (_sourceIds :: (DbEventSubscriptionResource s) -> (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasSourceType (DbEventSubscriptionResource s) (TF.Attr s P.Text) where
    sourceType =
        lens (_sourceType :: (DbEventSubscriptionResource s) -> (TF.Attr s P.Text))
...
instance P.HasTags (DbEventSubscriptionResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    tags =
        lens (_tags :: (DbEventSubscriptionResource s) -> (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))))
