...
instance P.HasComputedEncrypted (AmiCopyResource s) s (TF.Attr s P.Text) where
    computedEncrypted =
        (_encrypted :: AmiCopyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (AmiCopyResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedKmsKeyId (AmiCopyResource s) s (TF.Attr s P.Text) where
    computedKmsKeyId =
        (_kms_key_id :: AmiCopyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (AmiCopyResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: AmiCopyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSourceAmiId (AmiCopyResource s) s (TF.Attr s P.Text) where
    computedSourceAmiId =
...
instance P.HasComputedId (AmiFromInstanceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (AmiFromInstanceResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: AmiFromInstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotWithoutReboot (AmiFromInstanceResource s) s (TF.Attr s P.Text) where
    computedSnapshotWithoutReboot =
        (_snapshot_without_reboot :: AmiFromInstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSourceInstanceId (AmiFromInstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedCertificateArn (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificateArn =
        (_certificate_arn :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificateBody (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificateBody =
        (_certificate_body :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificateChain (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificateChain =
        (_certificate_chain :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificateName (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificateName =
        (_certificate_name :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificatePrivateKey (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificatePrivateKey =
        (_certificate_private_key :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificateUploadDate (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCertificateUploadDate x = TF.compute (TF.refKey x) "certificate_upload_date"

instance P.HasComputedCloudfrontDomainName (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCloudfrontDomainName x = TF.compute (TF.refKey x) "cloudfront_domain_name"

instance P.HasComputedCloudfrontZoneId (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedCloudfrontZoneId x = TF.compute (TF.refKey x) "cloudfront_zone_id"

instance P.HasComputedDomainName (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedDomainName =
        (_domain_name :: ApiGatewayDomainNameResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (ApiGatewayDomainNameResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedResponseParameters (ApiGatewayGatewayResponseResource s) s (TF.Attr s P.Text) where
    computedResponseParameters =
        (_response_parameters :: ApiGatewayGatewayResponseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedResponseTemplates (ApiGatewayGatewayResponseResource s) s (TF.Attr s P.Text) where
    computedResponseTemplates =
        (_response_templates :: ApiGatewayGatewayResponseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedResponseType (ApiGatewayGatewayResponseResource s) s (TF.Attr s P.Text) where
    computedResponseType =
        (_response_type :: ApiGatewayGatewayResponseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRestApiId (ApiGatewayGatewayResponseResource s) s (TF.Attr s P.Text) where
    computedRestApiId =
        (_rest_api_id :: ApiGatewayGatewayResponseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStatusCode (ApiGatewayGatewayResponseResource s) s (TF.Attr s P.Text) where
    computedStatusCode =
...
instance P.HasComputedMethodPath (ApiGatewayMethodSettingsResource s) s (TF.Attr s P.Text) where
    computedMethodPath =
        (_method_path :: ApiGatewayMethodSettingsResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRestApiId (ApiGatewayMethodSettingsResource s) s (TF.Attr s P.Text) where
    computedRestApiId =
        (_rest_api_id :: ApiGatewayMethodSettingsResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSettings (ApiGatewayMethodSettingsResource s) s (TF.Attr s P.Text) where
    computedSettings =
        (_settings :: ApiGatewayMethodSettingsResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStageName (ApiGatewayMethodSettingsResource s) s (TF.Attr s P.Text) where
    computedStageName =
...
instance P.HasComputedBinaryMediaTypes (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedBinaryMediaTypes =
        (_binary_media_types :: ApiGatewayRestApiResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedBody (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedBody =
        (_body :: ApiGatewayRestApiResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCreatedDate (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedCreatedDate x = TF.compute (TF.refKey x) "created_date"

instance P.HasComputedDescription (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ApiGatewayRestApiResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ApiGatewayRestApiResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRootResourceId (ApiGatewayRestApiResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedApiStages (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedApiStages x = TF.compute (TF.refKey x) "api_stages"

instance P.HasComputedDescription (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedDescription x = TF.compute (TF.refKey x) "description"

instance P.HasComputedId (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedProductCode (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedProductCode x = TF.compute (TF.refKey x) "product_code"

instance P.HasComputedQuotaSettings (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
    computedQuotaSettings x = TF.compute (TF.refKey x) "quota_settings"

instance P.HasComputedThrottleSettings (ApiGatewayUsagePlanResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedAdjustmentType (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedAdjustmentType x = TF.compute (TF.refKey x) "adjustment_type"

instance P.HasComputedArn (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedName (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedPolicyType (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedPolicyType x = TF.compute (TF.refKey x) "policy_type"

instance P.HasComputedResourceId (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedResourceId =
        (_resource_id :: AppautoscalingPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedScalableDimension (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedScalableDimension =
        (_scalable_dimension :: AppautoscalingPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedServiceNamespace (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedServiceNamespace =
        (_service_namespace :: AppautoscalingPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStepScalingPolicyConfiguration (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
    computedStepScalingPolicyConfiguration =
        (_step_scaling_policy_configuration :: AppautoscalingPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTargetTrackingScalingPolicyConfiguration (AppautoscalingPolicyResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDatabase (AthenaNamedQueryResource s) s (TF.Attr s P.Text) where
    computedDatabase =
        (_database :: AthenaNamedQueryResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (AthenaNamedQueryResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: AthenaNamedQueryResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (AthenaNamedQueryResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (AthenaNamedQueryResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: AthenaNamedQueryResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedQuery (AthenaNamedQueryResource s) s (TF.Attr s P.Text) where
    computedQuery =
...
instance P.HasComputedAlbTargetGroupArn (AutoscalingAttachmentResource s) s (TF.Attr s P.Text) where
    computedAlbTargetGroupArn =
        (_alb_target_group_arn :: AutoscalingAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAutoscalingGroupName (AutoscalingAttachmentResource s) s (TF.Attr s P.Text) where
    computedAutoscalingGroupName =
        (_autoscaling_group_name :: AutoscalingAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedElb (AutoscalingAttachmentResource s) s (TF.Attr s P.Text) where
    computedElb =
...
instance P.HasComputedArn (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedAvailabilityZones (AutoscalingGroupResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedAvailabilityZones x = TF.compute (TF.refKey x) "availability_zones"

instance P.HasComputedDefaultCooldown (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedDefaultCooldown x = TF.compute (TF.refKey x) "default_cooldown"

instance P.HasComputedDesiredCapacity (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedForceDelete (AutoscalingGroupResource s) s (TF.Attr s P.Bool) where
    computedForceDelete =
        (_force_delete :: AutoscalingGroupResource s -> TF.Attr s P.Bool)
            . TF.refValue

instance P.HasComputedHealthCheckGracePeriod (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedHealthCheckGracePeriod x = TF.compute (TF.refKey x) "health_check_grace_period"

instance P.HasComputedHealthCheckType (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedHealthCheckType x = TF.compute (TF.refKey x) "health_check_type"

instance P.HasComputedId (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedInitialLifecycleHook (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedInitialLifecycleHook =
        (_initial_lifecycle_hook :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLaunchConfiguration (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedLaunchConfiguration x = TF.compute (TF.refKey x) "launch_configuration"

instance P.HasComputedLoadBalancers (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedLoadBalancers x = TF.compute (TF.refKey x) "load_balancers"

instance P.HasComputedMaxSize (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedMaxSize x = TF.compute (TF.refKey x) "max_size"

instance P.HasComputedMetricsGranularity (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedMetricsGranularity =
        (_metrics_granularity :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMinElbCapacity (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedMinElbCapacity =
        (_min_elb_capacity :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMinSize (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedMinSize x = TF.compute (TF.refKey x) "min_size"

instance P.HasComputedName (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedNamePrefix (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
        (_name_prefix :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPlacementGroup (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedPlacementGroup =
        (_placement_group :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedProtectFromScaleIn (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedProtectFromScaleIn =
        (_protect_from_scale_in :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSuspendedProcesses (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedSuspendedProcesses =
        (_suspended_processes :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTag (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedTag =
...
instance P.HasComputedTargetGroupArns (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedTargetGroupArns x = TF.compute (TF.refKey x) "target_group_arns"

instance P.HasComputedTerminationPolicies (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedTerminationPolicies =
        (_termination_policies :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcZoneIdentifier (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedVpcZoneIdentifier x = TF.compute (TF.refKey x) "vpc_zone_identifier"

instance P.HasComputedWaitForCapacityTimeout (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
    computedWaitForCapacityTimeout =
        (_wait_for_capacity_timeout :: AutoscalingGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedWaitForElbCapacity (AutoscalingGroupResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDescription (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: CloudwatchEventRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEventPattern (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedName (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: CloudwatchEventRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRoleArn (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
    computedRoleArn =
        (_role_arn :: CloudwatchEventRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedScheduleExpression (CloudwatchEventRuleResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedAccessPolicy (CloudwatchLogDestinationPolicyResource s) s (TF.Attr s P.Text) where
    computedAccessPolicy =
        (_access_policy :: CloudwatchLogDestinationPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDestinationName (CloudwatchLogDestinationPolicyResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (CloudwatchLogGroupResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedKmsKeyId (CloudwatchLogGroupResource s) s (TF.Attr s P.Text) where
    computedKmsKeyId =
        (_kms_key_id :: CloudwatchLogGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (CloudwatchLogGroupResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: CloudwatchLogGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNamePrefix (CloudwatchLogGroupResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
        (_name_prefix :: CloudwatchLogGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRetentionInDays (CloudwatchLogGroupResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDestinationArn (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedDestinationArn =
        (_destination_arn :: CloudwatchLogSubscriptionFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDistribution (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedDistribution =
        (_distribution :: CloudwatchLogSubscriptionFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFilterPattern (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedFilterPattern =
        (_filter_pattern :: CloudwatchLogSubscriptionFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLogGroupName (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedLogGroupName =
        (_log_group_name :: CloudwatchLogSubscriptionFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: CloudwatchLogSubscriptionFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRoleArn (CloudwatchLogSubscriptionFilterResource s) s (TF.Attr s P.Text) where
    computedRoleArn =
...
instance P.HasComputedAlarmActions (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedAlarmActions =
        (_alarm_actions :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAlarmDescription (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedAlarmDescription =
        (_alarm_description :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAlarmName (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedAlarmName =
        (_alarm_name :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedComparisonOperator (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedComparisonOperator =
        (_comparison_operator :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDatapointsToAlarm (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedDatapointsToAlarm =
        (_datapoints_to_alarm :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDimensions (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedDimensions =
        (_dimensions :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEvaluateLowSampleCountPercentiles (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedEvaluationPeriods (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedEvaluationPeriods =
        (_evaluation_periods :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedExtendedStatistic (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedExtendedStatistic =
        (_extended_statistic :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedInsufficientDataActions (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedInsufficientDataActions =
        (_insufficient_data_actions :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMetricName (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedMetricName =
        (_metric_name :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNamespace (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedNamespace =
        (_namespace :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedOkActions (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedOkActions =
        (_ok_actions :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPeriod (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedPeriod =
        (_period :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStatistic (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedStatistic =
        (_statistic :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedThreshold (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedThreshold =
        (_threshold :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTreatMissingData (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedTreatMissingData =
        (_treat_missing_data :: CloudwatchMetricAlarmResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedUnit (CloudwatchMetricAlarmResource s) s (TF.Attr s P.Text) where
    computedUnit =
...
instance P.HasComputedArtifacts (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedArtifacts =
        (_artifacts :: CodebuildProjectResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedBuildTimeout (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedBuildTimeout =
        (_build_timeout :: CodebuildProjectResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedDescription x = TF.compute (TF.refKey x) "description"

instance P.HasComputedEncryptionKey (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedEncryptionKey x = TF.compute (TF.refKey x) "encryption_key"

instance P.HasComputedEnvironment (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedEnvironment =
        (_environment :: CodebuildProjectResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedServiceRole (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedServiceRole x = TF.compute (TF.refKey x) "service_role"

instance P.HasComputedSource (CodebuildProjectResource s) s (TF.Attr s P.Text) where
    computedSource =
...
instance P.HasComputedBranches (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
    computedBranches =
        (_branches :: CodecommitTriggerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomData (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
    computedCustomData =
        (_custom_data :: CodecommitTriggerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDestinationArn (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
    computedDestinationArn =
        (_destination_arn :: CodecommitTriggerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEvents (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
    computedEvents =
        (_events :: CodecommitTriggerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: CodecommitTriggerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRepositoryName (CodecommitTriggerResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDeploymentConfigId (CodedeployDeploymentConfigResource s) s (TF.Attr s P.Text) where
    computedDeploymentConfigId x = TF.compute (TF.refKey x) "deployment_config_id"

instance P.HasComputedDeploymentConfigName (CodedeployDeploymentConfigResource s) s (TF.Attr s P.Text) where
    computedDeploymentConfigName =
        (_deployment_config_name :: CodedeployDeploymentConfigResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (CodedeployDeploymentConfigResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedMinimumHealthyHosts (CodedeployDeploymentConfigResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ConfigDeliveryChannelResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3BucketName (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedS3BucketName =
        (_s3_bucket_name :: ConfigDeliveryChannelResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3KeyPrefix (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedS3KeyPrefix =
        (_s3_key_prefix :: ConfigDeliveryChannelResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotDeliveryProperties (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedSnapshotDeliveryProperties =
        (_snapshot_delivery_properties :: ConfigDeliveryChannelResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnsTopicArn (ConfigDeliveryChannelResource s) s (TF.Attr s P.Text) where
    computedSnsTopicArn =
...
instance P.HasComputedBgpAsn (CustomerGatewayResource s) s (TF.Attr s P.Text) where
    computedBgpAsn x = TF.compute (TF.refKey x) "bgp_asn"

instance P.HasComputedId (CustomerGatewayResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedIpAddress (CustomerGatewayResource s) s (TF.Attr s P.Text) where
    computedIpAddress x = TF.compute (TF.refKey x) "ip_address"

instance P.HasComputedTags (CustomerGatewayResource s) s (TF.Attr s P.Tags) where
    computedTags x = TF.compute (TF.refKey x) "tags"

instance P.HasComputedType' (CustomerGatewayResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedEventCategories (DbEventSubscriptionResource s) s (TF.Attr s P.Text) where
    computedEventCategories =
        (_event_categories :: DbEventSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (DbEventSubscriptionResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: DbEventSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnsTopic (DbEventSubscriptionResource s) s (TF.Attr s P.Text) where
    computedSnsTopic =
        (_sns_topic :: DbEventSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSourceIds (DbEventSubscriptionResource s) s (TF.Attr s P.Text) where
    computedSourceIds =
        (_source_ids :: DbEventSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSourceType (DbEventSubscriptionResource s) s (TF.Attr s P.Text) where
    computedSourceType =
...
instance P.HasComputedArn (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDescription (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: DbParameterGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFamily' (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedFamily' =
        (_family' :: DbParameterGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: DbParameterGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNamePrefix (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
        (_name_prefix :: DbParameterGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedParameter (DbParameterGroupResource s) s (TF.Attr s P.Text) where
    computedParameter =
...
instance P.HasComputedAllocatedStorage (DbSnapshotResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDbInstanceIdentifier (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedDbInstanceIdentifier =
        (_db_instance_identifier :: DbSnapshotResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDbSnapshotArn (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedDbSnapshotArn x = TF.compute (TF.refKey x) "db_snapshot_arn"

instance P.HasComputedDbSnapshotIdentifier (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedDbSnapshotIdentifier =
        (_db_snapshot_identifier :: DbSnapshotResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEncrypted (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedEncrypted x = TF.compute (TF.refKey x) "encrypted"

instance P.HasComputedEngine (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedEngine x = TF.compute (TF.refKey x) "engine"

instance P.HasComputedEngineVersion (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedEngineVersion x = TF.compute (TF.refKey x) "engine_version"

instance P.HasComputedIops (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedIops x = TF.compute (TF.refKey x) "iops"

instance P.HasComputedKmsKeyId (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedKmsKeyId x = TF.compute (TF.refKey x) "kms_key_id"

instance P.HasComputedLicenseModel (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedLicenseModel x = TF.compute (TF.refKey x) "license_model"

instance P.HasComputedOptionGroupName (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedOptionGroupName x = TF.compute (TF.refKey x) "option_group_name"

instance P.HasComputedSourceDbSnapshotIdentifier (DbSnapshotResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedStatus (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedStatus x = TF.compute (TF.refKey x) "status"

instance P.HasComputedStorageType (DbSnapshotResource s) s (TF.Attr s P.Text) where
    computedStorageType x = TF.compute (TF.refKey x) "storage_type"

instance P.HasComputedVpcId (DbSnapshotResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (DefaultSubnetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedIpv6AssociationId (DefaultSubnetResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedVpcId (DefaultSubnetResource s) s (TF.Attr s P.Text) where
    computedVpcId x = TF.compute (TF.refKey x) "vpc_id"
...
instance P.HasComputedId (DefaultVpcDhcpOptionsResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedNetbiosNameServers (DefaultVpcDhcpOptionsResource s) s (TF.Attr s P.Text) where
    computedNetbiosNameServers =
        (_netbios_name_servers :: DefaultVpcDhcpOptionsResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNetbiosNodeType (DefaultVpcDhcpOptionsResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (DevicefarmProjectResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedName (DevicefarmProjectResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedCertificateArn (DmsCertificateResource s) s (TF.Attr s P.Text) where
    computedCertificateArn x = TF.compute (TF.refKey x) "certificate_arn"

instance P.HasComputedCertificateId (DmsCertificateResource s) s (TF.Attr s P.Text) where
    computedCertificateId =
        (_certificate_id :: DmsCertificateResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificatePem (DmsCertificateResource s) s (TF.Attr s P.Text) where
    computedCertificatePem =
        (_certificate_pem :: DmsCertificateResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCertificateWallet (DmsCertificateResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedConnectionId (DxConnectionAssociationResource s) s (TF.Attr s P.Text) where
    computedConnectionId =
        (_connection_id :: DxConnectionAssociationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLagId (DxConnectionAssociationResource s) s (TF.Attr s P.Text) where
    computedLagId =
...
instance P.HasComputedPolicy (EcrLifecyclePolicyResource s) s (TF.Attr s P.Text) where
    computedPolicy =
        (_policy :: EcrLifecyclePolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRegistryId (EcrLifecyclePolicyResource s) s (TF.Attr s P.Text) where
    computedRegistryId x = TF.compute (TF.refKey x) "registry_id"

instance P.HasComputedRepository (EcrLifecyclePolicyResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (EcrRepositoryResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedName (EcrRepositoryResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedRegistryId (EcrRepositoryResource s) s (TF.Attr s P.Text) where
    computedRegistryId x = TF.compute (TF.refKey x) "registry_id"

instance P.HasComputedRepositoryUrl (EcrRepositoryResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDnsName (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedDnsName x = TF.compute (TF.refKey x) "dns_name"

instance P.HasComputedFileSystemId (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedFileSystemId =
        (_file_system_id :: EfsMountTargetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedIpAddress (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedIpAddress =
        (_ip_address :: EfsMountTargetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNetworkInterfaceId (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceId x = TF.compute (TF.refKey x) "network_interface_id"

instance P.HasComputedSecurityGroups (EfsMountTargetResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSecurityGroups =
        (_security_groups :: EfsMountTargetResource s -> TF.Attr s [TF.Attr s P.Text])
            . TF.refValue

instance P.HasComputedSubnetId (EfsMountTargetResource s) s (TF.Attr s P.Text) where
    computedSubnetId =
...
instance P.HasComputedAssociateWithPrivateIp (EipResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedInstance' (EipResource s) s (TF.Attr s P.Text) where
    computedInstance' x = TF.compute (TF.refKey x) "instance"

instance P.HasComputedNetworkInterface (EipResource s) s (TF.Attr s P.Text) where
    computedNetworkInterface x = TF.compute (TF.refKey x) "network_interface"

instance P.HasComputedPrivateIp (EipResource s) s (TF.Attr s P.Text) where
    computedPrivateIp x = TF.compute (TF.refKey x) "private_ip"

instance P.HasComputedPublicIp (EipResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedVpc (EipResource s) s (TF.Attr s P.Text) where
    computedVpc =
...
instance P.HasComputedAllSettings (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedAllSettings x = TF.compute (TF.refKey x) "all_settings"

instance P.HasComputedApplication (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedApplication x = TF.compute (TF.refKey x) "application"

instance P.HasComputedAutoscalingGroups (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedAutoscalingGroups x = TF.compute (TF.refKey x) "autoscaling_groups"

instance P.HasComputedCname (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedCname x = TF.compute (TF.refKey x) "cname"

instance P.HasComputedCnamePrefix (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedCnamePrefix =
        (_cname_prefix :: ElasticBeanstalkEnvironmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedDescription x = TF.compute (TF.refKey x) "description"

instance P.HasComputedId (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedInstances (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedInstances x = TF.compute (TF.refKey x) "instances"

instance P.HasComputedLaunchConfigurations (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedLaunchConfigurations x = TF.compute (TF.refKey x) "launch_configurations"

instance P.HasComputedLoadBalancers (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedLoadBalancers x = TF.compute (TF.refKey x) "load_balancers"

instance P.HasComputedName (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedPollInterval (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedPollInterval =
        (_poll_interval :: ElasticBeanstalkEnvironmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedQueues (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedQueues x = TF.compute (TF.refKey x) "queues"

instance P.HasComputedSetting (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedSetting x = TF.compute (TF.refKey x) "setting"

instance P.HasComputedSolutionStackName (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedTemplateName (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedTemplateName =
        (_template_name :: ElasticBeanstalkEnvironmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTier (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedTier x = TF.compute (TF.refKey x) "tier"

instance P.HasComputedTriggers (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedTriggers x = TF.compute (TF.refKey x) "triggers"

instance P.HasComputedVersionLabel (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
    computedVersionLabel =
        (_version_label :: ElasticBeanstalkEnvironmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedWaitForReadyTimeout (ElasticBeanstalkEnvironmentResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDescription (ElasticacheSecurityGroupResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ElasticacheSecurityGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (ElasticacheSecurityGroupResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ElasticacheSecurityGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSecurityGroupNames (ElasticacheSecurityGroupResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDescription (ElasticacheSubnetGroupResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ElasticacheSubnetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (ElasticacheSubnetGroupResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ElasticacheSubnetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSubnetIds (ElasticacheSubnetGroupResource s) s (TF.Attr s P.Text) where
    computedSubnetIds =
...
instance P.HasComputedAudio (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedAudio =
        (_audio :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAudioCodecOptions (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedAudioCodecOptions =
        (_audio_codec_options :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedContainer (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedContainer =
        (_container :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedThumbnails (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedThumbnails =
        (_thumbnails :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVideo (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedVideo =
        (_video :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVideoCodecOptions (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
    computedVideoCodecOptions =
        (_video_codec_options :: ElastictranscoderPresetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVideoWatermarks (ElastictranscoderPresetResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (ElbLoadBalancerBackendServerPolicyResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedLoadBalancerName (ElbLoadBalancerBackendServerPolicyResource s) s (TF.Attr s P.Text) where
    computedLoadBalancerName x = TF.compute (TF.refKey x) "load_balancer_name"

instance P.HasComputedPolicyNames (ElbLoadBalancerBackendServerPolicyResource s) s (TF.Attr s P.Text) where
    computedPolicyNames =
...
instance P.HasComputedConfiguration (EmrSecurityConfigurationResource s) s (TF.Attr s P.Text) where
    computedConfiguration x = TF.compute (TF.refKey x) "configuration"

instance P.HasComputedCreationDate (EmrSecurityConfigurationResource s) s (TF.Attr s P.Text) where
    computedCreationDate x = TF.compute (TF.refKey x) "creation_date"

instance P.HasComputedId (EmrSecurityConfigurationResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (EmrSecurityConfigurationResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedNamePrefix (EmrSecurityConfigurationResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
...
instance P.HasComputedCatalogId (GlueCatalogDatabaseResource s) s (TF.Attr s P.Text) where
    computedCatalogId =
        (_catalog_id :: GlueCatalogDatabaseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (GlueCatalogDatabaseResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: GlueCatalogDatabaseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLocationUri (GlueCatalogDatabaseResource s) s (TF.Attr s P.Text) where
    computedLocationUri =
        (_location_uri :: GlueCatalogDatabaseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (GlueCatalogDatabaseResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: GlueCatalogDatabaseResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedParameters (GlueCatalogDatabaseResource s) s (TF.Attr s P.Text) where
    computedParameters =
...
instance P.HasComputedAccountId (GuarddutyDetectorResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (GuarddutyDetectorResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedActivate (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedActivate =
        (_activate :: GuarddutyIpsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDetectorId (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedDetectorId =
        (_detector_id :: GuarddutyIpsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFormat (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedFormat =
        (_format :: GuarddutyIpsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedLocation (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedLocation =
        (_location :: GuarddutyIpsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (GuarddutyIpsetResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedAccountId (GuarddutyMemberResource s) s (TF.Attr s P.Text) where
    computedAccountId =
        (_account_id :: GuarddutyMemberResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDetectorId (GuarddutyMemberResource s) s (TF.Attr s P.Text) where
    computedDetectorId =
        (_detector_id :: GuarddutyMemberResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEmail (GuarddutyMemberResource s) s (TF.Attr s P.Text) where
    computedEmail =
        (_email :: GuarddutyMemberResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (GuarddutyMemberResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedActivate (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedActivate =
        (_activate :: GuarddutyThreatintelsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDetectorId (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedDetectorId =
        (_detector_id :: GuarddutyThreatintelsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFormat (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedFormat =
        (_format :: GuarddutyThreatintelsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedLocation (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedLocation =
        (_location :: GuarddutyThreatintelsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (GuarddutyThreatintelsetResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedGroup (IamGroupPolicyAttachmentResource s) s (TF.Attr s P.Text) where
    computedGroup =
        (_group :: IamGroupPolicyAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPolicyArn (IamGroupPolicyAttachmentResource s) s (TF.Attr s P.Text) where
    computedPolicyArn =
...
instance P.HasComputedPolicyArn (IamUserPolicyAttachmentResource s) s (TF.Attr s P.Text) where
    computedPolicyArn =
        (_policy_arn :: IamUserPolicyAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedUser (IamUserPolicyAttachmentResource s) s (TF.Attr s P.Text) where
    computedUser =
...
instance P.HasComputedAmi (InstanceResource s) s (TF.Attr s P.Text) where
    computedAmi =
        (_ami :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAssociatePublicIpAddress (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDisableApiTermination (InstanceResource s) s (TF.Attr s P.Text) where
    computedDisableApiTermination =
        (_disable_api_termination :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEbsBlockDevice (InstanceResource s) s (TF.Attr s [P.Ec2EbsBlockDevice s]) where
    computedEbsBlockDevice =
        (_ebs_block_device :: InstanceResource s -> TF.Attr s [P.Ec2EbsBlockDevice s])
            . TF.refValue

instance P.HasComputedEbsOptimized (InstanceResource s) s (TF.Attr s P.Text) where
    computedEbsOptimized =
        (_ebs_optimized :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEphemeralBlockDevice (InstanceResource s) s (TF.Attr s [P.Ec2EphemeralBlockDevice s]) where
    computedEphemeralBlockDevice =
        (_ephemeral_block_device :: InstanceResource s -> TF.Attr s [P.Ec2EphemeralBlockDevice s])
            . TF.refValue

instance P.HasComputedIamInstanceProfile (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedInstanceInitiatedShutdownBehavior (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedIpv6AddressCount (InstanceResource s) s (TF.Attr s P.Text) where
    computedIpv6AddressCount =
        (_ipv6_address_count :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIpv6Addresses (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedMonitoring (InstanceResource s) s (TF.Attr s P.Text) where
    computedMonitoring =
        (_monitoring :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNetworkInterface (InstanceResource s) s (TF.Attr s P.Text) where
    computedNetworkInterface =
        (_network_interface :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNetworkInterfaceId (InstanceResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceId x = TF.compute (TF.refKey x) "network_interface_id"

instance P.HasComputedPlacementGroup (InstanceResource s) s (TF.Attr s P.Text) where
    computedPlacementGroup x = TF.compute (TF.refKey x) "placement_group"

instance P.HasComputedPrimaryNetworkInterfaceId (InstanceResource s) s (TF.Attr s P.Text) where
    computedPrimaryNetworkInterfaceId x = TF.compute (TF.refKey x) "primary_network_interface_id"

instance P.HasComputedPrivateDns (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedPublicDns (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedSecurityGroups (InstanceResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSecurityGroups x = TF.compute (TF.refKey x) "security_groups"

instance P.HasComputedSourceDestCheck (InstanceResource s) s (TF.Attr s P.Text) where
    computedSourceDestCheck =
        (_source_dest_check :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSubnetId (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedTenancy (InstanceResource s) s (TF.Attr s P.Text) where
    computedTenancy =
...
instance P.HasComputedUserDataBase64 (InstanceResource s) s (TF.Attr s P.Text) where
    computedUserDataBase64 =
        (_user_data_base64 :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVolumeTags (InstanceResource s) s (TF.Attr s P.Text) where
    computedVolumeTags =
        (_volume_tags :: InstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcSecurityGroupIds (InstanceResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDestination (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedDestination =
        (_destination :: KinesisFirehoseDeliveryStreamResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedExtendedS3Configuration (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedExtendedS3Configuration =
        (_extended_s3_configuration :: KinesisFirehoseDeliveryStreamResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedKinesisSourceConfiguration (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedKinesisSourceConfiguration =
        (_kinesis_source_configuration :: KinesisFirehoseDeliveryStreamResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: KinesisFirehoseDeliveryStreamResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRedshiftConfiguration (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
    computedRedshiftConfiguration =
        (_redshift_configuration :: KinesisFirehoseDeliveryStreamResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3Configuration (KinesisFirehoseDeliveryStreamResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedKeyId (KmsKeyResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedPolicy (KmsKeyResource s) s (TF.Attr s P.Text) where
    computedPolicy =
...
instance P.HasComputedArn (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDeadLetterConfig (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedDeadLetterConfig =
        (_dead_letter_config :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDescription (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEnvironment (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedEnvironment =
        (_environment :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFilename (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedFilename =
        (_filename :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFunctionName (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedFunctionName =
        (_function_name :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHandler (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedHandler =
        (_handler :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInvokeArn (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedInvokeArn x = TF.compute (TF.refKey x) "invoke_arn"

instance P.HasComputedKmsKeyArn (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedKmsKeyArn x = TF.compute (TF.refKey x) "kms_key_arn"

instance P.HasComputedLastModified (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedLastModified x = TF.compute (TF.refKey x) "last_modified"

instance P.HasComputedMemorySize (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedMemorySize =
        (_memory_size :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPublish (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedPublish =
        (_publish :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedQualifiedArn (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedQualifiedArn x = TF.compute (TF.refKey x) "qualified_arn"

instance P.HasComputedReservedConcurrentExecutions (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedReservedConcurrentExecutions =
        (_reserved_concurrent_executions :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRole (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedRole =
        (_role :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRuntime (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedRuntime =
        (_runtime :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3Bucket (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedS3Bucket =
        (_s3_bucket :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3Key (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedS3Key =
        (_s3_key :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedS3ObjectVersion (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedS3ObjectVersion =
        (_s3_object_version :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSourceCodeHash (LambdaFunctionResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedTimeout (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedTimeout =
        (_timeout :: LambdaFunctionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVersion (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedVersion x = TF.compute (TF.refKey x) "version"

instance P.HasComputedVpcConfig (LambdaFunctionResource s) s (TF.Attr s P.Text) where
    computedVpcConfig =
...
instance P.HasComputedCookieExpirationPeriod (LbCookieStickinessPolicyResource s) s (TF.Attr s P.Text) where
    computedCookieExpirationPeriod x = TF.compute (TF.refKey x) "cookie_expiration_period"

instance P.HasComputedId (LbCookieStickinessPolicyResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedLoadBalancer (LbCookieStickinessPolicyResource s) s (TF.Attr s P.Text) where
    computedLoadBalancer x = TF.compute (TF.refKey x) "load_balancer"

instance P.HasComputedName (LbCookieStickinessPolicyResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"
...
instance P.HasComputedCertificateArn (LbListenerCertificateResource s) s (TF.Attr s P.Text) where
    computedCertificateArn =
        (_certificate_arn :: LbListenerCertificateResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedListenerArn (LbListenerCertificateResource s) s (TF.Attr s P.Text) where
    computedListenerArn =
        (_listener_arn :: LbListenerCertificateResource s -> TF.Attr s P.Text)
            . TF.refValue

lbListenerCertificateResource :: TF.Schema TF.Resource P.AWS (LbListenerCertificateResource s)
lbListenerCertificateResource =
...
instance P.HasComputedAccessLogs (LbResource s) s (TF.Attr s P.Text) where
    computedAccessLogs =
        (_access_logs :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedArn (LbResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedArnSuffix (LbResource s) s (TF.Attr s P.Text) where
    computedArnSuffix x = TF.compute (TF.refKey x) "arn_suffix"

instance P.HasComputedCanonicalHostedZoneId (LbResource s) s (TF.Attr s P.Text) where
    computedCanonicalHostedZoneId x = TF.compute (TF.refKey x) "canonical_hosted_zone_id"

instance P.HasComputedDnsName (LbResource s) s (TF.Attr s P.Text) where
    computedDnsName x = TF.compute (TF.refKey x) "dns_name"
...
instance P.HasComputedIdleTimeout (LbResource s) s (TF.Attr s P.Text) where
    computedIdleTimeout =
        (_idle_timeout :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInternal (LbResource s) s (TF.Attr s P.Text) where
    computedInternal =
        (_internal :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIpAddressType (LbResource s) s (TF.Attr s P.Text) where
    computedIpAddressType =
        (_ip_address_type :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLoadBalancerType (LbResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedNamePrefix (LbResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
        (_name_prefix :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSecurityGroups (LbResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSecurityGroups =
        (_security_groups :: LbResource s -> TF.Attr s [TF.Attr s P.Text])
            . TF.refValue

instance P.HasComputedSubnetMapping (LbResource s) s (TF.Attr s P.Text) where
    computedSubnetMapping =
        (_subnet_mapping :: LbResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSubnets (LbResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSubnets =
...
instance P.HasComputedZoneId (LbResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedArnSuffix (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedArnSuffix x = TF.compute (TF.refKey x) "arn_suffix"

instance P.HasComputedDeregistrationDelay (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedDeregistrationDelay =
        (_deregistration_delay :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHealthCheck (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedHealthCheck =
        (_health_check :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedName x = TF.compute (TF.refKey x) "name"

instance P.HasComputedNamePrefix (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedNamePrefix =
        (_name_prefix :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPort (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedPort =
        (_port :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedProtocol (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedProtocol =
        (_protocol :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStickiness (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedStickiness =
...
instance P.HasComputedTargetType (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedTargetType =
        (_target_type :: LbTargetGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcId (LbTargetGroupResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedArn (LightsailDomainResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDomainName (LightsailDomainResource s) s (TF.Attr s P.Text) where
    computedDomainName =
        (_domain_name :: LightsailDomainResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (LightsailDomainResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedArn (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedEncryptedFingerprint (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedEncryptedFingerprint x = TF.compute (TF.refKey x) "encrypted_fingerprint"

instance P.HasComputedEncryptedPrivateKey (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedEncryptedPrivateKey x = TF.compute (TF.refKey x) "encrypted_private_key"

instance P.HasComputedFingerprint (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedFingerprint x = TF.compute (TF.refKey x) "fingerprint"

instance P.HasComputedId (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: LightsailKeyPairResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPgpKey (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedPgpKey =
        (_pgp_key :: LightsailKeyPairResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPrivateKey (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
    computedPrivateKey x = TF.compute (TF.refKey x) "private_key"

instance P.HasComputedPublicKey (LightsailKeyPairResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (LightsailStaticIpAttachmentResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedInstanceName (LightsailStaticIpAttachmentResource s) s (TF.Attr s P.Text) where
    computedInstanceName =
        (_instance_name :: LightsailStaticIpAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIpAddress (LightsailStaticIpAttachmentResource s) s (TF.Attr s P.Text) where
    computedIpAddress x = TF.compute (TF.refKey x) "ip_address"

instance P.HasComputedStaticIpName (LightsailStaticIpAttachmentResource s) s (TF.Attr s P.Text) where
    computedStaticIpName =
        (_static_ip_name :: LightsailStaticIpAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSupportCode (LightsailStaticIpAttachmentResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (MainRouteTableAssociationResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedOriginalRouteTableId (MainRouteTableAssociationResource s) s (TF.Attr s P.Text) where
    computedOriginalRouteTableId x = TF.compute (TF.refKey x) "original_route_table_id"

instance P.HasComputedRouteTableId (MainRouteTableAssociationResource s) s (TF.Attr s P.Text) where
    computedRouteTableId =
        (_route_table_id :: MainRouteTableAssociationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcId (MainRouteTableAssociationResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedAllocationId (NatGatewayResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedNetworkInterfaceId (NatGatewayResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceId x = TF.compute (TF.refKey x) "network_interface_id"

instance P.HasComputedPrivateIp (NatGatewayResource s) s (TF.Attr s P.Text) where
    computedPrivateIp x = TF.compute (TF.refKey x) "private_ip"

instance P.HasComputedPublicIp (NatGatewayResource s) s (TF.Attr s P.Text) where
    computedPublicIp x = TF.compute (TF.refKey x) "public_ip"

instance P.HasComputedSubnetId (NatGatewayResource s) s (TF.Attr s P.Text) where
    computedSubnetId x = TF.compute (TF.refKey x) "subnet_id"
...
instance P.HasComputedEgress (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedEgress =
        (_egress :: NetworkAclResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedIngress (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedIngress =
        (_ingress :: NetworkAclResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSubnetId (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedSubnetId =
        (_subnet_id :: NetworkAclResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSubnetIds (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedSubnetIds =
...
instance P.HasComputedVpcId (NetworkAclResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedEgress (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedEgress =
...
instance P.HasComputedIcmpCode (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedIcmpCode =
        (_icmp_code :: NetworkAclRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIcmpType (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedIcmpType =
        (_icmp_type :: NetworkAclRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedNetworkAclId (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedNetworkAclId =
        (_network_acl_id :: NetworkAclRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedProtocol (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedProtocol =
        (_protocol :: NetworkAclRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRuleAction (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedRuleAction =
        (_rule_action :: NetworkAclRuleResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRuleNumber (NetworkAclRuleResource s) s (TF.Attr s P.Text) where
    computedRuleNumber =
...
instance P.HasComputedAttachmentId (NetworkInterfaceAttachmentResource s) s (TF.Attr s P.Text) where
    computedAttachmentId x = TF.compute (TF.refKey x) "attachment_id"

instance P.HasComputedDeviceIndex (NetworkInterfaceAttachmentResource s) s (TF.Attr s P.Text) where
    computedDeviceIndex =
        (_device_index :: NetworkInterfaceAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInstanceId (NetworkInterfaceAttachmentResource s) s (TF.Attr s P.Text) where
    computedInstanceId x = TF.compute (TF.refKey x) "instance_id"

instance P.HasComputedNetworkInterfaceId (NetworkInterfaceAttachmentResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceId x = TF.compute (TF.refKey x) "network_interface_id"

instance P.HasComputedStatus (NetworkInterfaceAttachmentResource s) s (TF.Attr s P.Text) where
    computedStatus x = TF.compute (TF.refKey x) "status"
...
instance P.HasComputedAttachment (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedAttachment x = TF.compute (TF.refKey x) "attachment"

instance P.HasComputedDescription (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedDescription x = TF.compute (TF.refKey x) "description"

instance P.HasComputedId (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedPrivateIps (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedPrivateIps x = TF.compute (TF.refKey x) "private_ips"

instance P.HasComputedPrivateIpsCount (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedPrivateIpsCount =
        (_private_ips_count :: NetworkInterfaceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSecurityGroups (NetworkInterfaceResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSecurityGroups x = TF.compute (TF.refKey x) "security_groups"

instance P.HasComputedSourceDestCheck (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedSourceDestCheck x = TF.compute (TF.refKey x) "source_dest_check"

instance P.HasComputedSubnetId (NetworkInterfaceResource s) s (TF.Attr s P.Text) where
    computedSubnetId x = TF.compute (TF.refKey x) "subnet_id"
...
instance P.HasComputedAppServer (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedAppServer =
        (_app_server :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAppServerVersion (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedAppServerVersion =
        (_app_server_version :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAutoAssignElasticIps (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedAutoAssignElasticIps =
        (_auto_assign_elastic_ips :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAutoAssignPublicIps (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedAutoAssignPublicIps =
        (_auto_assign_public_ips :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAutoHealing (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedAutoHealing =
        (_auto_healing :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomInstanceProfileArn (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedCustomInstanceProfileArn =
        (_custom_instance_profile_arn :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomJson (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedCustomJson =
        (_custom_json :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomSecurityGroupIds (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedCustomSecurityGroupIds =
        (_custom_security_group_ids :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDrainElbOnShutdown (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedDrainElbOnShutdown =
        (_drain_elb_on_shutdown :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEbsVolume (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedEbsVolume =
        (_ebs_volume :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedElasticLoadBalancer (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedElasticLoadBalancer =
        (_elastic_load_balancer :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedInstallUpdatesOnBoot (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedInstallUpdatesOnBoot =
        (_install_updates_on_boot :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInstanceShutdownTimeout (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedInstanceShutdownTimeout =
        (_instance_shutdown_timeout :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedJvmOptions (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedJvmOptions =
        (_jvm_options :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedJvmType (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedJvmType =
        (_jvm_type :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedJvmVersion (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedJvmVersion =
        (_jvm_version :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStackId (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedStackId =
        (_stack_id :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSystemPackages (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
    computedSystemPackages =
        (_system_packages :: OpsworksJavaAppLayerResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedUseEbsOptimizedInstances (OpsworksJavaAppLayerResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDbPassword (OpsworksRdsDbInstanceResource s) s (TF.Attr s P.Text) where
    computedDbPassword =
        (_db_password :: OpsworksRdsDbInstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDbUser (OpsworksRdsDbInstanceResource s) s (TF.Attr s P.Text) where
    computedDbUser =
        (_db_user :: OpsworksRdsDbInstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (OpsworksRdsDbInstanceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedRdsDbInstanceArn (OpsworksRdsDbInstanceResource s) s (TF.Attr s P.Text) where
    computedRdsDbInstanceArn =
        (_rds_db_instance_arn :: OpsworksRdsDbInstanceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStackId (OpsworksRdsDbInstanceResource s) s (TF.Attr s P.Text) where
    computedStackId =
...
instance P.HasComputedAgentVersion (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedAgentVersion =
        (_agent_version :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedBerkshelfVersion (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedBerkshelfVersion =
        (_berkshelf_version :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedColor (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedColor =
        (_color :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedConfigurationManagerName (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedConfigurationManagerName =
        (_configuration_manager_name :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedConfigurationManagerVersion (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedConfigurationManagerVersion =
        (_configuration_manager_version :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomCookbooksSource (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedCustomCookbooksSource =
        (_custom_cookbooks_source :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCustomJson (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedCustomJson =
...
instance P.HasComputedDefaultInstanceProfileArn (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedDefaultInstanceProfileArn =
        (_default_instance_profile_arn :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDefaultOs (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedDefaultOs =
        (_default_os :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDefaultRootDeviceType (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedDefaultRootDeviceType =
        (_default_root_device_type :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDefaultSshKeyName (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedDefaultSshKeyName =
        (_default_ssh_key_name :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDefaultSubnetId (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedDefaultSubnetId =
        (_default_subnet_id :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHostnameTheme (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedHostnameTheme =
        (_hostname_theme :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedManageBerkshelf (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedManageBerkshelf =
        (_manage_berkshelf :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedServiceRoleArn (OpsworksStackResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedUseCustomCookbooks (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedUseCustomCookbooks =
        (_use_custom_cookbooks :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedUseOpsworksSecurityGroups (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedUseOpsworksSecurityGroups =
        (_use_opsworks_security_groups :: OpsworksStackResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcId (OpsworksStackResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedId (ProxyProtocolPolicyResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedInstancePorts (ProxyProtocolPolicyResource s) s (TF.Attr s P.Text) where
    computedInstancePorts =
        (_instance_ports :: ProxyProtocolPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLoadBalancer (ProxyProtocolPolicyResource s) s (TF.Attr s P.Text) where
    computedLoadBalancer x = TF.compute (TF.refKey x) "load_balancer"
...
instance P.HasComputedAllocatedStorage (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedAllocatedStorage x = TF.compute (TF.refKey x) "allocated_storage"

instance P.HasComputedApplyImmediately (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedApplyImmediately =
        (_apply_immediately :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAvailabilityZones (RdsClusterResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedAvailabilityZones x = TF.compute (TF.refKey x) "availability_zones"

instance P.HasComputedBackupRetentionPeriod (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedBackupRetentionPeriod x = TF.compute (TF.refKey x) "backup_retention_period"

instance P.HasComputedClusterIdentifier (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedClusterIdentifier x = TF.compute (TF.refKey x) "cluster_identifier"

instance P.HasComputedClusterIdentifierPrefix (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedClusterIdentifierPrefix =
        (_cluster_identifier_prefix :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedClusterMembers (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedClusterMembers x = TF.compute (TF.refKey x) "cluster_members"

instance P.HasComputedClusterResourceId (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedClusterResourceId x = TF.compute (TF.refKey x) "cluster_resource_id"

instance P.HasComputedDatabaseName (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedDatabaseName x = TF.compute (TF.refKey x) "database_name"

instance P.HasComputedDbClusterParameterGroupName (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedDbClusterParameterGroupName =
        (_db_cluster_parameter_group_name :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDbSubnetGroupName (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedDbSubnetGroupName =
        (_db_subnet_group_name :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEndpoint (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedEndpoint x = TF.compute (TF.refKey x) "endpoint"

instance P.HasComputedEngine (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedEngine x = TF.compute (TF.refKey x) "engine"

instance P.HasComputedEngineVersion (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedEngineVersion x = TF.compute (TF.refKey x) "engine_version"

instance P.HasComputedFinalSnapshotIdentifier (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedFinalSnapshotIdentifier =
        (_final_snapshot_identifier :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHostedZoneId (RdsClusterResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedIamRoles (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedIamRoles =
        (_iam_roles :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedKmsKeyId (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedKmsKeyId =
        (_kms_key_id :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMaintenanceWindow (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedMaintenanceWindow x = TF.compute (TF.refKey x) "maintenance_window"

instance P.HasComputedMasterPassword (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedMasterPassword =
        (_master_password :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMasterUsername (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedMasterUsername x = TF.compute (TF.refKey x) "master_username"

instance P.HasComputedPort (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedPort x = TF.compute (TF.refKey x) "port"

instance P.HasComputedPreferredBackupWindow (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedPreferredBackupWindow x = TF.compute (TF.refKey x) "preferred_backup_window"

instance P.HasComputedPreferredMaintenanceWindow (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedPreferredMaintenanceWindow x = TF.compute (TF.refKey x) "preferred_maintenance_window"

instance P.HasComputedReaderEndpoint (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedReaderEndpoint x = TF.compute (TF.refKey x) "reader_endpoint"

instance P.HasComputedReplicationSourceIdentifier (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedReplicationSourceIdentifier x = TF.compute (TF.refKey x) "replication_source_identifier"

instance P.HasComputedSkipFinalSnapshot (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedSkipFinalSnapshot =
        (_skip_final_snapshot :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotIdentifier (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedSnapshotIdentifier =
        (_snapshot_identifier :: RdsClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedStatus (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedStatus x = TF.compute (TF.refKey x) "status"

instance P.HasComputedStorageEncrypted (RdsClusterResource s) s (TF.Attr s P.Text) where
    computedStorageEncrypted x = TF.compute (TF.refKey x) "storage_encrypted"

instance P.HasComputedVpcSecurityGroupIds (RdsClusterResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedAllowVersionUpgrade (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedAllowVersionUpgrade =
        (_allow_version_upgrade :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedAutomatedSnapshotRetentionPeriod (RedshiftClusterResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedClusterIdentifier (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterIdentifier x = TF.compute (TF.refKey x) "cluster_identifier"

instance P.HasComputedClusterParameterGroupName (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterParameterGroupName x = TF.compute (TF.refKey x) "cluster_parameter_group_name"

instance P.HasComputedClusterPublicKey (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterPublicKey x = TF.compute (TF.refKey x) "cluster_public_key"

instance P.HasComputedClusterRevisionNumber (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterRevisionNumber x = TF.compute (TF.refKey x) "cluster_revision_number"

instance P.HasComputedClusterSecurityGroups (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterSecurityGroups x = TF.compute (TF.refKey x) "cluster_security_groups"

instance P.HasComputedClusterSubnetGroupName (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterSubnetGroupName x = TF.compute (TF.refKey x) "cluster_subnet_group_name"

instance P.HasComputedClusterType (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterType x = TF.compute (TF.refKey x) "cluster_type"

instance P.HasComputedClusterVersion (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedClusterVersion x = TF.compute (TF.refKey x) "cluster_version"

instance P.HasComputedDatabaseName (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedDatabaseName x = TF.compute (TF.refKey x) "database_name"

instance P.HasComputedElasticIp (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedElasticIp =
        (_elastic_ip :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEncrypted (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedEncrypted x = TF.compute (TF.refKey x) "encrypted"

instance P.HasComputedEndpoint (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedEndpoint x = TF.compute (TF.refKey x) "endpoint"

instance P.HasComputedEnhancedVpcRouting (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedEnhancedVpcRouting =
        (_enhanced_vpc_routing :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFinalSnapshotIdentifier (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedFinalSnapshotIdentifier =
        (_final_snapshot_identifier :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIamRoles (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedIamRoles =
        (_iam_roles :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedKmsKeyId (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedKmsKeyId =
        (_kms_key_id :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedLogging (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedLogging =
        (_logging :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMasterPassword (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedMasterPassword =
        (_master_password :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMasterUsername (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedMasterUsername =
        (_master_username :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNodeType (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedNodeType x = TF.compute (TF.refKey x) "node_type"

instance P.HasComputedNumberOfNodes (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedNumberOfNodes =
        (_number_of_nodes :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedOwnerAccount (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedOwnerAccount =
        (_owner_account :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPort (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedPort x = TF.compute (TF.refKey x) "port"

instance P.HasComputedPreferredMaintenanceWindow (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedPreferredMaintenanceWindow x = TF.compute (TF.refKey x) "preferred_maintenance_window"

instance P.HasComputedPubliclyAccessible (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedPubliclyAccessible =
        (_publicly_accessible :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSkipFinalSnapshot (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedSkipFinalSnapshot =
        (_skip_final_snapshot :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotClusterIdentifier (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedSnapshotClusterIdentifier =
        (_snapshot_cluster_identifier :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotCopy (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedSnapshotCopy =
        (_snapshot_copy :: RedshiftClusterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSnapshotIdentifier (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedSnapshotIdentifier =
...
instance P.HasComputedVpcSecurityGroupIds (RedshiftClusterResource s) s (TF.Attr s P.Text) where
    computedVpcSecurityGroupIds x = TF.compute (TF.refKey x) "vpc_security_group_ids"
...
instance P.HasComputedId (Route53DelegationSetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedNameServers (Route53DelegationSetResource s) s (TF.Attr s P.Text) where
    computedNameServers x = TF.compute (TF.refKey x) "name_servers"

instance P.HasComputedReferenceName (Route53DelegationSetResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedChildHealthThreshold (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedChildHealthThreshold =
        (_child_health_threshold :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedChildHealthchecks (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedChildHealthchecks =
        (_child_healthchecks :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCloudwatchAlarmName (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedFailureThreshold (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedFailureThreshold =
        (_failure_threshold :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFqdn (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedFqdn =
        (_fqdn :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInsufficientDataHealthStatus (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedInsufficientDataHealthStatus =
        (_insufficient_data_health_status :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInvertHealthcheck (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedInvertHealthcheck =
        (_invert_healthcheck :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedIpAddress (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedIpAddress =
        (_ip_address :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedMeasureLatency (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedMeasureLatency =
        (_measure_latency :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPort (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedPort =
        (_port :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedReferenceName (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedReferenceName =
        (_reference_name :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRegions (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedRegions =
        (_regions :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedRequestInterval (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedRequestInterval =
        (_request_interval :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedResourcePath (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedResourcePath =
        (_resource_path :: Route53HealthCheckResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSearchString (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedType' (Route53HealthCheckResource s) s (TF.Attr s P.Text) where
    computedType' =
...
instance P.HasComputedCloudwatchLogGroupArn (Route53QueryLogResource s) s (TF.Attr s P.Text) where
    computedCloudwatchLogGroupArn =
        (_cloudwatch_log_group_arn :: Route53QueryLogResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (Route53QueryLogResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedZoneId (Route53QueryLogResource s) s (TF.Attr s P.Text) where
    computedZoneId =
...
instance P.HasComputedComment (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedComment =
        (_comment :: Route53ZoneResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDelegationSetId (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedDelegationSetId =
        (_delegation_set_id :: Route53ZoneResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedForceDestroy (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedForceDestroy =
        (_force_destroy :: Route53ZoneResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: Route53ZoneResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedNameServers (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedNameServers x = TF.compute (TF.refKey x) "name_servers"
...
instance P.HasComputedVpcId (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedZoneId (Route53ZoneResource s) s (TF.Attr s P.Text) where
    computedZoneId x = TF.compute (TF.refKey x) "zone_id"
...
instance P.HasComputedEgressOnlyGatewayId (RouteResource s) s (TF.Attr s P.Text) where
    computedEgressOnlyGatewayId x = TF.compute (TF.refKey x) "egress_only_gateway_id"

instance P.HasComputedGatewayId (RouteResource s) s (TF.Attr s P.Text) where
    computedGatewayId x = TF.compute (TF.refKey x) "gateway_id"

instance P.HasComputedInstanceId (RouteResource s) s (TF.Attr s P.Text) where
    computedInstanceId x = TF.compute (TF.refKey x) "instance_id"

instance P.HasComputedNatGatewayId (RouteResource s) s (TF.Attr s P.Text) where
    computedNatGatewayId x = TF.compute (TF.refKey x) "nat_gateway_id"

instance P.HasComputedNetworkInterfaceId (RouteResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceId x = TF.compute (TF.refKey x) "network_interface_id"

instance P.HasComputedRouteTableId (RouteResource s) s (TF.Attr s P.Text) where
    computedRouteTableId x = TF.compute (TF.refKey x) "route_table_id"

instance P.HasComputedVpcPeeringConnectionId (RouteResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedBucket (S3BucketMetricResource s) s (TF.Attr s P.Text) where
    computedBucket =
        (_bucket :: S3BucketMetricResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFilter (S3BucketMetricResource s) s (TF.Attr s P.Text) where
    computedFilter =
        (_filter :: S3BucketMetricResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (S3BucketMetricResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedArn (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDescription (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ServiceDiscoveryPrivateDnsNamespaceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHostedZone (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedHostedZone x = TF.compute (TF.refKey x) "hosted_zone"

instance P.HasComputedId (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ServiceDiscoveryPrivateDnsNamespaceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpc (ServiceDiscoveryPrivateDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedVpc =
...
instance P.HasComputedArn (ServiceDiscoveryPublicDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDescription (ServiceDiscoveryPublicDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ServiceDiscoveryPublicDnsNamespaceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHostedZone (ServiceDiscoveryPublicDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedHostedZone x = TF.compute (TF.refKey x) "hosted_zone"

instance P.HasComputedId (ServiceDiscoveryPublicDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ServiceDiscoveryPublicDnsNamespaceResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedArn (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedDescription (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ServiceDiscoveryServiceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDnsConfig (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedDnsConfig =
        (_dns_config :: ServiceDiscoveryServiceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedHealthCheckConfig (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedHealthCheckConfig =
        (_health_check_config :: ServiceDiscoveryServiceResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ServiceDiscoveryServiceResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedDescription (ServicecatalogPortfolioResource s) s (TF.Attr s P.Text) where
    computedDescription =
        (_description :: ServicecatalogPortfolioResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (ServicecatalogPortfolioResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (ServicecatalogPortfolioResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: ServicecatalogPortfolioResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedProviderName (ServicecatalogPortfolioResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedDomain (SesDomainMailFromResource s) s (TF.Attr s P.Text) where
    computedDomain =
        (_domain :: SesDomainMailFromResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (SesDomainMailFromResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedMailFromDomain (SesDomainMailFromResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedCidr (SesReceiptFilterResource s) s (TF.Attr s P.Text) where
    computedCidr =
        (_cidr :: SesReceiptFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (SesReceiptFilterResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: SesReceiptFilterResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPolicy (SesReceiptFilterResource s) s (TF.Attr s P.Text) where
    computedPolicy =
...
instance P.HasComputedId (SimpledbDomainResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (SimpledbDomainResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedEventDeliveryFailureTopicArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedEventDeliveryFailureTopicArn =
        (_event_delivery_failure_topic_arn :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEventEndpointCreatedTopicArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedEventEndpointCreatedTopicArn =
        (_event_endpoint_created_topic_arn :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEventEndpointDeletedTopicArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedEventEndpointDeletedTopicArn =
        (_event_endpoint_deleted_topic_arn :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEventEndpointUpdatedTopic (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedEventEndpointUpdatedTopic =
        (_event_endpoint_updated_topic :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFailureFeedbackRoleArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedFailureFeedbackRoleArn =
        (_failure_feedback_role_arn :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPlatform (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedPlatform =
        (_platform :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPlatformCredential (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedPlatformCredential =
        (_platform_credential :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPlatformPrincipal (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedPlatformPrincipal =
        (_platform_principal :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSuccessFeedbackRoleArn (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
    computedSuccessFeedbackRoleArn =
        (_success_feedback_role_arn :: SnsPlatformApplicationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSuccessFeedbackSampleRate (SnsPlatformApplicationResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedArn (SnsTopicPolicyResource s) s (TF.Attr s P.Text) where
    computedArn =
        (_arn :: SnsTopicPolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPolicy (SnsTopicPolicyResource s) s (TF.Attr s P.Text) where
    computedPolicy =
...
instance P.HasComputedArn (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedArn x = TF.compute (TF.refKey x) "arn"

instance P.HasComputedConfirmationTimeoutInMinutes (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedConfirmationTimeoutInMinutes =
        (_confirmation_timeout_in_minutes :: SnsTopicSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedEndpoint (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedEndpoint x = TF.compute (TF.refKey x) "endpoint"

instance P.HasComputedEndpointAutoConfirms (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedEndpointAutoConfirms =
        (_endpoint_auto_confirms :: SnsTopicSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedFilterPolicy (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedFilterPolicy =
        (_filter_policy :: SnsTopicSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedProtocol (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedProtocol x = TF.compute (TF.refKey x) "protocol"

instance P.HasComputedRawMessageDelivery (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
    computedRawMessageDelivery =
        (_raw_message_delivery :: SnsTopicSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTopicArn (SnsTopicSubscriptionResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedBucket (SpotDatafeedSubscriptionResource s) s (TF.Attr s P.Text) where
    computedBucket =
        (_bucket :: SpotDatafeedSubscriptionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPrefix (SpotDatafeedSubscriptionResource s) s (TF.Attr s P.Text) where
    computedPrefix =
...
instance P.HasComputedPolicy (SqsQueuePolicyResource s) s (TF.Attr s P.Text) where
    computedPolicy =
        (_policy :: SqsQueuePolicyResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedQueueUrl (SqsQueuePolicyResource s) s (TF.Attr s P.Text) where
    computedQueueUrl =
...
instance P.HasComputedAllowUnassociatedTargets (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedAllowUnassociatedTargets =
        (_allow_unassociated_targets :: SsmMaintenanceWindowResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCutoff (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedCutoff =
        (_cutoff :: SsmMaintenanceWindowResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedDuration (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedDuration =
        (_duration :: SsmMaintenanceWindowResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: SsmMaintenanceWindowResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSchedule (SsmMaintenanceWindowResource s) s (TF.Attr s P.Text) where
    computedSchedule =
...
instance P.HasComputedId (SsmMaintenanceWindowTargetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedOwnerInformation (SsmMaintenanceWindowTargetResource s) s (TF.Attr s P.Text) where
    computedOwnerInformation =
        (_owner_information :: SsmMaintenanceWindowTargetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedResourceType (SsmMaintenanceWindowTargetResource s) s (TF.Attr s P.Text) where
    computedResourceType =
        (_resource_type :: SsmMaintenanceWindowTargetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTargets (SsmMaintenanceWindowTargetResource s) s (TF.Attr s P.Text) where
    computedTargets =
        (_targets :: SsmMaintenanceWindowTargetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedWindowId (SsmMaintenanceWindowTargetResource s) s (TF.Attr s P.Text) where
    computedWindowId =
...
instance P.HasComputedBaselineId (SsmPatchGroupResource s) s (TF.Attr s P.Text) where
    computedBaselineId =
        (_baseline_id :: SsmPatchGroupResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (SsmPatchGroupResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedPatchGroup (SsmPatchGroupResource s) s (TF.Attr s P.Text) where
    computedPatchGroup =
...
instance P.HasComputedDeviceName (VolumeAttachmentResource s) s (TF.Attr s P.Text) where
    computedDeviceName x = TF.compute (TF.refKey x) "device_name"

instance P.HasComputedForceDetach (VolumeAttachmentResource s) s (TF.Attr s P.Text) where
    computedForceDetach =
        (_force_detach :: VolumeAttachmentResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedInstanceId (VolumeAttachmentResource s) s (TF.Attr s P.Text) where
    computedInstanceId x = TF.compute (TF.refKey x) "instance_id"

instance P.HasComputedSkipDestroy (VolumeAttachmentResource s) s (TF.Attr s P.Text) where
    computedSkipDestroy =
...
instance P.HasComputedDhcpOptionsId (VpcDhcpOptionsAssociationResource s) s (TF.Attr s P.Text) where
    computedDhcpOptionsId =
        (_dhcp_options_id :: VpcDhcpOptionsAssociationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedId (VpcDhcpOptionsAssociationResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedVpcId (VpcDhcpOptionsAssociationResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedAutoAccept (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedAutoAccept =
        (_auto_accept :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedCidrBlocks (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedCidrBlocks x = TF.compute (TF.refKey x) "cidr_blocks"

instance P.HasComputedDnsEntry (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedDnsEntry x = TF.compute (TF.refKey x) "dns_entry"

instance P.HasComputedId (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedNetworkInterfaceIds (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedNetworkInterfaceIds x = TF.compute (TF.refKey x) "network_interface_ids"

instance P.HasComputedPolicy (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedPolicy =
        (_policy :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedPrefixListId (VpcEndpointResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedRouteTableIds (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedRouteTableIds =
        (_route_table_ids :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSecurityGroupIds (VpcEndpointResource s) s (TF.Attr s [TF.Attr s P.Text]) where
    computedSecurityGroupIds =
        (_security_group_ids :: VpcEndpointResource s -> TF.Attr s [TF.Attr s P.Text])
            . TF.refValue

instance P.HasComputedServiceName (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedServiceName =
        (_service_name :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedState (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedState x = TF.compute (TF.refKey x) "state"

instance P.HasComputedSubnetIds (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedSubnetIds =
        (_subnet_ids :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcEndpointType (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedVpcEndpointType =
        (_vpc_endpoint_type :: VpcEndpointResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpcId (VpcEndpointResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedCustomerGatewayConfiguration (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedCustomerGatewayConfiguration x = TF.compute (TF.refKey x) "customer_gateway_configuration"

instance P.HasComputedCustomerGatewayId (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedCustomerGatewayId x = TF.compute (TF.refKey x) "customer_gateway_id"

instance P.HasComputedId (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedStaticRoutesOnly (VpnConnectionResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedTunnel1Address (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1Address x = TF.compute (TF.refKey x) "tunnel1_address"

instance P.HasComputedTunnel1BgpAsn (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1BgpAsn x = TF.compute (TF.refKey x) "tunnel1_bgp_asn"

instance P.HasComputedTunnel1BgpHoldtime (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1BgpHoldtime x = TF.compute (TF.refKey x) "tunnel1_bgp_holdtime"

instance P.HasComputedTunnel1CgwInsideAddress (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1CgwInsideAddress x = TF.compute (TF.refKey x) "tunnel1_cgw_inside_address"

instance P.HasComputedTunnel1InsideCidr (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1InsideCidr =
        (_tunnel1_inside_cidr :: VpnConnectionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTunnel1PresharedKey (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1PresharedKey x = TF.compute (TF.refKey x) "tunnel1_preshared_key"

instance P.HasComputedTunnel1VgwInsideAddress (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel1VgwInsideAddress x = TF.compute (TF.refKey x) "tunnel1_vgw_inside_address"

instance P.HasComputedTunnel2Address (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2Address x = TF.compute (TF.refKey x) "tunnel2_address"

instance P.HasComputedTunnel2BgpAsn (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2BgpAsn x = TF.compute (TF.refKey x) "tunnel2_bgp_asn"

instance P.HasComputedTunnel2BgpHoldtime (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2BgpHoldtime x = TF.compute (TF.refKey x) "tunnel2_bgp_holdtime"

instance P.HasComputedTunnel2CgwInsideAddress (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2CgwInsideAddress x = TF.compute (TF.refKey x) "tunnel2_cgw_inside_address"

instance P.HasComputedTunnel2InsideCidr (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2InsideCidr =
        (_tunnel2_inside_cidr :: VpnConnectionResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedTunnel2PresharedKey (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2PresharedKey x = TF.compute (TF.refKey x) "tunnel2_preshared_key"

instance P.HasComputedTunnel2VgwInsideAddress (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedTunnel2VgwInsideAddress x = TF.compute (TF.refKey x) "tunnel2_vgw_inside_address"

instance P.HasComputedType' (VpnConnectionResource s) s (TF.Attr s P.Text) where
    computedType' x = TF.compute (TF.refKey x) "type"

instance P.HasComputedVpnGatewayId (VpnConnectionResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedVpcId (VpnGatewayAttachmentResource s) s (TF.Attr s P.Text) where
    computedVpcId x = TF.compute (TF.refKey x) "vpc_id"

instance P.HasComputedVpnGatewayId (VpnGatewayAttachmentResource s) s (TF.Attr s P.Text) where
    computedVpnGatewayId x = TF.compute (TF.refKey x) "vpn_gateway_id"
...
instance P.HasComputedAmazonSideAsn (VpnGatewayResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (VpnGatewayResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"
...
instance P.HasComputedVpcId (VpnGatewayResource s) s (TF.Attr s P.Text) where
    computedVpcId =
...
instance P.HasComputedRouteTableId (VpnGatewayRoutePropagationResource s) s (TF.Attr s P.Text) where
    computedRouteTableId =
        (_route_table_id :: VpnGatewayRoutePropagationResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedVpnGatewayId (VpnGatewayRoutePropagationResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (WafIpsetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedIpSetDescriptors (WafIpsetResource s) s (TF.Attr s P.Text) where
    computedIpSetDescriptors =
        (_ip_set_descriptors :: WafIpsetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedName (WafIpsetResource s) s (TF.Attr s P.Text) where
    computedName =
...
instance P.HasComputedId (WafSqlInjectionMatchSetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (WafSqlInjectionMatchSetResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: WafSqlInjectionMatchSetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedSqlInjectionMatchTuples (WafSqlInjectionMatchSetResource s) s (TF.Attr s P.Text) where
...
instance P.HasComputedId (WafXssMatchSetResource s) s (TF.Attr s P.Text) where
    computedId x = TF.compute (TF.refKey x) "id"

instance P.HasComputedName (WafXssMatchSetResource s) s (TF.Attr s P.Text) where
    computedName =
        (_name :: WafXssMatchSetResource s -> TF.Attr s P.Text)
            . TF.refValue

instance P.HasComputedXssMatchTuples (WafXssMatchSetResource s) s (TF.Attr s P.Text) where
