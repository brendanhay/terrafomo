...
instance P.HasCertificateArn (LbListenerCertificateResource s) (TF.Attr s Text) where
    certificateArn =
        lens (_certificate_arn :: LbListenerCertificateResource s -> TF.Attr s Text)
             (\s a -> s { _certificate_arn = a } :: LbListenerCertificateResource s)

instance P.HasListenerArn (LbListenerCertificateResource s) (TF.Attr s Text) where
    listenerArn =
        lens (_listener_arn :: LbListenerCertificateResource s -> TF.Attr s Text)
             (\s a -> s { _listener_arn = a } :: LbListenerCertificateResource s)

instance P.HasComputedCertificateArn (LbListenerCertificateResource s) s (TF.Attr s Text) where
    computedCertificateArn =
        (_certificate_arn :: LbListenerCertificateResource s -> TF.Attr s Text)
            . TF.refValue

instance P.HasComputedListenerArn (LbListenerCertificateResource s) s (TF.Attr s Text) where
    computedListenerArn =
        (_listener_arn :: LbListenerCertificateResource s -> TF.Attr s Text)
            . TF.refValue
