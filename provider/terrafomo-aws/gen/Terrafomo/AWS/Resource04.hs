...
data LbSslNegotiationPolicyResource s = LbSslNegotiationPolicyResource'
    { _attribute :: TF.Attr s [TF.Attr s (P.LbSslNegotiationPolicyAttributeSetting s)]
...
instance P.HasAttribute (LbSslNegotiationPolicyResource s) (TF.Attr s [TF.Attr s (P.LbSslNegotiationPolicyAttributeSetting s)]) where
    attribute =
        P.lens (_attribute :: LbSslNegotiationPolicyResource s -> TF.Attr s [TF.Attr s (P.LbSslNegotiationPolicyAttributeSetting s)])
