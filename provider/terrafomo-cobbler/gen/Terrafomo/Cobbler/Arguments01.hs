...
instance HasBondingOpts a b => HasBondingOpts (TF.Schema l p a) b where
...
instance HasBridgeOpts a b => HasBridgeOpts (TF.Schema l p a) b where
...
instance HasCnames a b => HasCnames (TF.Schema l p a) b where
...
instance HasDhcpTag a b => HasDhcpTag (TF.Schema l p a) b where
...
instance HasInterfaceMaster a b => HasInterfaceMaster (TF.Schema l p a) b where
    interfaceMaster = TF.configuration . interfaceMaster

class HasInterfaceType a b | a -> b where
    interfaceType :: P.Lens' a b

instance HasInterfaceType a b => HasInterfaceType (TF.Schema l p a) b where
...
instance HasStatic a b => HasStatic (TF.Schema l p a) b where
    static = TF.configuration . static

class HasStaticRoutes a b | a -> b where
    staticRoutes :: P.Lens' a b

instance HasStaticRoutes a b => HasStaticRoutes (TF.Schema l p a) b where
