...
instance HasAllowMergeCommit a s b => HasAllowMergeCommit (TF.DataSource p a) s b where
...
instance HasAllowRebaseMerge a s b => HasAllowRebaseMerge (TF.DataSource p a) s b where
...
instance HasAllowSquashMerge a s b => HasAllowSquashMerge (TF.DataSource p a) s b where
...
instance HasAutoInit a s b => HasAutoInit (TF.DataSource p a) s b where
...
instance HasBranch a s b => HasBranch (TF.DataSource p a) s b where
...
instance HasEnforceAdmins a s b => HasEnforceAdmins (TF.DataSource p a) s b where
...
instance HasGitignoreTemplate a s b => HasGitignoreTemplate (TF.DataSource p a) s b where
...
instance HasHasDownloads a s b => HasHasDownloads (TF.DataSource p a) s b where
...
instance HasHomepageUrl a s b => HasHomepageUrl (TF.DataSource p a) s b where
...
instance HasLdapDn a s b => HasLdapDn (TF.DataSource p a) s b where
...
instance HasLicenseTemplate a s b => HasLicenseTemplate (TF.DataSource p a) s b where
...
instance HasPermission a s b => HasPermission (TF.DataSource p a) s b where
...
instance HasPrivacy a s b => HasPrivacy (TF.DataSource p a) s b where
...
instance HasPrivate a s b => HasPrivate (TF.DataSource p a) s b where
...
instance HasRequiredPullRequestReviews a s b => HasRequiredPullRequestReviews (TF.DataSource p a) s b where
...
instance HasRequiredStatusChecks a s b => HasRequiredStatusChecks (TF.DataSource p a) s b where
