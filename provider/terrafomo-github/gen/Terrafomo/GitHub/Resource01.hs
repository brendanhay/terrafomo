...
data BranchProtectionResource s = BranchProtectionResource'
    ...
    --
    , _requiredPullRequestReviews :: TF.Attr s (BranchProtectionRequiredPullRequestReviewsSetting s)
    -- ^ @required_pull_request_reviews@ - (Optional)
    --
    , _requiredStatusChecks :: TF.Attr s (BranchProtectionRequiredStatusChecksSetting s)
    -- ^ @required_status_checks@ - (Optional)
    --
    , _restrictions :: TF.Attr s (BranchProtectionRestrictionsSetting s)
    ...
    validator = P.mempty
           P.<> TF.settingsValidator "_requiredPullRequestReviews"
                  (_requiredPullRequestReviews
                      :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRequiredPullRequestReviewsSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_requiredStatusChecks"
                  (_requiredStatusChecks
                      :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRequiredStatusChecksSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_restrictions"
                  (_restrictions
                      :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRestrictionsSetting s))
                  TF.validator
...
instance P.HasRequiredPullRequestReviews (BranchProtectionResource s) (TF.Attr s (BranchProtectionRequiredPullRequestReviewsSetting s)) where
    requiredPullRequestReviews =
        P.lens (_requiredPullRequestReviews :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRequiredPullRequestReviewsSetting s))
               (\s a -> s { _requiredPullRequestReviews = a } :: BranchProtectionResource s)

instance P.HasRequiredStatusChecks (BranchProtectionResource s) (TF.Attr s (BranchProtectionRequiredStatusChecksSetting s)) where
    requiredStatusChecks =
        P.lens (_requiredStatusChecks :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRequiredStatusChecksSetting s))
               (\s a -> s { _requiredStatusChecks = a } :: BranchProtectionResource s)

instance P.HasRestrictions (BranchProtectionResource s) (TF.Attr s (BranchProtectionRestrictionsSetting s)) where
    restrictions =
        P.lens (_restrictions :: BranchProtectionResource s -> TF.Attr s (BranchProtectionRestrictionsSetting s))
