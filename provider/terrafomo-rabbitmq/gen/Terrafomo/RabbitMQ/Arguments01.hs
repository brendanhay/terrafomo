...
-- |
-- Module      : Terrafomo.RabbitMQ.Arguments01
...
instance HasApplyTo a b => HasApplyTo (TF.Resource l p a) b where
...
instance HasArgumentsJson a b => HasArgumentsJson (TF.Resource l p a) b where
...
instance HasConfigure a b => HasConfigure (TF.Resource l p a) b where
...
instance HasDurable a b => HasDurable (TF.Resource l p a) b where
...
instance HasRoutingKey a b => HasRoutingKey (TF.Resource l p a) b where
...
instance HasVhost a b => HasVhost (TF.Resource l p a) b where
