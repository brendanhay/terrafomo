...
instance P.HasAccountManageAccountSettings (ApikeyResource s) (TF.Attr s P.Bool) where
    accountManageAccountSettings =
        P.lens (_accountManageAccountSettings :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _accountManageAccountSettings = a
                          } :: ApikeyResource s)
...
instance P.HasAccountManagePaymentMethods (ApikeyResource s) (TF.Attr s P.Bool) where
    accountManagePaymentMethods =
        P.lens (_accountManagePaymentMethods :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _accountManagePaymentMethods = a
                          } :: ApikeyResource s)
...
instance P.HasAccountViewActivityLog (ApikeyResource s) (TF.Attr s P.Bool) where
    accountViewActivityLog =
        P.lens (_accountViewActivityLog :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _accountViewActivityLog = a
                          } :: ApikeyResource s)
...
instance P.HasDataManageDatasources (ApikeyResource s) (TF.Attr s P.Bool) where
    dataManageDatasources =
        P.lens (_dataManageDatasources :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _dataManageDatasources = a
                          } :: ApikeyResource s)
...
instance P.HasDnsZonesAllowByDefault (ApikeyResource s) (TF.Attr s P.Bool) where
    dnsZonesAllowByDefault =
        P.lens (_dnsZonesAllowByDefault :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _dnsZonesAllowByDefault = a
                          } :: ApikeyResource s)
...
instance P.HasMonitoringManageLists (ApikeyResource s) (TF.Attr s P.Bool) where
    monitoringManageLists =
        P.lens (_monitoringManageLists :: ApikeyResource s -> TF.Attr s P.Bool)
               (\s a -> s { _monitoringManageLists = a
                          } :: ApikeyResource s)
...
instance P.HasRules (MonitoringjobResource s) (TF.Attr s [Rules s]) where
    rules =
        P.lens (_rules :: MonitoringjobResource s -> TF.Attr s [Rules s])
               (\s a -> s { _rules = a
                          } :: MonitoringjobResource s)
...
instance P.HasNotifications (NotifylistResource s) (TF.Attr s [Notifications s]) where
    notifications =
        P.lens (_notifications :: NotifylistResource s -> TF.Attr s [Notifications s])
...
instance P.HasAnswers (RecordResource s) (TF.Attr s [Answers s]) where
    answers =
        P.lens (_answers :: RecordResource s -> TF.Attr s [Answers s])
               (\s a -> s { _answers = a
                          } :: RecordResource s)
...
instance P.HasFilters (RecordResource s) (TF.Attr s [Filters s]) where
    filters =
        P.lens (_filters :: RecordResource s -> TF.Attr s [Filters s])
               (\s a -> s { _filters = a
                          } :: RecordResource s)
...
instance P.HasRegions (RecordResource s) (TF.Attr s [Regions s]) where
    regions =
        P.lens (_regions :: RecordResource s -> TF.Attr s [Regions s])
               (\s a -> s { _regions = a
                          } :: RecordResource s)
...
data ZoneResource s = ZoneResource'
    ...
    -- ^ @link@ - (Optional)
    --
    , _networks :: TF.Attr s [TF.Attr s (TF.Attr s P.Integer)]
    -- ^ @networks@ - (Optional)
    --
...
instance P.HasNetworks (ZoneResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Integer)]) where
    networks =
        P.lens (_networks :: ZoneResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Integer)])
               (\s a -> s { _networks = a
                          } :: ZoneResource s)
