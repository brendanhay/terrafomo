...
data MonitoringjobResource s = MonitoringjobResource'
    ...
    -- ^ @regions@ - (Required)
    --
    , _rules          :: TF.Attr s [TF.Attr s (MonitoringjobRulesSetting s)]
    -- ^ @rules@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasRules (MonitoringjobResource s) (TF.Attr s [TF.Attr s (MonitoringjobRulesSetting s)]) where
    rules =
        P.lens (_rules :: MonitoringjobResource s -> TF.Attr s [TF.Attr s (MonitoringjobRulesSetting s)])
...
data NotifylistResource s = NotifylistResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _notifications :: TF.Attr s [TF.Attr s (NotifylistNotificationsSetting s)]
...
instance P.HasNotifications (NotifylistResource s) (TF.Attr s [TF.Attr s (NotifylistNotificationsSetting s)]) where
    notifications =
        P.lens (_notifications :: NotifylistResource s -> TF.Attr s [TF.Attr s (NotifylistNotificationsSetting s)])
...
data RecordResource s = RecordResource'
    { _answers         :: TF.Attr s [TF.Attr s (RecordAnswersSetting s)]
    -- ^ @answers@ - (Optional)
    --
    , _domain          :: TF.Attr s P.Text
    -- ^ @domain@ - (Required, Forces New)
    --
    , _filters         :: TF.Attr s [TF.Attr s (RecordFiltersSetting s)]
    -- ^ @filters@ - (Optional)
    --
    ...
    -- ^ @meta@ - (Optional)
    --
    , _regions         :: TF.Attr s [TF.Attr s (RecordRegionsSetting s)]
    -- ^ @regions@ - (Optional)
    --
...
instance P.HasAnswers (RecordResource s) (TF.Attr s [TF.Attr s (RecordAnswersSetting s)]) where
    answers =
        P.lens (_answers :: RecordResource s -> TF.Attr s [TF.Attr s (RecordAnswersSetting s)])
...
instance P.HasFilters (RecordResource s) (TF.Attr s [TF.Attr s (RecordFiltersSetting s)]) where
    filters =
        P.lens (_filters :: RecordResource s -> TF.Attr s [TF.Attr s (RecordFiltersSetting s)])
...
instance P.HasRegions (RecordResource s) (TF.Attr s [TF.Attr s (RecordRegionsSetting s)]) where
    regions =
        P.lens (_regions :: RecordResource s -> TF.Attr s [TF.Attr s (RecordRegionsSetting s)])
