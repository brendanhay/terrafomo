...
-- |
-- Module      : Terrafomo.VCloudDirector.Arguments01
...
instance HasCatalogName a b => HasCatalogName (TF.Resource l p a) b where
    catalogName = TF.configuration . catalogName

class HasCpus a b | a -> b where
    cpus :: P.Lens' a b

instance HasCpus a b => HasCpus (TF.Resource l p a) b where
...
instance HasDefaultLeaseTime a b => HasDefaultLeaseTime (TF.Resource l p a) b where
...
instance HasDestinationIp a b => HasDestinationIp (TF.Resource l p a) b where
...
instance HasFenceMode a b => HasFenceMode (TF.Resource l p a) b where
...
instance HasHref a b => HasHref (TF.Resource l p a) b where
...
instance HasInitscript a b => HasInitscript (TF.Resource l p a) b where
...
instance HasNetworkHref a b => HasNetworkHref (TF.Resource l p a) b where
    networkHref = TF.configuration . networkHref

class HasNetworkName a b | a -> b where
    networkName :: P.Lens' a b

instance HasNetworkName a b => HasNetworkName (TF.Resource l p a) b where
    networkName = TF.configuration . networkName

class HasOrg a b | a -> b where
    org :: P.Lens' a b

instance HasOrg a b => HasOrg (TF.Resource l p a) b where
    org = TF.configuration . org

class HasOvf a b | a -> b where
    ovf :: P.Lens' a b

instance HasOvf a b => HasOvf (TF.Resource l p a) b where
...
instance HasPowerOn a b => HasPowerOn (TF.Resource l p a) b where
...
instance HasStartAddress a b => HasStartAddress (TF.Resource l p a) b where
    startAddress = TF.configuration . startAddress

class HasStaticIpPool a b | a -> b where
    staticIpPool :: P.Lens' a b

instance HasStaticIpPool a b => HasStaticIpPool (TF.Resource l p a) b where
...
instance HasTranslatedPort a b => HasTranslatedPort (TF.Resource l p a) b where
...
instance HasVappName a b => HasVappName (TF.Resource l p a) b where
    vappName = TF.configuration . vappName

class HasVdc a b | a -> b where
    vdc :: P.Lens' a b

instance HasVdc a b => HasVdc (TF.Resource l p a) b where
