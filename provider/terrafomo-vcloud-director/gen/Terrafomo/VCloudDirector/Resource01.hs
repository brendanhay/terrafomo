...
dnatResource
    :: TF.Attr s P.Text -- ^ @edge_gateway@ ('P._edgeGateway', 'P.edgeGateway')
...
data EdgegatewayVpnResource s = EdgegatewayVpnResource'
    ...
    --
    , _localSubnets :: TF.Attr s [TF.Attr s (EdgegatewayVpnLocalSubnetsSetting s)]
    ...
    --
    , _peerSubnets :: TF.Attr s [TF.Attr s (EdgegatewayVpnPeerSubnetsSetting s)]
...
edgegatewayVpnResource
    :: TF.Attr s P.Text -- ^ @local_ip_address@ ('P._localIpAddress', 'P.localIpAddress')
    -> TF.Attr s P.Text -- ^ @peer_ip_address@ ('P._peerIpAddress', 'P.peerIpAddress')
    -> TF.Attr s P.Text -- ^ @edge_gateway@ ('P._edgeGateway', 'P.edgeGateway')
    -> TF.Attr s P.Text -- ^ @local_id@ ('P._localId', 'P.localId')
    -> TF.Attr s P.Text -- ^ @peer_id@ ('P._peerId', 'P.peerId')
    -> TF.Attr s P.Int -- ^ @mtu@ ('P._mtu', 'P.mtu')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @encryption_protocol@ ('P._encryptionProtocol', 'P.encryptionProtocol')
...
instance P.HasLocalSubnets (EdgegatewayVpnResource s) (TF.Attr s [TF.Attr s (EdgegatewayVpnLocalSubnetsSetting s)]) where
    localSubnets =
        P.lens (_localSubnets :: EdgegatewayVpnResource s -> TF.Attr s [TF.Attr s (EdgegatewayVpnLocalSubnetsSetting s)])
...
instance P.HasPeerSubnets (EdgegatewayVpnResource s) (TF.Attr s [TF.Attr s (EdgegatewayVpnPeerSubnetsSetting s)]) where
    peerSubnets =
        P.lens (_peerSubnets :: EdgegatewayVpnResource s -> TF.Attr s [TF.Attr s (EdgegatewayVpnPeerSubnetsSetting s)])
...
data FirewallRulesResource s = FirewallRulesResource'
    ...
    -- ^ @edge_gateway@ - (Required, Forces New)
    --
    , _rule          :: TF.Attr s [TF.Attr s (FirewallRulesRuleSetting s)]
...
firewallRulesResource
    :: TF.Attr s P.Text -- ^ @default_action@ ('P._defaultAction', 'P.defaultAction')
    -> TF.Attr s P.Text -- ^ @edge_gateway@ ('P._edgeGateway', 'P.edgeGateway')
...
instance P.HasRule (FirewallRulesResource s) (TF.Attr s [TF.Attr s (FirewallRulesRuleSetting s)]) where
    rule =
        P.lens (_rule :: FirewallRulesResource s -> TF.Attr s [TF.Attr s (FirewallRulesRuleSetting s)])
...
data NetworkResource s = NetworkResource'
    { _dhcpPool     :: TF.Attr s [TF.Attr s (NetworkDhcpPoolSetting s)]
    ...
    --
    , _staticIpPool :: TF.Attr s [TF.Attr s (NetworkStaticIpPoolSetting s)]
...
instance P.HasDhcpPool (NetworkResource s) (TF.Attr s [TF.Attr s (NetworkDhcpPoolSetting s)]) where
    dhcpPool =
        P.lens (_dhcpPool :: NetworkResource s -> TF.Attr s [TF.Attr s (NetworkDhcpPoolSetting s)])
...
instance P.HasStaticIpPool (NetworkResource s) (TF.Attr s [TF.Attr s (NetworkStaticIpPoolSetting s)]) where
    staticIpPool =
        P.lens (_staticIpPool :: NetworkResource s -> TF.Attr s [TF.Attr s (NetworkStaticIpPoolSetting s)])
...
vappVmResource
    :: TF.Attr s P.Text -- ^ @catalog_name@ ('P._catalogName', 'P.catalogName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @template_name@ ('P._templateName', 'P.templateName')
    -> TF.Attr s P.Text -- ^ @vapp_name@ ('P._vappName', 'P.vappName')
