...
instance HasAggregator a b => HasAggregator (TF.Resource l p a) b where
...
instance HasEscalationMessage a b => HasEscalationMessage (TF.Resource l p a) b where
    escalationMessage = TF.configuration . escalationMessage

class HasEvaluationDelay a b | a -> b where
    evaluationDelay :: P.Lens' a b

instance HasEvaluationDelay a b => HasEvaluationDelay (TF.Resource l p a) b where
...
instance HasExtraCol a b => HasExtraCol (TF.Resource l p a) b where
    extraCol = TF.configuration . extraCol

class HasGraph a b | a -> b where
    graph :: P.Lens' a b

instance HasGraph a b => HasGraph (TF.Resource l p a) b where
...
instance HasMarker a b => HasMarker (TF.Resource l p a) b where
...
instance HasMonitorId a b => HasMonitorId (TF.Resource l p a) b where
...
instance HasPrecision a b => HasPrecision (TF.Resource l p a) b where
...
instance HasQ a b => HasQ (TF.Resource l p a) b where
...
instance HasRenotifyInterval a b => HasRenotifyInterval (TF.Resource l p a) b where
...
instance HasRequireFullWindow a b => HasRequireFullWindow (TF.Resource l p a) b where
...
instance HasSilenced a b => HasSilenced (TF.Resource l p a) b where
    silenced = TF.configuration . silenced

class HasStacked a b | a -> b where
    stacked :: P.Lens' a b

instance HasStacked a b => HasStacked (TF.Resource l p a) b where
...
instance HasStatsdInterval a b => HasStatsdInterval (TF.Resource l p a) b where
    statsdInterval = TF.configuration . statsdInterval

class HasStyle a b | a -> b where
    style :: P.Lens' a b

instance HasStyle a b => HasStyle (TF.Resource l p a) b where
...
instance HasTemplateVariable a b => HasTemplateVariable (TF.Resource l p a) b where
    templateVariable = TF.configuration . templateVariable

class HasTextAlign a b | a -> b where
    textAlign :: P.Lens' a b

instance HasTextAlign a b => HasTextAlign (TF.Resource l p a) b where
    textAlign = TF.configuration . textAlign

class HasThresholds a b | a -> b where
    thresholds :: P.Lens' a b

instance HasThresholds a b => HasThresholds (TF.Resource l p a) b where
    thresholds = TF.configuration . thresholds

class HasTimeoutH a b | a -> b where
    timeoutH :: P.Lens' a b

instance HasTimeoutH a b => HasTimeoutH (TF.Resource l p a) b where
...
instance HasUnknown a b => HasUnknown (TF.Resource l p a) b where
    unknown = TF.configuration . unknown

class HasUntilDate a b | a -> b where
    untilDate :: P.Lens' a b

instance HasUntilDate a b => HasUntilDate (TF.Resource l p a) b where
    untilDate = TF.configuration . untilDate

class HasUntilOccurrences a b | a -> b where
    untilOccurrences :: P.Lens' a b

instance HasUntilOccurrences a b => HasUntilOccurrences (TF.Resource l p a) b where
...
instance HasViz a b => HasViz (TF.Resource l p a) b where
...
instance HasWarningRecovery a b => HasWarningRecovery (TF.Resource l p a) b where
...
instance HasYaxis a b => HasYaxis (TF.Resource l p a) b where
