...
-- |
-- Module      : Terrafomo.Spotinst.Arguments01
...
instance HasAdjustment a b => HasAdjustment (TF.Resource l p a) b where
    adjustment = TF.configuration . adjustment

class HasApiServer a b | a -> b where
    apiServer :: P.Lens' a b

instance HasApiServer a b => HasApiServer (TF.Resource l p a) b where
    apiServer = TF.configuration . apiServer

class HasApplicationName a b | a -> b where
    applicationName :: P.Lens' a b

instance HasApplicationName a b => HasApplicationName (TF.Resource l p a) b where
...
instance HasAutoscaleAttributes a b => HasAutoscaleAttributes (TF.Resource l p a) b where
...
instance HasAutoscaleConstraints a b => HasAutoscaleConstraints (TF.Resource l p a) b where
...
instance HasAutoscaleCooldown a b => HasAutoscaleCooldown (TF.Resource l p a) b where
    autoscaleCooldown = TF.configuration . autoscaleCooldown

class HasAutoscaleDown a b | a -> b where
    autoscaleDown :: P.Lens' a b

instance HasAutoscaleDown a b => HasAutoscaleDown (TF.Resource l p a) b where
    autoscaleDown = TF.configuration . autoscaleDown

class HasAutoscaleHeadroom a b | a -> b where
    autoscaleHeadroom :: P.Lens' a b

instance HasAutoscaleHeadroom a b => HasAutoscaleHeadroom (TF.Resource l p a) b where
...
instance HasAutoscaleIsAutoConfig a b => HasAutoscaleIsAutoConfig (TF.Resource l p a) b where
...
instance HasAutoscaleIsEnabled a b => HasAutoscaleIsEnabled (TF.Resource l p a) b where
    autoscaleIsEnabled = TF.configuration . autoscaleIsEnabled

class HasAutoscaleLabels a b | a -> b where
    autoscaleLabels :: P.Lens' a b

instance HasAutoscaleLabels a b => HasAutoscaleLabels (TF.Resource l p a) b where
...
instance HasAutoscaleScaleDownNonServiceTasks a b => HasAutoscaleScaleDownNonServiceTasks (TF.Resource l p a) b where
...
instance HasBalancerId a b => HasBalancerId (TF.Resource l p a) b where
    balancerId = TF.configuration . balancerId

class HasBatchSizePercentage a b | a -> b where
    batchSizePercentage :: P.Lens' a b

instance HasBatchSizePercentage a b => HasBatchSizePercentage (TF.Resource l p a) b where
...
instance HasBlockDevicesMode a b => HasBlockDevicesMode (TF.Resource l p a) b where
    blockDevicesMode = TF.configuration . blockDevicesMode

class HasCapacityUnit a b | a -> b where
    capacityUnit :: P.Lens' a b

instance HasCapacityUnit a b => HasCapacityUnit (TF.Resource l p a) b where
    capacityUnit = TF.configuration . capacityUnit

class HasCleanupOnFailure a b | a -> b where
    cleanupOnFailure :: P.Lens' a b

instance HasCleanupOnFailure a b => HasCleanupOnFailure (TF.Resource l p a) b where
...
instance HasCpuPerUnit a b => HasCpuPerUnit (TF.Resource l p a) b where
    cpuPerUnit = TF.configuration . cpuPerUnit

class HasCronExpression a b | a -> b where
    cronExpression :: P.Lens' a b

instance HasCronExpression a b => HasCronExpression (TF.Resource l p a) b where
...
instance HasDeploymentGroups a b => HasDeploymentGroups (TF.Resource l p a) b where
...
instance HasDrainingTimeout a b => HasDrainingTimeout (TF.Resource l p a) b where
...
instance HasElasticIps a b => HasElasticIps (TF.Resource l p a) b where
    elasticIps = TF.configuration . elasticIps

class HasElasticLoadBalancers a b | a -> b where
    elasticLoadBalancers :: P.Lens' a b

instance HasElasticLoadBalancers a b => HasElasticLoadBalancers (TF.Resource l p a) b where
...
instance HasFallbackToOndemand a b => HasFallbackToOndemand (TF.Resource l p a) b where
...
instance HasGracePeriod a b => HasGracePeriod (TF.Resource l p a) b where
...
instance HasHealthCheckUnhealthyDurationBeforeReplacement a b => HasHealthCheckUnhealthyDurationBeforeReplacement (TF.Resource l p a) b where
...
instance HasInstanceTypesOndemand a b => HasInstanceTypesOndemand (TF.Resource l p a) b where
...
instance HasInstanceTypesSpot a b => HasInstanceTypesSpot (TF.Resource l p a) b where
...
instance HasInstanceTypesWeights a b => HasInstanceTypesWeights (TF.Resource l p a) b where
...
instance HasIntegrationCodedeploy a b => HasIntegrationCodedeploy (TF.Resource l p a) b where
...
instance HasIntegrationEcs a b => HasIntegrationEcs (TF.Resource l p a) b where
    integrationEcs = TF.configuration . integrationEcs

class HasIntegrationGitlab a b | a -> b where
    integrationGitlab :: P.Lens' a b

instance HasIntegrationGitlab a b => HasIntegrationGitlab (TF.Resource l p a) b where
...
instance HasIntegrationKubernetes a b => HasIntegrationKubernetes (TF.Resource l p a) b where
...
instance HasIntegrationMesosphere a b => HasIntegrationMesosphere (TF.Resource l p a) b where
...
instance HasIntegrationMode a b => HasIntegrationMode (TF.Resource l p a) b where
...
instance HasIntegrationMultaiRuntime a b => HasIntegrationMultaiRuntime (TF.Resource l p a) b where
...
instance HasIntegrationNomad a b => HasIntegrationNomad (TF.Resource l p a) b where
    integrationNomad = TF.configuration . integrationNomad

class HasIntegrationRancher a b | a -> b where
    integrationRancher :: P.Lens' a b

instance HasIntegrationRancher a b => HasIntegrationRancher (TF.Resource l p a) b where
...
instance HasLifetimePeriod a b => HasLifetimePeriod (TF.Resource l p a) b where
    lifetimePeriod = TF.configuration . lifetimePeriod

class HasMasterHost a b | a -> b where
    masterHost :: P.Lens' a b

instance HasMasterHost a b => HasMasterHost (TF.Resource l p a) b where
    masterHost = TF.configuration . masterHost

class HasMasterPort a b | a -> b where
    masterPort :: P.Lens' a b

instance HasMasterPort a b => HasMasterPort (TF.Resource l p a) b where
...
instance HasMaxTargetCapacity a b => HasMaxTargetCapacity (TF.Resource l p a) b where
...
instance HasMemoryPerUnit a b => HasMemoryPerUnit (TF.Resource l p a) b where
...
instance HasMinTargetCapacity a b => HasMinTargetCapacity (TF.Resource l p a) b where
...
instance HasMultaiTargetSets a b => HasMultaiTargetSets (TF.Resource l p a) b where
...
instance HasNumOfUnits a b => HasNumOfUnits (TF.Resource l p a) b where
    numOfUnits = TF.configuration . numOfUnits

class HasOndemandCount a b | a -> b where
    ondemandCount :: P.Lens' a b

instance HasOndemandCount a b => HasOndemandCount (TF.Resource l p a) b where
...
instance HasOrientation a b => HasOrientation (TF.Resource l p a) b where
    orientation = TF.configuration . orientation

class HasPerformAt a b | a -> b where
    performAt :: P.Lens' a b

instance HasPerformAt a b => HasPerformAt (TF.Resource l p a) b where
...
instance HasPersistBlockDevices a b => HasPersistBlockDevices (TF.Resource l p a) b where
...
instance HasPersistPrivateIp a b => HasPersistPrivateIp (TF.Resource l p a) b where
    persistPrivateIp = TF.configuration . persistPrivateIp

class HasPersistRootDevice a b | a -> b where
    persistRootDevice :: P.Lens' a b

instance HasPersistRootDevice a b => HasPersistRootDevice (TF.Resource l p a) b where
...
instance HasScaleTargetCapacity a b => HasScaleTargetCapacity (TF.Resource l p a) b where
...
instance HasScalingDownPolicy a b => HasScalingDownPolicy (TF.Resource l p a) b where
...
instance HasScalingTargetPolicy a b => HasScalingTargetPolicy (TF.Resource l p a) b where
    scalingTargetPolicy = TF.configuration . scalingTargetPolicy

class HasScalingUpPolicy a b | a -> b where
    scalingUpPolicy :: P.Lens' a b

instance HasScalingUpPolicy a b => HasScalingUpPolicy (TF.Resource l p a) b where
    scalingUpPolicy = TF.configuration . scalingUpPolicy

class HasScheduledTask a b | a -> b where
    scheduledTask :: P.Lens' a b

instance HasScheduledTask a b => HasScheduledTask (TF.Resource l p a) b where
...
instance HasSecondaryPrivateIpAddressCount a b => HasSecondaryPrivateIpAddressCount (TF.Resource l p a) b where
...
instance HasShouldDeleteImages a b => HasShouldDeleteImages (TF.Resource l p a) b where
...
instance HasShouldDeleteNetworkInterfaces a b => HasShouldDeleteNetworkInterfaces (TF.Resource l p a) b where
...
instance HasShouldDeleteSnapshots a b => HasShouldDeleteSnapshots (TF.Resource l p a) b where
...
instance HasShouldDeleteVolumes a b => HasShouldDeleteVolumes (TF.Resource l p a) b where
...
instance HasShouldResumeStateful a b => HasShouldResumeStateful (TF.Resource l p a) b where
    shouldResumeStateful = TF.configuration . shouldResumeStateful

class HasShouldRoll a b | a -> b where
    shouldRoll :: P.Lens' a b

instance HasShouldRoll a b => HasShouldRoll (TF.Resource l p a) b where
    shouldRoll = TF.configuration . shouldRoll

class HasSignal a b | a -> b where
    signal :: P.Lens' a b

instance HasSignal a b => HasSignal (TF.Resource l p a) b where
...
instance HasSpotPercentage a b => HasSpotPercentage (TF.Resource l p a) b where
...
instance HasStatefulDeallocation a b => HasStatefulDeallocation (TF.Resource l p a) b where
...
instance HasTargetSetId a b => HasTargetSetId (TF.Resource l p a) b where
...
instance HasTerminateInstanceOnFailure a b => HasTerminateInstanceOnFailure (TF.Resource l p a) b where
...
instance HasTimeWindows a b => HasTimeWindows (TF.Resource l p a) b where
...
instance HasUpdatePolicy a b => HasUpdatePolicy (TF.Resource l p a) b where
...
instance HasUtilizeReservedInstances a b => HasUtilizeReservedInstances (TF.Resource l p a) b where
