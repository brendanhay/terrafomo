...
data DistributedPortGroupResource s = DistributedPortGroupResource'
    ...
    --
    , _vlanRange :: TF.Attr s [TF.Attr s (DistributedPortGroupVlanRangeSetting s)]
    -- ^ @vlan_range@ - (Optional)
    -- The VLAN ID for single VLAN mode. 0 denotes no VLAN.
    --
    -- Conflicts with:
...
instance P.HasVlanRange (DistributedPortGroupResource s) (TF.Attr s [TF.Attr s (DistributedPortGroupVlanRangeSetting s)]) where
    vlanRange =
        P.lens (_vlanRange :: DistributedPortGroupResource s -> TF.Attr s [TF.Attr s (DistributedPortGroupVlanRangeSetting s)])
...
instance s ~ s' => P.HasComputedVlanRange (TF.Ref s' (DistributedPortGroupResource s)) (TF.Attr s [TF.Attr s (DistributedPortGroupVlanRangeSetting s)]) where
...
data DistributedVirtualSwitchResource s = DistributedVirtualSwitchResource'
    ...
    -- normal, or custom.
    --
    , _host :: TF.Attr s [TF.Attr s (DistributedVirtualSwitchHostSetting s)]
    -- ^ @host@ - (Optional)
    ...
    -- * 'portPrivateSecondaryVlanId'
    -- * 'vlanRange'
    , _vlanRange :: TF.Attr s [TF.Attr s (DistributedVirtualSwitchVlanRangeSetting s)]
    -- ^ @vlan_range@ - (Optional)
    -- The VLAN ID for single VLAN mode. 0 denotes no VLAN.
    --
    -- Conflicts with:
...
instance P.HasHost (DistributedVirtualSwitchResource s) (TF.Attr s [TF.Attr s (DistributedVirtualSwitchHostSetting s)]) where
    host =
        P.lens (_host :: DistributedVirtualSwitchResource s -> TF.Attr s [TF.Attr s (DistributedVirtualSwitchHostSetting s)])
...
instance P.HasVlanRange (DistributedVirtualSwitchResource s) (TF.Attr s [TF.Attr s (DistributedVirtualSwitchVlanRangeSetting s)]) where
    vlanRange =
        P.lens (_vlanRange :: DistributedVirtualSwitchResource s -> TF.Attr s [TF.Attr s (DistributedVirtualSwitchVlanRangeSetting s)])
...
instance s ~ s' => P.HasComputedVlanRange (TF.Ref s' (DistributedVirtualSwitchResource s)) (TF.Attr s [TF.Attr s (DistributedVirtualSwitchVlanRangeSetting s)]) where
    computedVlanRange x = TF.compute (TF.refKey x) "vlan_range"
...
instance s ~ s' => P.HasComputedPorts (TF.Ref s' (HostPortGroupResource s)) (TF.Attr s (HostPortGroupPortsSetting s)) where
...
data VirtualMachineResource s = VirtualMachineResource'
    ...
    --
    , _cdrom :: TF.Attr s (VirtualMachineCdromSetting s)
    -- ^ @cdrom@ - (Optional)
    -- A specification for a CDROM device on this virtual machine.
    --
    , _clone :: TF.Attr s (VirtualMachineCloneSetting s)
    -- ^ @clone@ - (Optional)
    ...
    --
    -- * 'datastoreClusterId'
    , _disk :: TF.Attr s [TF.Attr s (VirtualMachineDiskSetting s)]
    -- ^ @disk@ - (Optional)
    ...
    --
    , _networkInterface :: TF.Attr s [TF.Attr s (VirtualMachineNetworkInterfaceSetting s)]
    ...
    -- A list of tag IDs to apply to this object.
    --
    , _vapp :: TF.Attr s (VirtualMachineVappSetting s)
    -- ^ @vapp@ - (Optional)
...
virtualMachineResource
    ...
    -> TF.Attr s [TF.Attr s (VirtualMachineNetworkInterfaceSetting s)] -- ^ @network_interface@ ('P._networkInterface', 'P.networkInterface')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    ...
    validator = TF.fieldsValidator (\VirtualMachineResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_datastoreId P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_cdrom"
                  (_cdrom
                      :: VirtualMachineResource s -> TF.Attr s (VirtualMachineCdromSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_clone"
                  (_clone
                      :: VirtualMachineResource s -> TF.Attr s (VirtualMachineCloneSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_vapp"
                  (_vapp
                      :: VirtualMachineResource s -> TF.Attr s (VirtualMachineVappSetting s))
                  TF.validator
...
instance P.HasCdrom (VirtualMachineResource s) (TF.Attr s (VirtualMachineCdromSetting s)) where
    cdrom =
        P.lens (_cdrom :: VirtualMachineResource s -> TF.Attr s (VirtualMachineCdromSetting s))
               (\s a -> s { _cdrom = a } :: VirtualMachineResource s)

instance P.HasClone (VirtualMachineResource s) (TF.Attr s (VirtualMachineCloneSetting s)) where
    clone =
        P.lens (_clone :: VirtualMachineResource s -> TF.Attr s (VirtualMachineCloneSetting s))
...
instance P.HasDisk (VirtualMachineResource s) (TF.Attr s [TF.Attr s (VirtualMachineDiskSetting s)]) where
    disk =
        P.lens (_disk :: VirtualMachineResource s -> TF.Attr s [TF.Attr s (VirtualMachineDiskSetting s)])
...
instance P.HasNetworkInterface (VirtualMachineResource s) (TF.Attr s [TF.Attr s (VirtualMachineNetworkInterfaceSetting s)]) where
    networkInterface =
        P.lens (_networkInterface :: VirtualMachineResource s -> TF.Attr s [TF.Attr s (VirtualMachineNetworkInterfaceSetting s)])
...
instance P.HasVapp (VirtualMachineResource s) (TF.Attr s (VirtualMachineVappSetting s)) where
    vapp =
        P.lens (_vapp :: VirtualMachineResource s -> TF.Attr s (VirtualMachineVappSetting s))
...
instance s ~ s' => P.HasComputedDisk (TF.Ref s' (VirtualMachineResource s)) (TF.Attr s [TF.Attr s (VirtualMachineDiskSetting s)]) where
