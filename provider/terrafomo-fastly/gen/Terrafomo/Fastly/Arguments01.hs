...
-- |
-- Module      : Terrafomo.Fastly.Arguments01
...
instance HasAutoLoadbalance a b => HasAutoLoadbalance (TF.Resource l p a) b where
...
instance HasBetweenBytesTimeout a b => HasBetweenBytesTimeout (TF.Resource l p a) b where
    betweenBytesTimeout = TF.configuration . betweenBytesTimeout

class HasBigquerylogging a b | a -> b where
    bigquerylogging :: P.Lens' a b

instance HasBigquerylogging a b => HasBigquerylogging (TF.Resource l p a) b where
...
instance HasContentTypes a b => HasContentTypes (TF.Resource l p a) b where
    contentTypes = TF.configuration . contentTypes

class HasDataset a b | a -> b where
    dataset :: P.Lens' a b

instance HasDataset a b => HasDataset (TF.Resource l p a) b where
    dataset = TF.configuration . dataset

class HasDefaultHost a b | a -> b where
    defaultHost :: P.Lens' a b

instance HasDefaultHost a b => HasDefaultHost (TF.Resource l p a) b where
...
instance HasForceMiss a b => HasForceMiss (TF.Resource l p a) b where
    forceMiss = TF.configuration . forceMiss

class HasForceSsl a b | a -> b where
    forceSsl :: P.Lens' a b

instance HasForceSsl a b => HasForceSsl (TF.Resource l p a) b where
...
instance HasGcslogging a b => HasGcslogging (TF.Resource l p a) b where
    gcslogging = TF.configuration . gcslogging

class HasGeoHeaders a b | a -> b where
    geoHeaders :: P.Lens' a b

instance HasGeoHeaders a b => HasGeoHeaders (TF.Resource l p a) b where
    geoHeaders = TF.configuration . geoHeaders

class HasGzip a b | a -> b where
    gzip :: P.Lens' a b

instance HasGzip a b => HasGzip (TF.Resource l p a) b where
    gzip = TF.configuration . gzip

class HasGzipLevel a b | a -> b where
    gzipLevel :: P.Lens' a b

instance HasGzipLevel a b => HasGzipLevel (TF.Resource l p a) b where
    gzipLevel = TF.configuration . gzipLevel

class HasHashKeys a b | a -> b where
    hashKeys :: P.Lens' a b

instance HasHashKeys a b => HasHashKeys (TF.Resource l p a) b where
...
instance HasPapertrail a b => HasPapertrail (TF.Resource l p a) b where
...
instance HasRedundancy a b => HasRedundancy (TF.Resource l p a) b where
...
instance HasRequestCondition a b => HasRequestCondition (TF.Resource l p a) b where
    requestCondition = TF.configuration . requestCondition

class HasRequestSetting a b | a -> b where
    requestSetting :: P.Lens' a b

instance HasRequestSetting a b => HasRequestSetting (TF.Resource l p a) b where
...
instance HasSslCaCert a b => HasSslCaCert (TF.Resource l p a) b where
    sslCaCert = TF.configuration . sslCaCert

class HasSslCertHostname a b | a -> b where
    sslCertHostname :: P.Lens' a b

instance HasSslCertHostname a b => HasSslCertHostname (TF.Resource l p a) b where
    sslCertHostname = TF.configuration . sslCertHostname

class HasSslCheckCert a b | a -> b where
    sslCheckCert :: P.Lens' a b

instance HasSslCheckCert a b => HasSslCheckCert (TF.Resource l p a) b where
...
instance HasSubstitution a b => HasSubstitution (TF.Resource l p a) b where
    substitution = TF.configuration . substitution

class HasSumologic a b | a -> b where
    sumologic :: P.Lens' a b

instance HasSumologic a b => HasSumologic (TF.Resource l p a) b where
    sumologic = TF.configuration . sumologic

class HasSyslog a b | a -> b where
    syslog :: P.Lens' a b

instance HasSyslog a b => HasSyslog (TF.Resource l p a) b where
...
instance HasUseSsl a b => HasUseSsl (TF.Resource l p a) b where
    useSsl = TF.configuration . useSsl

class HasUseTls a b | a -> b where
    useTls :: P.Lens' a b

instance HasUseTls a b => HasUseTls (TF.Resource l p a) b where
    useTls = TF.configuration . useTls

class HasVcl a b | a -> b where
    vcl :: P.Lens' a b

instance HasVcl a b => HasVcl (TF.Resource l p a) b where
...
instance HasXff a b => HasXff (TF.Resource l p a) b where
