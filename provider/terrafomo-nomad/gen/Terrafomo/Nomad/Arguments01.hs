...
instance HasDeregisterOnDestroy a b => HasDeregisterOnDestroy (TF.Resource l p a) b where
...
instance HasDeregisterOnIdChange a b => HasDeregisterOnIdChange (TF.Resource l p a) b where
...
instance HasEnforcementLevel a b => HasEnforcementLevel (TF.Resource l p a) b where
...
instance HasJobspec a b => HasJobspec (TF.Resource l p a) b where
...
instance HasPolicyOverride a b => HasPolicyOverride (TF.Resource l p a) b where
...
instance HasRegionLimit a b => HasRegionLimit (TF.Resource l p a) b where
    regionLimit = TF.configuration . regionLimit

class HasRulesHcl a b | a -> b where
    rulesHcl :: P.Lens' a b

instance HasRulesHcl a b => HasRulesHcl (TF.Resource l p a) b where
...
instance HasVaultToken a b => HasVaultToken (TF.Resource l p a) b where
