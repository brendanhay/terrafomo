...
data ComputeInstanceV2Resource s = ComputeInstanceV2Resource'
    ...
    -- ^ @name@ - (Required)
    --
    , _network :: TF.Attr s [TF.Attr s (ComputeInstanceV2Network s)]
...
instance P.HasNetwork (ComputeInstanceV2Resource s) (TF.Attr s [TF.Attr s (ComputeInstanceV2Network s)]) where
    network =
        P.lens (_network :: ComputeInstanceV2Resource s -> TF.Attr s [TF.Attr s (ComputeInstanceV2Network s)])
...
data ComputeSecgroupV2Resource s = ComputeSecgroupV2Resource'
    ...
    -- ^ @region@ - (Optional, Forces New)
    --
    , _rule        :: TF.Attr s [TF.Attr s (ComputeSecgroupV2Rule s)]
    -- ^ @rule@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Ord)
...
instance P.HasRule (ComputeSecgroupV2Resource s) (TF.Attr s [TF.Attr s (ComputeSecgroupV2Rule s)]) where
    rule =
        P.lens (_rule :: ComputeSecgroupV2Resource s -> TF.Attr s [TF.Attr s (ComputeSecgroupV2Rule s)])
...
dbConfigurationV1Resource
    :: TF.Attr s (DbConfigurationV1Datastore s) -- ^ @datastore@ ('P._datastore', 'P.datastore')
    -> TF.Attr s P.Text -- ^ @description@ ('P._description', 'P.description')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
dbInstanceV1Resource
    :: TF.Attr s (DbInstanceV1Datastore s) -- ^ @datastore@ ('P._datastore', 'P.datastore')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @region@ ('P._region', 'P.region')
    -> TF.Attr s P.Int -- ^ @size@ ('P._size', 'P.size')
...
data NetworkingRouterV2Resource s = NetworkingRouterV2Resource'
    ...
    --
    , _externalFixedIp :: TF.Attr s [TF.Attr s (NetworkingRouterV2ExternalFixedIp s)]
...
instance P.HasExternalFixedIp (NetworkingRouterV2Resource s) (TF.Attr s [TF.Attr s (NetworkingRouterV2ExternalFixedIp s)]) where
    externalFixedIp =
        P.lens (_externalFixedIp :: NetworkingRouterV2Resource s -> TF.Attr s [TF.Attr s (NetworkingRouterV2ExternalFixedIp s)])
...
data NetworkingSubnetV2Resource s = NetworkingSubnetV2Resource'
    { _allocationPools :: TF.Attr s [TF.Attr s (NetworkingSubnetV2AllocationPools s)]
...
instance P.HasAllocationPools (NetworkingSubnetV2Resource s) (TF.Attr s [TF.Attr s (NetworkingSubnetV2AllocationPools s)]) where
    allocationPools =
        P.lens (_allocationPools :: NetworkingSubnetV2Resource s -> TF.Attr s [TF.Attr s (NetworkingSubnetV2AllocationPools s)])
...
data VpnaasIkePolicyV2Resource s = VpnaasIkePolicyV2Resource'
    ...
    --
    , _lifetime :: TF.Attr s [TF.Attr s (VpnaasIkePolicyV2Lifetime s)]
    -- ^ @lifetime@ - (Optional)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Optional)
...
instance P.HasLifetime (VpnaasIkePolicyV2Resource s) (TF.Attr s [TF.Attr s (VpnaasIkePolicyV2Lifetime s)]) where
    lifetime =
        P.lens (_lifetime :: VpnaasIkePolicyV2Resource s -> TF.Attr s [TF.Attr s (VpnaasIkePolicyV2Lifetime s)])
...
data VpnaasIpsecPolicyV2Resource s = VpnaasIpsecPolicyV2Resource'
    ...
    -- ^ @encryption_algorithm@ - (Optional)
    --
    , _lifetime :: TF.Attr s [TF.Attr s (VpnaasIpsecPolicyV2Lifetime s)]
    -- ^ @lifetime@ - (Optional)
    --
    , _name :: TF.Attr s P.Text
    -- ^ @name@ - (Optional)
...
instance P.HasLifetime (VpnaasIpsecPolicyV2Resource s) (TF.Attr s [TF.Attr s (VpnaasIpsecPolicyV2Lifetime s)]) where
    lifetime =
        P.lens (_lifetime :: VpnaasIpsecPolicyV2Resource s -> TF.Attr s [TF.Attr s (VpnaasIpsecPolicyV2Lifetime s)])
...
data VpnaasSiteConnectionV2Resource s = VpnaasSiteConnectionV2Resource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _dpd            :: TF.Attr s [TF.Attr s (VpnaasSiteConnectionV2Dpd s)]
    -- ^ @dpd@ - (Optional)
    --
...
instance P.HasDpd (VpnaasSiteConnectionV2Resource s) (TF.Attr s [TF.Attr s (VpnaasSiteConnectionV2Dpd s)]) where
    dpd =
        P.lens (_dpd :: VpnaasSiteConnectionV2Resource s -> TF.Attr s [TF.Attr s (VpnaasSiteConnectionV2Dpd s)])
