...
type instance Computed DbInstanceV1Resource
    = '[ '("database/charset", Text)
       {- - See Argument Reference above. -}
       , '("database/collate", Text)
       {- - See Argument Reference above. -}
       , '("database/name", Text)
       {- - See Argument Reference above. -}
       , '("datastore/type", Text)
       {- - See Argument Reference above. -}
       , '("datastore/version", Text)
       {- - See Argument Reference above. -}
       , '("flavor_id", Text)
       {- - See Argument Reference above. -}
       , '("name", Text)
...
data NetworkingRouterV2Resource = NetworkingRouterV2Resource
    ...
    , _external_network_id :: !(Attr Text)
