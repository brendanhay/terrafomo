...
diskSetting
    ...
    -> TF.Attr s [TF.Attr s (WarningSetting s)] -- ^ 'P._warning': @warning@
    -> DiskSetting s
diskSetting _critical _warning =
    DiskSetting'
        { _critical = _critical
        , _warning = _warning
        }
...
internalPingSetting _critical _warning =
    InternalPingSetting'
        { _critical = _critical
        , _warning = _warning
        }
...
portsSetting
    ...
    -> PortsSetting s
portsSetting _emailNotification _port =
    PortsSetting'
        { _alertIf = TF.Nil
...
processesSetting
    ...
    -> ProcessesSetting s
processesSetting _emailNotification _process =
    ProcessesSetting'
        { _alertIf = TF.Nil
        , _emailNotification = _emailNotification
        , _process = _process
...
rulesSetting
    ...
    -> RulesSetting s
rulesSetting _portBalancer _protocol _portServer =
    RulesSetting'
        { _portFrom = TF.Nil
        , _portTo = TF.Nil
        , _protocol = _protocol
...
storageServersSetting _id _rights =
    StorageServersSetting'
        { _id = _id
        , _rights = _rights
        }
...
thresholdsSetting
    ...
    -> ThresholdsSetting s
thresholdsSetting _cpu _disk _internalPing _ram _transfer =
    ThresholdsSetting'
        { _cpu = _cpu
        , _disk = _disk
...
transferSetting
    ...
    -> TF.Attr s [TF.Attr s (WarningSetting s)] -- ^ 'P._warning': @warning@
    -> TransferSetting s
transferSetting _critical _warning =
    TransferSetting'
        { _critical = _critical
        , _warning = _warning
        }
