...
instance HasAaPolicyId a s b => HasAaPolicyId (TF.DataSource p a) s b where
...
instance HasAdditionalDisks a s b => HasAdditionalDisks (TF.DataSource p a) s b where
...
instance HasCreatedDat a s b => HasCreatedDat (TF.DataSource p a) s b where
...
instance HasCustomFields a s b => HasCustomFields (TF.DataSource p a) s b where
...
instance HasInternalIpAddress a s b => HasInternalIpAddress (TF.DataSource p a) s b where
...
instance HasLocationId a s b => HasLocationId (TF.DataSource p a) s b where
...
instance HasMemoryMb a s b => HasMemoryMb (TF.DataSource p a) s b where
...
instance HasModifiedDat a s b => HasModifiedDat (TF.DataSource p a) s b where
...
instance HasNameTemplate a s b => HasNameTemplate (TF.DataSource p a) s b where
...
instance HasNodes a s b => HasNodes (TF.DataSource p a) s b where
...
instance HasParentGroupId a s b => HasParentGroupId (TF.DataSource p a) s b where
...
instance HasPowerState a s b => HasPowerState (TF.DataSource p a) s b where
...
instance HasPublicIpAddress a s b => HasPublicIpAddress (TF.DataSource p a) s b where
...
instance HasServerId a s b => HasServerId (TF.DataSource p a) s b where
...
instance HasSourceRestrictions a s b => HasSourceRestrictions (TF.DataSource p a) s b where
...
instance HasSourceServerId a s b => HasSourceServerId (TF.DataSource p a) s b where
