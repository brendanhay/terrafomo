...
data AppResource s = AppResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _organization :: TF.Attr s [Organization s]
...
instance P.HasOrganization (AppResource s) (TF.Attr s [Organization s]) where
    organization =
        P.lens (_organization :: AppResource s -> TF.Attr s [Organization s])
...
data SpaceAppAccessResource s = SpaceAppAccessResource'
    ...
    -- ^ @email@ - (Required)
    --
    , _permissions :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance TF.IsObject (SpaceAppAccessResource s) where
    toObject SpaceAppAccessResource'{..} = catMaybes
...
spaceAppAccessResource
    ...
    -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)] -- ^ @permissions@ - 'P.permissions'
...
spaceAppAccessResource _email _permissions _space =
    TF.newResource "heroku_space_app_access" $
        SpaceAppAccessResource'
            { _email = _email
...
instance P.HasEmail (SpaceAppAccessResource s) (TF.Attr s P.Text) where
    email =
        P.lens (_email :: SpaceAppAccessResource s -> TF.Attr s P.Text)
               (\s a -> s { _email = a
                          } :: SpaceAppAccessResource s)

instance P.HasPermissions (SpaceAppAccessResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    permissions =
        P.lens (_permissions :: SpaceAppAccessResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
...
data SpaceVpnConnectionResource s = SpaceVpnConnectionResource'
    ...
    -- ^ @public_ip@ - (Required)
    --
    , _routableCidrs :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
spaceVpnConnectionResource
    ...
    -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)] -- ^ @routable_cidrs@ - 'P.routableCidrs'
    -> TF.Attr s P.Text -- ^ @space@ - 'P.space'
...
instance P.HasRoutableCidrs (SpaceVpnConnectionResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    routableCidrs =
        P.lens (_routableCidrs :: SpaceVpnConnectionResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _routableCidrs = a
                          } :: SpaceVpnConnectionResource s)
...
instance P.HasPermissions (TeamCollaboratorResource s) (TF.Attr s (P.NonEmpty (TF.Attr s (TF.Attr s P.Text)))) where
    permissions =
        P.lens (_permissions :: TeamCollaboratorResource s -> TF.Attr s (P.NonEmpty (TF.Attr s (TF.Attr s P.Text))))
               (\s a -> s { _permissions = a
                          } :: TeamCollaboratorResource s)
