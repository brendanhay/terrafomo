...
instance s ~ s' => P.HasComputedConfigVars (TF.Ref s' (AppData s)) (TF.Attr s (P.Map P.Text (TF.Attr s P.Text))) where
...
instance s ~ s' => P.HasComputedOrganization (TF.Ref s' (AppData s)) (TF.Attr s [TF.Attr s (AppOrganizationSetting s)]) where
