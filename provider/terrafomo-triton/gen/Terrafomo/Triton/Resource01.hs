...
data MachineResource s = MachineResource'
    ...
    -- Desired network IDs
    --
    , _nic                       :: TF.Attr s [TF.Attr s (MachineNic s)]
    -- ^ @nic@ - (Optional)
    -- Network interface
    --
    , _package                   :: TF.Attr s P.Text
...
instance P.HasNic (MachineResource s) (TF.Attr s [TF.Attr s (MachineNic s)]) where
    nic =
        P.lens (_nic :: MachineResource s -> TF.Attr s [TF.Attr s (MachineNic s)])
