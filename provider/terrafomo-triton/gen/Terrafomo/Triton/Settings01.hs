...
instance P.HasDisk (PackageFilter s) (TF.Attr s P.Int) where
    disk =
        P.lens (_disk :: PackageFilter s -> TF.Attr s P.Int)
...
instance P.HasLwps (PackageFilter s) (TF.Attr s P.Int) where
    lwps =
        P.lens (_lwps :: PackageFilter s -> TF.Attr s P.Int)
               (\s a -> s { _lwps = a } :: PackageFilter s)

instance P.HasMemory (PackageFilter s) (TF.Attr s P.Int) where
    memory =
        P.lens (_memory :: PackageFilter s -> TF.Attr s P.Int)
...
instance P.HasSwap (PackageFilter s) (TF.Attr s P.Int) where
    swap =
        P.lens (_swap :: PackageFilter s -> TF.Attr s P.Int)
               (\s a -> s { _swap = a } :: PackageFilter s)

instance P.HasVcpus (PackageFilter s) (TF.Attr s P.Int) where
    vcpus =
        P.lens (_vcpus :: PackageFilter s -> TF.Attr s P.Int)
