...
data PackageData s = PackageData'
    { _filter :: TF.Attr s [TF.Attr s (PackageFilterSetting s)]
...
packageData
    :: TF.Attr s [TF.Attr s (PackageFilterSetting s)] -- ^ @filter@ ('P._filter', 'P.filter')
...
instance P.HasFilter (PackageData s) (TF.Attr s [TF.Attr s (PackageFilterSetting s)]) where
    filter =
        P.lens (_filter :: PackageData s -> TF.Attr s [TF.Attr s (PackageFilterSetting s)])
