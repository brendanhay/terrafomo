...
-- |
-- Module      : Terrafomo.AzureRM.Resources03
...
module Terrafomo.AzureRM.Resources03
    ...
    , newSharedImageGalleryR
    , SharedImageGalleryR (..)
    , SharedImageGalleryR_Required (..)

    -- * azurerm_shared_image
    , newSharedImageR
    , SharedImageR (..)
    , SharedImageR_Required (..)

    -- * azurerm_shared_image_version
    , newSharedImageVersionR
    , SharedImageVersionR (..)
    , SharedImageVersionR_Required (..)
...
newRecoveryServicesVaultR x =
    TF.unsafeResource "azurerm_recovery_services_vault"  Encode.lifecycle
...
newRedisCacheR x =
    TF.unsafeResource "azurerm_redis_cache"  Encode.lifecycle
...
newRedisFirewallRuleR =
    TF.unsafeResource "azurerm_redis_firewall_rule"  Encode.lifecycle
        (\RedisFirewallRuleR{..} ->
          P.mempty
...
newRelayNamespaceR x =
    TF.unsafeResource "azurerm_relay_namespace"  Encode.lifecycle
...
newResourceGroupR x =
    TF.unsafeResource "azurerm_resource_group"  Encode.lifecycle
...
newRoleAssignmentR x =
    TF.unsafeResource "azurerm_role_assignment"  Encode.lifecycle
...
newRoleDefinitionR x =
    TF.unsafeResource "azurerm_role_definition"  Encode.lifecycle
...
newRouteR
    ...
    -> P.Resource RouteR s
newRouteR x =
    TF.unsafeResource "azurerm_route"  Encode.lifecycle
        (\RouteR_Internal{..} ->
          P.mempty
...
newRouteTableR x =
    TF.unsafeResource "azurerm_route_table"  Encode.lifecycle
...
newSchedulerJobCollectionR x =
    TF.unsafeResource "azurerm_scheduler_job_collection"  Encode.lifecycle
...
newSchedulerJobR x =
    TF.unsafeResource "azurerm_scheduler_job"  Encode.lifecycle
...
newSearchServiceR x =
    TF.unsafeResource "azurerm_search_service"  Encode.lifecycle
...
data ServiceFabricClusterR s = ServiceFabricClusterR_Internal
    ...
    -- - (Optional)
    , cluster_code_version :: P.Maybe (TF.Expr s P.Text)
...
#cluster_code_version           :: Lens' (Resource ServiceFabricClusterR s) (Maybe (Expr s Text))
...
#cluster_code_version           :: Getting r (Ref ServiceFabricClusterR s) (Expr s Text)
...
newServiceFabricClusterR x =
    TF.unsafeResource "azurerm_service_fabric_cluster"  Encode.lifecycle
       ...
       <> P.maybe P.mempty (TF.pair "cluster_code_version") cluster_code_version
       ...
       <> TF.pair "vm_image" vm_image
        ...
        (let ServiceFabricClusterR{..} = x in ServiceFabricClusterR_Internal
            ...
            , cluster_code_version = P.Nothing
...
instance Lens.HasField "cluster_code_version" f (P.Resource ServiceFabricClusterR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (cluster_code_version :: ServiceFabricClusterR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { cluster_code_version = a } :: ServiceFabricClusterR s)
...
instance Lens.HasField "cluster_code_version" (P.Const r) (TF.Ref ServiceFabricClusterR s) (TF.Expr s P.Text) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "cluster_code_version"))
...
newServicebusNamespaceAuthorizationRuleR x =
    TF.unsafeResource "azurerm_servicebus_namespace_authorization_rule"  Encode.lifecycle
...
newServicebusNamespaceR x =
    TF.unsafeResource "azurerm_servicebus_namespace"  Encode.lifecycle
...
newServicebusQueueAuthorizationRuleR x =
    TF.unsafeResource "azurerm_servicebus_queue_authorization_rule"  Encode.lifecycle
...
newServicebusQueueR x =
    TF.unsafeResource "azurerm_servicebus_queue"  Encode.lifecycle
...
newServicebusSubscriptionR x =
    TF.unsafeResource "azurerm_servicebus_subscription"  Encode.lifecycle
...
newServicebusSubscriptionRuleR x =
    TF.unsafeResource "azurerm_servicebus_subscription_rule"  Encode.lifecycle
...
newServicebusTopicAuthorizationRuleR x =
    TF.unsafeResource "azurerm_servicebus_topic_authorization_rule"  Encode.lifecycle
...
newServicebusTopicR x =
    TF.unsafeResource "azurerm_servicebus_topic"  Encode.lifecycle
...
-- | The main @azurerm_shared_image_gallery@ resource definition.
data SharedImageGalleryR s = SharedImageGalleryR_Internal
    { description :: P.Maybe (TF.Expr s P.Text)
    -- ^ @description@
    -- - (Optional)
    , location :: TF.Expr s P.Text
...
{- | Construct a new @azurerm_shared_image_gallery@ resource. The
available argument lenses and computed attribute getters are documented below.
See the <https://www.terraform.io/docs/providers/azurerm/r/shared_image_gallery.html terraform documentation> for more information.

=== Example Usage

You can define a minimal @azurerm_shared_image_gallery@ via:

@
AzureRM.newSharedImageGalleryR
  (AzureRM.SharedImageGalleryR
        { AzureRM.location = location -- Expr s Text
        , AzureRM.name = name -- Expr s Text
        , AzureRM.resource_group_name = resource_group_name -- Expr s Text
        })
...
@
#description                    :: Lens' (Resource SharedImageGalleryR s) (Maybe (Expr s Text))
#location                       :: Lens' (Resource SharedImageGalleryR s) (Expr s Text)
#name                           :: Lens' (Resource SharedImageGalleryR s) (Expr s Text)
#resource_group_name            :: Lens' (Resource SharedImageGalleryR s) (Expr s Text)
#tags                           :: Lens' (Resource SharedImageGalleryR s) (Maybe (Expr s (Map Text (Expr s Text))))
@
...
@
#id                             :: Getting r (Ref SharedImageGalleryR s) (Expr s Id)
#tags                           :: Getting r (Ref SharedImageGalleryR s) (Expr s (Map Text (Expr s Text)))
#unique_name                    :: Getting r (Ref SharedImageGalleryR s) (Expr s Text)
@
...
@
#prevent_destroy                :: Lens' (Resource SharedImageGalleryR s) Bool
#create_before_destroy          :: Lens' (Resource SharedImageGalleryR s) Bool
#ignore_changes                 :: Lens' (Resource SharedImageGalleryR s) (Changes s)
#depends_on                     :: Lens' (Resource SharedImageGalleryR s) (Set (Depends s))
#provider                       :: Lens' (Resource SharedImageGalleryR s) (Maybe AzureRM)
@
-}
newSharedImageGalleryR
    :: SharedImageGalleryR_Required s -- ^ The minimal/required arguments.
    -> P.Resource SharedImageGalleryR s
newSharedImageGalleryR x =
    TF.unsafeResource "azurerm_shared_image_gallery"  Encode.lifecycle
        (\SharedImageGalleryR_Internal{..} ->
          P.mempty
       <> P.maybe P.mempty (TF.pair "description") description
       <> TF.pair "location" location
       <> TF.pair "name" name
       ...
       <> P.maybe P.mempty (TF.pair "tags") tags
        ...
        (let SharedImageGalleryR{..} = x in SharedImageGalleryR_Internal
            { description = P.Nothing
            , location = location
            , name = name
            , resource_group_name = resource_group_name
...
-- | The required arguments for 'newSharedImageGalleryR'.
data SharedImageGalleryR_Required s = SharedImageGalleryR
    { location            :: TF.Expr s P.Text
    -- ^ (Required, Forces New)
    , name                :: TF.Expr s P.Text
    -- ^ (Required, Forces New)
...
instance Lens.HasField "description" f (P.Resource SharedImageGalleryR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (description :: SharedImageGalleryR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { description = a } :: SharedImageGalleryR s)

instance Lens.HasField "location" f (P.Resource SharedImageGalleryR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (location :: SharedImageGalleryR s -> TF.Expr s P.Text)
        (\s a -> s { location = a } :: SharedImageGalleryR s)

instance Lens.HasField "name" f (P.Resource SharedImageGalleryR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (name :: SharedImageGalleryR s -> TF.Expr s P.Text)
        (\s a -> s { name = a } :: SharedImageGalleryR s)

instance Lens.HasField "resource_group_name" f (P.Resource SharedImageGalleryR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (resource_group_name :: SharedImageGalleryR s -> TF.Expr s P.Text)
        (\s a -> s { resource_group_name = a } :: SharedImageGalleryR s)

instance Lens.HasField "tags" f (P.Resource SharedImageGalleryR s) (P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text)))) where
    field = Lens.resourceLens P.. Lens.lens'
        (tags :: SharedImageGalleryR s -> P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))))
        (\s a -> s { tags = a } :: SharedImageGalleryR s)

instance Lens.HasField "id" (P.Const r) (TF.Ref SharedImageGalleryR s) (TF.Expr s TF.Id) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "id"))

instance Lens.HasField "tags" (P.Const r) (TF.Ref SharedImageGalleryR s) (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "tags"))

instance Lens.HasField "unique_name" (P.Const r) (TF.Ref SharedImageGalleryR s) (TF.Expr s P.Text) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "unique_name"))

-- | The main @azurerm_shared_image@ resource definition.
data SharedImageR s = SharedImageR_Internal
    { description :: P.Maybe (TF.Expr s P.Text)
    -- ^ @description@
    -- - (Optional)
    , eula :: P.Maybe (TF.Expr s P.Text)
    -- ^ @eula@
    -- - (Optional)
    , gallery_name :: TF.Expr s P.Text
    -- ^ @gallery_name@
    -- - (Required, Forces New)
    , identifier :: TF.Expr s (SharedImageIdentifier s)
    -- ^ @identifier@
    -- - (Required)
    , location :: TF.Expr s P.Text
    -- ^ @location@
    ...
    -- ^ @os_type@
    -- - (Required)
    , privacy_statement_uri :: P.Maybe (TF.Expr s P.Text)
    -- ^ @privacy_statement_uri@
    -- - (Optional)
    , release_note_uri :: P.Maybe (TF.Expr s P.Text)
    -- ^ @release_note_uri@
    -- - (Optional)
    , resource_group_name :: TF.Expr s P.Text
    -- ^ @resource_group_name@
...
{- | Construct a new @azurerm_shared_image@ resource. The
available argument lenses and computed attribute getters are documented below.
See the <https://www.terraform.io/docs/providers/azurerm/r/shared_image.html terraform documentation> for more information.

=== Example Usage

You can define a minimal @azurerm_shared_image@ via:

@
AzureRM.newSharedImageR
  (AzureRM.SharedImageR
        { AzureRM.identifier = identifier -- Expr s (SharedImageIdentifier s)
        , AzureRM.location = location -- Expr s Text
        , AzureRM.gallery_name = gallery_name -- Expr s Text
        , AzureRM.name = name -- Expr s Text
        , AzureRM.resource_group_name = resource_group_name -- Expr s Text
...
@
#description                    :: Lens' (Resource SharedImageR s) (Maybe (Expr s Text))
#eula                           :: Lens' (Resource SharedImageR s) (Maybe (Expr s Text))
#gallery_name                   :: Lens' (Resource SharedImageR s) (Expr s Text)
#identifier                     :: Lens' (Resource SharedImageR s) (Expr s (SharedImageIdentifier s))
#location                       :: Lens' (Resource SharedImageR s) (Expr s Text)
#name                           :: Lens' (Resource SharedImageR s) (Expr s Text)
#os_type                        :: Lens' (Resource SharedImageR s) (Expr s Text)
#privacy_statement_uri          :: Lens' (Resource SharedImageR s) (Maybe (Expr s Text))
#release_note_uri               :: Lens' (Resource SharedImageR s) (Maybe (Expr s Text))
#resource_group_name            :: Lens' (Resource SharedImageR s) (Expr s Text)
#tags                           :: Lens' (Resource SharedImageR s) (Maybe (Expr s (Map Text (Expr s Text))))
@
...
@
#id                             :: Getting r (Ref SharedImageR s) (Expr s Id)
#tags                           :: Getting r (Ref SharedImageR s) (Expr s (Map Text (Expr s Text)))
@
...
@
#prevent_destroy                :: Lens' (Resource SharedImageR s) Bool
#create_before_destroy          :: Lens' (Resource SharedImageR s) Bool
#ignore_changes                 :: Lens' (Resource SharedImageR s) (Changes s)
#depends_on                     :: Lens' (Resource SharedImageR s) (Set (Depends s))
#provider                       :: Lens' (Resource SharedImageR s) (Maybe AzureRM)
@
-}
newSharedImageR
    :: SharedImageR_Required s -- ^ The minimal/required arguments.
    -> P.Resource SharedImageR s
newSharedImageR x =
    TF.unsafeResource "azurerm_shared_image"  Encode.lifecycle
        (\SharedImageR_Internal{..} ->
          P.mempty
       <> P.maybe P.mempty (TF.pair "description") description
       <> P.maybe P.mempty (TF.pair "eula") eula
       <> TF.pair "gallery_name" gallery_name
       <> TF.pair "identifier" identifier
       <> TF.pair "location" location
       <> TF.pair "name" name
       <> TF.pair "os_type" os_type
       <> P.maybe P.mempty (TF.pair "privacy_statement_uri") privacy_statement_uri
       <> P.maybe P.mempty (TF.pair "release_note_uri") release_note_uri
       <> TF.pair "resource_group_name" resource_group_name
       <> P.maybe P.mempty (TF.pair "tags") tags
        )
        (let SharedImageR{..} = x in SharedImageR_Internal
            { description = P.Nothing
            , eula = P.Nothing
            ...
            , name = name
            , os_type = os_type
            , privacy_statement_uri = P.Nothing
            , release_note_uri = P.Nothing
            , resource_group_name = resource_group_name
            , tags = P.Nothing
            })

-- | The required arguments for 'newSharedImageR'.
data SharedImageR_Required s = SharedImageR
    { identifier          :: TF.Expr s (SharedImageIdentifier s)
    -- ^ (Required)
    , location            :: TF.Expr s P.Text
    -- ^ (Required, Forces New)
...
instance Lens.HasField "description" f (P.Resource SharedImageR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (description :: SharedImageR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { description = a } :: SharedImageR s)

instance Lens.HasField "eula" f (P.Resource SharedImageR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (eula :: SharedImageR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { eula = a } :: SharedImageR s)

instance Lens.HasField "gallery_name" f (P.Resource SharedImageR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (gallery_name :: SharedImageR s -> TF.Expr s P.Text)
        (\s a -> s { gallery_name = a } :: SharedImageR s)

instance Lens.HasField "identifier" f (P.Resource SharedImageR s) (TF.Expr s (SharedImageIdentifier s)) where
    field = Lens.resourceLens P.. Lens.lens'
        (identifier :: SharedImageR s -> TF.Expr s (SharedImageIdentifier s))
        (\s a -> s { identifier = a } :: SharedImageR s)

instance Lens.HasField "location" f (P.Resource SharedImageR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (location :: SharedImageR s -> TF.Expr s P.Text)
        (\s a -> s { location = a } :: SharedImageR s)

instance Lens.HasField "name" f (P.Resource SharedImageR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (name :: SharedImageR s -> TF.Expr s P.Text)
        (\s a -> s { name = a } :: SharedImageR s)

instance Lens.HasField "os_type" f (P.Resource SharedImageR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (os_type :: SharedImageR s -> TF.Expr s P.Text)
        (\s a -> s { os_type = a } :: SharedImageR s)

instance Lens.HasField "privacy_statement_uri" f (P.Resource SharedImageR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (privacy_statement_uri :: SharedImageR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { privacy_statement_uri = a } :: SharedImageR s)

instance Lens.HasField "release_note_uri" f (P.Resource SharedImageR s) (P.Maybe (TF.Expr s P.Text)) where
    field = Lens.resourceLens P.. Lens.lens'
        (release_note_uri :: SharedImageR s -> P.Maybe (TF.Expr s P.Text))
        (\s a -> s { release_note_uri = a } :: SharedImageR s)

instance Lens.HasField "resource_group_name" f (P.Resource SharedImageR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (resource_group_name :: SharedImageR s -> TF.Expr s P.Text)
        (\s a -> s { resource_group_name = a } :: SharedImageR s)

instance Lens.HasField "tags" f (P.Resource SharedImageR s) (P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text)))) where
    field = Lens.resourceLens P.. Lens.lens'
        (tags :: SharedImageR s -> P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))))
        (\s a -> s { tags = a } :: SharedImageR s)

instance Lens.HasField "id" (P.Const r) (TF.Ref SharedImageR s) (TF.Expr s TF.Id) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "id"))

instance Lens.HasField "tags" (P.Const r) (TF.Ref SharedImageR s) (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "tags"))

-- | The main @azurerm_shared_image_version@ resource definition.
data SharedImageVersionR s = SharedImageVersionR_Internal
    { exclude_from_latest :: TF.Expr s P.Bool
    -- ^ @exclude_from_latest@
    -- - (Default __@false@__)
    , gallery_name :: TF.Expr s P.Text
    -- ^ @gallery_name@
    -- - (Required, Forces New)
    , image_name :: TF.Expr s P.Text
    -- ^ @image_name@
    -- - (Required, Forces New)
    , location :: TF.Expr s P.Text
    -- ^ @location@
    -- - (Required, Forces New)
    , managed_image_id :: TF.Expr s TF.Id
    -- ^ @managed_image_id@
    -- - (Required, Forces New)
    , name :: TF.Expr s P.Text
    -- ^ @name@
    ...
    -- ^ @tags@
    -- - (Optional)
    , target_region :: TF.Expr s [TF.Expr s (SharedImageVersionTargetRegion s)]
    -- ^ @target_region@
    -- - (Required)
    } deriving (P.Show)

{- | Construct a new @azurerm_shared_image_version@ resource. The
available argument lenses and computed attribute getters are documented below.
See the <https://www.terraform.io/docs/providers/azurerm/r/shared_image_version.html terraform documentation> for more information.

=== Example Usage

You can define a minimal @azurerm_shared_image_version@ via:

@
AzureRM.newSharedImageVersionR
  (AzureRM.SharedImageVersionR
        { AzureRM.managed_image_id = managed_image_id -- Expr s Id
        , AzureRM.location = location -- Expr s Text
        , AzureRM.gallery_name = gallery_name -- Expr s Text
        , AzureRM.image_name = image_name -- Expr s Text
        , AzureRM.name = name -- Expr s Text
        , AzureRM.resource_group_name = resource_group_name -- Expr s Text
        , AzureRM.target_region = target_region -- Expr s [Expr s (SharedImageVersionTargetRegion s)]
        })
@
...
@
#exclude_from_latest            :: Lens' (Resource SharedImageVersionR s) (Expr s Bool)
#gallery_name                   :: Lens' (Resource SharedImageVersionR s) (Expr s Text)
#image_name                     :: Lens' (Resource SharedImageVersionR s) (Expr s Text)
#location                       :: Lens' (Resource SharedImageVersionR s) (Expr s Text)
#managed_image_id               :: Lens' (Resource SharedImageVersionR s) (Expr s Id)
#name                           :: Lens' (Resource SharedImageVersionR s) (Expr s Text)
#resource_group_name            :: Lens' (Resource SharedImageVersionR s) (Expr s Text)
#tags                           :: Lens' (Resource SharedImageVersionR s) (Maybe (Expr s (Map Text (Expr s Text))))
#target_region                  :: Lens' (Resource SharedImageVersionR s) (Expr s [Expr s (SharedImageVersionTargetRegion s)])
@
...
@
#id                             :: Getting r (Ref SharedImageVersionR s) (Expr s Id)
#tags                           :: Getting r (Ref SharedImageVersionR s) (Expr s (Map Text (Expr s Text)))
@
...
@
#prevent_destroy                :: Lens' (Resource SharedImageVersionR s) Bool
#create_before_destroy          :: Lens' (Resource SharedImageVersionR s) Bool
#ignore_changes                 :: Lens' (Resource SharedImageVersionR s) (Changes s)
#depends_on                     :: Lens' (Resource SharedImageVersionR s) (Set (Depends s))
#provider                       :: Lens' (Resource SharedImageVersionR s) (Maybe AzureRM)
@
-}
newSharedImageVersionR
    :: SharedImageVersionR_Required s -- ^ The minimal/required arguments.
    -> P.Resource SharedImageVersionR s
newSharedImageVersionR x =
    TF.unsafeResource "azurerm_shared_image_version"  Encode.lifecycle
        (\SharedImageVersionR_Internal{..} ->
          P.mempty
       <> TF.pair "exclude_from_latest" exclude_from_latest
       <> TF.pair "gallery_name" gallery_name
       <> TF.pair "image_name" image_name
       <> TF.pair "location" location
       <> TF.pair "managed_image_id" managed_image_id
       <> TF.pair "name" name
       <> TF.pair "resource_group_name" resource_group_name
       <> P.maybe P.mempty (TF.pair "tags") tags
       <> TF.pair "target_region" target_region
        )
        (let SharedImageVersionR{..} = x in SharedImageVersionR_Internal
            { exclude_from_latest = TF.expr P.False
            , gallery_name = gallery_name
...
-- | The required arguments for 'newSharedImageVersionR'.
data SharedImageVersionR_Required s = SharedImageVersionR
    { managed_image_id :: TF.Expr s TF.Id
    -- ^ (Required, Forces New)
    , location :: TF.Expr s P.Text
    -- ^ (Required, Forces New)
...
instance Lens.HasField "exclude_from_latest" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Bool) where
    field = Lens.resourceLens P.. Lens.lens'
        (exclude_from_latest :: SharedImageVersionR s -> TF.Expr s P.Bool)
        (\s a -> s { exclude_from_latest = a } :: SharedImageVersionR s)

instance Lens.HasField "gallery_name" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (gallery_name :: SharedImageVersionR s -> TF.Expr s P.Text)
        (\s a -> s { gallery_name = a } :: SharedImageVersionR s)

instance Lens.HasField "image_name" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (image_name :: SharedImageVersionR s -> TF.Expr s P.Text)
        (\s a -> s { image_name = a } :: SharedImageVersionR s)

instance Lens.HasField "location" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (location :: SharedImageVersionR s -> TF.Expr s P.Text)
        (\s a -> s { location = a } :: SharedImageVersionR s)

instance Lens.HasField "managed_image_id" f (P.Resource SharedImageVersionR s) (TF.Expr s TF.Id) where
    field = Lens.resourceLens P.. Lens.lens'
        (managed_image_id :: SharedImageVersionR s -> TF.Expr s TF.Id)
        (\s a -> s { managed_image_id = a } :: SharedImageVersionR s)

instance Lens.HasField "name" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (name :: SharedImageVersionR s -> TF.Expr s P.Text)
        (\s a -> s { name = a } :: SharedImageVersionR s)

instance Lens.HasField "resource_group_name" f (P.Resource SharedImageVersionR s) (TF.Expr s P.Text) where
    field = Lens.resourceLens P.. Lens.lens'
        (resource_group_name :: SharedImageVersionR s -> TF.Expr s P.Text)
        (\s a -> s { resource_group_name = a } :: SharedImageVersionR s)

instance Lens.HasField "tags" f (P.Resource SharedImageVersionR s) (P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text)))) where
    field = Lens.resourceLens P.. Lens.lens'
        (tags :: SharedImageVersionR s -> P.Maybe (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))))
        (\s a -> s { tags = a } :: SharedImageVersionR s)

instance Lens.HasField "target_region" f (P.Resource SharedImageVersionR s) (TF.Expr s [TF.Expr s (SharedImageVersionTargetRegion s)]) where
    field = Lens.resourceLens P.. Lens.lens'
        (target_region :: SharedImageVersionR s -> TF.Expr s [TF.Expr s (SharedImageVersionTargetRegion s)])
        (\s a -> s { target_region = a } :: SharedImageVersionR s)

instance Lens.HasField "id" (P.Const r) (TF.Ref SharedImageVersionR s) (TF.Expr s TF.Id) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "id"))

instance Lens.HasField "tags" (P.Const r) (TF.Ref SharedImageVersionR s) (TF.Expr s (P.Map P.Text (TF.Expr s P.Text))) where
    field = Lens.to (TF.unsafeComputed Encode.attribute (proxy# :: Proxy# "tags"))
...
newSnapshotR x =
    TF.unsafeResource "azurerm_snapshot"  Encode.lifecycle
        (\SnapshotR_Internal{..} ->
          P.mempty
...
newSqlActiveDirectoryAdministratorR =
    TF.unsafeResource "azurerm_sql_active_directory_administrator"  Encode.lifecycle
        (\SqlActiveDirectoryAdministratorR{..} ->
          P.mempty
       <> TF.pair "login" login
...
newSqlDatabaseR x =
    TF.unsafeResource "azurerm_sql_database"  Encode.lifecycle
...
newSqlElasticpoolR x =
    TF.unsafeResource "azurerm_sql_elasticpool"  Encode.lifecycle
...
newSqlFirewallRuleR =
    TF.unsafeResource "azurerm_sql_firewall_rule"  Encode.lifecycle
        (\SqlFirewallRuleR{..} ->
          P.mempty
...
newSqlServerR x =
    TF.unsafeResource "azurerm_sql_server"  Encode.lifecycle
        (\SqlServerR_Internal{..} ->
          P.mempty
...
newSqlVirtualNetworkRuleR x =
    TF.unsafeResource "azurerm_sql_virtual_network_rule"  Encode.lifecycle
...
newStorageAccountR x =
    TF.unsafeResource "azurerm_storage_account"  Encode.lifecycle
...
newStorageBlobR x =
    TF.unsafeResource "azurerm_storage_blob"  Encode.lifecycle
...
newStorageContainerR x =
    TF.unsafeResource "azurerm_storage_container"  Encode.lifecycle
...
newStorageQueueR =
    TF.unsafeResource "azurerm_storage_queue"  Encode.lifecycle
        (\StorageQueueR{..} ->
          P.mempty
       <> TF.pair "name" name
       <> TF.pair "resource_group_name" resource_group_name
...
newStorageShareR x =
    TF.unsafeResource "azurerm_storage_share"  Encode.lifecycle
...
newStorageTableR =
    TF.unsafeResource "azurerm_storage_table"  Encode.lifecycle
        (\StorageTableR{..} ->
          P.mempty
       <> TF.pair "name" name
       <> TF.pair "resource_group_name" resource_group_name
...
newSubnetR x =
    TF.unsafeResource "azurerm_subnet"  Encode.lifecycle
        (\SubnetR_Internal{..} ->
          P.mempty
       <> TF.pair "address_prefix" address_prefix
...
newTemplateDeploymentR x =
    TF.unsafeResource "azurerm_template_deployment"  Encode.lifecycle
...
newTrafficManagerEndpointR x =
    TF.unsafeResource "azurerm_traffic_manager_endpoint"  Encode.lifecycle
...
newTrafficManagerProfileR x =
    TF.unsafeResource "azurerm_traffic_manager_profile"  Encode.lifecycle
...
newUserAssignedIdentityR x =
    TF.unsafeResource "azurerm_user_assigned_identity"  Encode.lifecycle
...
newVirtualMachineDataDiskAttachmentR x =
    TF.unsafeResource "azurerm_virtual_machine_data_disk_attachment"  Encode.lifecycle
...
newVirtualMachineExtensionR x =
    TF.unsafeResource "azurerm_virtual_machine_extension"  Encode.lifecycle
...
newVirtualMachineR x =
    TF.unsafeResource "azurerm_virtual_machine"  Encode.lifecycle
...
newVirtualMachineScaleSetR x =
    TF.unsafeResource "azurerm_virtual_machine_scale_set"  Encode.lifecycle
...
newVirtualNetworkGatewayConnectionR x =
    TF.unsafeResource "azurerm_virtual_network_gateway_connection"  Encode.lifecycle
...
newVirtualNetworkGatewayR x =
    TF.unsafeResource "azurerm_virtual_network_gateway"  Encode.lifecycle
...
newVirtualNetworkPeeringR x =
    TF.unsafeResource "azurerm_virtual_network_peering"  Encode.lifecycle
...
newVirtualNetworkR x =
    TF.unsafeResource "azurerm_virtual_network"  Encode.lifecycle
