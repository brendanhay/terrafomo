...
data AppServicePlanResource s = AppServicePlanResource'
    ...
    --
    , _properties        :: TF.Attr s (AppServicePlanProperties s)
    -- ^ @properties@ - (Optional)
    --
    , _resourceGroupName :: TF.Attr s P.Text
    -- ^ @resource_group_name@ - (Required, Forces New)
...
appServicePlanResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (AppServicePlanSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
instance TF.IsValid (AppServicePlanResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_properties"
                  (_properties
                      :: AppServicePlanResource s -> TF.Attr s (AppServicePlanProperties s))
                  TF.validator
...
instance P.HasProperties (AppServicePlanResource s) (TF.Attr s (AppServicePlanProperties s)) where
    properties =
        P.lens (_properties :: AppServicePlanResource s -> TF.Attr s (AppServicePlanProperties s))
...
data AppServiceResource s = AppServiceResource'
    ...
    --
    , _connectionString :: TF.Attr s [TF.Attr s (AppServiceConnectionString s)]
    ...
    -- ^ @https_only@ - (Optional)
    --
    , _identity :: TF.Attr s (AppServiceIdentity s)
    -- ^ @identity@ - (Optional)
    --
    , _location :: TF.Attr s P.Text
    -- ^ @location@ - (Required, Forces New)
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _siteConfig :: TF.Attr s (AppServiceSiteConfig s)
...
instance TF.IsValid (AppServiceResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_identity"
                  (_identity
                      :: AppServiceResource s -> TF.Attr s (AppServiceIdentity s))
                  TF.validator
           P.<> TF.settingsValidator "_siteConfig"
                  (_siteConfig
                      :: AppServiceResource s -> TF.Attr s (AppServiceSiteConfig s))
                  TF.validator
...
instance P.HasConnectionString (AppServiceResource s) (TF.Attr s [TF.Attr s (AppServiceConnectionString s)]) where
    connectionString =
        P.lens (_connectionString :: AppServiceResource s -> TF.Attr s [TF.Attr s (AppServiceConnectionString s)])
...
instance P.HasIdentity (AppServiceResource s) (TF.Attr s (AppServiceIdentity s)) where
    identity =
        P.lens (_identity :: AppServiceResource s -> TF.Attr s (AppServiceIdentity s))
...
instance P.HasSiteConfig (AppServiceResource s) (TF.Attr s (AppServiceSiteConfig s)) where
    siteConfig =
        P.lens (_siteConfig :: AppServiceResource s -> TF.Attr s (AppServiceSiteConfig s))
...
data AppServiceSlotResource s = AppServiceSlotResource'
    ...
    -- ^ @client_affinity_enabled@ - (Optional)
    --
    , _connectionString :: TF.Attr s [TF.Attr s (AppServiceSlotConnectionString s)]
    -- ^ @connection_string@ - (Optional)
    --
    , _enabled :: TF.Attr s P.Bool
    -- ^ @enabled@ - (Optional)
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _siteConfig :: TF.Attr s (AppServiceSlotSiteConfig s)
    -- ^ @site_config@ - (Optional)
    --
    , _tags :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance TF.IsValid (AppServiceSlotResource s) where
    validator = P.mempty
           ...
           P.<> TF.settingsValidator "_siteConfig"
                  (_siteConfig
                      :: AppServiceSlotResource s -> TF.Attr s (AppServiceSlotSiteConfig s))
                  TF.validator
...
instance P.HasConnectionString (AppServiceSlotResource s) (TF.Attr s [TF.Attr s (AppServiceSlotConnectionString s)]) where
    connectionString =
        P.lens (_connectionString :: AppServiceSlotResource s -> TF.Attr s [TF.Attr s (AppServiceSlotConnectionString s)])
...
instance P.HasSiteConfig (AppServiceSlotResource s) (TF.Attr s (AppServiceSlotSiteConfig s)) where
    siteConfig =
        P.lens (_siteConfig :: AppServiceSlotResource s -> TF.Attr s (AppServiceSlotSiteConfig s))
...
applicationGatewayResource
    :: TF.Attr s (P.NonEmpty (TF.Attr s (ApplicationGatewayFrontendIpConfiguration s))) -- ^ @frontend_ip_configuration@ ('P._frontendIpConfiguration', 'P.frontendIpConfiguration')
    -> TF.Attr s [TF.Attr s (ApplicationGatewayGatewayIpConfiguration s)] -- ^ @gateway_ip_configuration@ ('P._gatewayIpConfiguration', 'P.gatewayIpConfiguration')
    -> TF.Attr s [TF.Attr s (ApplicationGatewayHttpListener s)] -- ^ @http_listener@ ('P._httpListener', 'P.httpListener')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (ApplicationGatewayBackendAddressPool s)] -- ^ @backend_address_pool@ ('P._backendAddressPool', 'P.backendAddressPool')
    -> TF.Attr s [TF.Attr s (ApplicationGatewayFrontendPort s)] -- ^ @frontend_port@ ('P._frontendPort', 'P.frontendPort')
    -> TF.Attr s (P.NonEmpty (TF.Attr s (ApplicationGatewayRequestRoutingRule s))) -- ^ @request_routing_rule@ ('P._requestRoutingRule', 'P.requestRoutingRule')
    -> TF.Attr s (P.NonEmpty (TF.Attr s (ApplicationGatewayBackendHttpSettings s))) -- ^ @backend_http_settings@ ('P._backendHttpSettings', 'P.backendHttpSettings')
    -> TF.Attr s (ApplicationGatewaySku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
automationAccountResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (AutomationAccountSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
automationRunbookResource
    :: TF.Attr s (AutomationRunbookPublishContentLink s) -- ^ @publish_content_link@ ('P._publishContentLink', 'P.publishContentLink')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @account_name@ ('P._accountName', 'P.accountName')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
...
autoscaleSettingResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (AutoscaleSettingProfile s)] -- ^ @profile@ ('P._profile', 'P.profile')
...
cdnEndpointResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (CdnEndpointOrigin s)] -- ^ @origin@ ('P._origin', 'P.origin')
...
containerGroupResource
    :: TF.Attr s [TF.Attr s (ContainerGroupContainer s)] -- ^ @container@ ('P._container', 'P.container')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
...
containerServiceResource
    ...
    -> TF.Attr s (ContainerServiceAgentPoolProfile s) -- ^ @agent_pool_profile@ ('P._agentPoolProfile', 'P.agentPoolProfile')
    -> TF.Attr s (ContainerServiceDiagnosticsProfile s) -- ^ @diagnostics_profile@ ('P._diagnosticsProfile', 'P.diagnosticsProfile')
    -> TF.Attr s (ContainerServiceLinuxProfile s) -- ^ @linux_profile@ ('P._linuxProfile', 'P.linuxProfile')
    -> TF.Attr s (ContainerServiceMasterProfile s) -- ^ @master_profile@ ('P._masterProfile', 'P.masterProfile')
...
data CosmosdbAccountResource s = CosmosdbAccountResource'
    ...
    --
    , _geoLocation :: TF.Attr s [TF.Attr s (CosmosdbAccountGeoLocation s)]
...
cosmosdbAccountResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (CosmosdbAccountConsistencyPolicy s) -- ^ @consistency_policy@ ('P._consistencyPolicy', 'P.consistencyPolicy')
...
instance P.HasGeoLocation (CosmosdbAccountResource s) (TF.Attr s [TF.Attr s (CosmosdbAccountGeoLocation s)]) where
    geoLocation =
        P.lens (_geoLocation :: CosmosdbAccountResource s -> TF.Attr s [TF.Attr s (CosmosdbAccountGeoLocation s)])
...
dnsCaaRecordResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @zone_name@ ('P._zoneName', 'P.zoneName')
    -> TF.Attr s [TF.Attr s (DnsCaaRecordRecord s)] -- ^ @record@ ('P._record', 'P.record')
    -> TF.Attr s P.Int -- ^ @ttl@ ('P._ttl', 'P.ttl')
...
dnsMxRecordResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @zone_name@ ('P._zoneName', 'P.zoneName')
    -> TF.Attr s [TF.Attr s (DnsMxRecordRecord s)] -- ^ @record@ ('P._record', 'P.record')
    -> TF.Attr s P.Int -- ^ @ttl@ ('P._ttl', 'P.ttl')
...
dnsSrvRecordResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @zone_name@ ('P._zoneName', 'P.zoneName')
    -> TF.Attr s [TF.Attr s (DnsSrvRecordRecord s)] -- ^ @record@ ('P._record', 'P.record')
    -> TF.Attr s P.Int -- ^ @ttl@ ('P._ttl', 'P.ttl')
...
dnsTxtRecordResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @zone_name@ ('P._zoneName', 'P.zoneName')
    -> TF.Attr s [TF.Attr s (DnsTxtRecordRecord s)] -- ^ @record@ ('P._record', 'P.record')
    -> TF.Attr s P.Int -- ^ @ttl@ ('P._ttl', 'P.ttl')
...
expressRouteCircuitResource
    ...
    -> TF.Attr s (ExpressRouteCircuitSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
data FunctionAppResource s = FunctionAppResource'
    ...
    -- ^ @client_affinity_enabled@ - (Optional)
    --
    , _connectionString :: TF.Attr s [TF.Attr s (FunctionAppConnectionString s)]
    -- ^ @connection_string@ - (Optional)
    --
    , _enabled :: TF.Attr s P.Bool
    -- ^ @enabled@ - (Optional)
    ...
    -- ^ @https_only@ - (Optional)
    --
    , _identity :: TF.Attr s (FunctionAppIdentity s)
    -- ^ @identity@ - (Optional)
    --
    , _location :: TF.Attr s P.Text
    -- ^ @location@ - (Required, Forces New)
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _siteConfig :: TF.Attr s (FunctionAppSiteConfig s)
    -- ^ @site_config@ - (Optional)
    --
...
instance TF.IsValid (FunctionAppResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_identity"
                  (_identity
                      :: FunctionAppResource s -> TF.Attr s (FunctionAppIdentity s))
                  TF.validator
           P.<> TF.settingsValidator "_siteConfig"
                  (_siteConfig
                      :: FunctionAppResource s -> TF.Attr s (FunctionAppSiteConfig s))
                  TF.validator
...
instance P.HasConnectionString (FunctionAppResource s) (TF.Attr s [TF.Attr s (FunctionAppConnectionString s)]) where
    connectionString =
        P.lens (_connectionString :: FunctionAppResource s -> TF.Attr s [TF.Attr s (FunctionAppConnectionString s)])
...
instance P.HasIdentity (FunctionAppResource s) (TF.Attr s (FunctionAppIdentity s)) where
    identity =
        P.lens (_identity :: FunctionAppResource s -> TF.Attr s (FunctionAppIdentity s))
...
instance P.HasSiteConfig (FunctionAppResource s) (TF.Attr s (FunctionAppSiteConfig s)) where
    siteConfig =
        P.lens (_siteConfig :: FunctionAppResource s -> TF.Attr s (FunctionAppSiteConfig s))
...
iothubResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (IothubSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
keyVaultCertificateResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s (KeyVaultCertificateCertificatePolicy s) -- ^ @certificate_policy@ ('P._certificatePolicy', 'P.certificatePolicy')
...
data KeyVaultResource s = KeyVaultResource'
    { _accessPolicy :: TF.Attr s [TF.Attr s (KeyVaultAccessPolicy s)]
...
keyVaultResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (KeyVaultSku s)] -- ^ @sku@ ('P._sku', 'P.sku')
...
instance P.HasAccessPolicy (KeyVaultResource s) (TF.Attr s [TF.Attr s (KeyVaultAccessPolicy s)]) where
    accessPolicy =
        P.lens (_accessPolicy :: KeyVaultResource s -> TF.Attr s [TF.Attr s (KeyVaultAccessPolicy s)])
...
data KubernetesClusterResource s = KubernetesClusterResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _networkProfile    :: TF.Attr s (KubernetesClusterNetworkProfile s)
...
kubernetesClusterResource
    ...
    -> TF.Attr s (KubernetesClusterServicePrincipal s) -- ^ @service_principal@ ('P._servicePrincipal', 'P.servicePrincipal')
    -> TF.Attr s (KubernetesClusterAgentPoolProfile s) -- ^ @agent_pool_profile@ ('P._agentPoolProfile', 'P.agentPoolProfile')
    -> TF.Attr s (KubernetesClusterLinuxProfile s) -- ^ @linux_profile@ ('P._linuxProfile', 'P.linuxProfile')
...
instance TF.IsValid (KubernetesClusterResource s) where
    validator = P.mempty
           ...
           P.<> TF.settingsValidator "_networkProfile"
                  (_networkProfile
                      :: KubernetesClusterResource s -> TF.Attr s (KubernetesClusterNetworkProfile s))
                  TF.validator
           P.<> TF.settingsValidator "_servicePrincipal"
                  (_servicePrincipal
...
instance P.HasNetworkProfile (KubernetesClusterResource s) (TF.Attr s (KubernetesClusterNetworkProfile s)) where
    networkProfile =
        P.lens (_networkProfile :: KubernetesClusterResource s -> TF.Attr s (KubernetesClusterNetworkProfile s))
