...
instance P.HasLocation (NetworkSecurityGroupResource s) (TF.Attr s P.Text) where
    location =
        P.lens (_location :: NetworkSecurityGroupResource s -> TF.Attr s P.Text)
               (\s a -> s { _location = a
                          } :: NetworkSecurityGroupResource s)
...
data NetworkSecurityRuleResource s = NetworkSecurityRuleResource'
    ...
    , _destinationAddressPrefixes :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    , _destinationPortRanges :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    , _sourceAddressPrefixes :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    --
    -- * 'sourcePortRanges'
    , _sourcePortRanges :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance P.HasDestinationAddressPrefix (NetworkSecurityRuleResource s) (TF.Attr s P.Text) where
    destinationAddressPrefix =
        P.lens (_destinationAddressPrefix :: NetworkSecurityRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _destinationAddressPrefix = a
                          , _destinationAddressPrefixes = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasDestinationAddressPrefixes (NetworkSecurityRuleResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    destinationAddressPrefixes =
        P.lens (_destinationAddressPrefixes :: NetworkSecurityRuleResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _destinationAddressPrefixes = a
                          , _destinationAddressPrefix = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasDestinationApplicationSecurityGroupIds (NetworkSecurityRuleResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    destinationApplicationSecurityGroupIds =
        P.lens (_destinationApplicationSecurityGroupIds :: NetworkSecurityRuleResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasDestinationPortRange (NetworkSecurityRuleResource s) (TF.Attr s P.Text) where
    destinationPortRange =
        P.lens (_destinationPortRange :: NetworkSecurityRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _destinationPortRange = a
                          , _destinationPortRanges = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasDestinationPortRanges (NetworkSecurityRuleResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    destinationPortRanges =
        P.lens (_destinationPortRanges :: NetworkSecurityRuleResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _destinationPortRanges = a
                          , _destinationPortRange = TF.Nil
                          } :: NetworkSecurityRuleResource s)
...
instance P.HasNetworkSecurityGroupName (NetworkSecurityRuleResource s) (TF.Attr s P.Text) where
    networkSecurityGroupName =
        P.lens (_networkSecurityGroupName :: NetworkSecurityRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _networkSecurityGroupName = a
                          } :: NetworkSecurityRuleResource s)
...
instance P.HasSourceAddressPrefix (NetworkSecurityRuleResource s) (TF.Attr s P.Text) where
    sourceAddressPrefix =
        P.lens (_sourceAddressPrefix :: NetworkSecurityRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _sourceAddressPrefix = a
                          , _sourceAddressPrefixes = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasSourceAddressPrefixes (NetworkSecurityRuleResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    sourceAddressPrefixes =
        P.lens (_sourceAddressPrefixes :: NetworkSecurityRuleResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _sourceAddressPrefixes = a
                          , _sourceAddressPrefix = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasSourceApplicationSecurityGroupIds (NetworkSecurityRuleResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    sourceApplicationSecurityGroupIds =
        P.lens (_sourceApplicationSecurityGroupIds :: NetworkSecurityRuleResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
...
instance P.HasSourcePortRange (NetworkSecurityRuleResource s) (TF.Attr s P.Text) where
    sourcePortRange =
        P.lens (_sourcePortRange :: NetworkSecurityRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _sourcePortRange = a
                          , _sourcePortRanges = TF.Nil
                          } :: NetworkSecurityRuleResource s)

instance P.HasSourcePortRanges (NetworkSecurityRuleResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    sourcePortRanges =
        P.lens (_sourcePortRanges :: NetworkSecurityRuleResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _sourcePortRanges = a
                          , _sourcePortRange = TF.Nil
                          } :: NetworkSecurityRuleResource s)
...
instance P.HasApnsCredential (NotificationHubResource s) (TF.Attr s [ApnsCredential s]) where
    apnsCredential =
        P.lens (_apnsCredential :: NotificationHubResource s -> TF.Attr s [ApnsCredential s])
               (\s a -> s { _apnsCredential = a
                          } :: NotificationHubResource s)
...
instance P.HasListen (NotificationHubAuthorizationRuleResource s) (TF.Attr s P.Bool) where
    listen =
        P.lens (_listen :: NotificationHubAuthorizationRuleResource s -> TF.Attr s P.Bool)
               (\s a -> s { _listen = a
                          } :: NotificationHubAuthorizationRuleResource s)
...
instance P.HasEnabled (NotificationHubNamespaceResource s) (TF.Attr s P.Bool) where
    enabled =
        P.lens (_enabled :: NotificationHubNamespaceResource s -> TF.Attr s P.Bool)
               (\s a -> s { _enabled = a
                          } :: NotificationHubNamespaceResource s)
...
instance P.HasFilter (PacketCaptureResource s) (TF.Attr s [Filter s]) where
    filter =
        P.lens (_filter :: PacketCaptureResource s -> TF.Attr s [Filter s])
               (\s a -> s { _filter = a
                          } :: PacketCaptureResource s)
...
instance P.HasMaximumBytesPerPacket (PacketCaptureResource s) (TF.Attr s P.Integer) where
    maximumBytesPerPacket =
        P.lens (_maximumBytesPerPacket :: PacketCaptureResource s -> TF.Attr s P.Integer)
               (\s a -> s { _maximumBytesPerPacket = a
                          } :: PacketCaptureResource s)
...
instance P.HasMaximumBytesPerSession (PacketCaptureResource s) (TF.Attr s P.Integer) where
    maximumBytesPerSession =
        P.lens (_maximumBytesPerSession :: PacketCaptureResource s -> TF.Attr s P.Integer)
               (\s a -> s { _maximumBytesPerSession = a
                          } :: PacketCaptureResource s)
...
instance P.HasMaximumCaptureDuration (PacketCaptureResource s) (TF.Attr s P.Integer) where
    maximumCaptureDuration =
        P.lens (_maximumCaptureDuration :: PacketCaptureResource s -> TF.Attr s P.Integer)
               (\s a -> s { _maximumCaptureDuration = a
                          } :: PacketCaptureResource s)
...
instance P.HasName (PostgresqlConfigurationResource s) (TF.Attr s P.Text) where
    name =
        P.lens (_name :: PostgresqlConfigurationResource s -> TF.Attr s P.Text)
               (\s a -> s { _name = a
                          } :: PostgresqlConfigurationResource s)
    ...
    endIpAddress =
        P.lens (_endIpAddress :: PostgresqlFirewallRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _endIpAddress = a
                          } :: PostgresqlFirewallRuleResource s)
...
instance P.HasPublicIpAddressAllocation (PublicIpResource s) (TF.Attr s P.Text) where
    publicIpAddressAllocation =
        P.lens (_publicIpAddressAllocation :: PublicIpResource s -> TF.Attr s P.Text)
               (\s a -> s { _publicIpAddressAllocation = a
                          } :: PublicIpResource s)
...
instance P.HasZones (PublicIpResource s) (TF.Attr s [TF.Attr s P.Text]) where
    zones =
        P.lens (_zones :: PublicIpResource s -> TF.Attr s [TF.Attr s P.Text])
               (\s a -> s { _zones = a
                          } :: PublicIpResource s)
...
instance P.HasLocation (RecoveryServicesVaultResource s) (TF.Attr s P.Text) where
    location =
        P.lens (_location :: RecoveryServicesVaultResource s -> TF.Attr s P.Text)
               (\s a -> s { _location = a
                          } :: RecoveryServicesVaultResource s)
...
data RedisCacheResource s = RedisCacheResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _patchSchedule      :: TF.Attr s [PatchSchedule s]
...
instance P.HasPatchSchedule (RedisCacheResource s) (TF.Attr s [PatchSchedule s]) where
    patchSchedule =
        P.lens (_patchSchedule :: RedisCacheResource s -> TF.Attr s [PatchSchedule s])
               (\s a -> s { _patchSchedule = a
                          } :: RedisCacheResource s)
...
instance P.HasPrincipalId (RoleAssignmentResource s) (TF.Attr s P.Text) where
    principalId =
        P.lens (_principalId :: RoleAssignmentResource s -> TF.Attr s P.Text)
               (\s a -> s { _principalId = a
                          } :: RoleAssignmentResource s)
...
instance P.HasAssignableScopes (RoleDefinitionResource s) (TF.Attr s [TF.Attr s P.Text]) where
    assignableScopes =
        P.lens (_assignableScopes :: RoleDefinitionResource s -> TF.Attr s [TF.Attr s P.Text])
               (\s a -> s { _assignableScopes = a
                          } :: RoleDefinitionResource s)
...
instance P.HasPermissions (RoleDefinitionResource s) (TF.Attr s [Permissions s]) where
    permissions =
        P.lens (_permissions :: RoleDefinitionResource s -> TF.Attr s [Permissions s])
...
instance P.HasDisableBgpRoutePropagation (RouteTableResource s) (TF.Attr s P.Bool) where
    disableBgpRoutePropagation =
        P.lens (_disableBgpRoutePropagation :: RouteTableResource s -> TF.Attr s P.Bool)
               (\s a -> s { _disableBgpRoutePropagation = a
...
instance s ~ s' => P.HasComputedSubnets (TF.Ref s' (RouteTableResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
data SchedulerJobResource s = SchedulerJobResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _recurrence              :: TF.Attr s (P.NonEmpty (Recurrence s))
    -- ^ @recurrence@ - (Optional)
    --
    , _resourceGroupName       :: TF.Attr s P.Text
    -- ^ @resource_group_name@ - (Required)
...
instance P.HasActionStorageQueue (SchedulerJobResource s) (TF.Attr s [ActionStorageQueue s]) where
    actionStorageQueue =
        P.lens (_actionStorageQueue :: SchedulerJobResource s -> TF.Attr s [ActionStorageQueue s])
               (\s a -> s { _actionStorageQueue = a
                          , _actionWeb = TF.Nil
                          } :: SchedulerJobResource s)
...
instance P.HasErrorActionStorageQueue (SchedulerJobResource s) (TF.Attr s [ErrorActionStorageQueue s]) where
    errorActionStorageQueue =
        P.lens (_errorActionStorageQueue :: SchedulerJobResource s -> TF.Attr s [ErrorActionStorageQueue s])
               (\s a -> s { _errorActionStorageQueue = a
                          , _errorActionWeb = TF.Nil
                          } :: SchedulerJobResource s)
...
instance P.HasRecurrence (SchedulerJobResource s) (TF.Attr s (P.NonEmpty (Recurrence s))) where
    recurrence =
        P.lens (_recurrence :: SchedulerJobResource s -> TF.Attr s (P.NonEmpty (Recurrence s)))
               (\s a -> s { _recurrence = a
                          } :: SchedulerJobResource s)
...
instance P.HasLocation (SchedulerJobCollectionResource s) (TF.Attr s P.Text) where
    location =
        P.lens (_location :: SchedulerJobCollectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _location = a
                          } :: SchedulerJobCollectionResource s)
...
data ServiceFabricClusterResource s = ServiceFabricClusterResource'
    { _addOnFeatures               :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    --
    , _fabricSettings              :: TF.Attr s [FabricSettings s]
    ...
    -- ^ @name@ - (Required)
    --
    , _nodeType                    :: TF.Attr s [NodeType s]
    -- ^ @node_type@ - (Required)
    --
...
serviceFabricClusterResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ - 'P.name'
    -> TF.Attr s [NodeType s] -- ^ @node_type@ - 'P.nodeType'
...
instance P.HasAddOnFeatures (ServiceFabricClusterResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    addOnFeatures =
        P.lens (_addOnFeatures :: ServiceFabricClusterResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _addOnFeatures = a
                          } :: ServiceFabricClusterResource s)
...
instance P.HasClientCertificateThumbprint (ServiceFabricClusterResource s) (TF.Attr s [ClientCertificateThumbprint s]) where
    clientCertificateThumbprint =
        P.lens (_clientCertificateThumbprint :: ServiceFabricClusterResource s -> TF.Attr s [ClientCertificateThumbprint s])
               (\s a -> s { _clientCertificateThumbprint = a
                          } :: ServiceFabricClusterResource s)
...
instance P.HasDiagnosticsConfig (ServiceFabricClusterResource s) (TF.Attr s [DiagnosticsConfig s]) where
    diagnosticsConfig =
        P.lens (_diagnosticsConfig :: ServiceFabricClusterResource s -> TF.Attr s [DiagnosticsConfig s])
               (\s a -> s { _diagnosticsConfig = a
                          } :: ServiceFabricClusterResource s)

instance P.HasFabricSettings (ServiceFabricClusterResource s) (TF.Attr s [FabricSettings s]) where
    fabricSettings =
        P.lens (_fabricSettings :: ServiceFabricClusterResource s -> TF.Attr s [FabricSettings s])
               (\s a -> s { _fabricSettings = a
                          } :: ServiceFabricClusterResource s)
...
instance P.HasNodeType (ServiceFabricClusterResource s) (TF.Attr s [NodeType s]) where
    nodeType =
        P.lens (_nodeType :: ServiceFabricClusterResource s -> TF.Attr s [NodeType s])
               (\s a -> s { _nodeType = a
                          } :: ServiceFabricClusterResource s)
...
instance P.HasListen (ServicebusNamespaceAuthorizationRuleResource s) (TF.Attr s P.Bool) where
    listen =
        P.lens (_listen :: ServicebusNamespaceAuthorizationRuleResource s -> TF.Attr s P.Bool)
               (\s a -> s { _listen = a
                          } :: ServicebusNamespaceAuthorizationRuleResource s)
...
instance P.HasDeadLetteringOnMessageExpiration (ServicebusQueueResource s) (TF.Attr s P.Bool) where
    deadLetteringOnMessageExpiration =
        P.lens (_deadLetteringOnMessageExpiration :: ServicebusQueueResource s -> TF.Attr s P.Bool)
               (\s a -> s { _deadLetteringOnMessageExpiration = a
                          } :: ServicebusQueueResource s)
...
instance P.HasEnableBatchedOperations (ServicebusQueueResource s) (TF.Attr s P.Bool) where
    enableBatchedOperations =
        P.lens (_enableBatchedOperations :: ServicebusQueueResource s -> TF.Attr s P.Bool)
               (\s a -> s { _enableBatchedOperations = a
                          } :: ServicebusQueueResource s)
...
instance P.HasRequiresDuplicateDetection (ServicebusQueueResource s) (TF.Attr s P.Bool) where
    requiresDuplicateDetection =
        P.lens (_requiresDuplicateDetection :: ServicebusQueueResource s -> TF.Attr s P.Bool)
               (\s a -> s { _requiresDuplicateDetection = a
                          } :: ServicebusQueueResource s)
...
instance P.HasListen (ServicebusQueueAuthorizationRuleResource s) (TF.Attr s P.Bool) where
    listen =
        P.lens (_listen :: ServicebusQueueAuthorizationRuleResource s -> TF.Attr s P.Bool)
               (\s a -> s { _listen = a
                          } :: ServicebusQueueAuthorizationRuleResource s)
...
instance P.HasDeadLetteringOnFilterEvaluationExceptions (ServicebusSubscriptionResource s) (TF.Attr s P.Bool) where
    deadLetteringOnFilterEvaluationExceptions =
        P.lens (_deadLetteringOnFilterEvaluationExceptions :: ServicebusSubscriptionResource s -> TF.Attr s P.Bool)
               (\s a -> s { _deadLetteringOnFilterEvaluationExceptions = a
                          } :: ServicebusSubscriptionResource s)
...
instance P.HasAction (ServicebusSubscriptionRuleResource s) (TF.Attr s P.Text) where
    action =
        P.lens (_action :: ServicebusSubscriptionRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _action = a
                          } :: ServicebusSubscriptionRuleResource s)
...
instance P.HasEnableFilteringMessagesBeforePublishing (ServicebusTopicResource s) (TF.Attr s P.Bool) where
    enableFilteringMessagesBeforePublishing =
        P.lens (_enableFilteringMessagesBeforePublishing :: ServicebusTopicResource s -> TF.Attr s P.Bool)
               (\s a -> s { _enableFilteringMessagesBeforePublishing = a
                          } :: ServicebusTopicResource s)
...
instance P.HasListen (ServicebusTopicAuthorizationRuleResource s) (TF.Attr s P.Bool) where
    listen =
        P.lens (_listen :: ServicebusTopicAuthorizationRuleResource s -> TF.Attr s P.Bool)
               (\s a -> s { _listen = a
                          } :: ServicebusTopicAuthorizationRuleResource s)
...
instance P.HasLogin (SqlActiveDirectoryAdministratorResource s) (TF.Attr s P.Text) where
    login =
        P.lens (_login :: SqlActiveDirectoryAdministratorResource s -> TF.Attr s P.Text)
               (\s a -> s { _login = a
                          } :: SqlActiveDirectoryAdministratorResource s)
...
instance P.HasIgnoreMissingVnetServiceEndpoint (SqlVirtualNetworkRuleResource s) (TF.Attr s P.Bool) where
    ignoreMissingVnetServiceEndpoint =
        P.lens (_ignoreMissingVnetServiceEndpoint :: SqlVirtualNetworkRuleResource s -> TF.Attr s P.Bool)
               (\s a -> s { _ignoreMissingVnetServiceEndpoint = a
                          } :: SqlVirtualNetworkRuleResource s)
...
instance P.HasAccountEncryptionSource (StorageAccountResource s) (TF.Attr s P.Text) where
    accountEncryptionSource =
        P.lens (_accountEncryptionSource :: StorageAccountResource s -> TF.Attr s P.Text)
               (\s a -> s { _accountEncryptionSource = a
                          } :: StorageAccountResource s)
...
instance P.HasAccountReplicationType (StorageAccountResource s) (TF.Attr s P.Text) where
    accountReplicationType =
        P.lens (_accountReplicationType :: StorageAccountResource s -> TF.Attr s P.Text)
               (\s a -> s { _accountReplicationType = a
                          } :: StorageAccountResource s)
...
instance P.HasEnableHttpsTrafficOnly (StorageAccountResource s) (TF.Attr s P.Bool) where
    enableHttpsTrafficOnly =
        P.lens (_enableHttpsTrafficOnly :: StorageAccountResource s -> TF.Attr s P.Bool)
               (\s a -> s { _enableHttpsTrafficOnly = a
                          } :: StorageAccountResource s)
...
instance s ~ s' => P.HasComputedAccountType (TF.Ref s' (StorageAccountResource s)) (TF.Attr s P.Text) where
    computedAccountType x = TF.compute (TF.refKey x) "account_type"
...
instance s ~ s' => P.HasComputedIpConfigurations (TF.Ref s' (SubnetResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance P.HasGeoMappings (TrafficManagerEndpointResource s) (TF.Attr s [TF.Attr s P.Text]) where
    geoMappings =
        P.lens (_geoMappings :: TrafficManagerEndpointResource s -> TF.Attr s [TF.Attr s P.Text])
               (\s a -> s { _geoMappings = a
                          } :: TrafficManagerEndpointResource s)
...
instance P.HasDnsConfig (TrafficManagerProfileResource s) (TF.Attr s [TF.Attr s (DnsConfig s)]) where
    dnsConfig =
        P.lens (_dnsConfig :: TrafficManagerProfileResource s -> TF.Attr s [TF.Attr s (DnsConfig s)])
               (\s a -> s { _dnsConfig = a
                          } :: TrafficManagerProfileResource s)
...
instance P.HasLocation (UserAssignedIdentityResource s) (TF.Attr s P.Text) where
    location =
        P.lens (_location :: UserAssignedIdentityResource s -> TF.Attr s P.Text)
               (\s a -> s { _location = a
                          } :: UserAssignedIdentityResource s)
...
data VirtualMachineResource s = VirtualMachineResource'
    ...
    --
    , _osProfile :: TF.Attr s (TF.Attr s (OsProfile s))
    -- ^ @os_profile@ - (Optional)
    --
    , _osProfileLinuxConfig :: TF.Attr s (TF.Attr s (OsProfileLinuxConfig s))
    -- ^ @os_profile_linux_config@ - (Optional)
    --
    -- Conflicts with:
    --
    -- * 'osProfileWindowsConfig'
    , _osProfileSecrets :: TF.Attr s [OsProfileSecrets s]
    -- ^ @os_profile_secrets@ - (Optional)
    --
    , _osProfileWindowsConfig :: TF.Attr s (TF.Attr s (OsProfileWindowsConfig s))
...
instance P.HasDeleteDataDisksOnTermination (VirtualMachineResource s) (TF.Attr s P.Bool) where
    deleteDataDisksOnTermination =
        P.lens (_deleteDataDisksOnTermination :: VirtualMachineResource s -> TF.Attr s P.Bool)
               (\s a -> s { _deleteDataDisksOnTermination = a
                          } :: VirtualMachineResource s)
...
instance P.HasDeleteOsDiskOnTermination (VirtualMachineResource s) (TF.Attr s P.Bool) where
    deleteOsDiskOnTermination =
        P.lens (_deleteOsDiskOnTermination :: VirtualMachineResource s -> TF.Attr s P.Bool)
               (\s a -> s { _deleteOsDiskOnTermination = a
                          } :: VirtualMachineResource s)
...
instance P.HasNetworkInterfaceIds (VirtualMachineResource s) (TF.Attr s [TF.Attr s P.Text]) where
    networkInterfaceIds =
        P.lens (_networkInterfaceIds :: VirtualMachineResource s -> TF.Attr s [TF.Attr s P.Text])
               (\s a -> s { _networkInterfaceIds = a
                          } :: VirtualMachineResource s)

instance P.HasOsProfile (VirtualMachineResource s) (TF.Attr s (TF.Attr s (OsProfile s))) where
    osProfile =
        P.lens (_osProfile :: VirtualMachineResource s -> TF.Attr s (TF.Attr s (OsProfile s)))
               (\s a -> s { _osProfile = a
                          } :: VirtualMachineResource s)

instance P.HasOsProfileLinuxConfig (VirtualMachineResource s) (TF.Attr s (TF.Attr s (OsProfileLinuxConfig s))) where
    osProfileLinuxConfig =
        P.lens (_osProfileLinuxConfig :: VirtualMachineResource s -> TF.Attr s (TF.Attr s (OsProfileLinuxConfig s)))
               (\s a -> s { _osProfileLinuxConfig = a
                          , _osProfileWindowsConfig = TF.Nil
                          } :: VirtualMachineResource s)

instance P.HasOsProfileSecrets (VirtualMachineResource s) (TF.Attr s [OsProfileSecrets s]) where
    osProfileSecrets =
        P.lens (_osProfileSecrets :: VirtualMachineResource s -> TF.Attr s [OsProfileSecrets s])
               (\s a -> s { _osProfileSecrets = a
                          } :: VirtualMachineResource s)

instance P.HasOsProfileWindowsConfig (VirtualMachineResource s) (TF.Attr s (TF.Attr s (OsProfileWindowsConfig s))) where
    osProfileWindowsConfig =
        P.lens (_osProfileWindowsConfig :: VirtualMachineResource s -> TF.Attr s (TF.Attr s (OsProfileWindowsConfig s)))
               (\s a -> s { _osProfileWindowsConfig = a
                          , _osProfileLinuxConfig = TF.Nil
                          } :: VirtualMachineResource s)
...
instance P.HasPrimaryNetworkInterfaceId (VirtualMachineResource s) (TF.Attr s P.Text) where
    primaryNetworkInterfaceId =
        P.lens (_primaryNetworkInterfaceId :: VirtualMachineResource s -> TF.Attr s P.Text)
               (\s a -> s { _primaryNetworkInterfaceId = a
                          } :: VirtualMachineResource s)
...
instance P.HasZones (VirtualMachineResource s) (TF.Attr s [TF.Attr s P.Text]) where
    zones =
        P.lens (_zones :: VirtualMachineResource s -> TF.Attr s [TF.Attr s P.Text])
               (\s a -> s { _zones = a
                          } :: VirtualMachineResource s)
...
instance s ~ s' => P.HasComputedStorageDataDisk (TF.Ref s' (VirtualMachineResource s)) (TF.Attr s [StorageDataDisk s]) where
    computedStorageDataDisk x = TF.compute (TF.refKey x) "storage_data_disk"

instance s ~ s' => P.HasComputedStorageImageReference (TF.Ref s' (VirtualMachineResource s)) (TF.Attr s (TF.Attr s (StorageImageReference s))) where
...
instance P.HasCaching (VirtualMachineDataDiskAttachmentResource s) (TF.Attr s P.Text) where
    caching =
        P.lens (_caching :: VirtualMachineDataDiskAttachmentResource s -> TF.Attr s P.Text)
               (\s a -> s { _caching = a
                          } :: VirtualMachineDataDiskAttachmentResource s)
    ...
    autoUpgradeMinorVersion =
        P.lens (_autoUpgradeMinorVersion :: VirtualMachineExtensionResource s -> TF.Attr s P.Bool)
               (\s a -> s { _autoUpgradeMinorVersion = a
                          } :: VirtualMachineExtensionResource s)
...
data VirtualMachineScaleSetResource s = VirtualMachineScaleSetResource'
    ...
    --
    , _plan :: TF.Attr s (TF.Attr s (Plan s))
    -- ^ @plan@ - (Optional)
    --
    ...
    -- ^ @sku@ - (Required)
    --
    , _storageProfileDataDisk :: TF.Attr s [StorageProfileDataDisk s]
    -- ^ @storage_profile_data_disk@ - (Optional)
    --
    , _storageProfileOsDisk :: TF.Attr s (TF.Attr s (StorageProfileOsDisk s))
...
virtualMachineScaleSetResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ - 'P.resourceGroupName'
    -> TF.Attr s [Sku s] -- ^ @sku@ - 'P.sku'
    -> TF.Attr s (TF.Attr s (StorageProfileOsDisk s)) -- ^ @storage_profile_os_disk@ - 'P.storageProfileOsDisk'
...
instance P.HasBootDiagnostics (VirtualMachineScaleSetResource s) (TF.Attr s [BootDiagnostics s]) where
    bootDiagnostics =
        P.lens (_bootDiagnostics :: VirtualMachineScaleSetResource s -> TF.Attr s [BootDiagnostics s])
               (\s a -> s { _bootDiagnostics = a
                          } :: VirtualMachineScaleSetResource s)
...
instance P.HasOsProfileWindowsConfig (VirtualMachineScaleSetResource s) (TF.Attr s (TF.Attr s (OsProfileWindowsConfig s))) where
    osProfileWindowsConfig =
        P.lens (_osProfileWindowsConfig :: VirtualMachineScaleSetResource s -> TF.Attr s (TF.Attr s (OsProfileWindowsConfig s)))
               (\s a -> s { _osProfileWindowsConfig = a
                          } :: VirtualMachineScaleSetResource s)
...
instance P.HasOverprovision (VirtualMachineScaleSetResource s) (TF.Attr s P.Bool) where
    overprovision =
        P.lens (_overprovision :: VirtualMachineScaleSetResource s -> TF.Attr s P.Bool)
               (\s a -> s { _overprovision = a
                          } :: VirtualMachineScaleSetResource s)

instance P.HasPlan (VirtualMachineScaleSetResource s) (TF.Attr s (TF.Attr s (Plan s))) where
    plan =
        P.lens (_plan :: VirtualMachineScaleSetResource s -> TF.Attr s (TF.Attr s (Plan s)))
               (\s a -> s { _plan = a
                          } :: VirtualMachineScaleSetResource s)
...
instance P.HasStorageProfileDataDisk (VirtualMachineScaleSetResource s) (TF.Attr s [StorageProfileDataDisk s]) where
    storageProfileDataDisk =
        P.lens (_storageProfileDataDisk :: VirtualMachineScaleSetResource s -> TF.Attr s [StorageProfileDataDisk s])
               (\s a -> s { _storageProfileDataDisk = a
                          } :: VirtualMachineScaleSetResource s)

instance P.HasStorageProfileOsDisk (VirtualMachineScaleSetResource s) (TF.Attr s (TF.Attr s (StorageProfileOsDisk s))) where
    storageProfileOsDisk =
        P.lens (_storageProfileOsDisk :: VirtualMachineScaleSetResource s -> TF.Attr s (TF.Attr s (StorageProfileOsDisk s)))
               (\s a -> s { _storageProfileOsDisk = a
                          } :: VirtualMachineScaleSetResource s)
...
instance s ~ s' => P.HasComputedOsProfileLinuxConfig (TF.Ref s' (VirtualMachineScaleSetResource s)) (TF.Attr s (TF.Attr s (OsProfileLinuxConfig s))) where
    computedOsProfileLinuxConfig x = TF.compute (TF.refKey x) "os_profile_linux_config"

instance s ~ s' => P.HasComputedStorageProfileImageReference (TF.Ref s' (VirtualMachineScaleSetResource s)) (TF.Attr s (TF.Attr s (StorageProfileImageReference s))) where
...
instance P.HasDefaultLocalNetworkGatewayId (VirtualNetworkGatewayResource s) (TF.Attr s P.Text) where
    defaultLocalNetworkGatewayId =
        P.lens (_defaultLocalNetworkGatewayId :: VirtualNetworkGatewayResource s -> TF.Attr s P.Text)
               (\s a -> s { _defaultLocalNetworkGatewayId = a
                          } :: VirtualNetworkGatewayResource s)

instance P.HasIpConfiguration (VirtualNetworkGatewayResource s) (TF.Attr s [IpConfiguration s]) where
    ipConfiguration =
        P.lens (_ipConfiguration :: VirtualNetworkGatewayResource s -> TF.Attr s [IpConfiguration s])
...
instance P.HasVpnClientConfiguration (VirtualNetworkGatewayResource s) (TF.Attr s [VpnClientConfiguration s]) where
    vpnClientConfiguration =
        P.lens (_vpnClientConfiguration :: VirtualNetworkGatewayResource s -> TF.Attr s [VpnClientConfiguration s])
               (\s a -> s { _vpnClientConfiguration = a
                          } :: VirtualNetworkGatewayResource s)
...
instance P.HasAuthorizationKey (VirtualNetworkGatewayConnectionResource s) (TF.Attr s P.Text) where
    authorizationKey =
        P.lens (_authorizationKey :: VirtualNetworkGatewayConnectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _authorizationKey = a
                          } :: VirtualNetworkGatewayConnectionResource s)
...
instance P.HasExpressRouteCircuitId (VirtualNetworkGatewayConnectionResource s) (TF.Attr s P.Text) where
    expressRouteCircuitId =
        P.lens (_expressRouteCircuitId :: VirtualNetworkGatewayConnectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _expressRouteCircuitId = a
                          } :: VirtualNetworkGatewayConnectionResource s)
...
instance P.HasLocalNetworkGatewayId (VirtualNetworkGatewayConnectionResource s) (TF.Attr s P.Text) where
    localNetworkGatewayId =
        P.lens (_localNetworkGatewayId :: VirtualNetworkGatewayConnectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _localNetworkGatewayId = a
                          } :: VirtualNetworkGatewayConnectionResource s)
...
instance P.HasPeerVirtualNetworkGatewayId (VirtualNetworkGatewayConnectionResource s) (TF.Attr s P.Text) where
    peerVirtualNetworkGatewayId =
        P.lens (_peerVirtualNetworkGatewayId :: VirtualNetworkGatewayConnectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _peerVirtualNetworkGatewayId = a
                          } :: VirtualNetworkGatewayConnectionResource s)
...
instance P.HasVirtualNetworkGatewayId (VirtualNetworkGatewayConnectionResource s) (TF.Attr s P.Text) where
    virtualNetworkGatewayId =
        P.lens (_virtualNetworkGatewayId :: VirtualNetworkGatewayConnectionResource s -> TF.Attr s P.Text)
               (\s a -> s { _virtualNetworkGatewayId = a
                          } :: VirtualNetworkGatewayConnectionResource s)
...
instance P.HasName (VirtualNetworkPeeringResource s) (TF.Attr s P.Text) where
    name =
        P.lens (_name :: VirtualNetworkPeeringResource s -> TF.Attr s P.Text)
               (\s a -> s { _name = a
                          } :: VirtualNetworkPeeringResource s)
...
instance P.HasRemoteVirtualNetworkId (VirtualNetworkPeeringResource s) (TF.Attr s P.Text) where
    remoteVirtualNetworkId =
        P.lens (_remoteVirtualNetworkId :: VirtualNetworkPeeringResource s -> TF.Attr s P.Text)
               (\s a -> s { _remoteVirtualNetworkId = a
                          } :: VirtualNetworkPeeringResource s)
