...
logAnalyticsSolutionResource
    ...
    -> TF.Attr s (LogAnalyticsSolutionPlan s) -- ^ @plan@ ('P._plan', 'P.plan')
...
data MetricAlertruleResource s = MetricAlertruleResource'
    ...
    --
    , _emailAction       :: TF.Attr s (MetricAlertruleEmailAction s)
    ...
    -- ^ @threshold@ - (Required)
    --
    , _webhookAction     :: TF.Attr s (MetricAlertruleWebhookAction s)
...
instance TF.IsValid (MetricAlertruleResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_emailAction"
                  (_emailAction
                      :: MetricAlertruleResource s -> TF.Attr s (MetricAlertruleEmailAction s))
                  TF.validator
           P.<> TF.settingsValidator "_webhookAction"
                  (_webhookAction
                      :: MetricAlertruleResource s -> TF.Attr s (MetricAlertruleWebhookAction s))
                  TF.validator
...
instance P.HasEmailAction (MetricAlertruleResource s) (TF.Attr s (MetricAlertruleEmailAction s)) where
    emailAction =
        P.lens (_emailAction :: MetricAlertruleResource s -> TF.Attr s (MetricAlertruleEmailAction s))
...
instance P.HasWebhookAction (MetricAlertruleResource s) (TF.Attr s (MetricAlertruleWebhookAction s)) where
    webhookAction =
        P.lens (_webhookAction :: MetricAlertruleResource s -> TF.Attr s (MetricAlertruleWebhookAction s))
...
mysqlServerResource
    ...
    -> TF.Attr s (MysqlServerStorageProfile s) -- ^ @storage_profile@ ('P._storageProfile', 'P.storageProfile')
    -> TF.Attr s (MysqlServerSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
networkInterfaceResource
    :: TF.Attr s [TF.Attr s (NetworkInterfaceIpConfiguration s)] -- ^ @ip_configuration@ ('P._ipConfiguration', 'P.ipConfiguration')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
...
data NetworkSecurityGroupResource s = NetworkSecurityGroupResource'
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _securityRule :: TF.Attr s [TF.Attr s (NetworkSecurityGroupSecurityRule s)]
...
instance P.HasSecurityRule (NetworkSecurityGroupResource s) (TF.Attr s [TF.Attr s (NetworkSecurityGroupSecurityRule s)]) where
    securityRule =
        P.lens (_securityRule :: NetworkSecurityGroupResource s -> TF.Attr s [TF.Attr s (NetworkSecurityGroupSecurityRule s)])
...
notificationHubNamespaceResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (NotificationHubNamespaceSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
packetCaptureResource
    ...
    -> TF.Attr s (PacketCaptureStorageLocation s) -- ^ @storage_location@ ('P._storageLocation', 'P.storageLocation')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
...
postgresqlServerResource
    ...
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @administrator_login_password@ ('P._administratorLoginPassword', 'P.administratorLoginPassword')
    -> TF.Attr s (PostgresqlServerStorageProfile s) -- ^ @storage_profile@ ('P._storageProfile', 'P.storageProfile')
    -> TF.Attr s (PostgresqlServerSku s) -- ^ @sku@ ('P._sku', 'P.sku')
    -> TF.Attr s P.Text -- ^ @version@ ('P._version', 'P.version')
...
redisCacheResource
    ...
    -> TF.Attr s (RedisCacheRedisConfiguration s) -- ^ @redis_configuration@ ('P._redisConfiguration', 'P.redisConfiguration')
...
relayNamespaceResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s (RelayNamespaceSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
roleDefinitionResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s [TF.Attr s (RoleDefinitionPermissions s)] -- ^ @permissions@ ('P._permissions', 'P.permissions')
    -> TF.Attr s P.Text -- ^ @scope@ ('P._scope', 'P.scope')
...
serviceFabricClusterResource
    ...
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (ServiceFabricClusterNodeType s)] -- ^ @node_type@ ('P._nodeType', 'P.nodeType')
...
data StorageAccountResource s = StorageAccountResource'
    ...
    --
    , _identity                :: TF.Attr s (StorageAccountIdentity s)
    -- ^ @identity@ - (Optional)
    --
    , _location                :: TF.Attr s P.Text
    -- ^ @location@ - (Required, Forces New)
...
instance TF.IsValid (StorageAccountResource s) where
    validator = P.mempty
           ...
           P.<> TF.settingsValidator "_identity"
                  (_identity
                      :: StorageAccountResource s -> TF.Attr s (StorageAccountIdentity s))
                  TF.validator
...
instance P.HasIdentity (StorageAccountResource s) (TF.Attr s (StorageAccountIdentity s)) where
    identity =
        P.lens (_identity :: StorageAccountResource s -> TF.Attr s (StorageAccountIdentity s))
...
trafficManagerProfileResource
    :: TF.Attr s [TF.Attr s (TrafficManagerProfileDnsConfig s)] -- ^ @dns_config@ ('P._dnsConfig', 'P.dnsConfig')
    -> TF.Attr s [TF.Attr s (TrafficManagerProfileMonitorConfig s)] -- ^ @monitor_config@ ('P._monitorConfig', 'P.monitorConfig')
...
data VirtualMachineResource s = VirtualMachineResource'
    ...
    --
    , _identity :: TF.Attr s (VirtualMachineIdentity s)
    -- ^ @identity@ - (Optional)
    --
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _storageDataDisk :: TF.Attr s [TF.Attr s (VirtualMachineStorageDataDisk s)]
    -- ^ @storage_data_disk@ - (Optional)
    --
    , _storageImageReference :: TF.Attr s (VirtualMachineStorageImageReference s)
...
virtualMachineResource
    :: TF.Attr s (VirtualMachineStorageOsDisk s) -- ^ @storage_os_disk@ ('P._storageOsDisk', 'P.storageOsDisk')
...
instance TF.IsValid (VirtualMachineResource s) where
    validator = TF.fieldsValidator (\VirtualMachineResource'{..} -> Map.fromList $ P.catMaybes
        ...
        , if (_osProfileWindowsConfig P.== TF.Nil)
           ...
           P.<> TF.settingsValidator "_identity"
                  (_identity
                      :: VirtualMachineResource s -> TF.Attr s (VirtualMachineIdentity s))
                  TF.validator
           ...
           P.<> TF.settingsValidator "_storageImageReference"
                  (_storageImageReference
                      :: VirtualMachineResource s -> TF.Attr s (VirtualMachineStorageImageReference s))
                  TF.validator
...
instance P.HasIdentity (VirtualMachineResource s) (TF.Attr s (VirtualMachineIdentity s)) where
    identity =
        P.lens (_identity :: VirtualMachineResource s -> TF.Attr s (VirtualMachineIdentity s))
...
instance P.HasStorageDataDisk (VirtualMachineResource s) (TF.Attr s [TF.Attr s (VirtualMachineStorageDataDisk s)]) where
    storageDataDisk =
        P.lens (_storageDataDisk :: VirtualMachineResource s -> TF.Attr s [TF.Attr s (VirtualMachineStorageDataDisk s)])
               (\s a -> s { _storageDataDisk = a } :: VirtualMachineResource s)

instance P.HasStorageImageReference (VirtualMachineResource s) (TF.Attr s (VirtualMachineStorageImageReference s)) where
    storageImageReference =
        P.lens (_storageImageReference :: VirtualMachineResource s -> TF.Attr s (VirtualMachineStorageImageReference s))
...
data VirtualMachineScaleSetResource s = VirtualMachineScaleSetResource'
    ...
    -- ^ @extension@ - (Optional)
    --
    , _identity :: TF.Attr s (VirtualMachineScaleSetIdentity s)
    -- ^ @identity@ - (Optional)
    --
    , _licenseType :: TF.Attr s P.Text
    -- ^ @license_type@ - (Optional)
    ...
    -- ^ @os_profile@ - (Required)
    --
    , _osProfileLinuxConfig :: TF.Attr s (VirtualMachineScaleSetOsProfileLinuxConfig s)
    -- ^ @os_profile_linux_config@ - (Optional)
    --
    ...
    --
    , _storageProfileImageReference :: TF.Attr s (VirtualMachineScaleSetStorageProfileImageReference s)
...
virtualMachineScaleSetResource
    :: TF.Attr s (VirtualMachineScaleSetStorageProfileOsDisk s) -- ^ @storage_profile_os_disk@ ('P._storageProfileOsDisk', 'P.storageProfileOsDisk')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @upgrade_policy_mode@ ('P._upgradePolicyMode', 'P.upgradePolicyMode')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s [TF.Attr s (VirtualMachineScaleSetNetworkProfile s)] -- ^ @network_profile@ ('P._networkProfile', 'P.networkProfile')
    -> TF.Attr s (VirtualMachineScaleSetOsProfile s) -- ^ @os_profile@ ('P._osProfile', 'P.osProfile')
    -> TF.Attr s (VirtualMachineScaleSetSku s) -- ^ @sku@ ('P._sku', 'P.sku')
...
instance TF.IsValid (VirtualMachineScaleSetResource s) where
    validator = P.mempty
           ...
           P.<> TF.settingsValidator "_identity"
                  (_identity
                      :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetIdentity s))
                  TF.validator
           P.<> TF.settingsValidator "_osProfile"
                  (_osProfile
           ...
           P.<> TF.settingsValidator "_osProfileLinuxConfig"
                  (_osProfileLinuxConfig
                      :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetOsProfileLinuxConfig s))
                  TF.validator
           P.<> TF.settingsValidator "_osProfileWindowsConfig"
                  (_osProfileWindowsConfig
           ...
           P.<> TF.settingsValidator "_storageProfileImageReference"
                  (_storageProfileImageReference
                      :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetStorageProfileImageReference s))
                  TF.validator
...
instance P.HasIdentity (VirtualMachineScaleSetResource s) (TF.Attr s (VirtualMachineScaleSetIdentity s)) where
    identity =
        P.lens (_identity :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetIdentity s))
...
instance P.HasOsProfileLinuxConfig (VirtualMachineScaleSetResource s) (TF.Attr s (VirtualMachineScaleSetOsProfileLinuxConfig s)) where
    osProfileLinuxConfig =
        P.lens (_osProfileLinuxConfig :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetOsProfileLinuxConfig s))
...
instance P.HasStorageProfileImageReference (VirtualMachineScaleSetResource s) (TF.Attr s (VirtualMachineScaleSetStorageProfileImageReference s)) where
    storageProfileImageReference =
        P.lens (_storageProfileImageReference :: VirtualMachineScaleSetResource s -> TF.Attr s (VirtualMachineScaleSetStorageProfileImageReference s))
...
data VirtualNetworkGatewayResource s = VirtualNetworkGatewayResource'
    ...
    --
    , _bgpSettings :: TF.Attr s (VirtualNetworkGatewayBgpSettings s)
    -- ^ @bgp_settings@ - (Optional)
    --
...
virtualNetworkGatewayResource
    :: TF.Attr s [TF.Attr s (VirtualNetworkGatewayIpConfiguration s)] -- ^ @ip_configuration@ ('P._ipConfiguration', 'P.ipConfiguration')
    -> TF.Attr s P.Text -- ^ @location@ ('P._location', 'P.location')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @resource_group_name@ ('P._resourceGroupName', 'P.resourceGroupName')
    -> TF.Attr s P.Text -- ^ @sku@ ('P._sku', 'P.sku')
...
instance TF.IsValid (VirtualNetworkGatewayResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_bgpSettings"
                  (_bgpSettings
                      :: VirtualNetworkGatewayResource s -> TF.Attr s (VirtualNetworkGatewayBgpSettings s))
                  TF.validator
...
instance P.HasBgpSettings (VirtualNetworkGatewayResource s) (TF.Attr s (VirtualNetworkGatewayBgpSettings s)) where
    bgpSettings =
        P.lens (_bgpSettings :: VirtualNetworkGatewayResource s -> TF.Attr s (VirtualNetworkGatewayBgpSettings s))
...
data VirtualNetworkResource s = VirtualNetworkResource'
    ...
    -- ^ @resource_group_name@ - (Required, Forces New)
    --
    , _subnet            :: TF.Attr s [TF.Attr s (VirtualNetworkSubnet s)]
    -- ^ @subnet@ - (Optional)
    --
    , _tags              :: TF.Attr s (P.Map P.Text (TF.Attr s P.Text))
    -- ^ @tags@ - (Optional)
...
instance P.HasSubnet (VirtualNetworkResource s) (TF.Attr s [TF.Attr s (VirtualNetworkSubnet s)]) where
    subnet =
        P.lens (_subnet :: VirtualNetworkResource s -> TF.Attr s [TF.Attr s (VirtualNetworkSubnet s)])
