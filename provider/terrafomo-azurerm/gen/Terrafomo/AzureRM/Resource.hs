...
data EventhubNamespaceResource = EventhubNamespaceResource
    { _auto_inflate_enabled     :: !(Attr Text)
    ...
    , _location                 :: !(Attr Text)
    {- ^ (Required) Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created. -}
    , _maximum_throughput_units :: !(Attr Text)
...
type instance Computed ManagementLockResource
    = '[ '("id", Text)
...
type instance Computed NetworkWatcherResource
    = '[ '("id", Text)
