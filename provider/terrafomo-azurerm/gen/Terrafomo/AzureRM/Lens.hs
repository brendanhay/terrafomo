...
instance HasAccess a s b => HasAccess (TF.DataSource p a) s b where
...
instance HasAccessTier a s b => HasAccessTier (TF.DataSource p a) s b where
...
instance HasAccountEncryptionSource a s b => HasAccountEncryptionSource (TF.DataSource p a) s b where
...
instance HasAccountKind a s b => HasAccountKind (TF.DataSource p a) s b where
...
instance HasAccountReplicationType a s b => HasAccountReplicationType (TF.DataSource p a) s b where
...
instance HasAccountTier a s b => HasAccountTier (TF.DataSource p a) s b where
...
instance HasActiveActive a s b => HasActiveActive (TF.DataSource p a) s b where
...
instance HasAddressPrefix a s b => HasAddressPrefix (TF.DataSource p a) s b where
...
instance HasAddressSpace a s b => HasAddressSpace (TF.DataSource p a) s b where
...
instance HasAdminEnabled a s b => HasAdminEnabled (TF.DataSource p a) s b where
...
instance HasAdministratorLogin a s b => HasAdministratorLogin (TF.DataSource p a) s b where
...
instance HasAdministratorLoginPassword a s b => HasAdministratorLoginPassword (TF.DataSource p a) s b where
...
instance HasAgentPoolProfile a s b => HasAgentPoolProfile (TF.DataSource p a) s b where
...
instance HasAllowClassicOperations a s b => HasAllowClassicOperations (TF.DataSource p a) s b where
...
instance HasAllowForwardedTraffic a s b => HasAllowForwardedTraffic (TF.DataSource p a) s b where
...
instance HasAllowGatewayTransit a s b => HasAllowGatewayTransit (TF.DataSource p a) s b where
...
instance HasAllowVirtualNetworkAccess a s b => HasAllowVirtualNetworkAccess (TF.DataSource p a) s b where
...
instance HasAppServicePlanId a s b => HasAppServicePlanId (TF.DataSource p a) s b where
...
instance HasAppSettings a s b => HasAppSettings (TF.DataSource p a) s b where
...
instance HasApplicationType a s b => HasApplicationType (TF.DataSource p a) s b where
...
instance HasAssignableScopes a s b => HasAssignableScopes (TF.DataSource p a) s b where
...
instance HasAttempts a s b => HasAttempts (TF.DataSource p a) s b where
...
instance HasAuthenticationCertificate a s b => HasAuthenticationCertificate (TF.DataSource p a) s b where
...
instance HasAuthorizationKey a s b => HasAuthorizationKey (TF.DataSource p a) s b where
...
instance HasAutoDeleteOnIdle a s b => HasAutoDeleteOnIdle (TF.DataSource p a) s b where
...
instance HasAutoInflateEnabled a s b => HasAutoInflateEnabled (TF.DataSource p a) s b where
...
instance HasAvailabilitySetId a s b => HasAvailabilitySetId (TF.DataSource p a) s b where
...
instance HasBackendAddressPool a s b => HasBackendAddressPool (TF.DataSource p a) s b where
...
instance HasBackendAddressPoolId a s b => HasBackendAddressPoolId (TF.DataSource p a) s b where
...
instance HasBackendHttpSettings a s b => HasBackendHttpSettings (TF.DataSource p a) s b where
...
instance HasBandwidthInMbps a s b => HasBandwidthInMbps (TF.DataSource p a) s b where
...
instance HasBgpSettings a s b => HasBgpSettings (TF.DataSource p a) s b where
...
instance HasBootDiagnostics a s b => HasBootDiagnostics (TF.DataSource p a) s b where
...
instance HasCaptureDescription a s b => HasCaptureDescription (TF.DataSource p a) s b where
...
instance HasCertificatePolicy a s b => HasCertificatePolicy (TF.DataSource p a) s b where
...
instance HasClientAffinityEnabled a s b => HasClientAffinityEnabled (TF.DataSource p a) s b where
...
instance HasClientId a s b => HasClientId (TF.Resource p a) s b where
    clientId = TF.configuration . clientId
...
instance HasConnectionString a s b => HasConnectionString (TF.DataSource p a) s b where
...
instance HasConsistencyPolicy a s b => HasConsistencyPolicy (TF.DataSource p a) s b where
...
instance HasContainerAccessType a s b => HasContainerAccessType (TF.DataSource p a) s b where
...
instance HasContentTypesToCompress a s b => HasContentTypesToCompress (TF.DataSource p a) s b where
...
instance HasCreateMode a s b => HasCreateMode (TF.DataSource p a) s b where
...
instance HasCreateOption a s b => HasCreateOption (TF.DataSource p a) s b where
...
instance HasCustomDomain a s b => HasCustomDomain (TF.DataSource p a) s b where
...
instance HasDbDtuMax a s b => HasDbDtuMax (TF.DataSource p a) s b where
...
instance HasDbDtuMin a s b => HasDbDtuMin (TF.DataSource p a) s b where
...
instance HasDeadLetteringOnMessageExpiration a s b => HasDeadLetteringOnMessageExpiration (TF.DataSource p a) s b where
...
instance HasDefaultLocalNetworkGatewayId a s b => HasDefaultLocalNetworkGatewayId (TF.DataSource p a) s b where
...
instance HasDefaultMessageTtl a s b => HasDefaultMessageTtl (TF.DataSource p a) s b where
...
instance HasDeleteDataDisksOnTermination a s b => HasDeleteDataDisksOnTermination (TF.DataSource p a) s b where
...
instance HasDeleteOsDiskOnTermination a s b => HasDeleteOsDiskOnTermination (TF.DataSource p a) s b where
...
instance HasDestinationAddressPrefix a s b => HasDestinationAddressPrefix (TF.DataSource p a) s b where
...
instance HasDestinationAddressPrefixes a s b => HasDestinationAddressPrefixes (TF.DataSource p a) s b where
...
instance HasDestinationPortRange a s b => HasDestinationPortRange (TF.DataSource p a) s b where
...
instance HasDestinationPortRanges a s b => HasDestinationPortRanges (TF.DataSource p a) s b where
...
instance HasDiagnosticsProfile a s b => HasDiagnosticsProfile (TF.DataSource p a) s b where
...
instance HasDisabledSslProtocols a s b => HasDisabledSslProtocols (TF.DataSource p a) s b where
...
instance HasDiskSizeGb a s b => HasDiskSizeGb (TF.DataSource p a) s b where
...
instance HasDnsServers a s b => HasDnsServers (TF.DataSource p a) s b where
...
instance HasDtu a s b => HasDtu (TF.DataSource p a) s b where
...
instance HasDuplicateDetectionHistoryTimeWindow a s b => HasDuplicateDetectionHistoryTimeWindow (TF.DataSource p a) s b where
...
instance HasEdition a s b => HasEdition (TF.DataSource p a) s b where
...
instance HasElasticPoolName a s b => HasElasticPoolName (TF.DataSource p a) s b where
...
instance HasEnableAcceleratedNetworking a s b => HasEnableAcceleratedNetworking (TF.DataSource p a) s b where
...
instance HasEnableBatchedOperations a s b => HasEnableBatchedOperations (TF.DataSource p a) s b where
...
instance HasEnableBgp a s b => HasEnableBgp (TF.DataSource p a) s b where
...
instance HasEnableBlobEncryption a s b => HasEnableBlobEncryption (TF.DataSource p a) s b where
...
instance HasEnableExpress a s b => HasEnableExpress (TF.DataSource p a) s b where
...
instance HasEnableFileEncryption a s b => HasEnableFileEncryption (TF.DataSource p a) s b where
...
instance HasEnableFloatingIp a s b => HasEnableFloatingIp (TF.DataSource p a) s b where
...
instance HasEnableHttpsTrafficOnly a s b => HasEnableHttpsTrafficOnly (TF.DataSource p a) s b where
...
instance HasEnableIpForwarding a s b => HasEnableIpForwarding (TF.DataSource p a) s b where
...
instance HasEnablePartitioning a s b => HasEnablePartitioning (TF.DataSource p a) s b where
...
instance HasEnabledForDeployment a s b => HasEnabledForDeployment (TF.DataSource p a) s b where
...
instance HasEnabledForDiskEncryption a s b => HasEnabledForDiskEncryption (TF.DataSource p a) s b where
...
instance HasEnabledForTemplateDeployment a s b => HasEnabledForTemplateDeployment (TF.DataSource p a) s b where
...
instance HasEncryptionSettings a s b => HasEncryptionSettings (TF.DataSource p a) s b where
...
instance HasEndIpAddress a s b => HasEndIpAddress (TF.DataSource p a) s b where
...
instance HasEndpointLocation a s b => HasEndpointLocation (TF.DataSource p a) s b where
...
instance HasEndpointStatus a s b => HasEndpointStatus (TF.DataSource p a) s b where
...
instance HasEventhubName a s b => HasEventhubName (TF.DataSource p a) s b where
...
instance HasExpiryTime a s b => HasExpiryTime (TF.DataSource p a) s b where
...
instance HasExpressRouteCircuitId a s b => HasExpressRouteCircuitId (TF.DataSource p a) s b where
...
instance HasExtension a s b => HasExtension (TF.DataSource p a) s b where
...
instance HasFailoverPolicy a s b => HasFailoverPolicy (TF.DataSource p a) s b where
...
instance HasFrontendIpConfiguration a s b => HasFrontendIpConfiguration (TF.DataSource p a) s b where
...
instance HasFrontendIpConfigurationName a s b => HasFrontendIpConfigurationName (TF.DataSource p a) s b where
...
instance HasFrontendPortEnd a s b => HasFrontendPortEnd (TF.DataSource p a) s b where
...
instance HasFrontendPortStart a s b => HasFrontendPortStart (TF.DataSource p a) s b where
...
instance HasGatewayAddress a s b => HasGatewayAddress (TF.DataSource p a) s b where
...
instance HasGatewayIpConfiguration a s b => HasGatewayIpConfiguration (TF.DataSource p a) s b where
...
instance HasHttpListener a s b => HasHttpListener (TF.DataSource p a) s b where
...
instance HasIdentity a s b => HasIdentity (TF.DataSource p a) s b where
...
instance HasIdleTimeoutInMinutes a s b => HasIdleTimeoutInMinutes (TF.DataSource p a) s b where
...
instance HasImageReferenceId a s b => HasImageReferenceId (TF.DataSource p a) s b where
...
instance HasInternalDnsNameLabel a s b => HasInternalDnsNameLabel (TF.DataSource p a) s b where
...
instance HasIntervalInSeconds a s b => HasIntervalInSeconds (TF.DataSource p a) s b where
...
instance HasIpConfiguration a s b => HasIpConfiguration (TF.DataSource p a) s b where
...
instance HasIpRangeFilter a s b => HasIpRangeFilter (TF.DataSource p a) s b where
...
instance HasIsCompressionEnabled a s b => HasIsCompressionEnabled (TF.DataSource p a) s b where
...
instance HasIsHttpAllowed a s b => HasIsHttpAllowed (TF.DataSource p a) s b where
...
instance HasIsHttpsAllowed a s b => HasIsHttpsAllowed (TF.DataSource p a) s b where
...
instance HasKeyOpts a s b => HasKeyOpts (TF.DataSource p a) s b where
...
instance HasKeySize a s b => HasKeySize (TF.DataSource p a) s b where
...
instance HasKind a s b => HasKind (TF.DataSource p a) s b where
...
instance HasLicenseType a s b => HasLicenseType (TF.DataSource p a) s b where
...
instance HasLinuxProfile a s b => HasLinuxProfile (TF.DataSource p a) s b where
...
instance HasLoadDistribution a s b => HasLoadDistribution (TF.DataSource p a) s b where
...
instance HasLocalNetworkGatewayId a s b => HasLocalNetworkGatewayId (TF.DataSource p a) s b where
...
instance HasLockDuration a s b => HasLockDuration (TF.DataSource p a) s b where
...
instance HasLockLevel a s b => HasLockLevel (TF.DataSource p a) s b where
...
instance HasLogProgress a s b => HasLogProgress (TF.DataSource p a) s b where
...
instance HasLogVerbose a s b => HasLogVerbose (TF.DataSource p a) s b where
...
instance HasMasterProfile a s b => HasMasterProfile (TF.DataSource p a) s b where
...
instance HasMaxDeliveryCount a s b => HasMaxDeliveryCount (TF.DataSource p a) s b where
...
instance HasMaxSizeBytes a s b => HasMaxSizeBytes (TF.DataSource p a) s b where
...
instance HasMaxSizeInMegabytes a s b => HasMaxSizeInMegabytes (TF.DataSource p a) s b where
...
instance HasMaximumThroughputUnits a s b => HasMaximumThroughputUnits (TF.DataSource p a) s b where
...
instance HasMessageRetention a s b => HasMessageRetention (TF.DataSource p a) s b where
...
instance HasMinChildEndpoints a s b => HasMinChildEndpoints (TF.DataSource p a) s b where
...
instance HasMonitorConfig a s b => HasMonitorConfig (TF.DataSource p a) s b where
...
instance HasNamespaceName a s b => HasNamespaceName (TF.DataSource p a) s b where
...
instance HasNetworkInterfaceIds a s b => HasNetworkInterfaceIds (TF.DataSource p a) s b where
...
instance HasNetworkProfile a s b => HasNetworkProfile (TF.DataSource p a) s b where
...
instance HasNetworkSecurityGroupId a s b => HasNetworkSecurityGroupId (TF.DataSource p a) s b where
...
instance HasNetworkSecurityGroupName a s b => HasNetworkSecurityGroupName (TF.DataSource p a) s b where
...
instance HasNextHopInIpAddress a s b => HasNextHopInIpAddress (TF.DataSource p a) s b where
...
instance HasNumberOfProbes a s b => HasNumberOfProbes (TF.DataSource p a) s b where
...
instance HasOffer a s b => HasOffer (TF.Resource p a) s b where
    offer = TF.configuration . offer

class HasOfferType a s b | a -> s b where
    offerType :: Lens' a (TF.Attribute s b)

instance HasOfferType a s b => HasOfferType (TF.DataSource p a) s b where
...
instance HasOrchestrationPlatform a s b => HasOrchestrationPlatform (TF.DataSource p a) s b where
...
instance HasOriginHostHeader a s b => HasOriginHostHeader (TF.DataSource p a) s b where
...
instance HasOriginPath a s b => HasOriginPath (TF.DataSource p a) s b where
...
instance HasOsDisk a s b => HasOsDisk (TF.DataSource p a) s b where
...
instance HasOsProfile a s b => HasOsProfile (TF.DataSource p a) s b where
...
instance HasOsProfileLinuxConfig a s b => HasOsProfileLinuxConfig (TF.DataSource p a) s b where
...
instance HasOsProfileSecrets a s b => HasOsProfileSecrets (TF.DataSource p a) s b where
...
instance HasOsProfileWindowsConfig a s b => HasOsProfileWindowsConfig (TF.DataSource p a) s b where
...
instance HasOverprovision a s b => HasOverprovision (TF.DataSource p a) s b where
...
instance HasPartitionCount a s b => HasPartitionCount (TF.DataSource p a) s b where
...
instance HasPeerVirtualNetworkGatewayId a s b => HasPeerVirtualNetworkGatewayId (TF.DataSource p a) s b where
...
instance HasPeeringLocation a s b => HasPeeringLocation (TF.DataSource p a) s b where
...
instance HasPlatformFaultDomainCount a s b => HasPlatformFaultDomainCount (TF.DataSource p a) s b where
...
instance HasPlatformUpdateDomainCount a s b => HasPlatformUpdateDomainCount (TF.DataSource p a) s b where
...
instance HasPoolSize a s b => HasPoolSize (TF.DataSource p a) s b where
...
instance HasPrimaryNetworkInterfaceId a s b => HasPrimaryNetworkInterfaceId (TF.DataSource p a) s b where
...
instance HasPrincipalId a s b => HasPrincipalId (TF.DataSource p a) s b where
...
instance HasProbe a s b => HasProbe (TF.DataSource p a) s b where
...
instance HasProbeId a s b => HasProbeId (TF.DataSource p a) s b where
...
instance HasProfileName a s b => HasProfileName (TF.DataSource p a) s b where
...
instance HasProfileStatus a s b => HasProfileStatus (TF.DataSource p a) s b where
...
instance HasPublishContentLink a s b => HasPublishContentLink (TF.DataSource p a) s b where
...
instance HasQuerystringCachingBehaviour a s b => HasQuerystringCachingBehaviour (TF.DataSource p a) s b where
...
instance HasQuota a s b => HasQuota (TF.DataSource p a) s b where
...
instance HasRecord a s b => HasRecord (TF.DataSource p a) s b where
...
instance HasRedisCacheName a s b => HasRedisCacheName (TF.DataSource p a) s b where
...
instance HasRemoteVirtualNetworkId a s b => HasRemoteVirtualNetworkId (TF.DataSource p a) s b where
...
instance HasReplicaCount a s b => HasReplicaCount (TF.DataSource p a) s b where
...
instance HasRequestRoutingRule a s b => HasRequestRoutingRule (TF.DataSource p a) s b where
...
instance HasRequestedServiceObjectiveId a s b => HasRequestedServiceObjectiveId (TF.DataSource p a) s b where
...
instance HasRequestedServiceObjectiveName a s b => HasRequestedServiceObjectiveName (TF.DataSource p a) s b where
...
instance HasRequiresDuplicateDetection a s b => HasRequiresDuplicateDetection (TF.DataSource p a) s b where
...
instance HasRequiresSession a s b => HasRequiresSession (TF.DataSource p a) s b where
...
instance HasRestorePointInTime a s b => HasRestorePointInTime (TF.DataSource p a) s b where
...
instance HasRouteTableName a s b => HasRouteTableName (TF.DataSource p a) s b where
...
instance HasRoutingWeight a s b => HasRoutingWeight (TF.DataSource p a) s b where
...
instance HasRunbookType a s b => HasRunbookType (TF.DataSource p a) s b where
...
instance HasSecurityRule a s b => HasSecurityRule (TF.DataSource p a) s b where
...
instance HasServicePrincipal a s b => HasServicePrincipal (TF.DataSource p a) s b where
...
instance HasServiceProviderName a s b => HasServiceProviderName (TF.DataSource p a) s b where
...
instance HasSharedKey a s b => HasSharedKey (TF.DataSource p a) s b where
...
instance HasSinglePlacementGroup a s b => HasSinglePlacementGroup (TF.DataSource p a) s b where
...
instance HasSiteConfig a s b => HasSiteConfig (TF.DataSource p a) s b where
...
instance HasSortDescending a s b => HasSortDescending (TF.Resource p a) s b where
    sortDescending = TF.configuration . sortDescending
...
instance HasSourceAddressPrefix a s b => HasSourceAddressPrefix (TF.DataSource p a) s b where
...
instance HasSourceAddressPrefixes a s b => HasSourceAddressPrefixes (TF.DataSource p a) s b where
...
instance HasSourceDatabaseDeletionDate a s b => HasSourceDatabaseDeletionDate (TF.DataSource p a) s b where
...
instance HasSourceDatabaseId a s b => HasSourceDatabaseId (TF.DataSource p a) s b where
...
instance HasSourcePortRange a s b => HasSourcePortRange (TF.DataSource p a) s b where
...
instance HasSourcePortRanges a s b => HasSourcePortRanges (TF.DataSource p a) s b where
...
instance HasSourceResourceId a s b => HasSourceResourceId (TF.DataSource p a) s b where
...
instance HasSourceUri a s b => HasSourceUri (TF.DataSource p a) s b where
...
instance HasSourceVirtualMachineId a s b => HasSourceVirtualMachineId (TF.DataSource p a) s b where
...
instance HasSslCertificate a s b => HasSslCertificate (TF.DataSource p a) s b where
...
instance HasStartIpAddress a s b => HasStartIpAddress (TF.DataSource p a) s b where
...
instance HasStorageAccountId a s b => HasStorageAccountId (TF.DataSource p a) s b where
...
instance HasStorageAccountName a s b => HasStorageAccountName (TF.DataSource p a) s b where
...
instance HasStorageAccountType a s b => HasStorageAccountType (TF.DataSource p a) s b where
...
instance HasStorageConnectionString a s b => HasStorageConnectionString (TF.DataSource p a) s b where
...
instance HasStorageContainerName a s b => HasStorageContainerName (TF.DataSource p a) s b where
...
instance HasStorageDataDisk a s b => HasStorageDataDisk (TF.DataSource p a) s b where
...
instance HasStorageImageReference a s b => HasStorageImageReference (TF.DataSource p a) s b where
...
instance HasStorageMb a s b => HasStorageMb (TF.DataSource p a) s b where
...
instance HasStorageOsDisk a s b => HasStorageOsDisk (TF.DataSource p a) s b where
...
instance HasStorageProfileDataDisk a s b => HasStorageProfileDataDisk (TF.DataSource p a) s b where
...
instance HasStorageProfileImageReference a s b => HasStorageProfileImageReference (TF.DataSource p a) s b where
...
instance HasStorageProfileOsDisk a s b => HasStorageProfileOsDisk (TF.DataSource p a) s b where
...
instance HasSubscriptionId a s b => HasSubscriptionId (TF.Resource p a) s b where
    subscriptionId = TF.configuration . subscriptionId

class HasSupportOrdering a s b | a -> s b where
    supportOrdering :: Lens' a (TF.Attribute s b)

instance HasSupportOrdering a s b => HasSupportOrdering (TF.DataSource p a) s b where
...
instance HasTargetResourceId a s b => HasTargetResourceId (TF.DataSource p a) s b where
...
instance HasTopicName a s b => HasTopicName (TF.DataSource p a) s b where
...
instance HasTrafficRoutingMethod a s b => HasTrafficRoutingMethod (TF.DataSource p a) s b where
...
instance HasUpgradePolicyMode a s b => HasUpgradePolicyMode (TF.DataSource p a) s b where
...
instance HasUrlPathMap a s b => HasUrlPathMap (TF.DataSource p a) s b where
...
instance HasUseRemoteGateways a s b => HasUseRemoteGateways (TF.DataSource p a) s b where
...
instance HasUseSubdomain a s b => HasUseSubdomain (TF.DataSource p a) s b where
...
instance HasUserMetadata a s b => HasUserMetadata (TF.DataSource p a) s b where
...
instance HasVaultUri a s b => HasVaultUri (TF.DataSource p a) s b where
...
instance HasVirtualMachineName a s b => HasVirtualMachineName (TF.DataSource p a) s b where
...
instance HasVirtualNetworkGatewayId a s b => HasVirtualNetworkGatewayId (TF.DataSource p a) s b where
...
instance HasVmSize a s b => HasVmSize (TF.DataSource p a) s b where
...
instance HasVpnClientConfiguration a s b => HasVpnClientConfiguration (TF.DataSource p a) s b where
...
instance HasVpnType a s b => HasVpnType (TF.DataSource p a) s b where
...
instance HasWafConfiguration a s b => HasWafConfiguration (TF.DataSource p a) s b where
...
instance HasZoneName a s b => HasZoneName (TF.DataSource p a) s b where
