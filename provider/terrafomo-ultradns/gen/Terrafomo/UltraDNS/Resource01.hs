...
data DirpoolResource s = DirpoolResource'
    ...
    --
    , _noResponse      :: TF.Attr s [TF.Attr s (DirpoolNoResponseSetting s)]
    -- ^ @no_response@ - (Optional)
    --
    , _rdata           :: TF.Attr s [TF.Attr s (DirpoolRdataSetting s)]
    -- ^ @rdata@ - (Required)
    --
...
dirpoolResource
    ...
    -> TF.Attr s [TF.Attr s (DirpoolRdataSetting s)] -- ^ @rdata@ ('P._rdata', 'P.rdata')
...
instance P.HasNoResponse (DirpoolResource s) (TF.Attr s [TF.Attr s (DirpoolNoResponseSetting s)]) where
    noResponse =
        P.lens (_noResponse :: DirpoolResource s -> TF.Attr s [TF.Attr s (DirpoolNoResponseSetting s)])
               (\s a -> s { _noResponse = a } :: DirpoolResource s)

instance P.HasRdata (DirpoolResource s) (TF.Attr s [TF.Attr s (DirpoolRdataSetting s)]) where
    rdata =
        P.lens (_rdata :: DirpoolResource s -> TF.Attr s [TF.Attr s (DirpoolRdataSetting s)])
...
data ProbeHttpResource s = ProbeHttpResource'
    ...
    -- ^ @agents@ - (Required)
    --
    , _httpProbe  :: TF.Attr s [TF.Attr s (ProbeHttpHttpProbeSetting s)]
    -- ^ @http_probe@ - (Optional)
    --
...
instance P.HasHttpProbe (ProbeHttpResource s) (TF.Attr s [TF.Attr s (ProbeHttpHttpProbeSetting s)]) where
    httpProbe =
        P.lens (_httpProbe :: ProbeHttpResource s -> TF.Attr s [TF.Attr s (ProbeHttpHttpProbeSetting s)])
...
data ProbePingResource s = ProbePingResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _pingProbe  :: TF.Attr s [TF.Attr s (ProbePingPingProbeSetting s)]
    -- ^ @ping_probe@ - (Optional)
    --
    , _poolRecord :: TF.Attr s P.Text
    -- ^ @pool_record@ - (Optional, Forces New)
...
instance P.HasPingProbe (ProbePingResource s) (TF.Attr s [TF.Attr s (ProbePingPingProbeSetting s)]) where
    pingProbe =
        P.lens (_pingProbe :: ProbePingResource s -> TF.Attr s [TF.Attr s (ProbePingPingProbeSetting s)])
...
data TcpoolResource s = TcpoolResource'
    ...
    -- ^ @name@ - (Required, Forces New)
    --
    , _rdata                     :: TF.Attr s [TF.Attr s (TcpoolRdataSetting s)]
    -- ^ @rdata@ - (Required)
    --
...
tcpoolResource
    :: TF.Attr s P.Text -- ^ @description@ ('P._description', 'P.description')
    -> TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s [TF.Attr s (TcpoolRdataSetting s)] -- ^ @rdata@ ('P._rdata', 'P.rdata')
    -> TF.Attr s P.Text -- ^ @zone@ ('P._zone', 'P.zone')
...
instance P.HasRdata (TcpoolResource s) (TF.Attr s [TF.Attr s (TcpoolRdataSetting s)]) where
    rdata =
        P.lens (_rdata :: TcpoolResource s -> TF.Attr s [TF.Attr s (TcpoolRdataSetting s)])
