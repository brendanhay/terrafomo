...
class HasRearmSeconds a s b | a -> s b where
    rearmSeconds :: Lens' a (TF.Attr s b)
...
class HasRelatedSpace a s b | a -> s b where
    relatedSpace :: Lens' a (TF.Attr s b)
