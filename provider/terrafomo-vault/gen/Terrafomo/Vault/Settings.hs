...
newGroup
    ...
    -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)] -- ^ @policies@ - 'P.policies'
    -> Group s
...
instance P.HasPolicies (Group s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    policies =
        P.lens (_policies :: Group s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _policies = a
                          } :: Group s)
...
instance P.HasGroups (User s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    groups =
        P.lens (_groups :: User s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _groups = a
                          } :: User s)

instance P.HasPolicies (User s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    policies =
        P.lens (_policies :: User s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _policies = a
                          } :: User s)
