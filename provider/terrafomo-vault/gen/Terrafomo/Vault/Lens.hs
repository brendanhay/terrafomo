...
instance HasAccessKey a s b => HasAccessKey (TF.DataSource p a) s b where
...
instance HasAllowInstanceMigration a s b => HasAllowInstanceMigration (TF.DataSource p a) s b where
...
instance HasAllowRead a s b => HasAllowRead (TF.DataSource p a) s b where
...
instance HasAuthType a s b => HasAuthType (TF.DataSource p a) s b where
...
instance HasAwsPublicCert a s b => HasAwsPublicCert (TF.DataSource p a) s b where
...
instance HasBoundAccountId a s b => HasBoundAccountId (TF.DataSource p a) s b where
...
instance HasBoundAmiId a s b => HasBoundAmiId (TF.DataSource p a) s b where
...
instance HasBoundIamInstanceProfileArn a s b => HasBoundIamInstanceProfileArn (TF.DataSource p a) s b where
...
instance HasBoundIamPrincipalArn a s b => HasBoundIamPrincipalArn (TF.DataSource p a) s b where
...
instance HasBoundIamRoleArn a s b => HasBoundIamRoleArn (TF.DataSource p a) s b where
...
instance HasBoundRegion a s b => HasBoundRegion (TF.DataSource p a) s b where
...
instance HasBoundSubnetId a s b => HasBoundSubnetId (TF.DataSource p a) s b where
...
instance HasBoundVpcId a s b => HasBoundVpcId (TF.DataSource p a) s b where
...
instance HasCertName a s b => HasCertName (TF.DataSource p a) s b where
...
instance HasDataJson a s b => HasDataJson (TF.DataSource p a) s b where
...
instance HasDefaultLeaseTtlSeconds a s b => HasDefaultLeaseTtlSeconds (TF.DataSource p a) s b where
...
instance HasDisableRead a s b => HasDisableRead (TF.DataSource p a) s b where
...
instance HasDisallowReauthentication a s b => HasDisallowReauthentication (TF.DataSource p a) s b where
...
instance HasEc2Endpoint a s b => HasEc2Endpoint (TF.DataSource p a) s b where
...
instance HasIamEndpoint a s b => HasIamEndpoint (TF.DataSource p a) s b where
...
instance HasIamHttpRequestMethod a s b => HasIamHttpRequestMethod (TF.DataSource p a) s b where
...
instance HasIamRequestBody a s b => HasIamRequestBody (TF.DataSource p a) s b where
...
instance HasIamRequestHeaders a s b => HasIamRequestHeaders (TF.DataSource p a) s b where
...
instance HasIamRequestUrl a s b => HasIamRequestUrl (TF.DataSource p a) s b where
...
instance HasIamServerIdHeaderValue a s b => HasIamServerIdHeaderValue (TF.DataSource p a) s b where
...
instance HasInferredAwsRegion a s b => HasInferredAwsRegion (TF.DataSource p a) s b where
...
instance HasInferredEntityType a s b => HasInferredEntityType (TF.DataSource p a) s b where
...
instance HasMaxLeaseTtlSeconds a s b => HasMaxLeaseTtlSeconds (TF.DataSource p a) s b where
...
instance HasMaxTtl a s b => HasMaxTtl (TF.DataSource p a) s b where
...
instance HasNonce a s b => HasNonce (TF.DataSource p a) s b where
...
instance HasPkcs7 a s b => HasPkcs7 (TF.DataSource p a) s b where
...
instance HasResolveAwsUniqueIds a s b => HasResolveAwsUniqueIds (TF.DataSource p a) s b where
...
instance HasRoleTag a s b => HasRoleTag (TF.DataSource p a) s b where
...
instance HasSecretKey a s b => HasSecretKey (TF.DataSource p a) s b where
...
instance HasSignature a s b => HasSignature (TF.DataSource p a) s b where
...
instance HasStsEndpoint a s b => HasStsEndpoint (TF.DataSource p a) s b where
...
instance HasStsRole a s b => HasStsRole (TF.DataSource p a) s b where
