...
data DefaultReviewersResource s = DefaultReviewersResource'
    ...
    -- ^ @repository@ - (Required)
    --
    , _reviewers  :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @reviewers@ - (Required)
    --
...
defaultReviewersResource
    ...
    -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)] -- ^ @reviewers@ - 'P.reviewers'
...
instance P.HasReviewers (DefaultReviewersResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    reviewers =
        P.lens (_reviewers :: DefaultReviewersResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _reviewers = a
                          } :: DefaultReviewersResource s)
...
instance P.HasEvents (HookResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    events =
        P.lens (_events :: HookResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _events = a
                          } :: HookResource s)
