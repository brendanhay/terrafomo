...
instance HasAccessConfig a b => HasAccessConfig (TF.Resource l p a) b where
...
instance HasAckDeadlineSeconds a b => HasAckDeadlineSeconds (TF.Resource l p a) b where
...
instance HasActivationPolicy a b => HasActivationPolicy (TF.Resource l p a) b where
    activationPolicy = TF.configuration . activationPolicy

class HasAdditionalZones a b | a -> b where
    additionalZones :: P.Lens' a b

instance HasAdditionalZones a b => HasAdditionalZones (TF.Resource l p a) b where
    additionalZones = TF.configuration . additionalZones

class HasAddonsConfig a b | a -> b where
    addonsConfig :: P.Lens' a b

instance HasAddonsConfig a b => HasAddonsConfig (TF.Resource l p a) b where
...
instance HasAdvertisedRoutePriority a b => HasAdvertisedRoutePriority (TF.Resource l p a) b where
    advertisedRoutePriority = TF.configuration . advertisedRoutePriority

class HasAge a b | a -> b where
    age :: P.Lens' a b

instance HasAge a b => HasAge (TF.Resource l p a) b where
    age = TF.configuration . age

class HasAliasIpRange a b | a -> b where
    aliasIpRange :: P.Lens' a b

instance HasAliasIpRange a b => HasAliasIpRange (TF.Resource l p a) b where
    aliasIpRange = TF.configuration . aliasIpRange

class HasAll a b | a -> b where
    all :: P.Lens' a b

instance HasAll a b => HasAll (TF.Resource l p a) b where
    all = TF.configuration . all

class HasAllow a b | a -> b where
    allow :: P.Lens' a b

instance HasAllow a b => HasAllow (TF.Resource l p a) b where
    allow = TF.configuration . allow

class HasAllowStoppingForUpdate a b | a -> b where
    allowStoppingForUpdate :: P.Lens' a b

instance HasAllowStoppingForUpdate a b => HasAllowStoppingForUpdate (TF.Resource l p a) b where
...
instance HasAlternativeLocationId a b => HasAlternativeLocationId (TF.Resource l p a) b where
    alternativeLocationId = TF.configuration . alternativeLocationId

class HasAppEngine a b | a -> b where
    appEngine :: P.Lens' a b

instance HasAppEngine a b => HasAppEngine (TF.Resource l p a) b where
    appEngine = TF.configuration . appEngine

class HasArchiveUris a b | a -> b where
    archiveUris :: P.Lens' a b

instance HasArchiveUris a b => HasArchiveUris (TF.Resource l p a) b where
...
instance HasAttachedDisk a b => HasAttachedDisk (TF.Resource l p a) b where
...
instance HasAuthDomain a b => HasAuthDomain (TF.Resource l p a) b where
...
instance HasAuthorizedGaeApplications a b => HasAuthorizedGaeApplications (TF.Resource l p a) b where
...
instance HasAuthorizedNetwork a b => HasAuthorizedNetwork (TF.Resource l p a) b where
...
instance HasAuthorizedNetworks a b => HasAuthorizedNetworks (TF.Resource l p a) b where
...
instance HasAutoCreateNetwork a b => HasAutoCreateNetwork (TF.Resource l p a) b where
    autoCreateNetwork = TF.configuration . autoCreateNetwork

class HasAutoCreateRoutes a b | a -> b where
    autoCreateRoutes :: P.Lens' a b

instance HasAutoCreateRoutes a b => HasAutoCreateRoutes (TF.Resource l p a) b where
...
instance HasBucketName a b => HasBucketName (TF.Resource l p a) b where
    bucketName = TF.configuration . bucketName

class HasBuild a b | a -> b where
    build :: P.Lens' a b

instance HasBuild a b => HasBuild (TF.Resource l p a) b where
    build = TF.configuration . build

class HasCaCertificate a b | a -> b where
    caCertificate :: P.Lens' a b

instance HasCaCertificate a b => HasCaCertificate (TF.Resource l p a) b where
...
instance HasCheckIntervalSec a b => HasCheckIntervalSec (TF.Resource l p a) b where
...
instance HasCidrBlocks a b => HasCidrBlocks (TF.Resource l p a) b where
    cidrBlocks = TF.configuration . cidrBlocks

class HasCiphertext a b | a -> b where
    ciphertext :: P.Lens' a b

instance HasCiphertext a b => HasCiphertext (TF.Resource l p a) b where
    ciphertext = TF.configuration . ciphertext

class HasClientCertificate a b | a -> b where
    clientCertificate :: P.Lens' a b

instance HasClientCertificate a b => HasClientCertificate (TF.Resource l p a) b where
...
instance HasClientCertificateConfig a b => HasClientCertificateConfig (TF.Resource l p a) b where
...
instance HasClusterSecondaryRangeName a b => HasClusterSecondaryRangeName (TF.Resource l p a) b where
...
instance HasCommitSha a b => HasCommitSha (TF.Resource l p a) b where
...
instance HasConnectRetryInterval a b => HasConnectRetryInterval (TF.Resource l p a) b where
...
instance HasConnectionDrainingTimeoutSec a b => HasConnectionDrainingTimeoutSec (TF.Resource l p a) b where
...
instance HasConstraint a b => HasConstraint (TF.Resource l p a) b where
    constraint = TF.configuration . constraint

class HasContainerType a b | a -> b where
    containerType :: P.Lens' a b

instance HasContainerType a b => HasContainerType (TF.Resource l p a) b where
...
instance HasContinueOnFailure a b => HasContinueOnFailure (TF.Resource l p a) b where
    continueOnFailure = TF.configuration . continueOnFailure

class HasCooldownPeriod a b | a -> b where
    cooldownPeriod :: P.Lens' a b

instance HasCooldownPeriod a b => HasCooldownPeriod (TF.Resource l p a) b where
    cooldownPeriod = TF.configuration . cooldownPeriod

class HasCors a b | a -> b where
    cors :: P.Lens' a b

instance HasCors a b => HasCors (TF.Resource l p a) b where
...
instance HasCryptoKey a b => HasCryptoKey (TF.Resource l p a) b where
    cryptoKey = TF.configuration . cryptoKey

class HasCryptoKeyId a b | a -> b where
    cryptoKeyId :: P.Lens' a b

instance HasCryptoKeyId a b => HasCryptoKeyId (TF.Resource l p a) b where
...
instance HasCustomFeatures a b => HasCustomFeatures (TF.Resource l p a) b where
    customFeatures = TF.configuration . customFeatures

class HasCustomRequestHeaders a b | a -> b where
    customRequestHeaders :: P.Lens' a b

instance HasCustomRequestHeaders a b => HasCustomRequestHeaders (TF.Resource l p a) b where
...
instance HasDailyMaintenanceWindow a b => HasDailyMaintenanceWindow (TF.Resource l p a) b where
...
instance HasDatabaseFlags a b => HasDatabaseFlags (TF.Resource l p a) b where
    databaseFlags = TF.configuration . databaseFlags

class HasDatabaseVersion a b | a -> b where
    databaseVersion :: P.Lens' a b

instance HasDatabaseVersion a b => HasDatabaseVersion (TF.Resource l p a) b where
    databaseVersion = TF.configuration . databaseVersion

class HasDatasetId a b | a -> b where
    datasetId :: P.Lens' a b

instance HasDatasetId a b => HasDatasetId (TF.Resource l p a) b where
...
instance HasDdl a b => HasDdl (TF.Resource l p a) b where
...
instance HasDefaultAcl a b => HasDefaultAcl (TF.Resource l p a) b where
    defaultAcl = TF.configuration . defaultAcl

class HasDefaultService a b | a -> b where
    defaultService :: P.Lens' a b

instance HasDefaultService a b => HasDefaultService (TF.Resource l p a) b where
...
instance HasDefaultTableExpirationMs a b => HasDefaultTableExpirationMs (TF.Resource l p a) b where
    defaultTableExpirationMs = TF.configuration . defaultTableExpirationMs

class HasDeleted a b | a -> b where
    deleted :: P.Lens' a b

instance HasDeleted a b => HasDeleted (TF.Resource l p a) b where
    deleted = TF.configuration . deleted

class HasDeletionProtection a b | a -> b where
    deletionProtection :: P.Lens' a b

instance HasDeletionProtection a b => HasDeletionProtection (TF.Resource l p a) b where
    deletionProtection = TF.configuration . deletionProtection

class HasDeny a b | a -> b where
    deny :: P.Lens' a b

instance HasDeny a b => HasDeny (TF.Resource l p a) b where
...
instance HasDestRange a b => HasDestRange (TF.Resource l p a) b where
...
instance HasDestinationRanges a b => HasDestinationRanges (TF.Resource l p a) b where
    destinationRanges = TF.configuration . destinationRanges

class HasDetectMd5hash a b | a -> b where
    detectMd5hash :: P.Lens' a b

instance HasDetectMd5hash a b => HasDetectMd5hash (TF.Resource l p a) b where
...
instance HasDigest a b => HasDigest (TF.Resource l p a) b where
    digest = TF.configuration . digest

class HasDir a b | a -> b where
    dir :: P.Lens' a b

instance HasDir a b => HasDir (TF.Resource l p a) b where
...
instance HasDisableOnDestroy a b => HasDisableOnDestroy (TF.Resource l p a) b where
...
instance HasDiskAutoresize a b => HasDiskAutoresize (TF.Resource l p a) b where
    diskAutoresize = TF.configuration . diskAutoresize

class HasDiskConfig a b | a -> b where
    diskConfig :: P.Lens' a b

instance HasDiskConfig a b => HasDiskConfig (TF.Resource l p a) b where
...
instance HasDiskEncryptionKeyRaw a b => HasDiskEncryptionKeyRaw (TF.Resource l p a) b where
    diskEncryptionKeyRaw = TF.configuration . diskEncryptionKeyRaw

class HasDiskName a b | a -> b where
    diskName :: P.Lens' a b

instance HasDiskName a b => HasDiskName (TF.Resource l p a) b where
...
instance HasDistributionPolicyZones a b => HasDistributionPolicyZones (TF.Resource l p a) b where
...
instance HasDriverLogLevels a b => HasDriverLogLevels (TF.Resource l p a) b where
    driverLogLevels = TF.configuration . driverLogLevels

class HasDumpFilePath a b | a -> b where
    dumpFilePath :: P.Lens' a b

instance HasDumpFilePath a b => HasDumpFilePath (TF.Resource l p a) b where
...
instance HasEnableCdn a b => HasEnableCdn (TF.Resource l p a) b where
    enableCdn = TF.configuration . enableCdn

class HasEnableFlowLogs a b | a -> b where
    enableFlowLogs :: P.Lens' a b

instance HasEnableFlowLogs a b => HasEnableFlowLogs (TF.Resource l p a) b where
...
instance HasEnableKubernetesAlpha a b => HasEnableKubernetesAlpha (TF.Resource l p a) b where
...
instance HasEnableLegacyAbac a b => HasEnableLegacyAbac (TF.Resource l p a) b where
...
instance HasFeatureSettings a b => HasFeatureSettings (TF.Resource l p a) b where
...
instance HasFileUris a b => HasFileUris (TF.Resource l p a) b where
...
instance HasFixed a b => HasFixed (TF.Resource l p a) b where
...
instance HasFolderId a b => HasFolderId (TF.Resource l p a) b where
    folderId = TF.configuration . folderId

class HasFollowGaeApplication a b | a -> b where
    followGaeApplication :: P.Lens' a b

instance HasFollowGaeApplication a b => HasFollowGaeApplication (TF.Resource l p a) b where
...
instance HasFriendlyName a b => HasFriendlyName (TF.Resource l p a) b where
    friendlyName = TF.configuration . friendlyName

class HasGceClusterConfig a b | a -> b where
    gceClusterConfig :: P.Lens' a b

instance HasGceClusterConfig a b => HasGceClusterConfig (TF.Resource l p a) b where
...
instance HasGrpcConfig a b => HasGrpcConfig (TF.Resource l p a) b where
    grpcConfig = TF.configuration . grpcConfig

class HasGuestAccelerator a b | a -> b where
    guestAccelerator :: P.Lens' a b

instance HasGuestAccelerator a b => HasGuestAccelerator (TF.Resource l p a) b where
    guestAccelerator = TF.configuration . guestAccelerator

class HasHadoopConfig a b | a -> b where
    hadoopConfig :: P.Lens' a b

instance HasHadoopConfig a b => HasHadoopConfig (TF.Resource l p a) b where
...
instance HasHealthChecks a b => HasHealthChecks (TF.Resource l p a) b where
...
instance HasHiveConfig a b => HasHiveConfig (TF.Resource l p a) b where
    hiveConfig = TF.configuration . hiveConfig

class HasHorizontalPodAutoscaling a b | a -> b where
    horizontalPodAutoscaling :: P.Lens' a b

instance HasHorizontalPodAutoscaling a b => HasHorizontalPodAutoscaling (TF.Resource l p a) b where
...
instance HasHostProject a b => HasHostProject (TF.Resource l p a) b where
    hostProject = TF.configuration . hostProject

class HasHostRule a b | a -> b where
    hostRule :: P.Lens' a b

instance HasHostRule a b => HasHostRule (TF.Resource l p a) b where
...
instance HasHttpsHealthCheck a b => HasHttpsHealthCheck (TF.Resource l p a) b where
    httpsHealthCheck = TF.configuration . httpsHealthCheck

class HasHttpsTriggerUrl a b | a -> b where
    httpsTriggerUrl :: P.Lens' a b

instance HasHttpsTriggerUrl a b => HasHttpsTriggerUrl (TF.Resource l p a) b where
    httpsTriggerUrl = TF.configuration . httpsTriggerUrl

class HasIap a b | a -> b where
    iap :: P.Lens' a b

instance HasIap a b => HasIap (TF.Resource l p a) b where
...
instance HasInitializationAction a b => HasInitializationAction (TF.Resource l p a) b where
...
instance HasInitializeParams a b => HasInitializeParams (TF.Resource l p a) b where
...
instance HasInstanceDescription a b => HasInstanceDescription (TF.Resource l p a) b where
...
instance HasInstanceTemplate a b => HasInstanceTemplate (TF.Resource l p a) b where
...
instance HasInternalIpOnly a b => HasInternalIpOnly (TF.Resource l p a) b where
...
instance HasIpAllocationPolicy a b => HasIpAllocationPolicy (TF.Resource l p a) b where
    ipAllocationPolicy = TF.configuration . ipAllocationPolicy

class HasIpCidrRange a b | a -> b where
    ipCidrRange :: P.Lens' a b

instance HasIpCidrRange a b => HasIpCidrRange (TF.Resource l p a) b where
...
instance HasKeyRing a b => HasKeyRing (TF.Resource l p a) b where
    keyRing = TF.configuration . keyRing

class HasKeyRingId a b | a -> b where
    keyRingId :: P.Lens' a b

instance HasKeyRingId a b => HasKeyRingId (TF.Resource l p a) b where
    keyRingId = TF.configuration . keyRingId

class HasKubernetesDashboard a b | a -> b where
    kubernetesDashboard :: P.Lens' a b

instance HasKubernetesDashboard a b => HasKubernetesDashboard (TF.Resource l p a) b where
...
instance HasLicenses a b => HasLicenses (TF.Resource l p a) b where
...
instance HasListPolicy a b => HasListPolicy (TF.Resource l p a) b where
    listPolicy = TF.configuration . listPolicy

class HasLoadBalancingScheme a b | a -> b where
    loadBalancingScheme :: P.Lens' a b

instance HasLoadBalancingScheme a b => HasLoadBalancingScheme (TF.Resource l p a) b where
...
instance HasLoadBalancingUtilization a b => HasLoadBalancingUtilization (TF.Resource l p a) b where
...
instance HasLocalSsdCount a b => HasLocalSsdCount (TF.Resource l p a) b where
    localSsdCount = TF.configuration . localSsdCount

class HasLocalTrafficSelector a b | a -> b where
    localTrafficSelector :: P.Lens' a b

instance HasLocalTrafficSelector a b => HasLocalTrafficSelector (TF.Resource l p a) b where
...
instance HasLocationPreference a b => HasLocationPreference (TF.Resource l p a) b where
    locationPreference = TF.configuration . locationPreference

class HasLogBucket a b | a -> b where
    logBucket :: P.Lens' a b

instance HasLogBucket a b => HasLogBucket (TF.Resource l p a) b where
    logBucket = TF.configuration . logBucket

class HasLogObjectPrefix a b | a -> b where
    logObjectPrefix :: P.Lens' a b

instance HasLogObjectPrefix a b => HasLogObjectPrefix (TF.Resource l p a) b where
...
instance HasManagedZone a b => HasManagedZone (TF.Resource l p a) b where
...
instance HasMasterAuth a b => HasMasterAuth (TF.Resource l p a) b where
...
instance HasMasterAuthorizedNetworksConfig a b => HasMasterAuthorizedNetworksConfig (TF.Resource l p a) b where
...
instance HasMasterConfig a b => HasMasterConfig (TF.Resource l p a) b where
    masterConfig = TF.configuration . masterConfig

class HasMasterHeartbeatPeriod a b | a -> b where
    masterHeartbeatPeriod :: P.Lens' a b

instance HasMasterHeartbeatPeriod a b => HasMasterHeartbeatPeriod (TF.Resource l p a) b where
...
instance HasMasterInstanceName a b => HasMasterInstanceName (TF.Resource l p a) b where
...
instance HasMasterIpv4CidrBlock a b => HasMasterIpv4CidrBlock (TF.Resource l p a) b where
...
instance HasMatchesStorageClass a b => HasMatchesStorageClass (TF.Resource l p a) b where
...
instance HasMaxConnectionsPerInstance a b => HasMaxConnectionsPerInstance (TF.Resource l p a) b where
...
instance HasMaxUnavailablePercent a b => HasMaxUnavailablePercent (TF.Resource l p a) b where
...
instance HasMaxUtilization a b => HasMaxUtilization (TF.Resource l p a) b where
    maxUtilization = TF.configuration . maxUtilization

class HasMaxWorkers a b | a -> b where
    maxWorkers :: P.Lens' a b

instance HasMaxWorkers a b => HasMaxWorkers (TF.Resource l p a) b where
...
instance HasMembers a b => HasMembers (TF.Resource l p a) b where
    members = TF.configuration . members

class HasMemorySizeGb a b | a -> b where
    memorySizeGb :: P.Lens' a b

instance HasMemorySizeGb a b => HasMemorySizeGb (TF.Resource l p a) b where
...
instance HasMetadataStartupScript a b => HasMetadataStartupScript (TF.Resource l p a) b where
...
instance HasMinimalAction a b => HasMinimalAction (TF.Resource l p a) b where
...
instance HasMonitoringService a b => HasMonitoringService (TF.Resource l p a) b where
    monitoringService = TF.configuration . monitoringService

class HasMqttConfig a b | a -> b where
    mqttConfig :: P.Lens' a b

instance HasMqttConfig a b => HasMqttConfig (TF.Resource l p a) b where
    mqttConfig = TF.configuration . mqttConfig

class HasMqttEnabledState a b | a -> b where
    mqttEnabledState :: P.Lens' a b

instance HasMqttEnabledState a b => HasMqttEnabledState (TF.Resource l p a) b where
...
instance HasNamedPort a b => HasNamedPort (TF.Resource l p a) b where
    namedPort = TF.configuration . namedPort

class HasNatIp a b | a -> b where
    natIp :: P.Lens' a b

instance HasNatIp a b => HasNatIp (TF.Resource l p a) b where
...
instance HasOverrideProperties a b => HasOverrideProperties (TF.Resource l p a) b where
...
instance HasPathMatcher a b => HasPathMatcher (TF.Resource l p a) b where
...
instance HasPayloadFormat a b => HasPayloadFormat (TF.Resource l p a) b where
...
instance HasPigConfig a b => HasPigConfig (TF.Resource l p a) b where
...
instance HasPodSecurityPolicyConfig a b => HasPodSecurityPolicyConfig (TF.Resource l p a) b where
    podSecurityPolicyConfig = TF.configuration . podSecurityPolicyConfig

class HasPolicyData a b | a -> b where
    policyData :: P.Lens' a b

instance HasPolicyData a b => HasPolicyData (TF.Resource l p a) b where
...
instance HasPortName a b => HasPortName (TF.Resource l p a) b where
...
instance HasPredefinedAcl a b => HasPredefinedAcl (TF.Resource l p a) b where
    predefinedAcl = TF.configuration . predefinedAcl

class HasPreemptible a b | a -> b where
    preemptible :: P.Lens' a b

instance HasPreemptible a b => HasPreemptible (TF.Resource l p a) b where
    preemptible = TF.configuration . preemptible

class HasPreemptibleWorkerConfig a b | a -> b where
    preemptibleWorkerConfig :: P.Lens' a b

instance HasPreemptibleWorkerConfig a b => HasPreemptibleWorkerConfig (TF.Resource l p a) b where
...
instance HasPreview a b => HasPreview (TF.Resource l p a) b where
    preview = TF.configuration . preview

class HasPricingPlan a b | a -> b where
    pricingPlan :: P.Lens' a b

instance HasPricingPlan a b => HasPricingPlan (TF.Resource l p a) b where
...
instance HasPrivateCluster a b => HasPrivateCluster (TF.Resource l p a) b where
...
instance HasPrivateIpGoogleAccess a b => HasPrivateIpGoogleAccess (TF.Resource l p a) b where
...
instance HasPrivateKeyType a b => HasPrivateKeyType (TF.Resource l p a) b where
...
instance HasProtocOutputBase64 a b => HasProtocOutputBase64 (TF.Resource l p a) b where
...
instance HasQueryFileUri a b => HasQueryFileUri (TF.Resource l p a) b where
    queryFileUri = TF.configuration . queryFileUri

class HasQueryList a b | a -> b where
    queryList :: P.Lens' a b

instance HasQueryList a b => HasQueryList (TF.Resource l p a) b where
    queryList = TF.configuration . queryList

class HasQueryStringBlacklist a b | a -> b where
    queryStringBlacklist :: P.Lens' a b

instance HasQueryStringBlacklist a b => HasQueryStringBlacklist (TF.Resource l p a) b where
...
instance HasQueryStringWhitelist a b => HasQueryStringWhitelist (TF.Resource l p a) b where
    queryStringWhitelist = TF.configuration . queryStringWhitelist

class HasQuicOverride a b | a -> b where
    quicOverride :: P.Lens' a b

instance HasQuicOverride a b => HasQuicOverride (TF.Resource l p a) b where
...
instance HasRemoteTrafficSelector a b => HasRemoteTrafficSelector (TF.Resource l p a) b where
...
instance HasRemoveDefaultNodePool a b => HasRemoveDefaultNodePool (TF.Resource l p a) b where
...
instance HasRetryOnFailure a b => HasRetryOnFailure (TF.Resource l p a) b where
...
instance HasRoleEntity a b => HasRoleEntity (TF.Resource l p a) b where
...
instance HasScheduling a b => HasScheduling (TF.Resource l p a) b where
...
instance HasServiceAccount a b => HasServiceAccount (TF.Resource l p a) b where
    serviceAccount = TF.configuration . serviceAccount

class HasServiceAccountId a b | a -> b where
    serviceAccountId :: P.Lens' a b

instance HasServiceAccountId a b => HasServiceAccountId (TF.Resource l p a) b where
...
instance HasServiceAccountScopes a b => HasServiceAccountScopes (TF.Resource l p a) b where
    serviceAccountScopes = TF.configuration . serviceAccountScopes

class HasServiceLabel a b | a -> b where
    serviceLabel :: P.Lens' a b

instance HasServiceLabel a b => HasServiceLabel (TF.Resource l p a) b where
...
instance HasServiceProject a b => HasServiceProject (TF.Resource l p a) b where
...
instance HasServicesSecondaryRangeName a b => HasServicesSecondaryRangeName (TF.Resource l p a) b where
...
instance HasServingStatus a b => HasServingStatus (TF.Resource l p a) b where
    servingStatus = TF.configuration . servingStatus

class HasSessionAffinity a b | a -> b where
    sessionAffinity :: P.Lens' a b

instance HasSessionAffinity a b => HasSessionAffinity (TF.Resource l p a) b where
...
instance HasSha1 a b => HasSha1 (TF.Resource l p a) b where
    sha1 = TF.configuration . sha1

class HasSharedSecret a b | a -> b where
    sharedSecret :: P.Lens' a b

instance HasSharedSecret a b => HasSharedSecret (TF.Resource l p a) b where
...
instance HasSkipDelete a b => HasSkipDelete (TF.Resource l p a) b where
...
instance HasSnapshotEncryptionKeyRaw a b => HasSnapshotEncryptionKeyRaw (TF.Resource l p a) b where
...
instance HasSoftwareConfig a b => HasSoftwareConfig (TF.Resource l p a) b where
...
instance HasSourceArchiveBucket a b => HasSourceArchiveBucket (TF.Resource l p a) b where
...
instance HasSourceArchiveObject a b => HasSourceArchiveObject (TF.Resource l p a) b where
    sourceArchiveObject = TF.configuration . sourceArchiveObject

class HasSourceDisk a b | a -> b where
    sourceDisk :: P.Lens' a b

instance HasSourceDisk a b => HasSourceDisk (TF.Resource l p a) b where
...
instance HasSourceDiskEncryptionKeyRaw a b => HasSourceDiskEncryptionKeyRaw (TF.Resource l p a) b where
...
instance HasSourceImage a b => HasSourceImage (TF.Resource l p a) b where
...
instance HasSourceImageEncryptionKey a b => HasSourceImageEncryptionKey (TF.Resource l p a) b where
...
instance HasSourceInstanceTemplate a b => HasSourceInstanceTemplate (TF.Resource l p a) b where
    sourceInstanceTemplate = TF.configuration . sourceInstanceTemplate

class HasSourceRanges a b | a -> b where
    sourceRanges :: P.Lens' a b

instance HasSourceRanges a b => HasSourceRanges (TF.Resource l p a) b where
    sourceRanges = TF.configuration . sourceRanges

class HasSourceServiceAccounts a b | a -> b where
    sourceServiceAccounts :: P.Lens' a b

instance HasSourceServiceAccounts a b => HasSourceServiceAccounts (TF.Resource l p a) b where
...
instance HasSourceSnapshotEncryptionKey a b => HasSourceSnapshotEncryptionKey (TF.Resource l p a) b where
...
instance HasStagingBucket a b => HasStagingBucket (TF.Resource l p a) b where
...
instance HasStateNotificationConfig a b => HasStateNotificationConfig (TF.Resource l p a) b where
...
instance HasSubnetwork a b => HasSubnetwork (TF.Resource l p a) b where
    subnetwork = TF.configuration . subnetwork

class HasSubnetworkProject a b | a -> b where
    subnetworkProject :: P.Lens' a b

instance HasSubnetworkProject a b => HasSubnetworkProject (TF.Resource l p a) b where
...
instance HasTagName a b => HasTagName (TF.Resource l p a) b where
...
instance HasTaint a b => HasTaint (TF.Resource l p a) b where
...
instance HasTimePartitioning a b => HasTimePartitioning (TF.Resource l p a) b where
    timePartitioning = TF.configuration . timePartitioning

class HasTimeToRetire a b | a -> b where
    timeToRetire :: P.Lens' a b

instance HasTimeToRetire a b => HasTimeToRetire (TF.Resource l p a) b where
...
instance HasTimeoutSec a b => HasTimeoutSec (TF.Resource l p a) b where
...
instance HasVerifyServerCertificate a b => HasVerifyServerCertificate (TF.Resource l p a) b where
...
instance HasVersionedExpr a b => HasVersionedExpr (TF.Resource l p a) b where
...
instance HasView a b => HasView (TF.Resource l p a) b where
    view = TF.configuration . view

class HasVpnTunnel a b | a -> b where
    vpnTunnel :: P.Lens' a b

instance HasVpnTunnel a b => HasVpnTunnel (TF.Resource l p a) b where
    vpnTunnel = TF.configuration . vpnTunnel

class HasWaitForInstances a b | a -> b where
    waitForInstances :: P.Lens' a b

instance HasWaitForInstances a b => HasWaitForInstances (TF.Resource l p a) b where
...
instance HasWorkerConfig a b => HasWorkerConfig (TF.Resource l p a) b where
    workerConfig = TF.configuration . workerConfig

class HasWorkloadMetadataConfig a b | a -> b where
    workloadMetadataConfig :: P.Lens' a b

instance HasWorkloadMetadataConfig a b => HasWorkloadMetadataConfig (TF.Resource l p a) b where
