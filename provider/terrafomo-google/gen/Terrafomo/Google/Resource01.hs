...
instance P.HasDefaultTableExpirationMs (BigqueryDatasetResource s) (TF.Attr s P.Integer) where
    defaultTableExpirationMs =
        P.lens (_defaultTableExpirationMs :: BigqueryDatasetResource s -> TF.Attr s P.Integer)
               (\s a -> s { _defaultTableExpirationMs = a
                          } :: BigqueryDatasetResource s)
...
instance P.HasAvailableMemoryMb (CloudfunctionsFunctionResource s) (TF.Attr s P.Integer) where
    availableMemoryMb =
        P.lens (_availableMemoryMb :: CloudfunctionsFunctionResource s -> TF.Attr s P.Integer)
               (\s a -> s { _availableMemoryMb = a
                          } :: CloudfunctionsFunctionResource s)
...
data CloudiotRegistryResource s = CloudiotRegistryResource'
    { _credentials :: TF.Attr s [Credentials s]
...
instance P.HasCredentials (CloudiotRegistryResource s) (TF.Attr s [Credentials s]) where
    credentials =
        P.lens (_credentials :: CloudiotRegistryResource s -> TF.Attr s [Credentials s])
               (\s a -> s { _credentials = a
                          } :: CloudiotRegistryResource s)
...
instance P.HasEventNotificationConfig (CloudiotRegistryResource s) (TF.Attr s (P.HashMap P.Text (EventNotificationConfig s))) where
    eventNotificationConfig =
        P.lens (_eventNotificationConfig :: CloudiotRegistryResource s -> TF.Attr s (P.HashMap P.Text (EventNotificationConfig s)))
               (\s a -> s { _eventNotificationConfig = a
                          } :: CloudiotRegistryResource s)
...
instance P.HasStateNotificationConfig (CloudiotRegistryResource s) (TF.Attr s (P.HashMap P.Text (StateNotificationConfig s))) where
    stateNotificationConfig =
        P.lens (_stateNotificationConfig :: CloudiotRegistryResource s -> TF.Attr s (P.HashMap P.Text (StateNotificationConfig s)))
               (\s a -> s { _stateNotificationConfig = a
                          } :: CloudiotRegistryResource s)
...
instance TF.IsObject (ComputeAddressResource s) where
    toObject ComputeAddressResource'{..} = catMaybes
...
instance P.HasAddressType (ComputeAddressResource s) (TF.Attr s P.Text) where
    addressType =
        P.lens (_addressType :: ComputeAddressResource s -> TF.Attr s P.Text)
               (\s a -> s { _addressType = a
                          } :: ComputeAddressResource s)
...
instance TF.IsObject (ComputeAutoscalerResource s) where
    toObject ComputeAutoscalerResource'{..} = catMaybes
...
instance TF.IsObject (ComputeBackendBucketResource s) where
    toObject ComputeBackendBucketResource'{..} = catMaybes
...
instance P.HasBucketName (ComputeBackendBucketResource s) (TF.Attr s P.Text) where
    bucketName =
        P.lens (_bucketName :: ComputeBackendBucketResource s -> TF.Attr s P.Text)
               (\s a -> s { _bucketName = a
                          } :: ComputeBackendBucketResource s)
...
data ComputeBackendServiceResource s = ComputeBackendServiceResource'
    ...
    --
    , _customRequestHeaders         :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    -- ^ @enable_cdn@ - (Optional)
    --
    , _healthChecks                 :: TF.Attr s (TF.Attr s (TF.Attr s P.Text))
...
computeBackendServiceResource
    :: TF.Attr s (TF.Attr s (TF.Attr s P.Text)) -- ^ @health_checks@ - 'P.healthChecks'
    -> TF.Attr s P.Text -- ^ @name@ - 'P.name'
...
instance P.HasBackend (ComputeBackendServiceResource s) (TF.Attr s [TF.Attr s (Backend s)]) where
    backend =
        P.lens (_backend :: ComputeBackendServiceResource s -> TF.Attr s [TF.Attr s (Backend s)])
               (\s a -> s { _backend = a
                          } :: ComputeBackendServiceResource s)
...
instance P.HasConnectionDrainingTimeoutSec (ComputeBackendServiceResource s) (TF.Attr s P.Integer) where
    connectionDrainingTimeoutSec =
        P.lens (_connectionDrainingTimeoutSec :: ComputeBackendServiceResource s -> TF.Attr s P.Integer)
               (\s a -> s { _connectionDrainingTimeoutSec = a
                          } :: ComputeBackendServiceResource s)

instance P.HasCustomRequestHeaders (ComputeBackendServiceResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    customRequestHeaders =
        P.lens (_customRequestHeaders :: ComputeBackendServiceResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _customRequestHeaders = a
                          } :: ComputeBackendServiceResource s)
...
instance P.HasHealthChecks (ComputeBackendServiceResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    healthChecks =
        P.lens (_healthChecks :: ComputeBackendServiceResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
               (\s a -> s { _healthChecks = a
                          } :: ComputeBackendServiceResource s)
...
instance TF.IsObject (ComputeDiskResource s) where
    toObject ComputeDiskResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
...
instance P.HasSourceImageEncryptionKey (ComputeDiskResource s) (TF.Attr s (SourceImageEncryptionKey s)) where
    sourceImageEncryptionKey =
        P.lens (_sourceImageEncryptionKey :: ComputeDiskResource s -> TF.Attr s (SourceImageEncryptionKey s))
               (\s a -> s { _sourceImageEncryptionKey = a
                          } :: ComputeDiskResource s)
...
instance P.HasSourceSnapshotEncryptionKey (ComputeDiskResource s) (TF.Attr s (SourceSnapshotEncryptionKey s)) where
    sourceSnapshotEncryptionKey =
        P.lens (_sourceSnapshotEncryptionKey :: ComputeDiskResource s -> TF.Attr s (SourceSnapshotEncryptionKey s))
               (\s a -> s { _sourceSnapshotEncryptionKey = a
                          } :: ComputeDiskResource s)
...
data ComputeFirewallResource s = ComputeFirewallResource'
    ...
    -- ^ @priority@ - (Optional)
    --
    , _sourceServiceAccounts :: TF.Attr s (TF.Attr s (TF.Attr s P.Text))
    ...
    -- * 'sourceTags'
    -- * 'targetTags'
    , _sourceTags            :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    ...
    , _targetServiceAccounts :: TF.Attr s (TF.Attr s (TF.Attr s P.Text))
    ...
    -- * 'sourceTags'
    -- * 'targetTags'
    , _targetTags            :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance P.HasSourceServiceAccounts (ComputeFirewallResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    sourceServiceAccounts =
        P.lens (_sourceServiceAccounts :: ComputeFirewallResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
               (\s a -> s { _sourceServiceAccounts = a
                          , _sourceTags = TF.Nil
                          , _targetTags = TF.Nil
                          } :: ComputeFirewallResource s)

instance P.HasSourceTags (ComputeFirewallResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    sourceTags =
        P.lens (_sourceTags :: ComputeFirewallResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _sourceTags = a
                          , _sourceServiceAccounts = TF.Nil
                          , _targetServiceAccounts = TF.Nil
                          } :: ComputeFirewallResource s)

instance P.HasTargetServiceAccounts (ComputeFirewallResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    targetServiceAccounts =
        P.lens (_targetServiceAccounts :: ComputeFirewallResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
               (\s a -> s { _targetServiceAccounts = a
                          , _sourceTags = TF.Nil
                          , _targetTags = TF.Nil
                          } :: ComputeFirewallResource s)

instance P.HasTargetTags (ComputeFirewallResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    targetTags =
        P.lens (_targetTags :: ComputeFirewallResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _targetTags = a
                          , _sourceServiceAccounts = TF.Nil
                          , _targetServiceAccounts = TF.Nil
                          } :: ComputeFirewallResource s)

instance s ~ s' => P.HasComputedDestinationRanges (TF.Ref s' (ComputeFirewallResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance s ~ s' => P.HasComputedSourceRanges (TF.Ref s' (ComputeFirewallResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance TF.IsObject (ComputeForwardingRuleResource s) where
    toObject ComputeForwardingRuleResource'{..} = catMaybes
...
instance P.HasBackendService (ComputeForwardingRuleResource s) (TF.Attr s P.Text) where
    backendService =
        P.lens (_backendService :: ComputeForwardingRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _backendService = a
                          } :: ComputeForwardingRuleResource s)
...
instance P.HasPorts (ComputeForwardingRuleResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    ports =
        P.lens (_ports :: ComputeForwardingRuleResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _ports = a
                          } :: ComputeForwardingRuleResource s)
...
instance TF.IsObject (ComputeGlobalAddressResource s) where
    toObject ComputeGlobalAddressResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
        , TF.assign "ip_version" <$> TF.attribute _ipVersion
        , TF.assign "labels" <$> TF.attribute _labels
        , TF.assign "name" <$> TF.attribute _name
...
instance P.HasDescription (ComputeGlobalAddressResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeGlobalAddressResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeGlobalAddressResource s)
...
instance P.HasDescription (ComputeGlobalForwardingRuleResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeGlobalForwardingRuleResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeGlobalForwardingRuleResource s)
...
instance P.HasCheckIntervalSec (ComputeHealthCheckResource s) (TF.Attr s P.Integer) where
    checkIntervalSec =
        P.lens (_checkIntervalSec :: ComputeHealthCheckResource s -> TF.Attr s P.Integer)
               (\s a -> s { _checkIntervalSec = a
                          } :: ComputeHealthCheckResource s)
...
instance TF.IsObject (ComputeHttpHealthCheckResource s) where
    toObject ComputeHttpHealthCheckResource'{..} = catMaybes
        [ TF.assign "check_interval_sec" <$> TF.attribute _checkIntervalSec
        , TF.assign "description" <$> TF.attribute _description
        , TF.assign "healthy_threshold" <$> TF.attribute _healthyThreshold
...
instance P.HasCheckIntervalSec (ComputeHttpHealthCheckResource s) (TF.Attr s P.Integer) where
    checkIntervalSec =
        P.lens (_checkIntervalSec :: ComputeHttpHealthCheckResource s -> TF.Attr s P.Integer)
               (\s a -> s { _checkIntervalSec = a
                          } :: ComputeHttpHealthCheckResource s)
...
instance TF.IsObject (ComputeHttpsHealthCheckResource s) where
    toObject ComputeHttpsHealthCheckResource'{..} = catMaybes
        [ TF.assign "check_interval_sec" <$> TF.attribute _checkIntervalSec
        , TF.assign "description" <$> TF.attribute _description
        , TF.assign "healthy_threshold" <$> TF.attribute _healthyThreshold
        , TF.assign "host" <$> TF.attribute _host
...
instance P.HasCheckIntervalSec (ComputeHttpsHealthCheckResource s) (TF.Attr s P.Integer) where
    checkIntervalSec =
        P.lens (_checkIntervalSec :: ComputeHttpsHealthCheckResource s -> TF.Attr s P.Integer)
               (\s a -> s { _checkIntervalSec = a
                          } :: ComputeHttpsHealthCheckResource s)
...
instance P.HasCreateTimeout (ComputeImageResource s) (TF.Attr s P.Integer) where
    createTimeout =
        P.lens (_createTimeout :: ComputeImageResource s -> TF.Attr s P.Integer)
               (\s a -> s { _createTimeout = a
                          } :: ComputeImageResource s)
...
data ComputeInstanceResource s = ComputeInstanceResource'
    ...
    --
    , _attachedDisk           :: TF.Attr s [AttachedDisk s]
    ...
    --
    , _scratchDisk            :: TF.Attr s [ScratchDisk s]
...
instance P.HasAllowStoppingForUpdate (ComputeInstanceResource s) (TF.Attr s P.Bool) where
    allowStoppingForUpdate =
        P.lens (_allowStoppingForUpdate :: ComputeInstanceResource s -> TF.Attr s P.Bool)
               (\s a -> s { _allowStoppingForUpdate = a
                          } :: ComputeInstanceResource s)

instance P.HasAttachedDisk (ComputeInstanceResource s) (TF.Attr s [AttachedDisk s]) where
    attachedDisk =
        P.lens (_attachedDisk :: ComputeInstanceResource s -> TF.Attr s [AttachedDisk s])
               (\s a -> s { _attachedDisk = a
                          } :: ComputeInstanceResource s)
...
instance P.HasDisk (ComputeInstanceResource s) (TF.Attr s [Disk s]) where
    disk =
        P.lens (_disk :: ComputeInstanceResource s -> TF.Attr s [Disk s])
               (\s a -> s { _disk = a
                          } :: ComputeInstanceResource s)
...
instance P.HasMetadataStartupScript (ComputeInstanceResource s) (TF.Attr s P.Text) where
    metadataStartupScript =
        P.lens (_metadataStartupScript :: ComputeInstanceResource s -> TF.Attr s P.Text)
               (\s a -> s { _metadataStartupScript = a
                          } :: ComputeInstanceResource s)
...
instance P.HasNetwork (ComputeInstanceResource s) (TF.Attr s [Network s]) where
    network =
        P.lens (_network :: ComputeInstanceResource s -> TF.Attr s [Network s])
               (\s a -> s { _network = a
                          } :: ComputeInstanceResource s)

instance P.HasNetworkInterface (ComputeInstanceResource s) (TF.Attr s [NetworkInterface s]) where
    networkInterface =
        P.lens (_networkInterface :: ComputeInstanceResource s -> TF.Attr s [NetworkInterface s])
               (\s a -> s { _networkInterface = a
                          } :: ComputeInstanceResource s)

instance P.HasScratchDisk (ComputeInstanceResource s) (TF.Attr s [ScratchDisk s]) where
    scratchDisk =
        P.lens (_scratchDisk :: ComputeInstanceResource s -> TF.Attr s [ScratchDisk s])
               (\s a -> s { _scratchDisk = a
                          } :: ComputeInstanceResource s)
...
instance P.HasTags (ComputeInstanceResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    tags =
        P.lens (_tags :: ComputeInstanceResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _tags = a
                          } :: ComputeInstanceResource s)
...
instance s ~ s' => P.HasComputedGuestAccelerator (TF.Ref s' (ComputeInstanceResource s)) (TF.Attr s [GuestAccelerator s]) where
...
instance P.HasName (ComputeInstanceFromTemplateResource s) (TF.Attr s P.Text) where
    name =
        P.lens (_name :: ComputeInstanceFromTemplateResource s -> TF.Attr s P.Text)
               (\s a -> s { _name = a
                          } :: ComputeInstanceFromTemplateResource s)
...
instance P.HasSourceInstanceTemplate (ComputeInstanceFromTemplateResource s) (TF.Attr s P.Text) where
    sourceInstanceTemplate =
        P.lens (_sourceInstanceTemplate :: ComputeInstanceFromTemplateResource s -> TF.Attr s P.Text)
               (\s a -> s { _sourceInstanceTemplate = a
                          } :: ComputeInstanceFromTemplateResource s)
...
instance s ~ s' => P.HasComputedAttachedDisk (TF.Ref s' (ComputeInstanceFromTemplateResource s)) (TF.Attr s [AttachedDisk s]) where
...
instance s ~ s' => P.HasComputedGuestAccelerator (TF.Ref s' (ComputeInstanceFromTemplateResource s)) (TF.Attr s [GuestAccelerator s]) where
    computedGuestAccelerator x = TF.compute (TF.refKey x) "_computedGuestAccelerator"
...
instance s ~ s' => P.HasComputedNetworkInterface (TF.Ref s' (ComputeInstanceFromTemplateResource s)) (TF.Attr s [NetworkInterface s]) where
...
instance s ~ s' => P.HasComputedScratchDisk (TF.Ref s' (ComputeInstanceFromTemplateResource s)) (TF.Attr s [ScratchDisk s]) where
...
instance s ~ s' => P.HasComputedTags (TF.Ref s' (ComputeInstanceFromTemplateResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
data ComputeInstanceGroupResource s = ComputeInstanceGroupResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _namedPort   :: TF.Attr s [NamedPort s]
    -- ^ @named_port@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Generic)
...
instance P.HasDescription (ComputeInstanceGroupResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeInstanceGroupResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeInstanceGroupResource s)
...
instance P.HasNamedPort (ComputeInstanceGroupResource s) (TF.Attr s [NamedPort s]) where
    namedPort =
        P.lens (_namedPort :: ComputeInstanceGroupResource s -> TF.Attr s [NamedPort s])
               (\s a -> s { _namedPort = a
                          } :: ComputeInstanceGroupResource s)

instance s ~ s' => P.HasComputedInstances (TF.Ref s' (ComputeInstanceGroupResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
data ComputeInstanceGroupManagerResource s = ComputeInstanceGroupManagerResource'
    ...
    --
    , _targetPools         :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance P.HasAutoHealingPolicies (ComputeInstanceGroupManagerResource s) (TF.Attr s (AutoHealingPolicies s)) where
    autoHealingPolicies =
        P.lens (_autoHealingPolicies :: ComputeInstanceGroupManagerResource s -> TF.Attr s (AutoHealingPolicies s))
               (\s a -> s { _autoHealingPolicies = a
                          } :: ComputeInstanceGroupManagerResource s)
...
instance P.HasNamedPort (ComputeInstanceGroupManagerResource s) (TF.Attr s [NamedPort s]) where
    namedPort =
        P.lens (_namedPort :: ComputeInstanceGroupManagerResource s -> TF.Attr s [NamedPort s])
               (\s a -> s { _namedPort = a
                          } :: ComputeInstanceGroupManagerResource s)
...
instance P.HasRollingUpdatePolicy (ComputeInstanceGroupManagerResource s) (TF.Attr s (RollingUpdatePolicy s)) where
    rollingUpdatePolicy =
        P.lens (_rollingUpdatePolicy :: ComputeInstanceGroupManagerResource s -> TF.Attr s (RollingUpdatePolicy s))
               (\s a -> s { _rollingUpdatePolicy = a
                          } :: ComputeInstanceGroupManagerResource s)

instance P.HasTargetPools (ComputeInstanceGroupManagerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    targetPools =
        P.lens (_targetPools :: ComputeInstanceGroupManagerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _targetPools = a
                          } :: ComputeInstanceGroupManagerResource s)
...
instance s ~ s' => P.HasComputedVersion (TF.Ref s' (ComputeInstanceGroupManagerResource s)) (TF.Attr s [Version s]) where
...
data ComputeInstanceTemplateResource s = ComputeInstanceTemplateResource'
    ...
    -- ^ @disk@ - (Required)
    --
    , _guestAccelerator      :: TF.Attr s [GuestAccelerator s]
...
instance P.HasAutomaticRestart (ComputeInstanceTemplateResource s) (TF.Attr s P.Bool) where
    automaticRestart =
        P.lens (_automaticRestart :: ComputeInstanceTemplateResource s -> TF.Attr s P.Bool)
               (\s a -> s { _automaticRestart = a
                          } :: ComputeInstanceTemplateResource s)
...
instance P.HasDisk (ComputeInstanceTemplateResource s) (TF.Attr s [Disk s]) where
    disk =
        P.lens (_disk :: ComputeInstanceTemplateResource s -> TF.Attr s [Disk s])
               (\s a -> s { _disk = a
                          } :: ComputeInstanceTemplateResource s)

instance P.HasGuestAccelerator (ComputeInstanceTemplateResource s) (TF.Attr s [GuestAccelerator s]) where
    guestAccelerator =
        P.lens (_guestAccelerator :: ComputeInstanceTemplateResource s -> TF.Attr s [GuestAccelerator s])
               (\s a -> s { _guestAccelerator = a
                          } :: ComputeInstanceTemplateResource s)
...
instance P.HasNetworkInterface (ComputeInstanceTemplateResource s) (TF.Attr s [NetworkInterface s]) where
    networkInterface =
        P.lens (_networkInterface :: ComputeInstanceTemplateResource s -> TF.Attr s [NetworkInterface s])
               (\s a -> s { _networkInterface = a
                          } :: ComputeInstanceTemplateResource s)
...
instance P.HasTags (ComputeInstanceTemplateResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    tags =
        P.lens (_tags :: ComputeInstanceTemplateResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _tags = a
                          } :: ComputeInstanceTemplateResource s)
...
instance s ~ s' => P.HasComputedScheduling (TF.Ref s' (ComputeInstanceTemplateResource s)) (TF.Attr s [Scheduling s]) where
    computedScheduling x = TF.compute (TF.refKey x) "_computedScheduling"
...
instance P.HasAutoCreateSubnetworks (ComputeNetworkResource s) (TF.Attr s P.Bool) where
    autoCreateSubnetworks =
        P.lens (_autoCreateSubnetworks :: ComputeNetworkResource s -> TF.Attr s P.Bool)
               (\s a -> s { _autoCreateSubnetworks = a
                          } :: ComputeNetworkResource s)
...
instance P.HasAutoCreateRoutes (ComputeNetworkPeeringResource s) (TF.Attr s P.Bool) where
    autoCreateRoutes =
        P.lens (_autoCreateRoutes :: ComputeNetworkPeeringResource s -> TF.Attr s P.Bool)
               (\s a -> s { _autoCreateRoutes = a
                          } :: ComputeNetworkPeeringResource s)
...
instance P.HasMetadata (ComputeProjectMetadataResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    metadata =
        P.lens (_metadata :: ComputeProjectMetadataResource s -> TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text)))
               (\s a -> s { _metadata = a
                          } :: ComputeProjectMetadataResource s)
...
instance P.HasKey (ComputeProjectMetadataItemResource s) (TF.Attr s P.Text) where
    key =
        P.lens (_key :: ComputeProjectMetadataItemResource s -> TF.Attr s P.Text)
               (\s a -> s { _key = a
                          } :: ComputeProjectMetadataItemResource s)
...
instance TF.IsObject (ComputeRegionAutoscalerResource s) where
    toObject ComputeRegionAutoscalerResource'{..} = catMaybes
        [ TF.assign "autoscaling_policy" <$> TF.attribute _autoscalingPolicy
        , TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
        , TF.assign "target" <$> TF.attribute _target
...
instance P.HasAutoscalingPolicy (ComputeRegionAutoscalerResource s) (TF.Attr s (AutoscalingPolicy s)) where
    autoscalingPolicy =
        P.lens (_autoscalingPolicy :: ComputeRegionAutoscalerResource s -> TF.Attr s (AutoscalingPolicy s))
               (\s a -> s { _autoscalingPolicy = a
                          } :: ComputeRegionAutoscalerResource s)
...
instance P.HasBackend (ComputeRegionBackendServiceResource s) (TF.Attr s [TF.Attr s (Backend s)]) where
    backend =
        P.lens (_backend :: ComputeRegionBackendServiceResource s -> TF.Attr s [TF.Attr s (Backend s)])
               (\s a -> s { _backend = a
                          } :: ComputeRegionBackendServiceResource s)
...
instance P.HasHealthChecks (ComputeRegionBackendServiceResource s) (TF.Attr s (TF.Attr s (TF.Attr s P.Text))) where
    healthChecks =
        P.lens (_healthChecks :: ComputeRegionBackendServiceResource s -> TF.Attr s (TF.Attr s (TF.Attr s P.Text)))
               (\s a -> s { _healthChecks = a
                          } :: ComputeRegionBackendServiceResource s)
...
instance TF.IsObject (ComputeRegionDiskResource s) where
    toObject ComputeRegionDiskResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
        , TF.assign "disk_encryption_key" <$> TF.attribute _diskEncryptionKey
        , TF.assign "labels" <$> TF.attribute _labels
        , TF.assign "name" <$> TF.attribute _name
...
computeRegionDiskResource _name _replicaZones =
    TF.newResource "google_compute_region_disk" $
        ComputeRegionDiskResource'
            { _description = TF.Nil
            , _diskEncryptionKey = TF.Nil
            , _labels = TF.Nil
...
instance P.HasAutoHealingPolicies (ComputeRegionInstanceGroupManagerResource s) (TF.Attr s (AutoHealingPolicies s)) where
    autoHealingPolicies =
        P.lens (_autoHealingPolicies :: ComputeRegionInstanceGroupManagerResource s -> TF.Attr s (AutoHealingPolicies s))
               (\s a -> s { _autoHealingPolicies = a
                          } :: ComputeRegionInstanceGroupManagerResource s)
...
instance P.HasNamedPort (ComputeRegionInstanceGroupManagerResource s) (TF.Attr s [NamedPort s]) where
    namedPort =
        P.lens (_namedPort :: ComputeRegionInstanceGroupManagerResource s -> TF.Attr s [NamedPort s])
               (\s a -> s { _namedPort = a
                          } :: ComputeRegionInstanceGroupManagerResource s)
...
instance P.HasTargetPools (ComputeRegionInstanceGroupManagerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    targetPools =
        P.lens (_targetPools :: ComputeRegionInstanceGroupManagerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _targetPools = a
                          } :: ComputeRegionInstanceGroupManagerResource s)
...
instance s ~ s' => P.HasComputedDistributionPolicyZones (TF.Ref s' (ComputeRegionInstanceGroupManagerResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance s ~ s' => P.HasComputedVersion (TF.Ref s' (ComputeRegionInstanceGroupManagerResource s)) (TF.Attr s [Version s]) where
    computedVersion x = TF.compute (TF.refKey x) "_computedVersion"
...
instance P.HasTags (ComputeRouteResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    tags =
        P.lens (_tags :: ComputeRouteResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _tags = a
                          } :: ComputeRouteResource s)
...
instance P.HasIpRange (ComputeRouterInterfaceResource s) (TF.Attr s P.Text) where
    ipRange =
        P.lens (_ipRange :: ComputeRouterInterfaceResource s -> TF.Attr s P.Text)
               (\s a -> s { _ipRange = a
                          } :: ComputeRouterInterfaceResource s)
...
instance TF.IsObject (ComputeRouterPeerResource s) where
    toObject ComputeRouterPeerResource'{..} = catMaybes
...
computeRouterPeerResource _interface _name _peerAsn _router =
    TF.newResource "google_compute_router_peer" $
        ComputeRouterPeerResource'
...
instance P.HasAdvertisedRoutePriority (ComputeRouterPeerResource s) (TF.Attr s P.Integer) where
    advertisedRoutePriority =
        P.lens (_advertisedRoutePriority :: ComputeRouterPeerResource s -> TF.Attr s P.Integer)
               (\s a -> s { _advertisedRoutePriority = a
                          } :: ComputeRouterPeerResource s)
...
instance P.HasDescription (ComputeSecurityPolicyResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeSecurityPolicyResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeSecurityPolicyResource s)
...
instance P.HasProject (ComputeSharedVpcHostProjectResource s) (TF.Attr s P.Text) where
    project =
        P.lens (_project :: ComputeSharedVpcHostProjectResource s -> TF.Attr s P.Text)
               (\s a -> s { _project = a
                          } :: ComputeSharedVpcHostProjectResource s)
...
instance P.HasHostProject (ComputeSharedVpcServiceProjectResource s) (TF.Attr s P.Text) where
    hostProject =
        P.lens (_hostProject :: ComputeSharedVpcServiceProjectResource s -> TF.Attr s P.Text)
               (\s a -> s { _hostProject = a
                          } :: ComputeSharedVpcServiceProjectResource s)
...
instance P.HasSnapshotEncryptionKeyRaw (ComputeSnapshotResource s) (TF.Attr s P.Text) where
    snapshotEncryptionKeyRaw =
        P.lens (_snapshotEncryptionKeyRaw :: ComputeSnapshotResource s -> TF.Attr s P.Text)
               (\s a -> s { _snapshotEncryptionKeyRaw = a
                          } :: ComputeSnapshotResource s)
...
instance P.HasSourceDiskEncryptionKeyRaw (ComputeSnapshotResource s) (TF.Attr s P.Text) where
    sourceDiskEncryptionKeyRaw =
        P.lens (_sourceDiskEncryptionKeyRaw :: ComputeSnapshotResource s -> TF.Attr s P.Text)
               (\s a -> s { _sourceDiskEncryptionKeyRaw = a
                          } :: ComputeSnapshotResource s)
    ...
    certificate =
        P.lens (_certificate :: ComputeSslCertificateResource s -> TF.Attr s P.Text)
               (\s a -> s { _certificate = a
                          } :: ComputeSslCertificateResource s)
...
data ComputeSslPolicyResource s = ComputeSslPolicyResource'
    { _customFeatures :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance TF.IsObject (ComputeSslPolicyResource s) where
    toObject ComputeSslPolicyResource'{..} = catMaybes
...
computeSslPolicyResource _name =
    TF.newResource "google_compute_ssl_policy" $
        ComputeSslPolicyResource'
...
instance P.HasCustomFeatures (ComputeSslPolicyResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    customFeatures =
        P.lens (_customFeatures :: ComputeSslPolicyResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _customFeatures = a
                          } :: ComputeSslPolicyResource s)
...
instance s ~ s' => P.HasComputedEnabledFeatures (TF.Ref s' (ComputeSslPolicyResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance TF.IsObject (ComputeSubnetworkResource s) where
    toObject ComputeSubnetworkResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
...
instance P.HasPrivateIpGoogleAccess (ComputeSubnetworkResource s) (TF.Attr s P.Bool) where
    privateIpGoogleAccess =
        P.lens (_privateIpGoogleAccess :: ComputeSubnetworkResource s -> TF.Attr s P.Bool)
               (\s a -> s { _privateIpGoogleAccess = a
                          } :: ComputeSubnetworkResource s)
...
instance s ~ s' => P.HasComputedSecondaryIpRange (TF.Ref s' (ComputeSubnetworkResource s)) (TF.Attr s [SecondaryIpRange s]) where
...
instance TF.IsObject (ComputeSubnetworkIamBindingResource s) where
    toObject ComputeSubnetworkIamBindingResource'{..} = catMaybes
...
computeSubnetworkIamBindingResource _members _role _subnetwork =
    TF.newResource "google_compute_subnetwork_iam_binding" $
        ComputeSubnetworkIamBindingResource'
            { _members = _members
            , _role = _role
...
instance P.HasMembers (ComputeSubnetworkIamBindingResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    members =
        P.lens (_members :: ComputeSubnetworkIamBindingResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _members = a
                          } :: ComputeSubnetworkIamBindingResource s)
...
instance TF.IsObject (ComputeSubnetworkIamMemberResource s) where
    toObject ComputeSubnetworkIamMemberResource'{..} = catMaybes
...
computeSubnetworkIamMemberResource _member _role _subnetwork =
    TF.newResource "google_compute_subnetwork_iam_member" $
        ComputeSubnetworkIamMemberResource'
            { _member = _member
            , _role = _role
            , _subnetwork = _subnetwork
...
instance P.HasMember (ComputeSubnetworkIamMemberResource s) (TF.Attr s P.Text) where
    member =
        P.lens (_member :: ComputeSubnetworkIamMemberResource s -> TF.Attr s P.Text)
               (\s a -> s { _member = a
                          } :: ComputeSubnetworkIamMemberResource s)
...
instance TF.IsObject (ComputeSubnetworkIamPolicyResource s) where
    toObject ComputeSubnetworkIamPolicyResource'{..} = catMaybes
...
computeSubnetworkIamPolicyResource _policyData _subnetwork =
    TF.newResource "google_compute_subnetwork_iam_policy" $
        ComputeSubnetworkIamPolicyResource'
...
instance P.HasPolicyData (ComputeSubnetworkIamPolicyResource s) (TF.Attr s P.Text) where
    policyData =
        P.lens (_policyData :: ComputeSubnetworkIamPolicyResource s -> TF.Attr s P.Text)
               (\s a -> s { _policyData = a
                          } :: ComputeSubnetworkIamPolicyResource s)
...
instance TF.IsObject (ComputeTargetHttpProxyResource s) where
    toObject ComputeTargetHttpProxyResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
...
instance P.HasDescription (ComputeTargetHttpProxyResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeTargetHttpProxyResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeTargetHttpProxyResource s)
...
instance TF.IsObject (ComputeTargetHttpsProxyResource s) where
    toObject ComputeTargetHttpsProxyResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
...
instance P.HasDescription (ComputeTargetHttpsProxyResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: ComputeTargetHttpsProxyResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: ComputeTargetHttpsProxyResource s)
...
data ComputeTargetPoolResource s = ComputeTargetPoolResource'
    ...
    --
    , _healthChecks    :: TF.Attr s (TF.Attr s P.Text)
...
instance P.HasFailoverRatio (ComputeTargetPoolResource s) (TF.Attr s P.Double) where
    failoverRatio =
        P.lens (_failoverRatio :: ComputeTargetPoolResource s -> TF.Attr s P.Double)
               (\s a -> s { _failoverRatio = a
                          } :: ComputeTargetPoolResource s)

instance P.HasHealthChecks (ComputeTargetPoolResource s) (TF.Attr s (TF.Attr s P.Text)) where
    healthChecks =
        P.lens (_healthChecks :: ComputeTargetPoolResource s -> TF.Attr s (TF.Attr s P.Text))
               (\s a -> s { _healthChecks = a
                          } :: ComputeTargetPoolResource s)
...
instance TF.IsObject (ComputeTargetSslProxyResource s) where
    toObject ComputeTargetSslProxyResource'{..} = catMaybes
        [ TF.assign "backend_service" <$> TF.attribute _backendService
        , TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
...
instance P.HasBackendService (ComputeTargetSslProxyResource s) (TF.Attr s P.Text) where
    backendService =
        P.lens (_backendService :: ComputeTargetSslProxyResource s -> TF.Attr s P.Text)
               (\s a -> s { _backendService = a
                          } :: ComputeTargetSslProxyResource s)
...
instance P.HasSslCertificates (ComputeTargetSslProxyResource s) (TF.Attr s (TF.Attr s P.Text)) where
    sslCertificates =
        P.lens (_sslCertificates :: ComputeTargetSslProxyResource s -> TF.Attr s (TF.Attr s P.Text))
               (\s a -> s { _sslCertificates = a
                          } :: ComputeTargetSslProxyResource s)
...
instance TF.IsObject (ComputeTargetTcpProxyResource s) where
    toObject ComputeTargetTcpProxyResource'{..} = catMaybes
        [ TF.assign "backend_service" <$> TF.attribute _backendService
        , TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
        , TF.assign "proxy_header" <$> TF.attribute _proxyHeader
...
instance P.HasBackendService (ComputeTargetTcpProxyResource s) (TF.Attr s P.Text) where
    backendService =
        P.lens (_backendService :: ComputeTargetTcpProxyResource s -> TF.Attr s P.Text)
               (\s a -> s { _backendService = a
                          } :: ComputeTargetTcpProxyResource s)
...
data ComputeUrlMapResource s = ComputeUrlMapResource'
    ...
    -- ^ @name@ - (Required)
    --
    , _pathMatcher    :: TF.Attr s [PathMatcher s]
    -- ^ @path_matcher@ - (Optional)
    --
    , _test           :: TF.Attr s [Test s]
    -- ^ @test@ - (Optional)
    --
    } deriving (P.Show, P.Eq, P.Generic)
...
instance P.HasPathMatcher (ComputeUrlMapResource s) (TF.Attr s [PathMatcher s]) where
    pathMatcher =
        P.lens (_pathMatcher :: ComputeUrlMapResource s -> TF.Attr s [PathMatcher s])
               (\s a -> s { _pathMatcher = a
                          } :: ComputeUrlMapResource s)

instance P.HasTest (ComputeUrlMapResource s) (TF.Attr s [Test s]) where
    test =
        P.lens (_test :: ComputeUrlMapResource s -> TF.Attr s [Test s])
               (\s a -> s { _test = a
                          } :: ComputeUrlMapResource s)
...
instance TF.IsObject (ComputeVpnGatewayResource s) where
    toObject ComputeVpnGatewayResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
        , TF.assign "name" <$> TF.attribute _name
        , TF.assign "network" <$> TF.attribute _network
        ]
...
instance TF.IsObject (ComputeVpnTunnelResource s) where
    toObject ComputeVpnTunnelResource'{..} = catMaybes
        [ TF.assign "description" <$> TF.attribute _description
...
instance s ~ s' => P.HasComputedLocalTrafficSelector (TF.Ref s' (ComputeVpnTunnelResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance s ~ s' => P.HasComputedRemoteTrafficSelector (TF.Ref s' (ComputeVpnTunnelResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance P.HasEnableKubernetesAlpha (ContainerClusterResource s) (TF.Attr s P.Bool) where
    enableKubernetesAlpha =
        P.lens (_enableKubernetesAlpha :: ContainerClusterResource s -> TF.Attr s P.Bool)
               (\s a -> s { _enableKubernetesAlpha = a
                          } :: ContainerClusterResource s)
...
instance P.HasMasterAuthorizedNetworksConfig (ContainerClusterResource s) (TF.Attr s (MasterAuthorizedNetworksConfig s)) where
    masterAuthorizedNetworksConfig =
        P.lens (_masterAuthorizedNetworksConfig :: ContainerClusterResource s -> TF.Attr s (MasterAuthorizedNetworksConfig s))
               (\s a -> s { _masterAuthorizedNetworksConfig = a
                          } :: ContainerClusterResource s)
...
instance P.HasPodSecurityPolicyConfig (ContainerClusterResource s) (TF.Attr s (PodSecurityPolicyConfig s)) where
    podSecurityPolicyConfig =
        P.lens (_podSecurityPolicyConfig :: ContainerClusterResource s -> TF.Attr s (PodSecurityPolicyConfig s))
               (\s a -> s { _podSecurityPolicyConfig = a
                          } :: ContainerClusterResource s)
...
instance P.HasRemoveDefaultNodePool (ContainerClusterResource s) (TF.Attr s P.Bool) where
    removeDefaultNodePool =
        P.lens (_removeDefaultNodePool :: ContainerClusterResource s -> TF.Attr s P.Bool)
               (\s a -> s { _removeDefaultNodePool = a
                          } :: ContainerClusterResource s)
...
instance P.HasResourceLabels (ContainerClusterResource s) (TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text))) where
    resourceLabels =
        P.lens (_resourceLabels :: ContainerClusterResource s -> TF.Attr s (P.HashMap P.Text (TF.Attr s P.Text)))
               (\s a -> s { _resourceLabels = a
                          } :: ContainerClusterResource s)

instance s ~ s' => P.HasComputedAdditionalZones (TF.Ref s' (ContainerClusterResource s)) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
...
instance s ~ s' => P.HasComputedNodePool (TF.Ref s' (ContainerClusterResource s)) (TF.Attr s [NodePool s]) where
...
instance P.HasManagedZone (DnsRecordSetResource s) (TF.Attr s P.Text) where
    managedZone =
        P.lens (_managedZone :: DnsRecordSetResource s -> TF.Attr s P.Text)
               (\s a -> s { _managedZone = a
                          } :: DnsRecordSetResource s)
...
instance s ~ s' => P.HasComputedApis (TF.Ref s' (EndpointsServiceResource s)) (TF.Attr s [Apis s]) where
...
instance s ~ s' => P.HasComputedEndpoints (TF.Ref s' (EndpointsServiceResource s)) (TF.Attr s [Endpoints s]) where
...
instance P.HasFolder (FolderIamBindingResource s) (TF.Attr s P.Text) where
    folder =
        P.lens (_folder :: FolderIamBindingResource s -> TF.Attr s P.Text)
               (\s a -> s { _folder = a
                          } :: FolderIamBindingResource s)

instance P.HasMembers (FolderIamBindingResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    members =
        P.lens (_members :: FolderIamBindingResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _members = a
                          } :: FolderIamBindingResource s)
    ...
    booleanPolicy =
        P.lens (_booleanPolicy :: FolderOrganizationPolicyResource s -> TF.Attr s (BooleanPolicy s))
               (\s a -> s { _booleanPolicy = a
                          , _listPolicy = TF.Nil
                          , _restorePolicy = TF.Nil
                          } :: FolderOrganizationPolicyResource s)
...
instance P.HasCryptoKeyId (KmsCryptoKeyIamBindingResource s) (TF.Attr s P.Text) where
    cryptoKeyId =
        P.lens (_cryptoKeyId :: KmsCryptoKeyIamBindingResource s -> TF.Attr s P.Text)
               (\s a -> s { _cryptoKeyId = a
                          } :: KmsCryptoKeyIamBindingResource s)

instance P.HasMembers (KmsCryptoKeyIamBindingResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    members =
        P.lens (_members :: KmsCryptoKeyIamBindingResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _members = a
                          } :: KmsCryptoKeyIamBindingResource s)
...
instance P.HasCryptoKeyId (KmsCryptoKeyIamMemberResource s) (TF.Attr s P.Text) where
    cryptoKeyId =
        P.lens (_cryptoKeyId :: KmsCryptoKeyIamMemberResource s -> TF.Attr s P.Text)
               (\s a -> s { _cryptoKeyId = a
                          } :: KmsCryptoKeyIamMemberResource s)
...
instance TF.IsObject (KmsKeyRingIamBindingResource s) where
    toObject KmsKeyRingIamBindingResource'{..} = catMaybes
...
kmsKeyRingIamBindingResource _keyRingId _members _role =
    TF.newResource "google_kms_key_ring_iam_binding" $
        KmsKeyRingIamBindingResource'
...
instance P.HasKeyRingId (KmsKeyRingIamBindingResource s) (TF.Attr s P.Text) where
    keyRingId =
        P.lens (_keyRingId :: KmsKeyRingIamBindingResource s -> TF.Attr s P.Text)
               (\s a -> s { _keyRingId = a
                          } :: KmsKeyRingIamBindingResource s)

instance P.HasMembers (KmsKeyRingIamBindingResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    members =
        P.lens (_members :: KmsKeyRingIamBindingResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _members = a
                          } :: KmsKeyRingIamBindingResource s)
...
instance TF.IsObject (KmsKeyRingIamMemberResource s) where
    toObject KmsKeyRingIamMemberResource'{..} = catMaybes
        [ TF.assign "key_ring_id" <$> TF.attribute _keyRingId
        , TF.assign "member" <$> TF.attribute _member
        , TF.assign "role" <$> TF.attribute _role
        ]
...
kmsKeyRingIamMemberResource _keyRingId _member _role =
    TF.newResource "google_kms_key_ring_iam_member" $
        KmsKeyRingIamMemberResource'
            { _keyRingId = _keyRingId
            , _member = _member
            , _role = _role
...
instance TF.IsObject (KmsKeyRingIamPolicyResource s) where
    toObject KmsKeyRingIamPolicyResource'{..} = catMaybes
        [ TF.assign "key_ring_id" <$> TF.attribute _keyRingId
        , TF.assign "policy_data" <$> TF.attribute _policyData
        ]
...
kmsKeyRingIamPolicyResource _keyRingId _policyData =
    TF.newResource "google_kms_key_ring_iam_policy" $
        KmsKeyRingIamPolicyResource'
            { _keyRingId = _keyRingId
            , _policyData = _policyData
            }
    ...
    billingAccount =
        P.lens (_billingAccount :: LoggingBillingAccountExclusionResource s -> TF.Attr s P.Text)
               (\s a -> s { _billingAccount = a
                          } :: LoggingBillingAccountExclusionResource s)
...
instance P.HasBillingAccount (LoggingBillingAccountSinkResource s) (TF.Attr s P.Text) where
    billingAccount =
        P.lens (_billingAccount :: LoggingBillingAccountSinkResource s -> TF.Attr s P.Text)
               (\s a -> s { _billingAccount = a
                          } :: LoggingBillingAccountSinkResource s)
...
instance P.HasDescription (LoggingFolderExclusionResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: LoggingFolderExclusionResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: LoggingFolderExclusionResource s)
...
instance P.HasDescription (LoggingOrganizationExclusionResource s) (TF.Attr s P.Text) where
    description =
        P.lens (_description :: LoggingOrganizationExclusionResource s -> TF.Attr s P.Text)
               (\s a -> s { _description = a
                          } :: LoggingOrganizationExclusionResource s)
