...
data ContainerClusterResource = ContainerClusterResource
    ...
    , _ip_allocation_policy :: !(Attr Text)
...
data DataprocJobResource = DataprocJobResource
    ...
    , _placement :: !(Attr Qual.PlacementType)
    ...
    , _scheduling :: !(Attr Qual.SchedulingType)
    {- ^ (Optional) See datatype documentation. -}
    , _xxx_config :: !(Attr Text)
...
type instance Computed DataprocJobResource
    = '[ '("driver_controls_files_uri", Text)
       {- - If present, the location of miscellaneous control files which may be used as part of job setup and handling. If not present, control files may be placed in the same location as driver_output_uri. -}
       , '("driver_output_resource_uri", Text)
       {- - A URI pointing to the location of the stdout of the job's driver program. -}
       , '("reference.0.cluster_uuid", Text)
       {- - A cluster UUID generated by the Cloud Dataproc service when the job is submitted. -}
       , '("status.0.details", Text)
       {- - Optional job state details, such as an error description if the state is ERROR. -}
       , '("status.0.state", Text)
       {- - A state message specifying the overall job state. -}
       , '("status.0.state_start_time", Text)
       {- - The time when this state was entered. -}
       , '("status.0.substate", Text)
...
type instance Computed FolderOrganizationPolicyResource
    = '[ '("etag", Text)
...
type instance Computed KmsCryptoKeyIamBindingResource
    = '[ '("etag", Text)
...
type instance Computed KmsCryptoKeyIamMemberResource
    = '[ '("etag", Text)
...
type instance Computed OrganizationIamBindingResource
    = '[ '("etag", Text)
...
type instance Computed OrganizationIamMemberResource
    = '[ '("etag", Text)
       {- - (Computed) The etag of the organization's IAM policy. -}
       ]
