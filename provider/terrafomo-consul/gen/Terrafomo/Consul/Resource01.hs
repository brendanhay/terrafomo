...
data CatalogEntryResource s = CatalogEntryResource'
    ...
    --
    , _service    :: TF.Attr s [TF.Attr s (CatalogEntryServiceSetting s)]
...
instance P.HasService (CatalogEntryResource s) (TF.Attr s [TF.Attr s (CatalogEntryServiceSetting s)]) where
    service =
        P.lens (_service :: CatalogEntryResource s -> TF.Attr s [TF.Attr s (CatalogEntryServiceSetting s)])
...
instance P.HasKey (KeysResource s) (TF.Attr s [TF.Attr s (KeysKeySetting s)]) where
    key =
        P.lens (_key :: KeysResource s -> TF.Attr s [TF.Attr s (KeysKeySetting s)])
...
data PreparedQueryResource s = PreparedQueryResource'
    ...
    -- ^ @datacenter@ - (Optional)
    --
    , _dns         :: TF.Attr s (PreparedQueryDnsSetting s)
    -- ^ @dns@ - (Optional)
    --
    , _failover    :: TF.Attr s (PreparedQueryFailoverSetting s)
    -- ^ @failover@ - (Optional)
    --
    , _name        :: TF.Attr s P.Text
    -- ^ @name@ - (Required)
    ...
    -- ^ @tags@ - (Optional)
    --
    , _template    :: TF.Attr s (PreparedQueryTemplateSetting s)
    -- ^ @template@ - (Optional)
    --
    , _token       :: TF.Attr s P.Text
    -- ^ @token@ - (Optional)
...
instance TF.IsValid (PreparedQueryResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_dns"
                  (_dns
                      :: PreparedQueryResource s -> TF.Attr s (PreparedQueryDnsSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_failover"
                  (_failover
                      :: PreparedQueryResource s -> TF.Attr s (PreparedQueryFailoverSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_template"
                  (_template
                      :: PreparedQueryResource s -> TF.Attr s (PreparedQueryTemplateSetting s))
                  TF.validator
...
instance P.HasDns (PreparedQueryResource s) (TF.Attr s (PreparedQueryDnsSetting s)) where
    dns =
        P.lens (_dns :: PreparedQueryResource s -> TF.Attr s (PreparedQueryDnsSetting s))
               (\s a -> s { _dns = a } :: PreparedQueryResource s)

instance P.HasFailover (PreparedQueryResource s) (TF.Attr s (PreparedQueryFailoverSetting s)) where
    failover =
        P.lens (_failover :: PreparedQueryResource s -> TF.Attr s (PreparedQueryFailoverSetting s))
...
instance P.HasTemplate (PreparedQueryResource s) (TF.Attr s (PreparedQueryTemplateSetting s)) where
    template =
        P.lens (_template :: PreparedQueryResource s -> TF.Attr s (PreparedQueryTemplateSetting s))
