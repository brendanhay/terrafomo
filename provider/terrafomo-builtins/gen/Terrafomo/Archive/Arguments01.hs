...
instance HasExcludes a b => HasExcludes (TF.Resource l p a) b where
...
instance HasOutputPath a b => HasOutputPath (TF.Resource l p a) b where
...
instance HasSourceContent a b => HasSourceContent (TF.Resource l p a) b where
    sourceContent = TF.configuration . sourceContent

class HasSourceContentFilename a b | a -> b where
    sourceContentFilename :: P.Lens' a b

instance HasSourceContentFilename a b => HasSourceContentFilename (TF.Resource l p a) b where
