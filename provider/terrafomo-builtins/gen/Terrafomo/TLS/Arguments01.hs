...
instance HasDnsNames a b => HasDnsNames (TF.Resource l p a) b where
    dnsNames = TF.configuration . dnsNames

class HasEarlyRenewalHours a b | a -> b where
    earlyRenewalHours :: P.Lens' a b

instance HasEarlyRenewalHours a b => HasEarlyRenewalHours (TF.Resource l p a) b where
    earlyRenewalHours = TF.configuration . earlyRenewalHours

class HasEcdsaCurve a b | a -> b where
    ecdsaCurve :: P.Lens' a b

instance HasEcdsaCurve a b => HasEcdsaCurve (TF.Resource l p a) b where
...
instance HasIsCaCertificate a b => HasIsCaCertificate (TF.Resource l p a) b where
...
instance HasValidityPeriodHours a b => HasValidityPeriodHours (TF.Resource l p a) b where
