...
instance P.HasPart (CloudinitConfigData s) (TF.Attr s [TF.Attr s (CloudinitConfigPartSetting s)]) where
    part =
        P.lens (_part :: CloudinitConfigData s -> TF.Attr s [TF.Attr s (CloudinitConfigPartSetting s)])
