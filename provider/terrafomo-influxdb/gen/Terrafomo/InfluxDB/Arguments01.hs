...
-- |
-- Module      : Terrafomo.InfluxDB.Arguments01
...
instance HasAdmin a b => HasAdmin (TF.Resource l p a) b where
...
instance HasRetentionPolicies a b => HasRetentionPolicies (TF.Resource l p a) b where
