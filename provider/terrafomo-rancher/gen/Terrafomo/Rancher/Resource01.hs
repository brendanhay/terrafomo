...
data EnvironmentResource s = EnvironmentResource'
    ...
    -- ^ @description@ - (Optional)
    --
    , _member            :: TF.Attr s [TF.Attr s (EnvironmentMemberSetting s)]
    -- ^ @member@ - (Optional)
    --
    , _name              :: TF.Attr s P.Text
    -- ^ @name@ - (Required)
...
instance P.HasMember (EnvironmentResource s) (TF.Attr s [TF.Attr s (EnvironmentMemberSetting s)]) where
    member =
        P.lens (_member :: EnvironmentResource s -> TF.Attr s [TF.Attr s (EnvironmentMemberSetting s)])
...
instance s ~ s' => P.HasComputedMember (TF.Ref s' (EnvironmentResource s)) (TF.Attr s [TF.Attr s (EnvironmentMemberSetting s)]) where
