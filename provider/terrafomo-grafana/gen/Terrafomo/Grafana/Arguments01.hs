...
instance HasAdminUser a b => HasAdminUser (TF.Resource l p a) b where
    adminUser = TF.configuration . adminUser

class HasAdmins a b | a -> b where
    admins :: P.Lens' a b

instance HasAdmins a b => HasAdmins (TF.Resource l p a) b where
    admins = TF.configuration . admins

class HasAssumeRoleArn a b | a -> b where
    assumeRoleArn :: P.Lens' a b

instance HasAssumeRoleArn a b => HasAssumeRoleArn (TF.Resource l p a) b where
...
instance HasDefaultRegion a b => HasDefaultRegion (TF.Resource l p a) b where
    defaultRegion = TF.configuration . defaultRegion

class HasEditors a b | a -> b where
    editors :: P.Lens' a b

instance HasEditors a b => HasEditors (TF.Resource l p a) b where
...
instance HasJsonData a b => HasJsonData (TF.Resource l p a) b where
...
instance HasSecureJsonData a b => HasSecureJsonData (TF.Resource l p a) b where
...
instance HasViewers a b => HasViewers (TF.Resource l p a) b where
