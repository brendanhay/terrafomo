...
instance HasBackups a s b => HasBackups (TF.DataSource p a) s b where
...
instance HasDropletId a s b => HasDropletId (TF.DataSource p a) s b where
...
instance HasDropletIds a s b => HasDropletIds (TF.DataSource p a) s b where
...
instance HasDropletTag a s b => HasDropletTag (TF.DataSource p a) s b where
...
instance HasForwardingRule a s b => HasForwardingRule (TF.DataSource p a) s b where
...
instance HasInboundRule a s b => HasInboundRule (TF.DataSource p a) s b where
...
instance HasIpv6 a s b => HasIpv6 (TF.DataSource p a) s b where
...
instance HasLeafCertificate a s b => HasLeafCertificate (TF.DataSource p a) s b where
...
instance HasOutboundRule a s b => HasOutboundRule (TF.DataSource p a) s b where
...
instance HasPrivateNetworking a s b => HasPrivateNetworking (TF.DataSource p a) s b where
...
instance HasRedirectHttpToHttps a s b => HasRedirectHttpToHttps (TF.DataSource p a) s b where
...
instance HasResizeDisk a s b => HasResizeDisk (TF.DataSource p a) s b where
...
instance HasStickySessions a s b => HasStickySessions (TF.DataSource p a) s b where
...
instance HasVolumeIds a s b => HasVolumeIds (TF.DataSource p a) s b where
