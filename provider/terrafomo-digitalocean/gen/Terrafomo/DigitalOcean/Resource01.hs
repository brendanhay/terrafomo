...
data FirewallResource s = FirewallResource'
    ...
    --
    , _inboundRule  :: TF.Attr s [TF.Attr s (FirewallInboundRuleSetting s)]
    -- ^ @inbound_rule@ - (Optional)
    --
    , _name         :: TF.Attr s P.Text
    -- ^ @name@ - (Required)
    --
    , _outboundRule :: TF.Attr s [TF.Attr s (FirewallOutboundRuleSetting s)]
...
instance P.HasInboundRule (FirewallResource s) (TF.Attr s [TF.Attr s (FirewallInboundRuleSetting s)]) where
    inboundRule =
        P.lens (_inboundRule :: FirewallResource s -> TF.Attr s [TF.Attr s (FirewallInboundRuleSetting s)])
...
instance P.HasOutboundRule (FirewallResource s) (TF.Attr s [TF.Attr s (FirewallOutboundRuleSetting s)]) where
    outboundRule =
        P.lens (_outboundRule :: FirewallResource s -> TF.Attr s [TF.Attr s (FirewallOutboundRuleSetting s)])
...
instance s ~ s' => P.HasComputedPendingChanges (TF.Ref s' (FirewallResource s)) (TF.Attr s [TF.Attr s (FirewallPendingChangesSetting s)]) where
...
data LoadbalancerResource s = LoadbalancerResource'
    ...
    --
    , _forwardingRule :: TF.Attr s (P.NonEmpty (TF.Attr s (LoadbalancerForwardingRuleSetting s)))
    -- ^ @forwarding_rule@ - (Required)
    --
    , _healthcheck :: TF.Attr s (LoadbalancerHealthcheckSetting s)
    ...
    -- ^ @region@ - (Required, Forces New)
    --
    , _stickySessions :: TF.Attr s (LoadbalancerStickySessionsSetting s)
...
loadbalancerResource
    :: TF.Attr s P.Text -- ^ @name@ ('P._name', 'P.name')
    -> TF.Attr s P.Text -- ^ @region@ ('P._region', 'P.region')
    -> TF.Attr s (P.NonEmpty (TF.Attr s (LoadbalancerForwardingRuleSetting s))) -- ^ @forwarding_rule@ ('P._forwardingRule', 'P.forwardingRule')
...
instance TF.IsValid (LoadbalancerResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_healthcheck"
                  (_healthcheck
                      :: LoadbalancerResource s -> TF.Attr s (LoadbalancerHealthcheckSetting s))
                  TF.validator
           P.<> TF.settingsValidator "_stickySessions"
                  (_stickySessions
                      :: LoadbalancerResource s -> TF.Attr s (LoadbalancerStickySessionsSetting s))
                  TF.validator
...
instance P.HasForwardingRule (LoadbalancerResource s) (TF.Attr s (P.NonEmpty (TF.Attr s (LoadbalancerForwardingRuleSetting s)))) where
    forwardingRule =
        P.lens (_forwardingRule :: LoadbalancerResource s -> TF.Attr s (P.NonEmpty (TF.Attr s (LoadbalancerForwardingRuleSetting s))))
               (\s a -> s { _forwardingRule = a } :: LoadbalancerResource s)

instance P.HasHealthcheck (LoadbalancerResource s) (TF.Attr s (LoadbalancerHealthcheckSetting s)) where
    healthcheck =
        P.lens (_healthcheck :: LoadbalancerResource s -> TF.Attr s (LoadbalancerHealthcheckSetting s))
...
instance P.HasStickySessions (LoadbalancerResource s) (TF.Attr s (LoadbalancerStickySessionsSetting s)) where
    stickySessions =
        P.lens (_stickySessions :: LoadbalancerResource s -> TF.Attr s (LoadbalancerStickySessionsSetting s))
...
instance s ~ s' => P.HasComputedStickySessions (TF.Ref s' (LoadbalancerResource s)) (TF.Attr s (LoadbalancerStickySessionsSetting s)) where
