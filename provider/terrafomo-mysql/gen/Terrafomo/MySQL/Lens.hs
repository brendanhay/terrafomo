...
instance HasDefaultCharacterSet a s b => HasDefaultCharacterSet (TF.Source l p a) s b where
...
instance HasDefaultCollation a s b => HasDefaultCollation (TF.Source l p a) s b where
...
instance HasPlaintextPassword a s b => HasPlaintextPassword (TF.Source l p a) s b where
...
instance HasPrivileges a s b => HasPrivileges (TF.Source l p a) s b where
