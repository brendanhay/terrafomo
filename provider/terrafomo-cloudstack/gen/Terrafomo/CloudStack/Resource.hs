...
instance TF.IsValid (EgressFirewallResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_rule"
                  (_rule
                      :: EgressFirewallResource s -> TF.Attr s [TF.Attr s (Rule s)])
                  TF.validator
...
instance TF.IsValid (FirewallResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_rule"
                  (_rule
                      :: FirewallResource s -> TF.Attr s [TF.Attr s (Rule s)])
                  TF.validator
...
instance TF.IsValid (NetworkAclRuleResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_rule"
                  (_rule
                      :: NetworkAclRuleResource s -> TF.Attr s [TF.Attr s (Rule s)])
                  TF.validator
...
instance TF.IsValid (PortForwardResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_forward"
                  (_forward
                      :: PortForwardResource s -> TF.Attr s [TF.Attr s (Forward s)])
                  TF.validator
...
instance TF.IsValid (SecurityGroupRuleResource s) where
    validator = P.mempty
           P.<> TF.settingsValidator "_rule"
                  (_rule
                      :: SecurityGroupRuleResource s -> TF.Attr s [TF.Attr s (Rule s)])
                  TF.validator
