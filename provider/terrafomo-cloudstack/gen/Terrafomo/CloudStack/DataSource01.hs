...
data TemplateData s = TemplateData'
    { _filter         :: TF.Attr s [TF.Attr s (TemplateFilterSetting s)]
...
templateData
    :: TF.Attr s [TF.Attr s (TemplateFilterSetting s)] -- ^ @filter@ ('P._filter', 'P.filter')
...
instance P.HasFilter (TemplateData s) (TF.Attr s [TF.Attr s (TemplateFilterSetting s)]) where
    filter =
        P.lens (_filter :: TemplateData s -> TF.Attr s [TF.Attr s (TemplateFilterSetting s)])
