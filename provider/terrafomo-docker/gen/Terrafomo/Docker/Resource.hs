...
data ContainerResource s = ContainerResource'
    ...
    -- ^ @devices@ - (Optional)
    --
    , _dns                 :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @dns@ - (Optional)
    --
    , _dnsOpts             :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @dns_opts@ - (Optional)
    --
    , _dnsSearch           :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @dns_search@ - (Optional)
    --
    ...
    -- ^ @entrypoint@ - (Optional)
    --
    , _env                 :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @env@ - (Optional)
    --
    ...
    -- ^ @labels@ - (Optional)
    --
    , _links               :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
    -- ^ @links@ - (Optional)
    --
    ...
    -- ^ @name@ - (Required)
    --
    , _networkAlias        :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance P.HasCapabilities (ContainerResource s) (TF.Attr s (TF.Attr s (Capabilities s))) where
    capabilities =
        P.lens (_capabilities :: ContainerResource s -> TF.Attr s (TF.Attr s (Capabilities s)))
...
instance P.HasDns (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    dns =
        P.lens (_dns :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _dns = a
                          } :: ContainerResource s)

instance P.HasDnsOpts (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    dnsOpts =
        P.lens (_dnsOpts :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _dnsOpts = a
                          } :: ContainerResource s)

instance P.HasDnsSearch (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    dnsSearch =
        P.lens (_dnsSearch :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _dnsSearch = a
                          } :: ContainerResource s)
...
instance P.HasEnv (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    env =
        P.lens (_env :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _env = a
                          } :: ContainerResource s)
...
instance P.HasLinks (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    links =
        P.lens (_links :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _links = a
                          } :: ContainerResource s)
...
instance P.HasNetworkAlias (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    networkAlias =
        P.lens (_networkAlias :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _networkAlias = a
                          } :: ContainerResource s)
...
instance P.HasNetworkMode (ContainerResource s) (TF.Attr s P.Text) where
    networkMode =
        P.lens (_networkMode :: ContainerResource s -> TF.Attr s P.Text)
               (\s a -> s { _networkMode = a
                          } :: ContainerResource s)

instance P.HasNetworks (ContainerResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    networks =
        P.lens (_networks :: ContainerResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _networks = a
                          } :: ContainerResource s)
...
data ImageResource s = ImageResource'
    ...
    --
    -- * 'pullTriggers'
    , _pullTriggers :: TF.Attr s [TF.Attr s (TF.Attr s P.Text)]
...
instance P.HasPullTrigger (ImageResource s) (TF.Attr s P.Text) where
    pullTrigger =
        P.lens (_pullTrigger :: ImageResource s -> TF.Attr s P.Text)
               (\s a -> s { _pullTrigger = a
                          , _pullTriggers = TF.Nil
                          } :: ImageResource s)

instance P.HasPullTriggers (ImageResource s) (TF.Attr s [TF.Attr s (TF.Attr s P.Text)]) where
    pullTriggers =
        P.lens (_pullTriggers :: ImageResource s -> TF.Attr s [TF.Attr s (TF.Attr s P.Text)])
               (\s a -> s { _pullTriggers = a
                          , _pullTrigger = TF.Nil
                          } :: ImageResource s)
