...
module Terraform.GitHub.Resource where
...
data Branch_Protection_Resource = Branch_Protection_Resource
    { branch :: !(Attr Text)
      {- ^ (Required) The Git branch to protect. -}
    , enforce_admins :: !(Attr Text)
...
type instance Computed Branch_Protection_Resource
    = '[]
...
data Issue_Label_Resource = Issue_Label_Resource
    { color :: !(Attr Text)
...
type instance Computed Issue_Label_Resource
    = '[]
...
data Membership_Resource = Membership_Resource
    { role :: !(Attr Text)
...
type instance Computed Membership_Resource
    = '[]
...
data Organization_Webhook_Resource = Organization_Webhook_Resource
    { active :: !(Attr Text)
...
type instance Computed Organization_Webhook_Resource
    = '[ '("url", Attr Text)
         {- - URL of the webhook -}
       ]
...
type instance Computed Repository_Collaborator_Resource
    = '[]
...
$(TH.makeResource
    ...
    ''GitHub
    'defaultProvider
    ''Repository_Collaborator_Resource)
...
data Repository_Deploy_Key_Resource = Repository_Deploy_Key_Resource
    { key :: !(Attr Text)
      {- ^ (Required) A ssh key. -}
    , read_only :: !(Attr Text)
...
type instance Computed Repository_Deploy_Key_Resource
    = '[]
...
$(TH.makeResource
    ...
    ''GitHub
    'defaultProvider
    ''Repository_Deploy_Key_Resource)

-- | The @github_repository@ GitHub resource.
--
-- This resource allows you to create and manage repositories within your Github organization. This resource cannot currently be used to manage personal repositories, outside of organizations.
data Repository_Resource = Repository_Resource
    { allow_merge_commit :: !(Attr Text)
      {- ^ (Optional) Set to @false@ to disable merge commits on the repository. -}
    , allow_rebase_merge :: !(Attr Text)
      {- ^ (Optional) Set to @false@ to disable rebase merges on the repository. -}
    , allow_squash_merge :: !(Attr Text)
    ...
    , homepage_url :: !(Attr Text)
      {- ^ (Optional) URL of a page describing the project. -}
    , license_template :: !(Attr Text)
...
--
-- This resource allows you to create and manage webhooks for repositories within your Github organization. This resource cannot currently be used to manage webhooks for personal repositories, outside of organizations.
data Repository_Webhook_Resource = Repository_Webhook_Resource
    { active :: !(Attr Text)
      {- ^ (Optional) Indicate of the webhook should receive events. Defaults to @true@ . -}
    , configuration :: !(Attr Text)
      {- ^ (Required) key/value pair of configuration for this webhook. Available keys are @url@ , @content_type@ , @secret@ and @insecure_ssl@ . -}
...
type instance Computed Repository_Webhook_Resource
    = '[ '("url", Attr Text)
         {- - URL of the webhook -}
       ]
...
type instance Computed Team_Repository_Resource
    = '[]
