...
module Terraform.Kubernetes.Resource where
...
data Config_Map_Resource = Config_Map_Resource
    { data' :: !(Attr Text)
...
type instance Computed Config_Map_Resource
    = '[]
...
data Horizontal_Pod_Autoscaler_Resource = Horizontal_Pod_Autoscaler_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Horizontal_Pod_Autoscaler_Resource
    = '[]
...
$(TH.makeResource
    ...
    ''Kubernetes
    'defaultProvider
    ''Horizontal_Pod_Autoscaler_Resource)

-- | The @kubernetes_limit_range@ Kubernetes resource.
--
-- Limit Range sets resource usage limits (e.g. memory, cpu, storage) for supported kinds of resources in a namespace. Read more in <https://kubernetes.io/docs/tasks/configure-pod-container/apply-resource-quota-limit/#applying-default-resource-requests-and-limits> .
data Limit_Range_Resource = Limit_Range_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Limit_Range_Resource
    = '[]
...
data Namespace_Resource = Namespace_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Namespace_Resource
    = '[]
...
data Persistent_Volume_Claim_Resource = Persistent_Volume_Claim_Resource
    { metadata :: !(Attr Text)
...
data Persistent_Volume_Resource = Persistent_Volume_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Persistent_Volume_Resource
    = '[]
...
--
-- A pod is a group of one or more containers, the shared storage for those containers, and options about how to run the containers. Pods are always co-located and co-scheduled, and run in a shared context. Read more at https://kubernetes.io/docs/concepts/workloads/pods/pod/
data Pod_Resource = Pod_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Pod_Resource
    = '[]
...
data Replication_Controller_Resource = Replication_Controller_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Replication_Controller_Resource
    = '[]
...
$(TH.makeResource
    ...
    ''Kubernetes
    'defaultProvider
    ''Replication_Controller_Resource)
...
data Resource_Quota_Resource = Resource_Quota_Resource
    { metadata :: !(Attr Text)
...
type instance Computed Resource_Quota_Resource
    = '[]
...
type instance Computed Secret_Resource
    = '[]
...
--
-- A service account provides an identity for processes that run in a Pod. Read more at https://kubernetes.io/docs/admin/service-accounts-admin/
data Service_Account_Resource = Service_Account_Resource
    { image_pull_secret :: !(Attr Text)
...
data Storage_Class_Resource = Storage_Class_Resource
    { metadata :: !(Attr Text)
    ...
    , storage_provisioner :: !(Attr Text)
      {- ^ (Required) Indicates the type of the provisioner -}
    } deriving (Show, Eq, Generic)

type instance Computed Storage_Class_Resource
    = '[]
