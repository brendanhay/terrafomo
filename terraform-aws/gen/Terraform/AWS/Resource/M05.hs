...
--
-- @
-- test_destination <- resource "test_destination" $
--     cloudwatch_log_destination_resource
--         & name .~ "test_destination"
--         & role_arn .~ compute iam_for_cloudwatch @"arn"
--         & target_arn .~ compute kinesis_for_cloudwatch @"arn"
-- @
...
--         & app_name .~ compute foo_app @"name"
--         & deployment_group_name .~ "bar"
--         & service_role_arn .~ compute foo_role @"arn"
--         & deployment_config_name .~ compute foo @"id"
-- @
...
--
-- Provides an Elastic Load Balancer resource, also known as a "Classic Load Balancer" after the release of </docs/providers/aws/r/lb.html> .
...
--  
-- output "password" $
--     "${aws_iam_user_login_profile.u.encrypted_password}"
-- @
...
--
-- @
-- my_instance <- resource "my_instance" $
--     opsworks_rds_db_instance_resource
--         & stack_id .~ compute my_stack @"id"
--         & rds_db_instance_arn .~ compute my_instance @"arn"
--         & db_user .~ "someUser"
...
--  
-- vpn_attachment <- resource "vpn_attachment" $
--     vpn_gateway_attachment_resource
--         & vpc_id .~ compute network @"id"
--         & vpn_gateway_id .~ compute vpn @"id"
-- @
